...
pub const gameplay_slug_mask_sprite_path = "SPRITES/SLUGMASK.TGA";
...
pub const gameplay_slow_ring_big_sprite_path = "SPRITES/PARTICLESLOW-BIG.TGA";
pub const gameplay_blaster_projectile_sprite_path = "SPRITES/PARTICLEBLASTERS.TGA";
pub const gameplay_blaster_trail_sprite_path = "SPRITES/JET.TGA";
