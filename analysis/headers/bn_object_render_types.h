...
/*
 * Binary Ninja-only view of the borrowed 0x60-byte immediate-mode lock.
 * The renderer owns the backing vertex buffer; this wrapper only preserves
 * the four consecutive ObjectRenderVertex records during decompilation.
 */
