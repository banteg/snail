...
typedef void (CALLBACK SYNCPROC)(HSYNC sync, DWORD channel, DWORD data, DWORD user);

BOOL WINAPI BASS_Init(DWORD device, DWORD freq, DWORD flags, HWND window, const GUID *clsid);
...
typedef BOOL (WINAPI *BASS_InitProc)(DWORD device, DWORD freq, DWORD flags, HWND window, const GUID *clsid);
typedef DWORD (WINAPI *BASS_SetConfigProc)(DWORD option, DWORD value);
typedef BOOL (WINAPI *BASS_FreeProc)(void);
typedef BOOL (WINAPI *BASS_UpdateProc)(void);
...
typedef void (WINAPI *BASS_StreamFreeProc)(HSTREAM stream);
typedef HSAMPLE (WINAPI *BASS_SampleLoadProc)(BOOL mem, const void *file, DWORD offset, DWORD length, DWORD max, DWORD flags);
typedef HCHANNEL (WINAPI *BASS_SamplePlayExProc)(HSAMPLE sample, DWORD start, INT freq, INT volume, INT pan, BOOL loop);
typedef BOOL (WINAPI *BASS_SampleStopProc)(HSAMPLE sample);
typedef BOOL (WINAPI *BASS_ChannelStopProc)(DWORD channel);
typedef float (WINAPI *BASS_ChannelBytes2SecondsProc)(DWORD channel, QWORD position);
...
typedef HSYNC (WINAPI *BASS_ChannelSetSyncProc)(DWORD channel, DWORD sync_type, QWORD parameter, SYNCPROC *proc, DWORD user);
typedef QWORD (WINAPI *BASS_ChannelGetPositionProc)(DWORD channel);
