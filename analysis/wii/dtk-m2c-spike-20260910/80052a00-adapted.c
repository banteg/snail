...
void fn_80052A00(void *arg0) {
    ...
    do {
        ...
        temp_r3 = fn_8003EFF4(&lbl_8058FB38, var_r29->unk4, 0, 0);
...
loop_2:
            ...
            if ((u32) (temp_r6 + var_r5)->unkC == temp_r3) {
                if (temp_r28->unk0 & 0x20) {
                    ...
                    temp_r3_2 = (temp_r6 + temp_r5_2)->unk2;
                    var_r30->unk808 = (f32) ((temp_r28->unk18 * (f32) (s8) *(temp_r28->unkAC + ((temp_r3_2 * 4) - temp_r3_2))) + var_r30->unk808);
                    temp_r3_3 = (temp_r28->unkD4 + temp_r5_2)->unk2;
                    var_r30->unk80C = (f32) ((temp_r28->unk18 * (f32) (s8) (temp_r28->unkAC + ((temp_r3_3 * 4) - temp_r3_3))->unk1) + var_r30->unk80C);
                    temp_r3_4 = (temp_r28->unkD4 + temp_r5_2)->unk2;
                    var_r30->unk810 = (f32) ((temp_r28->unk18 * (f32) (s8) (temp_r28->unkAC + ((temp_r3_4 * 4) - temp_r3_4))->unk2) + var_r30->unk810);
                }
    ...
    temp_f6 = arg0->unkA04 + lbl_808F53DC;
    arg0->unkA04 = temp_f6;
    arg0->unk95C = (f32) (arg0->unk95C + lbl_808F53CC);
    arg0->unkA18 = 1;
    arg0->unkA1C = (f32) lbl_808F5378;
    arg0->unkA20 = (f32) lbl_808F54CC;
    arg0->unkA24 = (f32) lbl_808F54FC;
    arg0->unkA38 = (f32) arg0->unkA00;
    arg0->unkA3C = temp_f6;
    arg0->unkA40 = (f32) arg0->unkA08;
}
