/*
 * mangled: _Z15ObjectProcSkirtP8cRObjectiffPc
 * demangled: ObjectProcSkirt(cRObject*, int, float, float, char*)
 * address: 000348a0
 * size: 360
 */

/* ObjectProcSkirt(cRObject*, int, float, float, char*) */

void ObjectProcSkirt(cRObject *param_1,int param_2,float param_3,float param_4,char *param_5)
