  ...
  *in_r2 = *(float *)param_2;
  ...
  if (*(float *)(param_1 + 4) != 0.0) {
    ...
    *in_r2 = *in_r2 * fVar2;
    ...
    in_r2[6] = in_r2[6] * fVar1;
    in_r2[4] = in_r2[4] * fVar1;
    in_r2[5] = in_r2[5] * fVar1;
  ...
  if (*(float *)(param_1 + 8) != 0.0) {
    ...
    fVar3 = fVar1 + fVar3 * fVar2;
    fVar2 = (float)Sin(extraout_s0);
    in_r2[6] = in_r2[6] * fVar3;
    *in_r2 = *in_r2 * fVar3;
    fVar1 = fVar1 - fVar2;
    in_r2[1] = in_r2[1] * fVar3;
    in_r2[10] = in_r2[10] * fVar1;
    in_r2[2] = in_r2[2] * fVar3;
    in_r2[4] = in_r2[4] * fVar3;
    in_r2[5] = in_r2[5] * fVar3;
