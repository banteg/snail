...

{
  ...
  if ((4 < *(int *)(Game + 600)) && ((*(uint *)(this + 0x194) & 0x100000) == 0)) {
    return 0;
  }
  if (this[0x50] != (cRBorder)0x0) {
    fVar11 = *(float *)(this + 0x234);
    fVar8 = *(float *)(this + 0x248);
    if (fVar11 + fVar8 <= *(float *)(*(int *)(Game + 0x224) + 0x60)) {
      return 0;
    }
    fVar6 = *(float *)(*(int *)(Game + 0x224) + 100);
    fVar9 = *(float *)(this + 0x238);
    if (NAN(fVar6) || NAN(fVar9)) {
      return 0;
    }
    fVar5 = *(float *)(this + 0x24c);
    uVar2 = in_fpscr & 0xfffffff | (uint)(fVar6 < fVar9 + fVar5) << 0x1f;
    if (!SUB41(uVar2 >> 0x1f,0)) {
      return 0;
    }
    fVar6 = *(float *)(Game + 0x234);
    fVar7 = *(float *)(Game + 0x238);
    iVar1 = cRSpriteManager::GetTga((cRSpriteManager *)&gRSpriteManager,*(int *)(this + 0x58));
    uVar4 = (uint)*(ushort *)(iVar1 + 0xc);
    uVar3 = (uint)*(ushort *)(iVar1 + 0xe);
    fVar12 = (float)VectorSignedToFloat(uVar4,(byte)(uVar2 >> 0x16) & 3);
    fVar13 = (float)VectorSignedToFloat(uVar3,(byte)(uVar2 >> 0x16) & 3);
    ...
    else if (iVar14 < (int)uVar3) {
      iVar14 = uVar4 * iVar14;
    }
    else {
      iVar14 = uVar4 * (uVar3 - 1);
    }
    uVar2 = (uint)*(byte *)(iVar1 + (iVar14 + iVar10) * 3 + 0x12);
    if (1 < uVar2) {
      return 0;
    }
    return 1 - uVar2;
