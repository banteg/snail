/*
 * mangled: _Z11JAVAC_UnJpgPviS_iii
 * demangled: JAVAC_UnJpg(void*, int, void*, int, int, int)
 * address: 000249e8
 * size: 360
 */

/* JAVAC_UnJpg(void*, int, void*, int, int, int) */

void JAVAC_UnJpg(void *param_1,int param_2,void *param_3,int param_4,int param_5,int param_6)

{
  ...
  _JNIEnv::CallVoidMethod(gJavaEnv,gJavaObj,DAT_0009b4a4,uVar1,uVar2);
