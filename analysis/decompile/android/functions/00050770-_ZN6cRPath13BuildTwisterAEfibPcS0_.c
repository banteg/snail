...

{
  ...
  *(undefined4 *)(iVar3 + 0x15dc) = 0;
  fVar10 = (float)tMatrix::Identity((tMatrix *)(iVar5 + 0x15a8));
  iVar5 = *(int *)(param_2 + 0x50);
  iVar3 = *(int *)(param_2 + 0x4c);
  *(undefined4 *)(iVar5 + 0x15e0) = 0x42040000;
  uVar12 = *(undefined4 *)(iVar3 + 0x1638);
  *(undefined4 *)(iVar5 + 0x15dc) = 0x3efae148;
  *(undefined4 *)(iVar5 + 0x15d8) = uVar12;
  iVar5 = 0;
  do {
    iVar8 = iVar8 + 1;
    iVar7 = iVar5 + 0xa8;
