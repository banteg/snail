/*
 * mangled: _ZN7tMatrix11PreMultiplyERKS_
 * demangled: tMatrix::PreMultiply(tMatrix const&)
 * address: 000276f8
 * size: 4
 */
...
void __thiscall tMatrix::PreMultiply(tMatrix *this,tMatrix *param_1)

{
  ...
  Multiply(this,param_1,(tMatrix *)&uStack_50);
  return;
}
