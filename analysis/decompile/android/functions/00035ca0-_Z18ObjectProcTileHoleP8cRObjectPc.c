/*
 * mangled: _Z18ObjectProcTileHoleP8cRObjectPc
 * demangled: ObjectProcTileHole(cRObject*, char*)
 * address: 00035ca0
 * size: 228
 */

/* ObjectProcTileHole(cRObject*, char*) */

void ObjectProcTileHole(cRObject *param_1,char *param_2)
