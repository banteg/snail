...

{
  ...
  fVar16 = DAT_00057590;
  fVar13 = (float)(uint)param_4 * DAT_00057590;
  *(char **)(param_3 + 0x48) = param_6;
  fVar11 = DAT_00057594;
  *(float *)(param_3 + 0x44) = DAT_00057594;
  ...
  *(undefined4 *)(param_3 + 0x40) = uVar15;
  fVar20 = (fVar13 / fVar20) * DAT_000575a4;
      ...
      *(float *)(iVar8 + 0x34) = fVar1 + -((fVar11 - fVar16) * fVar20) * (float)param_5;
      if (iVar6 == 0) {
        ...
        *(float *)(iVar7 + 0x28) = fVar13 - fVar18;
        ...
        if (iVar14 <= iVar6 + 1) goto LAB_00057570;
      }
      iVar6 = iVar6 + 1;
      iVar9 = *(int *)(param_3 + 0x4c);
      iVar2 = iVar5;
...
LAB_00057574:
  ...
  *(undefined4 *)(iVar9 + 0x8c) = DAT_000575ac;
