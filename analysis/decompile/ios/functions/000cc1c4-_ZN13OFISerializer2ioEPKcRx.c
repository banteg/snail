/*
 * mangled: _ZN13OFISerializer2ioEPKcRx
 * demangled: OFISerializer::io(char const*, long long&)
 * address: 000cc1c4
 * size: 212
 */

/* OFISerializer::io(char const*, long long&) */

void __thiscall OFISerializer::io(OFISerializer *this,char *param_1,longlong *param_2)

{
  ...
  local_7c = &GCC_except_table14;
  local_74 = &LAB_000cc298;
  local_b0 = param_2;
  local_ac = param_1;
  local_a8 = this;
  __Unwind_SjLj_Register(auStack_98);
  local_a4 = *(code **)(*(int *)local_a8 + 0x24);
  local_94 = 0xffffffff;
