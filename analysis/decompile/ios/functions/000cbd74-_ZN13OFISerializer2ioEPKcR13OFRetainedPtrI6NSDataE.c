/*
 * mangled: _ZN13OFISerializer2ioEPKcR13OFRetainedPtrI6NSDataE
 * demangled: OFISerializer::io(char const*, OFRetainedPtr<NSData>&)
 * address: 000cbd74
 * size: 212
 */

/* OFISerializer::io(char const*, OFRetainedPtr<NSData>&) */
...

{
  ...
  local_7c = &GCC_except_table8;
  local_74 = &LAB_000cbe48;
  local_b0 = param_2;
  local_ac = param_1;
  local_a8 = this;
  __Unwind_SjLj_Register(auStack_98);
  local_a4 = *(code **)(*(int *)local_a8 + 0x38);
  local_94 = 0xffffffff;
