/*
 * mangled: _ZN17OFResourceDataMap27addNestedResourceArrayFieldEP8NSStringP13objc_selectorS3_
 * demangled: OFResourceDataMap::addNestedResourceArrayField(NSString*, objc_selector*, objc_selector*)
 * address: 000fabfc
 * size: 372
 */

/* OFResourceDataMap::addNestedResourceArrayField(NSString*, objc_selector*, objc_selector*) */

void __thiscall
OFResourceDataMap::addNestedResourceArrayField
...

{
  ...
  local_8c = &::GCC_except_table2;
  local_84 = &LAB_000fad70;
  local_bc = param_3;
  local_b8 = param_2;
  local_b4 = param_1;
  local_b0 = this;
  ...
  if (local_ac == (local_b0->field2_0x8).field0_0x0.field2_0x8) {
    ...
    if (local_ac != (FieldDescription *)0x0) {
      ...
      *(undefined4 *)(local_ac + 0xc) = local_68;
