/*
 * mangled: _Z17MacOFAddChallengei
 * demangled: MacOFAddChallenge(int)
 * address: 00007bf0
 * size: 292
 */

/* MacOFAddChallenge(int) */

void MacOFAddChallenge(int param_1)

{
  ...
  local_98 = &GCC_except_table2;
  local_90 = &LAB_00007d14;
  local_cc = param_1;
