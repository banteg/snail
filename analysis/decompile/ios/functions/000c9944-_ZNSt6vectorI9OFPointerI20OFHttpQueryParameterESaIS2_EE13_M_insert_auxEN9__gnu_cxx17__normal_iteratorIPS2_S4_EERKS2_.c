/*
 * mangled: _ZNSt6vectorI9OFPointerI20OFHttpQueryParameterESaIS2_EE13_M_insert_auxEN9__gnu_cxx17__normal_iteratorIPS2_S4_EERKS2_
 * demangled: std::vector<OFPointer<OFHttpQueryParameter>, std::allocator<OFPointer<OFHttpQueryParameter>>>::_M_insert_aux(__gnu_cxx::__normal_iterator<OFPointer<OFHttpQueryParameter>*, std::vector<OFPointer<OFHttpQueryParameter>, std::allocator<OFPointer<OFHttpQueryParameter>>>>, OFPointer<OFHttpQueryParameter> const&)
 * address: 000c9944
 * size: 976
 */

/* std::vector<OFPointer<OFHttpQueryParameter>, std::allocator<OFPointer<OFHttpQueryParameter> >
   >::_M_insert_aux(__gnu_cxx::__normal_iterator<OFPointer<OFHttpQueryParameter>*,
   std::vector<OFPointer<OFHttpQueryParameter>, std::allocator<OFPointer<OFHttpQueryParameter> > >
   >, OFPointer<OFHttpQueryParameter> const&) */
...

{
  ...
  uint uVar5;
  int *piVar6;
  vector<OFPointer<OFHttpQueryParameter>,std::allocator<OFPointer<OFHttpQueryParameter>>> *pvVar7;
  bool bVar8;
  undefined4 local_c4;
  int *local_c0;
  int *local_bc;
  vector<OFPointer<OFHttpQueryParameter>,std::allocator<OFPointer<OFHttpQueryParameter>>> *local_b8;
  int *local_b4;
  vector<OFPointer<OFHttpQueryParameter>,std::allocator<OFPointer<OFHttpQueryParameter>>> *local_b0;
  int local_ac;
  int *local_a8;
...
LAB_000c9cc4:
    ...
    if (uVar5 < uVar1) {
      ...
      if (0x3fffffff < uVar5) goto LAB_000c9cc4;
      local_a0 = uVar5 << 2;
    }
    local_90 = 0xffffffff;
    ...
    while (local_a8 != piVar3) {
      ...
      if (bVar8) {
        pvVar7 = (vector<OFPointer<OFHttpQueryParameter>,std::allocator<OFPointer<OFHttpQueryParameter>>>
                  *)*piVar3;
        *piVar6 = (int)pvVar7;
      }
      piVar3 = piVar3 + 1;
      piVar6 = piVar6 + 1;
      if (bVar8 && pvVar7 != (vector<OFPointer<OFHttpQueryParameter>,std::allocator<OFPointer<OFHttpQueryParameter>>>
                              *)0x0) {
    ...
    pvVar7 = local_b8;
    local_b0 = (vector<OFPointer<OFHttpQueryParameter>,std::allocator<OFPointer<OFHttpQueryParameter>>>
                *)(piVar6 + 1);
    if (local_a8 != piVar3) {
      do {
        if (local_b0 !=
            (vector<OFPointer<OFHttpQueryParameter>,std::allocator<OFPointer<OFHttpQueryParameter>>>
             *)0x0) {
          pvVar7 = (vector<OFPointer<OFHttpQueryParameter>,std::allocator<OFPointer<OFHttpQueryParameter>>>
                    *)*local_a8;
          *(vector<OFPointer<OFHttpQueryParameter>,std::allocator<OFPointer<OFHttpQueryParameter>>>
        ...
        if (local_b0 !=
            (vector<OFPointer<OFHttpQueryParameter>,std::allocator<OFPointer<OFHttpQueryParameter>>>
             *)0x0 && pvVar7 != (vector<OFPointer<OFHttpQueryParameter>,std::allocator<OFPointer<OFHttpQueryParameter>>>
                                 *)0x0) {
          *(int *)(pvVar7 + 4) = *(int *)(pvVar7 + 4) + 1;
        }
        pvVar7 = local_b0 + 4;
    ...
    *(int *)(local_b8 + 4) = *(int *)(local_b8 + 4) + 4;
    ...
    if (local_a4 == pOVar2) {
      if (local_a4 == (OFSmartObject *)0x0) goto LAB_000c9ad0;
    }
    else {
      if (pOVar2 != (OFSmartObject *)0x0) {
        local_90 = 2;
