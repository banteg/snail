/*
 * mangled: _ZN17OFResourceDataMap8addFieldEP8NSStringP13objc_selectorS3_
 * demangled: OFResourceDataMap::addField(NSString*, objc_selector*, objc_selector*)
 * address: 000faa38
 * size: 376
 */

/* OFResourceDataMap::addField(NSString*, objc_selector*, objc_selector*) */

void __thiscall
OFResourceDataMap::addField
...

{
  ...
  local_8c = &::GCC_except_table1;
  local_84 = &LAB_000fabb0;
  local_bc = param_3;
  local_b8 = param_2;
  local_b4 = param_1;
  local_b0 = this;
