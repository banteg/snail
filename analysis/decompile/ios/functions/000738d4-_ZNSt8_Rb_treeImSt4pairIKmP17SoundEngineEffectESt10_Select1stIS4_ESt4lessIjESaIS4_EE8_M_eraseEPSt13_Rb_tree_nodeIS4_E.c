/*
 * mangled: _ZNSt8_Rb_treeImSt4pairIKmP17SoundEngineEffectESt10_Select1stIS4_ESt4lessIjESaIS4_EE8_M_eraseEPSt13_Rb_tree_nodeIS4_E
...
/* std::_Rb_tree<unsigned long, std::pair<unsigned long const, SoundEngineEffect*>,
   ...
   >::_M_erase(std::_Rb_tree_node<std::pair<unsigned long const, SoundEngineEffect*> >*) */
...
::_M_erase(_Rb_tree<unsigned_long,std::pair<unsigned_long_const,SoundEngineEffect*>,std::_Select1st<std::pair<unsigned_long_const,SoundEngineEffect*>>,std::less<unsigned_int>,std::allocator<std::pair<unsigned_long_const,SoundEngineEffect*>>>
