/*
 * mangled: _ZN13OFISerializer2ioEPKcRj
 * demangled: OFISerializer::io(char const*, unsigned int&)
 * address: 000cb8e4
 * size: 212
 */

/* OFISerializer::io(char const*, unsigned int&) */

void __thiscall OFISerializer::io(OFISerializer *this,char *param_1,uint *param_2)

{
  ...
  local_74 = &LAB_000cb9b8;
  local_b0 = param_2;
  local_ac = param_1;
  local_a8 = this;
  __Unwind_SjLj_Register(auStack_98);
  local_a4 = *(code **)(*(int *)local_a8 + 0x20);
  local_94 = 0xffffffff;
