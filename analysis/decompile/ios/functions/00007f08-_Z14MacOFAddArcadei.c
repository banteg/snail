/*
 * mangled: _Z14MacOFAddArcadei
 * demangled: MacOFAddArcade(int)
 * address: 00007f08
 * size: 288
 */
...
void MacOFAddArcade(int param_1)

{
  ...
  local_98 = &GCC_except_table4;
  local_90 = &LAB_00008028;
  local_cc = param_1;
  ...
  local_b8 = NSString::stringWithUTF8String_
                       ((ID)&_OBJC_CLASS___NSString,"stringWithUTF8String:",PTR__OFID_001b6128);
