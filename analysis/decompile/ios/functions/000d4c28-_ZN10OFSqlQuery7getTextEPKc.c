/*
 * mangled: _ZN10OFSqlQuery7getTextEPKc
 * demangled: OFSqlQuery::getText(char const*)
 * address: 000d4c28
 * size: 136
 */

/* OFSqlQuery::getText(char const*) */

void __thiscall OFSqlQuery::getText(OFSqlQuery *this,char *param_1)

{
  ...
  _sqlite3_column_text((sqlite3_stmt *)this->field2_0x8,iCol);
  return;
}
