/*
 * mangled: _ZNK16OFViewDataGetter21writeValueUITextFieldEP6UIViewP8NSStringP18OFOutputSerializer
 * demangled: OFViewDataGetter::writeValueUITextField(UIView*, NSString*, OFOutputSerializer*) const
 * address: 000fc6b0
 * size: 224
 */

/* OFViewDataGetter::writeValueUITextField(UIView*, NSString*, OFOutputSerializer*) const */

void __thiscall
OFViewDataGetter::writeValueUITextField
