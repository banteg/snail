...
void *__thiscall initialize_track_render_cache_manager(TrackRenderCacheManager *manager)
{
  ...
  manager->owner_subgame = (TrackRenderGrid *)((char *)g_game_base + 476696);
  v9 = 0;
  ...
  do
  {
    for ( i = 0; i < 5; ++i )
    {
      ...
      v4 = add_object_to_list((ObjectList *)g_object_list);
      ...
      *(_DWORD *)(*((_DWORD *)v3 + 31) + 192) = create_object_vertex_buffer_resource(
                                                  (VertexBufferFactory *)g_direct3d_renderer,
                                                  manager->max_vertex_counts[i],
                                                  322);
      *(_DWORD *)(*((_DWORD *)v3 + 31) + 200) = create_object_index_buffer_resource(
                                                  (IndexBufferFactory *)g_object_index_buffer_factory,
  ...
  do
  {
    *shared_vertex_buffers = (ObjectRenderVertex *)allocate_tracked_memory(
    ...
    shared_vertex_buffers[5] = (ObjectRenderVertex *)result;
