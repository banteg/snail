...
void *__cdecl set_input_controller_pointer_authored_xy(int slot, float a2, float a3)
{
  int v3; // edi
  int v4; // eax
  int v5; // ecx
  ...
  v4 = 56 * slot;
  *(float *)((char *)&g_input_controller_slot0.authored_x + v4) = a2;
  v5 = g_input_region_bottom[slot];
  *(float *)((char *)&g_input_controller_slot0.authored_y + v4) = a3;
  return click_mouse_screen(
           slot,
           (__int64)((double)(g_input_region_right[slot] - v3) * a2 * 0.0015625 + (double)v3),
           (__int64)((double)(v5 - g_input_region_top[slot]) * a3 * 0.0020833334 + (double)g_input_region_top[slot]));
}
