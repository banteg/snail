...
// Builds the Turnover attachment path-template pair; iOS Path.o names this `cRPath::BuildTurnover(float, int, bool, char*, char*)`.
        ...
        char *cap_texture)
{
  ...
  signed int v61; // [esp+24h] [ebp-44h]
  Vec3 *v62; // [esp+28h] [ebp-40h]
  ...
  float v79; // [esp+44h] [ebp-24h]
  float v80; // [esp+48h] [ebp-20h]
  float v81; // [esp+48h] [ebp-20h]
  float v82; // [esp+4Ch] [ebp-1Ch]
  float v83; // [esp+50h] [ebp-18h]
  float v84; // [esp+54h] [ebp-14h]
  ...
  v50 = (__int64)(length * 6.2831855);
  self->width_or_scale = 1.0;
  self->segment_count = v50 + 8;
  self->segment_count_f = (float)(v50 + 8);
  v9 = (double)v50;
  v52 = v9;
  arg2 = v9 * 0.15915494;
  get_path_nodes(self);
  ...
  do
  {
    ...
    self->primary_samples[v10].transform.position.z = v57;
    ...
    self->secondary_samples[v10++].transform.position.z = v57;
  ...
  do
  {
    ...
    self->primary_samples[v11].transform.position.z = v58;
    ...
    self->secondary_samples[v11].transform.position.z = v58;
  ...
  if ( v50 > 0 )
  {
    ...
    {
      v14 = (double)arg3b;
      v54 = v14 * 6.2831855 / v52;
      self->primary_samples[v13].center_x = (self->primary_samples[v50 + 6].center_x - self->primary_samples->center_x)
                                          * v14
                                          / v52
                                          + self->primary_samples->center_x;
      self->primary_samples[v13].rotation_scalar_98 = -v54;
      ...
      v59 = sine(v49);
      v16 = sine(v54);
      self->primary_samples[v13].transform.position.x = primary_samples[v13].center_x - (v16 * v59 + v16 * v59);
      self->primary_samples[v13].transform.position.z = (float)(arg3b + 6);
      self->primary_samples[v13].transform.position.y = (arg2 - cosine(v54) * arg2) * 0.40000001;
      v60 = cosine(v54);
      v63 = sine(v54);
      ...
      p_basis_up->y = v60;
      p_basis_up->z = 0.0;
      v18 = &self->primary_samples[v13];
      v70 = v18->transform.position.x - v18[-1].transform.position.x;
      v19 = v18->transform.position.y - v18[-1].transform.position.y;
      v18 = (PathTemplateSample *)((char *)v18 + 32);
      v73 = v19;
      v20 = v18->transform.basis_up.z - v18[-1].transform.basis_up.z;
      v18->transform.basis_right.x = v70;
      v18->transform.basis_right.y = v73;
      v76 = v20;
      v18->transform.basis_right.z = v76;
      ...
      v80 = v21[v13].transform.basis_up.y * 0.49000001;
      ...
      p_position->y = v80 + p_position->y;
      p_position->z = v82 + p_position->z;
      ++arg3b;
    }
    while ( arg3b < v50 );
    v8 = 0;
  ...
  if ( (signed int)(self->segment_count - 1) > 0 )
  {
    ...
    do
    {
      ...
      v71 = v26[v25 + 1].transform.position.x - v26[v25].transform.position.x;
      v74 = v26[v25 + 1].transform.position.y - v26[v25].transform.position.y;
      ...
      *p_x = v71;
      ...
      v64 = secondary_samples[v25 + 1].transform.position.x - secondary_samples[v25].transform.position.x;
      v66 = secondary_samples[v25 + 1].transform.position.y - secondary_samples[v25].transform.position.y;
  ...
  if ( (self->segment_count & 0x80000000) == 0 )
  {
    ...
    do
    {
      ...
      for ( arg3c = width_cells; v39 <= width_cells; arg2a = v39 )
      {
        ...
        {
          vertices = v62;
          v83 = v40 * v41[-1].transform.basis_right.x;
          v84 = v40 * v41[-1].transform.basis_right.y;
          v44 = v40 * v41[-1].transform.basis_right.z;
          v85 = v41[-1].transform.position.z + 1.0;
          v65 = v41[-1].transform.position.x + v83;
          v67 = v41[-1].transform.position.y + v84;
          v42 = &v62[v39 + v36 * (width_cells + 1)].x;
          *v42 = v65;
          v69 = v85 + v44;
          v42[1] = v67;
          v43 = v69;
        ...
        {
          v79 = v40 * v41->transform.basis_right.x;
          v81 = v40 * v41->transform.basis_right.y;
          v72 = v79 + v41->transform.position.x;
          v75 = v81 + v41->transform.position.y;
          v78 = v40 * v41->transform.basis_right.z + v41->transform.position.z;
