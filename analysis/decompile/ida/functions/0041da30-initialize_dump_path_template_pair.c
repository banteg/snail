        ...
        char *texture_b)
{
  ...
  char *texture_path; // [esp+78h] [ebp+18h]
  ...
  if ( v48 > 0 )
  {
    ...
    do
    {
      ...
      self->secondary_samples[v13].transform.position.y = 0.49000001 - (1.0 - cosine(v52)) * arg2a * arg3;
    ...
    do
    {
      ...
      if ( (int)self->width_cells > 0 )
      {
        ...
        do
        {
          ...
          while ( 1 )
          {
            v45 = &facequads[2 * v43 + 2 * v7 * self->width_cells + v44];
            v45->flags = 0;
            if ( v44 )
            {
              v45->vertex_index_a = v7 * (LOWORD(self->width_cells) + 1) + v43 + 1;
            ...
            {
              v45->vertex_index_a = v43 + v7 * (LOWORD(self->width_cells) + 1);
