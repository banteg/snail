...
/* selector: initialize_slalom_path_template_pair */
        ...
        char *texture_b)
{
  ...
  int v43; // ebx
  int v44; // ecx
  ObjectFaceQuad *v45; // edi
  float angle; // [esp+0h] [ebp-64h]
  float anglea; // [esp+0h] [ebp-64h]
  ...
  self->kind = PATH_TEMPLATE_KIND_SLALOM;
  v7 = arg2 + 4;
  ...
  if ( arg2 > 0 )
  {
    ...
    do
    {
      ...
      if ( v13 < 0.0 )
        v13 = -v13;
      arg3g = v13;
      self->primary_samples[v11].center_x = sine(v50) * (1.0 - arg3g) * (1.0 - v52) * 5.0;
      ...
      else
      {
        ...
        *p_x = v61;
        ...
        angle = v18[-1].center_x * 0.2617994;
        rotate_matrix_world_z(&v18[-1].transform, angle);
        ...
        *v21 = v72;
        ...
        anglea = self->primary_samples[v11 - 1].center_x * 0.2617994;
        rotate_matrix_world_z(&self->secondary_samples[v11 - 1].transform, anglea);
      }
      ++v10;
      ++v11;
      arg3c = v10;
    ...
    while ( 1 )
    {
      ...
      if ( (int)self->width_cells > 0 )
      {
        ...
        do
        {
          ...
          while ( 1 )
          {
            v45 = &facequads[2 * v6 + 2 * v43 * self->width_cells + v44];
            v45->flags = 0;
            if ( v44 )
            {
              v45->vertex_index_a = v43 * (LOWORD(self->width_cells) + 1) + v6 + 1;
              ...
              v45->texture_ref = get_or_create_texture_ref(&texture_list, texture_path, 0, 0);
              v45->u0 = v49;
              v45->v0 = arg3e;
              v45->u1 = arg2c;
              v45->v1 = arg3e;
            ...
            {
              v45->vertex_index_a = v6 + v43 * (LOWORD(self->width_cells) + 1);
              ...
              v45->texture_ref = get_or_create_texture_ref(&texture_list, texture_b, 0, 0);
              v45->u0 = arg2c;
              v45->v0 = arg3e;
              v45->u1 = v49;
              v45->v1 = arg3e;
