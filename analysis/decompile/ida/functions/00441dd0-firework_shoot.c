...
// Windows `FireWork::firework_shoot`, authored as `cRFireWork::Shoot`: spawns a randomized sprite burst through the exact empty one-byte child at `cRSubGoldy +0x1d0`. The receiver is unused by the body but is passed by the native thiscall; Android and iOS retain the owner with a by-value vector signature.
