...
void __thiscall initialize_tip(Tip *tip, TipData *definition, int32_t hide_disable_button)
{
  ...
  initialize_frontend_widget(tip->widget_main, 2u, v4->text, 20, v4->anchor_x, v4->layout_y, v5, v12, v13);
  v6 = tip->definition;
  if ( (v6->flags & 2) != 0 )
  {
  ...
  if ( (v6->flags & 1) != 0 )
  {
    ...
    {
      anchor_xb = tip->definition->anchor_x;
    ...
    {
      anchor_x = tip->definition->anchor_x + 40.0;
      ...
      anchor_xa = tip->definition->anchor_x - 60.0;
