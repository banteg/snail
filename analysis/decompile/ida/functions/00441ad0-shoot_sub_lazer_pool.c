...
// Exact `cRSubLazerManager::Shoot(tVector, tVector)`: scans the manager's 20 inline actors for SUB_LAZER_STATE_INACTIVE, dispatches that actor's Shoot method, and plays the positional fire cue. Android and iOS independently preserve the manager owner and signature; the former `shoot_subgoldy` name is retained only as an alias.
