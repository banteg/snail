...
int32_t __thiscall update_subgoldy(Player *player)
{
  ...
  update_squidge((float *)player + 4305);
  player->snail_visual->squidge_primary = *((float *)player + 4305);
  player->snail_visual->squidge_secondary = *((float *)player + 4308);
...
LABEL_60:
          ...
          if ( v29 > 0 && v29 != *(_DWORD *)&player->_pad_124[196] && v29 < *((_DWORD *)v26 + 10781) + 1 )
          {
            *(_DWORD *)&player->_pad_124[196] = v29;
            if ( *((_BYTE *)player->game + 16928 * *((_DWORD *)v28 + 60) + 42608) )
            {
              *(_DWORD *)&player->_pad_124[200] = 2;
              *(_DWORD *)&player->_pad_124[216] = (char *)player->game + 16928 * *((_DWORD *)v28 + 60) + 42608;
              *(_DWORD *)&player->_pad_124[204] = 0;
              *(_DWORD *)&player->_pad_124[208] = 1106247680;
              *(_DWORD *)&player->_pad_124[212] = *((_DWORD *)player->game + 4232 * *((_DWORD *)v28 + 60) + 10780);
              ...
              enqueue_tip_message((_DWORD *)MEMORY[0x4DF904] + 4955094, (int)&player->_pad_124[200], 1);
            }
          }
...
LABEL_101:
          ...
          else
          {
            ...
            else
            {
              ...
              if ( !player->follow_state.active )
              {
                ...
                if ( ((*((_DWORD *)player->game + 19) & 0x400) == 0 || (byte_4B2F40 & 2) != 0)
                  && player->position.y < 0.49000001 )
                {
                  start_squidge_y((int)player + 17220, player->velocity.y);
                  player->_pad_124[192] = 0;
                  player->velocity.y = 0.0;
                  player->attachment_exit_pending = 0;
                  player->position.y = 0.49000001;
            ...
            if ( *(float *)&player->_pad_124[184] != 0.0 )
            {
              v50 = *(float *)&player->_pad_124[188] + *(float *)&player->_pad_124[184];
              *(float *)&player->_pad_124[184] = v50;
              if ( v50 > 1.0 )
                *(_DWORD *)&player->_pad_124[184] = 0;
            }
            if ( player->attachment_exit_pending )
            {
              player->velocity.y = *((float *)player->game + 14) * *((float *)player->game + 14) * -0.0099999998
            ...
            else
            {
              ...
              else
              {
                ...
                {
                  if ( *(float *)&player->_pad_124[184] == 0.0 )
                    *(_DWORD *)&player->_pad_124[184] = *(_DWORD *)&player->_pad_124[188];
...
LABEL_98:
          ...
          else
          {
            ...
            if ( *((float *)player + 4308) == 0.0 )
              play_sound_effect(47);
            start_squidge_z((float *)player + 4305, -0.33000001);
          ...
          if ( *(float *)&player->_pad_124[176] != 0.0 )
          {
            v58 = *(float *)&player->_pad_124[180] + *(float *)&player->_pad_124[176];
            *(float *)&player->_pad_124[176] = v58;
            if ( v58 > 1.0 )
              *(_DWORD *)&player->_pad_124[176] = 0;
          }
          v59 = player->game;
          v123 = (float)*((int *)v59 + 22);
          if ( player->position.z < (double)v123 || player->attachment_exit_pending )
          {
            if ( !player->_pad_41c[0] && !player->_pad_124[436] )
            {
          ...
          else
          {
            if ( !LOBYTE(player->completion_handoff_active) )
            {
              if ( *((_DWORD *)v59 + 16) == 4 )
              {
                ...
                advance_timer_counters((float *)&player->_pad_124[452], v118);
              }
              v60 = player->game;
          ...
          *(float *)&player->_pad_340[56] = v85;
          if ( *(float *)&player->_pad_340[52] > 0.0 )
          {
            ...
            *(float *)&player->_pad_340[52] = v86;
            if ( v86 <= 1.0 )
            {
              update_nuke((float *)&player->_pad_124[44]);
            }
            else
            {
              *(_DWORD *)&player->_pad_340[52] = 0;
              uninit_nuke((int *)&player->_pad_124[44]);
            }
          }
          v87 = player->game;
          if ( *((_DWORD *)v87 + 16) == 4 )
          {
            ...
            if ( *((_DWORD *)v88 + 2429012) == 1 && !*((_BYTE *)v87 + 16721360) )
            {
              ...
              v90 = *(_DWORD *)&player->_pad_124[480];
          ...
          *(float *)&v119 = player->position.z / (double)*((int *)player->game + 21);
          ...
          if ( player->attachment_exit_pending )
          {
            ...
            if ( v98 > 0.69999999 && !player->attachment_exit_gate_a )
            {
              ...
              v99 = player->_pad_124[436];
              player->attachment_exit_gate_a = 1;
              if ( !v99 && player->position.y < -6.0 )
          ...
          update_anim_manager((char *)player + 15468);
