...
void __thiscall sub_43B120(int this)
{
  ...
  if ( *(_BYTE *)(*(_DWORD *)(this + 1032) + 9) )
  {
    if ( *((_DWORD *)MEMORY[0x4DF904] + 110) != 9 )
    {
      ...
      update_progress_bar();
      update_warning((float *)(this + 1012));
  ...
  update_squidge((float *)(this + 17220));
  ...
  *(_DWORD *)(*(_DWORD *)(this + 10664) + 136) = *(_DWORD *)(this + 17232);
  ...
  if ( v5 && v5 != 2 )
  {
    ...
    if ( *(_BYTE *)(v7 + 16721360) )
    {
      ...
      {
        v10 = (float *)(this + 104);
        *(float *)(this + 104) = convert_math_type16_to_32(*(_WORD *)(v8 + 6 * v9 + 112), 16.0);
          ...
          if ( *(_BYTE *)(16928 * *((_DWORD *)v28 + 60) + *(_DWORD *)(this + 1032) + 42608) )
          {
            ...
            *(_DWORD *)(this + 504) = *(_DWORD *)(16928 * *((_DWORD *)v28 + 60) + *(_DWORD *)(this + 1032) + 43120);
            ...
            if ( *(_DWORD *)(16928 * v30 + v31 + 43124) != -1 )
              play_voice_manager((int)unk_751498, 13, 2u, *(_DWORD *)(16928 * v30 + v31 + 43124));
          ...
          else
          {
            ...
            if ( !*(_BYTE *)(this + 900) )
            {
              if ( *(float *)(this + 108) < 0.49000001
                ...
                && v41[60] != 22 )
              {
                set_matrix_rotation_identity((_DWORD *)(this + 56));
                *(_BYTE *)(this + 484) = 0;
                if ( *(float *)(this + 1044) < -0.029999999 )
                {
                  v117 = *(float *)(this + 1044) - 0.029999999;
                  start_squidge_y(this + 17220, v117);
                }
              ...
              {
                start_squidge_y(this + 17220, *(float *)(this + 1044));
                *(_BYTE *)(this + 484) = 0;
                *(_DWORD *)(this + 1044) = 0;
                *(_BYTE *)(this + 1053) = 0;
                *(_DWORD *)(this + 108) = 1056629064;
...
LABEL_98:
        ...
        else
        {
          ...
          *(float *)(this + 112) = (double)(int)(__int64)(*(float *)(this + 112) + 0.49000001) - 0.5;
          ...
          start_squidge_z((float *)(this + 17220), -0.33000001);
        ...
        else
        {
          if ( !*(_BYTE *)(this + 1088) )
          {
            ...
            *(float *)(this + 1048) = v61;
            ...
            end_jetpack_hover((float *)(this + 10064));
            *(_DWORD *)(this + 17128) = 5;
            play_sound_effect(0);
            *(_BYTE *)(this + 1052) = 0;
          }
...
LABEL_287:
        ...
        *(float *)(this + 888) = v85;
        if ( *(float *)(this + 884) > 0.0 )
        {
          ...
          *(float *)(this + 884) = v86;
          if ( v86 <= 1.0 )
          {
            update_nuke((float *)(this + 336));
          }
          else
          {
            *(_DWORD *)(this + 884) = 0;
            uninit_nuke((int *)(this + 336));
          }
        }
        ...
        if ( *(_DWORD *)(v87 + 64) == 4 )
        {
          ...
          if ( *(_DWORD *)(v88 + 9716048) == 1 && !*(_BYTE *)(v87 + 16721360) )
          {
            ...
            if ( v90 && (v91 = *(_DWORD *)(v88 + 9716084) - v90 + v89) != 0 )
              v92 = convert_math_type16_to_32(*(_WORD *)(v88 + 6 * v91 + 9716162), 32.0) + unk_643190;
            else
              v92 = convert_math_type16_to_32(*(_WORD *)(v88 + 9716162), 32.0);
            unk_643190 = v92;
        ...
        *(float *)(this + 10624) = v94;
        ...
        update_anim_manager((char *)(this + 10888));
        update_anim_manager((char *)(this + 15468));
        update_anim_manager((char *)(this + 12504));
        update_anim_manager((char *)(this + 13492));
        update_anim_manager((char *)(this + 14480));
        update_track_parcels((_DWORD *)(*(_DWORD *)(this + 1032) + 19260544));
...
LABEL_365:
        ...
        update_times_up(*(_DWORD *)(this + 1032) + 19343400);
        return;
      }
    }
    ...
    else
    {
      ...
      {
        resolve_uncaptured_cursor_sensitivity_scale(*(&flt_4DF950 + *(_DWORD *)(this + 10608)));
...
LABEL_40:
    ...
    v10 = (float *)(this + 104);
    v18 = convert_math_type32_to_16(*(float *)(this + 104), 16.0);
    v120 = convert_math_type16_to_32(v18, 16.0);
    *(float *)(this + 104) = v120;
    v19 = *(_DWORD *)(this + 1032);
    *(_WORD *)(v19 + 6 * *(_DWORD *)(v19 + 16721372) + 16591744) = convert_math_type32_to_16(v120, 16.0);
    v20 = *(_DWORD *)(this + 1032);
    if ( *(_DWORD *)(v20 + 16721372) )
    {
      v114 = *(float *)(this + 112) - unk_643194;
      *(_WORD *)(v20 + 6 * (*(_DWORD *)(v20 + 16721372) + 2765291)) = convert_math_type32_to_16(v114, 32.0);
    ...
    {
      *(_WORD *)(v20 + 6 * (*(_DWORD *)(v20 + 16721372) + 2765291)) = convert_math_type32_to_16(
                                                                        *(float *)(this + 112),
                                                                        32.0);
      v21 = convert_math_type16_to_32(
              *(_WORD *)(*(_DWORD *)(this + 1032) + 6 * (*(_DWORD *)(*(_DWORD *)(this + 1032) + 16721372) + 2765291)),
