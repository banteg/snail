...
// Exact void Windows `cRSubGame::UnHideScores()`: unhides the two gameplay score widgets owned by cRSubGame. Android preserves the same two calls; no iOS symbol was found.
