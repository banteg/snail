...
void __thiscall initialize_main_menu(FrontendWidget **this)
{
  ...
  *this = allocate_border(&g_game_base->border_manager);
  ...
  initialize_frontend_widget(*this, 0x14u, g_new_game_text, 20, 20.0, 90.0, v3, 2, 0.0);
  *(this + 1) = allocate_border(&g_game_base->border_manager);
  v4 = set_color_rgba((tColour *)&color, 1.0, 1.0, 1.0, 1.0);
  initialize_frontend_widget(*(this + 1), 0x14u, g_high_scores_text, 20, 20.0, 20.0, v4, 2, 0.0);
  stack_widget_below(*(this + 1), *this);
  *(this + 2) = allocate_border(&g_game_base->border_manager);
  v5 = set_color_rgba((tColour *)&color, 1.0, 1.0, 1.0, 1.0);
  initialize_frontend_widget(*(this + 2), 0x14u, g_options_text, 20, 20.0, 20.0, v5, 2, 0.0);
  stack_widget_below(*(this + 2), *(this + 1));
  *(this + 2) = allocate_border(&g_game_base->border_manager);
  v6 = set_color_rgba((tColour *)&color, 1.0, 1.0, 1.0, 1.0);
  initialize_frontend_widget(*(this + 2), 0x14u, g_options_text, 20, 20.0, 20.0, v6, 2, 0.0);
  stack_widget_below(*(this + 2), *(this + 1));
  *(this + 3) = allocate_border(&g_game_base->border_manager);
  v7 = set_color_rgba((tColour *)&color, 1.0, 1.0, 1.0, 1.0);
  initialize_frontend_widget(*(this + 3), 0x40000014u, g_credits_text, 20, 20.0, 20.0, v7, 2, 0.0);
  stack_widget_below(*(this + 3), *(this + 2));
  *(this + 5) = allocate_border(&g_game_base->border_manager);
  v8 = set_color_rgba((tColour *)&color, 1.0, 1.0, 1.0, 1.0);
  initialize_frontend_widget(*(this + 5), 0x14u, g_exit_text, 20, 20.0, 390.0, v8, 2, 0.0);
