        ...
        float height_scale)
{
  ...
  file_bytes = (TgaImageView *)load_file_bytes(texture_path, nullptr);
  ...
  if ( file_bytes->width )
  {
    do
    {
      v11 = sample_tga_pixel_rgb(file_bytes, v9, 0);
      ...
      if ( v11 == 0xFFFFFF )
      {
        ...
        v13[1957057] = v25 / (double)file_bytes->width;
        v10 = 0;
        v24 = (double)v22 + 0.5;
        v13[1957185] = v24 / (double)file_bytes->width;
        *(int32_t *)((char *)g_font_sheets[0].texture_page + (_DWORD)v13) = 0;
        if ( file_bytes->width == 2048 )
        {
          if ( v14 <= v4 )
          {
            ...
            v13[1957185] = v24 / (double)(file_bytes->width >> 1);
            *(int32_t *)((char *)g_font_sheets[0].texture_page + (_DWORD)v13) = 0;
          }
          else
          {
            v13[1957057] = ((double)(v14 - v4) + 0.5) * 0.0009765625;
            v13[1957185] = ((double)(v9 - v4) + 0.5) / (double)(file_bytes->width >> 1);
  ...
  v15 = 1;
  if ( file_bytes->height > 1u )
  {
    while ( sample_tga_pixel_rgb(file_bytes, 0, v15) != 0xFFFFFF )
    {
      if ( ++v15 >= file_bytes->height )
      {
        v12 = g_registered_font_count;
        goto LABEL_23;
      }
...
LABEL_23:
  ...
  *(float *)(v16 + 7830284) = *(float *)(v16 + 7830276) / (double)(file_bytes->height - 1);
  ...
  if ( file_bytes->width == 2048 )
  {
    ...
    v18 = get_or_create_texture_ref(&g_texture_refs, v28, nullptr, 0);
    g_font_sheets[g_registered_font_count].texture_ref_b = v18;
    flags = v18->flags | 0x420;
  }
  else
  {
    v18 = get_or_create_texture_ref(&g_texture_refs, texture_path, nullptr, 0);
