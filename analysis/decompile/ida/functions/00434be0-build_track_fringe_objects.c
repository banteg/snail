...
int __thiscall sub_434BE0(_DWORD *this)
{
  _DWORD *v1; // ebp
  int v2; // ebx
  _BYTE *v3; // edx
...
LABEL_64:
        ...
        else
        {
          ...
          v9 = allocate_fringe_object((_DWORD *)MEMORY[0x4DF904] + 999541);
          v4[17] = v9;
          set_bod_object(v9, *((_DWORD *)MEMORY[0x4DF904] + 336 * v6 + 168 * v6 + 28 * v2 + 14 * v8 + 14 * v2 + 70517));
          *(_DWORD *)(v4[17] + 4) |= 0x20u;
          v10 = (_DWORD *)(v4[17] + 16);
          *v10 = v4[4];
          v10[1] = v4[5];
          v10[2] = v4[6];
          v11 = get_track_skirt_color((int *)MEMORY[0x4DF904] + 119174, v38);
          v12 = (_DWORD *)(v4[17] + 40);
          v1 = this;
          v2 = 0;
          *v12 = *v11;
