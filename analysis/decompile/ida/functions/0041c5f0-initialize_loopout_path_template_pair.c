  ...
  for ( i = 0; i < (signed int)self->segment_count; ++i )
  {
    ...
    if ( (int)self->width_cells > 0 )
    {
      ...
      do
      {
        ...
        while ( 1 )
        {
          v39 = &facequads[2 * v37 + 2 * i * self->width_cells + v38];
          v39->flags = 0;
          if ( v38 )
          {
            v39->vertex_index_a = i * (LOWORD(self->width_cells) + 1) + v37 + 1;
            ...
            v39->texture_ref = get_or_create_texture_ref(dword_4B7790, v82, 0, 0);
            v39->u0 = v43;
            v39->v0 = arg3e;
            v39->u1 = arg2d;
            v39->v1 = arg3e;
          ...
          {
            v39->vertex_index_a = v37 + i * (LOWORD(self->width_cells) + 1);
            ...
            v39->texture_ref = get_or_create_texture_ref(dword_4B7790, arg5, 0, 0);
            v39->u0 = arg2d;
            v39->v0 = arg3e;
            v39->u1 = v43;
            v39->v1 = arg3e;
