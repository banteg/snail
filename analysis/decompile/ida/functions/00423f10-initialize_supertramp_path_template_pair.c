        ...
        char *texture_c)
{
  ...
  int v32; // ecx
  uint32_t v33; // eax
  ObjectFaceQuad *v34; // ebp
  char *v35; // ecx
  TextureRef *texture_ref; // eax
  ObjectFaceQuad *v37; // ebp
  ...
  char *texture_path; // [esp+48h] [ebp+1Ch]
    ...
    do
    {
      ...
      while ( 1 )
      {
        ...
        if ( !v32 )
        {
          v34 = &facequads[v33];
          v34->flags = 0;
          v34->vertex_index_a = v31 + j * (LOWORD(self->width_cells) + 1);
          v34->vertex_index_b = j * (LOWORD(self->width_cells) + 1) + v31 + 1;
          v34->vertex_index_c = (j + 1) * (LOWORD(self->width_cells) + 1) + v31 + 1;
          v34->vertex_index_d = v31 + (j + 1) * (LOWORD(self->width_cells) + 1);
          ...
          if ( (((unsigned __int8)j ^ (unsigned __int8)v31) & 1) != 0 )
          {
            v35 = texture_b;
LABEL_22:
            texture_ref = get_or_create_texture_ref(&texture_list, v35, 0, 0);
          }
          else
          {
            texture_ref = get_or_create_texture_ref(&texture_list, texture_b, 0, 0);
          }
        ...
        v37 = &facequads[v33];
        v37->flags = 0;
        v37->vertex_index_a = j * (LOWORD(self->width_cells) + 1) + v31 + 1;
        ...
        v37->texture_ref = get_or_create_texture_ref(&texture_list, texture_c, 0, 0);
        v37->u0 = v39;
        v37->v0 = arg3d;
        v37->u1 = arg2d;
        v37->v1 = arg3d;
