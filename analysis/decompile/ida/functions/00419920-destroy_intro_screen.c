...
// Exact void Windows cRLogo::UnInit(): unlinks each active cRLogoLetter from the BOD lists and returns it to the shared free list. Its sole caller discards the loop count left in EAX.
