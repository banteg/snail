...
LABEL_25:
    ...
    case 2:
      ...
      if ( (read_pressed_text_input_key_code() == 11 || g_window_deactivated == 1) && g_game_base->fade.state == 0 )
      {
        ...
        set_sprite_manager_paused(&g_sprite_manager, true);
