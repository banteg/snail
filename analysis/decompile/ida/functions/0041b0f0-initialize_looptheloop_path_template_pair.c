  ...
  for ( i = 0; i < (signed int)self->segment_count; ++i )
  {
    ...
    if ( (int)self->width_cells > 0 )
    {
      ...
      do
      {
        ...
        while ( 1 )
        {
          v40 = (uint32_t)facequads + 96 * v38 + 96 * i * self->width_cells + 48 * v39;
          *(_WORD *)v40 = 0;
          if ( v39 )
          {
            *(_WORD *)(v40 + 2) = i * (LOWORD(self->width_cells) + 1) + v38 + 1;
            *(_WORD *)(v40 + 4) = v38 + i * (LOWORD(self->width_cells) + 1);
            *(_WORD *)(v40 + 6) = v38 + (i + 1) * (LOWORD(self->width_cells) + 1);
            *(_WORD *)(v40 + 8) = (i + 1) * (LOWORD(self->width_cells) + 1) + v38 + 1;
            *(_DWORD *)(v40 + 12) = get_or_create_texture_ref((TextureRefList *)dword_4B7790, v85, 0, 0);
            *(float *)(v40 + 16) = v46;
            *(float *)(v40 + 20) = arg3e;
            *(float *)(v40 + 24) = arg2d;
            *(float *)(v40 + 28) = arg3e;
          ...
          {
            *(_WORD *)(v40 + 2) = v38 + i * (LOWORD(self->width_cells) + 1);
            *(_WORD *)(v40 + 4) = i * (LOWORD(self->width_cells) + 1) + v38 + 1;
            *(_WORD *)(v40 + 6) = (i + 1) * (LOWORD(self->width_cells) + 1) + v38 + 1;
            *(_WORD *)(v40 + 8) = v38 + (i + 1) * (LOWORD(self->width_cells) + 1);
            *(_DWORD *)(v40 + 12) = get_or_create_texture_ref((TextureRefList *)dword_4B7790, texture_b, 0, 0);
            *(float *)(v40 + 16) = arg2d;
            *(float *)(v40 + 20) = arg3e;
            *(float *)(v40 + 24) = v46;
            *(float *)(v40 + 28) = arg3e;
