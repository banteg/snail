    ...
    else
    {
      ...
      *p_x = v52;
      ...
      cross_vectors(
        ...
        (Vec3 *)&self->primary_samples[i - 1].transform.basis_forward,
        (Vec3 *)&self->primary_samples[i - 1]);
      orthogonalize_matrix(&self->primary_samples[i - 1].transform.basis_right.x);
      ...
      *v19 = v63;
      ...
      cross_vectors(
        ...
        (Vec3 *)&self->secondary_samples[i - 1].transform.basis_forward,
        (Vec3 *)&self->secondary_samples[i - 1]);
      orthogonalize_matrix(&self->secondary_samples[i - 1].transform.basis_right.x);
    }
    arg3a = v10;
  }
  v21 = 0;
        ...
        do
        {
          ...
          while ( 1 )
          {
            ...
            else
            {
              ...
              v43->texture_ref = get_or_create_texture_ref(dword_4B7790, texture_a, 0, 0);
              v43->u0 = arg4c;
              v43->v0 = arg3d;
              v43->u1 = arg2b;
              v43->v1 = arg3d;
