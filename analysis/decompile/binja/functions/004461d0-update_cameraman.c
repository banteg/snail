...
00446264        if ((((x87_r7_2 < temp1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_2, temp1) ? 1 : 0) << 0xa | (x87_r7_2 == temp1 ? 1 : 0) << 0xe | 0x3800):1.b & 0x41) != 0)
...
00446287        if ((((x87_r7_5 < temp2_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_5, temp2_1) ? 1 : 0) << 0xa | (x87_r7_5 == temp2_1 ? 1 : 0) << 0xe | 0x3800):1.b & 1) == 0)
00446293        long double temp3_1 = fconvert.t(1f)
00446293        x87_r7_5 - temp3_1
0044629e        if ((((x87_r7_5 < temp3_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_5, temp3_1) ? 1 : 0) << 0xa | (x87_r7_5 == temp3_1 ? 1 : 0) << 0xe | 0x3800):1.b & 0x41) == 0)
...
00446348        if (player_4->follow_state.active == 1 && (kind == PATH_TEMPLATE_KIND_FAMILY_10 || kind == 0x8 || kind == 0x9 || kind == 0xa || kind == PATH_TEMPLATE_KIND_TWISTER || kind == PATH_TEMPLATE_KIND_TWISTER2 || kind == PATH_TEMPLATE_KIND_START || kind == 0xe))
00446356        long double x87_r7_18 = (fconvert.t(player_4->body.transform.position.z) - fconvert.t(player_4->follow_state.source_cell->anchor_position.z)) / fconvert.t(template_record_1->segment_count_f)
00446359        long double temp5_1 = fconvert.t(0f)
00446359        x87_r7_18 - temp5_1
00446364        if ((((x87_r7_18 < temp5_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_18, temp5_1) ? 1 : 0) << 0xa | (x87_r7_18 == temp5_1 ? 1 : 0) << 0xe | 0x3800):1.b & 1) == 0)
00446370        long double temp7_1 = fconvert.t(1f)
00446370        x87_r7_18 - temp7_1
0044637b        if ((((x87_r7_18 < temp7_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_18, temp7_1) ? 1 : 0) << 0xa | (x87_r7_18 == temp7_1 ? 1 : 0) << 0xe | 0x3800):1.b & 0x41) == 0)
0044637f        x87_r7_18 = fconvert.t(1f)
00446368        x87_r7_18 = fconvert.t(0f)
0044638b        struct Player* player_9 = player_4
004463a9        cameraman->attachment_lift_envelope = fconvert.s((fconvert.t(0.5f) - cosine(fconvert.s(x87_r7_18 * fconvert.t(6.28318548f))) * fconvert.t(0.5f)) * fconvert.t(0.349999994f))
...
004463d2        if ((((x87_r7_26 < temp4 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_26, temp4) ? 1 : 0) << 0xa | (x87_r7_26 == temp4 ? 1 : 0) << 0xe):1.b & 0x41) == 0)
004463e0        struct Player* player_10 = player_5
0044640a        cameraman->attachment_lift_envelope = fconvert.s((fconvert.t(0.5f) - cosine(fconvert.s(fconvert.t(player_5->cutscene_pitch_cycle) * fconvert.t(4.71238899f) + fconvert.t(1.57079637f))) * fconvert.t(0.5f)) * fconvert.t(0.239999995f) + fconvert.t(cameraman->attachment_lift_envelope))
...
00446477        if ((((x87_r6_11 < temp6 ? 1 : 0) << 8 | (is_unordered.t(x87_r6_11, temp6) ? 1 : 0) << 0xa | (x87_r6_11 == temp6 ? 1 : 0) << 0xe | 0x3000):1.b & 0x41) != 0)
00446489        long double temp8_1 = fconvert.t(1.70000005f)
00446489        x87_r6_11 - temp8_1
00446494        if ((((x87_r6_11 < temp8_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r6_11, temp8_1) ? 1 : 0) << 0xa | (x87_r6_11 == temp8_1 ? 1 : 0) << 0xe | 0x3800):1.b & 1) != 0)
...
004464d3        if ((((x87_r7_54 < temp9 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_54, temp9) ? 1 : 0) << 0xa | (x87_r7_54 == temp9 ? 1 : 0) << 0xe):1.b & 1) == 0)
...
004464ee        if ((((x87_r7_55 < temp10_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_55, temp10_1) ? 1 : 0) << 0xa | (x87_r7_55 == temp10_1 ? 1 : 0) << 0xe):1.b & 0x41) == 0)
004464f0        angle = 1.22149992f
004464d5        angle = -1.22149992f
004464ff        int32_t ecx_5 = rotate_matrix_local_x(&cameraman->desired_matrix, angle)
...
00446558        rotate_matrix_local_z(&cameraman->desired_matrix, fconvert.s(x87_r7_62 + fconvert.t(player_7->cached_camera_target_world.x) * fconvert.t(-8f) * fconvert.t(0.0174499992f) * fconvert.t(0.170000002f)))
...
00446608        long double x87_r7_66 = (fconvert.t(player_2->body.transform.position.z) - fconvert.t(player_2->follow_state.source_cell->anchor_position.z)) / fconvert.t(template_record->segment_count_f)
0044660b        long double temp11_1 = fconvert.t(0f)
0044660b        x87_r7_66 - temp11_1
00446616        if ((((x87_r7_66 < temp11_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_66, temp11_1) ? 1 : 0) << 0xa | (x87_r7_66 == temp11_1 ? 1 : 0) << 0xe | 0x3800):1.b & 1) == 0)
