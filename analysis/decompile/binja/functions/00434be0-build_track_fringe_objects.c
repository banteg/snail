...
00434bea        struct Game* game_1 = game
00434bf2        struct Game* game_2 = game_1
...
00434c0c        void* __offset(Game, 0x5ccac8) edx_1 = &game_1->__offset(0x5ccac8).d
00434c14        void* __offset(Game, 0x3bfac8) esi_1 = &game_1->__offset(0x3bfac8).d
00434c1a        void* __offset(Game, 0x5ccac8) var_44_1 = edx_1
0043514c        bool cond:2_1
00434c1e        int32_t var_4c_1 = 8
0043512e        bool cond:1_1
00434c26        int32_t ecx
00434c26        ecx.b = (esi_1 - 0x3bfac8)->:0x3bfb05.b
...
00434c59        eax_1.b = (esi_1 - 0x3bfac8)->:0x3bfb04.b
...
00434c96        edi_1 = 7
00434cbb        if (((edx_1 - 0x5ccac8)->:0x5ccac8.b & 4) != 0 || ecx.b == 0 || eax_1.b == 0x20 || (data_4df934 & 0x20) == 0)
004350e0        (esi_1 - 0x3bfac8)->__offset(0x3bfb0c).d = 0
004350e3        (esi_1 - 0x3bfac8)->__offset(0x3bfb10).d = 0
004350e6        (esi_1 - 0x3bfac8)->__offset(0x3bfb14).d = 0
004350e9        (esi_1 - 0x3bfac8)->__offset(0x3bfb18).d = 0
00434cc6        char eax_2
00434cc6        eax_2, ecx = is_neighbor_cell_solid(game_1, esi_1, 0, 0)
00434ccd        if (eax_2 == 1)
00434ce0        if (is_neighbor_cell_solid(game_1, esi_1, 0, 1) != 0)
00434dd4        (esi_1 - 0x3bfac8)->__offset(0x3bfb0c).d = 0
00434cf4        if (is_neighbor_cell_solid(game_1, esi_1, 1, 1) != 1)
00434d01        int32_t eax_5
00434d01        eax_5.b = is_neighbor_cell_solid(game_1, esi_1, 1, 0).b - 1
...
00434d2c        eax_10.b = is_neighbor_cell_solid(game_1, esi_1, 0xffffffff, 0).b - 1
...
00434d4b        (esi_1 - 0x3bfac8)->__offset(0x3bfb0c).d = eax_14
00434d70        set_bod_object(eax_14, *(data_4df904 + ((ebx + edi_1 * 0xc) * 3 + ebp) * 0x38 + 0x44dd4))
00434d75        void* eax_15 = (esi_1 - 0x3bfac8)->__offset(0x3bfb0c).d
00434d81        *(eax_15 + 4) |= 0x20
00434d89        int32_t* eax_17 = (esi_1 - 0x3bfac8)->__offset(0x3bfb0c).d + 0x10
00434d8c        *eax_17 = (esi_1 - 0x3bfac8)->__offset(0x3bfad8).d
00434d91        eax_17[1] = (esi_1 - 0x3bfac8)->__offset(0x3bfadc).d
00434d97        eax_17[2] = (esi_1 - 0x3bfac8)->__offset(0x3bfae0).d
00434dab        float var_40[0x4]
00434dab        float* eax_18 = get_track_skirt_color(data_4df904 + 0x74618, &var_40)
00434db5        float* edx_9 = (esi_1 - 0x3bfac8)->__offset(0x3bfb0c).d + 0x28
...
00434ed8        (esi_1 - 0x3bfac8)->__offset(0x3bfb10).d = 0
00434df8        if (is_neighbor_cell_solid(game_1, esi_1, 1, 0xffffffff) != 1)
00434e05        int32_t eax_22
00434e05        eax_22.b = is_neighbor_cell_solid(game_1, esi_1, 0, 0xffffffff).b - 1
...
00434e30        eax_27.b = is_neighbor_cell_solid(game_1, esi_1, 0, 1).b - 1
...
00434e4f        (esi_1 - 0x3bfac8)->__offset(0x3bfb10).d = eax_31
00434e74        set_bod_object(eax_31, *(data_4df904 + ((ebx + edi_1 * 0xc) * 3 + ebp_3) * 0x38 + 0x44fcc))
00434e79        void* eax_32 = (esi_1 - 0x3bfac8)->__offset(0x3bfb10).d
00434e85        *(eax_32 + 4) |= 0x20
00434e8d        int32_t* eax_34 = (esi_1 - 0x3bfac8)->__offset(0x3bfb10).d + 0x10
00434e90        *eax_34 = (esi_1 - 0x3bfac8)->__offset(0x3bfad8).d
00434e95        eax_34[1] = (esi_1 - 0x3bfac8)->__offset(0x3bfadc).d
00434e9b        eax_34[2] = (esi_1 - 0x3bfac8)->__offset(0x3bfae0).d
00434eaf        float var_30[0x4]
00434eaf        float* eax_35 = get_track_skirt_color(data_4df904 + 0x74618, &var_30)
00434eb9        float* edx_17 = (esi_1 - 0x3bfac8)->__offset(0x3bfb10).d + 0x28
...
00434fdc        (esi_1 - 0x3bfac8)->__offset(0x3bfb14).d = 0
00434efc        if (is_neighbor_cell_solid(game_1, esi_1, 0xffffffff, 1) != 1)
00434f09        int32_t eax_39
00434f09        eax_39.b = is_neighbor_cell_solid(game_1, esi_1, 0, 1).b - 1
...
00434f34        eax_44.b = is_neighbor_cell_solid(game_1, esi_1, 0, 0xffffffff).b - 1
00434f36        char temp6_1 = eax_44.b
00434f36        eax_44.b = neg.b(eax_44.b)
00434f3d        ebp_6 = neg.d(sbb.d(eax_44, eax_44, temp6_1 != 0)) + 1
00434f24        ebp_6 = 0
00434f4b        void* eax_48 = allocate_fringe_object(data_4df904 + 0x3d01d4)
00434f53        (esi_1 - 0x3bfac8)->__offset(0x3bfb14).d = eax_48
00434f78        set_bod_object(eax_48, *(data_4df904 + ((ebx + edi_1 * 0xc) * 3 + ebp_6) * 0x38 + 0x451c4))
00434f7d        void* eax_49 = (esi_1 - 0x3bfac8)->__offset(0x3bfb14).d
00434f89        *(eax_49 + 4) |= 0x20
00434f91        int32_t* eax_51 = (esi_1 - 0x3bfac8)->__offset(0x3bfb14).d + 0x10
00434f94        *eax_51 = (esi_1 - 0x3bfac8)->__offset(0x3bfad8).d
00434f99        eax_51[1] = (esi_1 - 0x3bfac8)->__offset(0x3bfadc).d
00434f9f        eax_51[2] = (esi_1 - 0x3bfac8)->__offset(0x3bfae0).d
00434fb3        float var_20[0x4]
00434fb3        float* eax_52 = get_track_skirt_color(data_4df904 + 0x74618, &var_20)
00434fbd        float* edx_25 = (esi_1 - 0x3bfac8)->__offset(0x3bfb14).d + 0x28
...
00434fe5        eax_54, ecx = is_neighbor_cell_solid(game_1, esi_1, 0, 0xffffffff)
00434fec        if (eax_54 != 0)
004350e9        (esi_1 - 0x3bfac8)->__offset(0x3bfb18).d = 0
00435000        if (is_neighbor_cell_solid(game_1, esi_1, 0xffffffff, 0xffffffff) != 1)
0043500d        int32_t eax_56
0043500d        eax_56.b = is_neighbor_cell_solid(game_1, esi_1, 0xffffffff, 0).b - 1
...
00435038        eax_61.b = is_neighbor_cell_solid(game_1, esi_1, 1, 0).b - 1
0043503a        char temp8_1 = eax_61.b
0043503a        eax_61.b = neg.b(eax_61.b)
00435041        ebp_9 = neg.d(sbb.d(eax_61, eax_61, temp8_1 != 0)) + 1
00435028        ebp_9 = 0
0043504f        void* eax_65 = allocate_fringe_object(data_4df904 + 0x3d01d4)
00435057        (esi_1 - 0x3bfac8)->__offset(0x3bfb18).d = eax_65
0043507c        set_bod_object(eax_65, *(data_4df904 + ((ebx + edi_1 * 0xc) * 3 + ebp_9) * 0x38 + 0x453bc))
00435081        void* eax_66 = (esi_1 - 0x3bfac8)->__offset(0x3bfb18).d
0043508d        *(eax_66 + 4) |= 0x20
00435095        int32_t* eax_68 = (esi_1 - 0x3bfac8)->__offset(0x3bfb18).d + 0x10
00435098        *eax_68 = (esi_1 - 0x3bfac8)->__offset(0x3bfad8).d
0043509d        eax_68[1] = (esi_1 - 0x3bfac8)->__offset(0x3bfadc).d
004350a3        eax_68[2] = (esi_1 - 0x3bfac8)->__offset(0x3bfae0).d
004350b7        float var_10[0x4]
004350b7        float* eax_69 = get_track_skirt_color(data_4df904 + 0x74618, &var_10)
004350c1        float* edx_33 = (esi_1 - 0x3bfac8)->__offset(0x3bfb18).d + 0x28
...
004350f5        void* eax_71 = (esi_1 - 0x3bfac8)->__offset(0x3bfb0c).d
004350ff        if (eax_71 != 0)
00435101        *(eax_71 + 4) &= 0xffffffdf
00435104        void* eax_72 = (esi_1 - 0x3bfac8)->__offset(0x3bfb18).d
00435109        if (eax_72 != 0)
0043510b        *(eax_72 + 4) &= 0xffffffdf
0043510e        void* eax_73 = (esi_1 - 0x3bfac8)->__offset(0x3bfb10).d
00435113        if (eax_73 != 0)
00435115        *(eax_73 + 4) &= 0xffffffdf
00435118        void* eax_74 = (esi_1 - 0x3bfac8)->__offset(0x3bfb14).d
