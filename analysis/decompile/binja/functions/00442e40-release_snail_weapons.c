...
00442ed0        snail->jetpack_channel.release_step.z = fconvert.s(fconvert.t(var_4_1) * fconvert.t(0.300000012f))
00442ef3        float var_1c_3 = fconvert.s((float.t(next_math_random_value()) - fconvert.t(16384f)) * fconvert.t(6.10351562e-05f))
00442ef7        long double st0_2 = random_float_below(1f, nullptr)
00442f14        float var_4_2 = fconvert.s(fconvert.t(snail->owner_player->velocity.z))
...
00442f4f        snail->weapon_channels[0].release_step.z = fconvert.s(fconvert.t(var_4_2) * fconvert.t(0.300000012f))
00442f72        float var_1c_5 = fconvert.s((float.t(next_math_random_value()) - fconvert.t(16384f)) * fconvert.t(6.10351562e-05f))
00442f7b        long double x87_r7_21 = random_float_below(1f, nullptr) + fconvert.t(0.5f)
00442f8d        float var_4_3 = fconvert.s(fconvert.t(snail->owner_player->velocity.z))
...
00442fce        snail->weapon_channels[2].release_step.z = fconvert.s(fconvert.t(var_4_3) * fconvert.t(0.300000012f))
00442ff1        float var_1c_7 = fconvert.s((float.t(next_math_random_value()) - fconvert.t(16384f)) * fconvert.t(6.10351562e-05f))
00442ff5        long double st0_4 = random_float_below(1f, nullptr)
00442ffa        struct Player* owner_player = snail->owner_player
00443050        snail->weapon_channels[1].release_step.x.12 = struct Vec3 {
    .x = fconvert.s(fconvert.t(var_1c_7) * fconvert.t(0.300000012f))
    .y = fconvert.s((st0_4 + fconvert.t(0.5f)) * fconvert.t(0.300000012f))
