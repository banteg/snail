...
0044e4f8        long double x87_r7_16 = fconvert.t(sprite->position.z) - fconvert.t(sprite->previous_position.z)
0044e4ff        vector.y = fconvert.s(x87_r7_14)
0044e50f        vector.z = fconvert.s(x87_r7_16)
0044e513        struct Vec3* eax_7 = rotate_vector_by_matrix(&vector, matrix)
0044e51a        float x_1 = eax_7->x
0044e51c        float y_1 = eax_7->y
0044e524        vector.z = eax_7->z
0044e536        sprite->facing_angle = fconvert.s(atan2_positive(x_1, y_1) + fconvert.t(7.06858349f))
0044e536        return
...
0044e459        long double x87_r7_6 = fconvert.t(sprite->position.z) - fconvert.t(sprite->previous_position.z)
0044e460        vector.y = fconvert.s(x87_r7_4)
0044e470        vector.z = fconvert.s(x87_r7_6)
0044e474        struct Vec3* eax_4 = rotate_vector_by_matrix(&vector, matrix)
0044e47b        float x = eax_4->x
0044e47d        float y = eax_4->y
0044e485        vector.z = eax_4->z
0044e48e        long double x87_r7_8 = atan2_positive(x, y) + fconvert.t(7.06858349f)
