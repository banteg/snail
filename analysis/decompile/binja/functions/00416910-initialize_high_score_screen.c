...
00416946        hide_star_field(&g_game_base->__offset(0x4f33c).d)
...
004169b6        set_border_justify_centre(&g_game_base->border_manager, 0x41c80000)
...
004169e5        struct tColour color_4
004169e5        if (selected_bank_1 == 0)
00416a66        struct tColour* color_15 = set_color_rgba(&color_3, 1f, 1f, 1f, 1f)
00416a7f        initialize_frontend_widget(high_score->title_widget, 0, "Postal High Scores", 0x17, 0f, 64f, color_15, 2, 0f)
...
00416a0a        struct tColour* color_14 = set_color_rgba(&color_4, 1f, 1f, 1f, 1f)
00416a23        initialize_frontend_widget(high_score->title_widget, 0, "Challenge High Scores", 0x17, 0f, 64f, color_14, 2, 0f)
...
00417043        struct tColour color_2
00417043        struct tColour color_5
...
00416da7        struct tColour color_8
00416da7        struct tColour* color_20 = set_color_rgba(&color_8, 1f, 1f, 1f, 1f)
...
00416e09        struct tColour color_12
00416e09        struct tColour* color_21 = set_color_rgba(&color_12, 1f, 1f, 1f, 1f)
...
00416e71        struct tColour color_10
00416e71        struct Color4f* color_22 = set_color_rgba(&color_10, 1f, 1f, 1f, 1f)
...
00416eb7        struct FrontendWidget* eax_38 = (esi - 0x7c)->name_row_widgets[0]
00416eb9        enum FrontendWidgetFlag widget_flags_1 = eax_38->widget_flags
00416ebf        widget_flags_1:1.b |= 0x20
00416ec2        eax_38->widget_flags = widget_flags_1
...
00416f05        struct tColour color_7
00416f05        struct Color4f* color_23 = set_color_rgba(&color_7, 1f, 1f, 1f, 1f)
...
00416f7d        struct tColour color_9
00416f7d        struct Color4f* color_24 = set_color_rgba(&color_9, 1f, 1f, 1f, 1f)
...
00416b62        struct tColour* color_16 = set_color_rgba(&color_3, 1f, 1f, 1f, 1f)
00416b82        initialize_frontend_widget((esi - 0x7c)->row_background_widgets[0], ecx_19 | 0x20000000, "                                           ", 0x16, 0f, y, color_16, 1, -228f)
...
00416bc2        struct tColour* color_17 = set_color_rgba(&color_4, 1f, 1f, 1f, 1f)
00416bda        initialize_frontend_widget((esi - 0x7c)->rank_row_widgets[0], widget_flags_2, &g_blank_text, 0x16, 0f, y, color_17, 1, -222f)
...
00416c2a        struct tColour color_11
00416c2a        struct tColour* color_18 = set_color_rgba(&color_11, 1f, 1f, 1f, 1f)
00416c51        initialize_frontend_widget((esi - 0x7c)->name_row_widgets[0], widget_flags_2, &g_game_base->subgame.sub_high_score.active_record_bank->player_name[i_1], 0x16, 0f, y, color_18, 1, -180f)
...
00416cc4        struct tColour color_6
00416cc4        struct Color4f* color = set_color_rgba(&color_6, 1f, 1f, 1f, 1f)
00416cd3        initialize_frontend_widget((esi - 0x7c)->score_row_widgets[0], widget_flags_2, &g_blank_text, 0x16, 0f, y, color, 3, 125f)
...
00416d32        struct tColour color_13
00416d32        struct Color4f* color_19 = set_color_rgba(&color_13, 1f, 1f, 1f, 1f)
...
00416fc9        struct tColour* eax_44 = set_color_rgba(&color_5, 0.329411775f, 0.184313729f, 0.419607848f, 0.699999988f)
00416fd3        struct tColour* ecx_80 = &(esi - 0x7c)->row_background_widgets[0]->idle_fill_color
00416fe8        ecx_80->r = eax_44->r
00416ff2        ecx_80->g = eax_44->g
00416ff8        ecx_80->b = eax_44->b
00416ffb        float a = eax_44->a
00416ffe        ecx_80->a.b = a.b
00416ffe        ecx_80->a:1.b = a:1.b
00416ffe        ecx_80->a:2.b = a:2.b
00416ffe        ecx_80->a:3.b = a:3.b
00417005        struct tColour* eax_45 = set_color_rgba(&color_2, 0.329411775f, 0.184313729f, 0.419607848f, 0.699999988f)
0041700f        struct tColour* ecx_83 = &(esi - 0x7c)->replay_row_widgets[0]->idle_fill_color
00417015        ecx_83->r = eax_45->r
0041701a        ecx_83->g = eax_45->g
00417020        ecx_83->b = eax_45->b
00417023        float a_1 = eax_45->a
...
0041709d        struct tColour* color_25 = set_color_rgba(&color_2, 1f, 1f, 1f, 1f)
...
004170fb        struct Color4f* color_26 = set_color_rgba(&color_2, 1f, 1f, 1f, 1f)
...
0041715f        struct tColour* color_27 = set_color_rgba(&color_2, 1f, 1f, 1f, 1f)
...
0041719a        struct Color4f* color_1
0041719a        if (selected_bank_3 == 0)
004171d0        int32_t __saved_ebx_2 = 0x42040000
004171d5        int32_t __saved_edi_3 = 2
004171f4        color_1 = set_color_rgba(&color_5, 1f, 1f, 1f, 1f)
004171f6        int32_t var_ec_11 = 0
004171f8        int32_t var_f0_12 = 0x17
00417207        initialize_frontend_widget(high_score->bank_toggle_button, 0x20000014, "Challenge Scores", 0x17, 0f, y_2, color_1, 2, 33f)
0041719d        if (selected_bank_3 == 1)
0041719f        int32_t __saved_ebx_1 = 0x42040000
004171a4        int32_t __saved_edi_2 = 2
004171c3        color_1 = set_color_rgba(&color_2, 1f, 1f, 1f, 1f)
004171c5        int32_t var_ec_10 = 0
004171c7        int32_t var_f0_11 = 0x17
00417207        initialize_frontend_widget(high_score->bank_toggle_button, 0x20000014, "Postal Scores", 0x17, 0f, y_2, color_1, 2, 33f)
00417214        return
