...
00416946        hide_star_field(&g_game_base[0x4f33c])
00416957        hide_gameplay_scores(&g_game_base[0x74618])
0041695c        void* __saved_ebx = &g_blank_text
00416961        int32_t __saved_edi = 0
00416968        cache_music_file("music/mainmenu.ogg")
00416980        int32_t eax_2 = load_landscape_script_by_name(&g_game_base[0x106c218], "Menubg.txt")
0041698d        char* game_base_1 = g_game_base
004169a0        change_backdrop(&game_base_1[0x4ec10], &game_base_1[eax_2 * 0x124 + 0x106c7bc], 0)
004169b6        set_border_justify_centre(&g_game_base[0xb4c], 0x41c80000)
004169c6        capture_mouse_cursor(&g_game_base[0x290])
004169dc        high_score->title_widget = allocate_border(&g_game_base[0xb4c])
...
00416a84        char* game_base_2 = g_game_base
00416a8f        *(game_base_2 + 0x6ffae0) = &game_base_2[0x6ffae8]
00416a9b        *(g_game_base + 0x6ffae4) = 0xa
00416aa5        var_c4 = 27f
...
00416a28        char* game_base_3 = g_game_base
00416a33        *(game_base_3 + 0x6ffae0) = &game_base_3[0x85c128]
00416a3e        *(g_game_base + 0x6ffae4) = 0xa
00416aa5        var_c4 = 27f
...
00416afa        char* game_base_4 = g_game_base
00416b0a        if (*(*(game_base_4 + 0x6ffae0) + i) == 1)
...
00416da4        (esi - 0x7c)->row_background_widgets[0] = allocate_border(&game_base_4[0xb4c])
...
00416e00        (esi - 0x7c)->rank_row_widgets[0] = allocate_border(&g_game_base[0xb4c])
...
00416e6f        (esi - 0x7c)->name_row_widgets[0] = allocate_border(&g_game_base[0xb4c])
00416e71        struct tColour color_9
00416e71        struct Color4f* color_22 = set_color_rgba(&color_9, 1f, 1f, 1f, 1f)
00416e97        initialize_frontend_widget((esi - 0x7c)->name_row_widgets[0], widget_flags_3, *(g_game_base + 0x6ffae0) + i_1 + 0x54, 0x16, 0f, y_1, color_22, 1, -180f)
00416ea5        if (var_cc == high_score->selected_rank)
00416eb2        border_input_text_init((esi - 0x7c)->name_row_widgets[0], 0x10, &data_4df978, 0x10)
00416eb7        struct FrontendWidget* eax_37 = (esi - 0x7c)->name_row_widgets[0]
00416eb9        uint32_t widget_flags_1 = eax_37->widget_flags
...
00416f02        (esi - 0x7c)->score_row_widgets[0] = allocate_border(&g_game_base[0xb4c])
...
00416f3a        border_add_text_number((esi - 0x7c)->score_row_widgets[0], *(*(g_game_base + 0x6ffae0) + i_1 + 4))
00416f42        layout_frontend_widget((esi - 0x7c)->score_row_widgets[0])
00416f7a        (esi - 0x7c)->replay_row_widgets[0] = allocate_border(&g_game_base[0xb4c])
...
00416b5f        (esi - 0x7c)->row_background_widgets[0] = allocate_border(&game_base_4[0xb4c])
...
00416bb9        (esi - 0x7c)->rank_row_widgets[0] = allocate_border(&g_game_base[0xb4c])
...
00416c28        (esi - 0x7c)->name_row_widgets[0] = allocate_border(&g_game_base[0xb4c])
00416c2a        struct tColour color_10
00416c2a        struct tColour* color_17 = set_color_rgba(&color_10, 1f, 1f, 1f, 1f)
00416c51        initialize_frontend_widget((esi - 0x7c)->name_row_widgets[0], widget_flags_2, *(g_game_base + 0x6ffae0) + i_1 + 0x54, 0x16, 0f, y, color_17, 1, -180f)
00416c5f        if (var_cc == high_score->selected_rank)
00416c6c        border_input_text_init((esi - 0x7c)->name_row_widgets[0], 0x10, &data_4df978, 0x10)
00416c71        struct FrontendWidget* eax_19 = (esi - 0x7c)->name_row_widgets[0]
00416c73        uint32_t widget_flags = eax_19->widget_flags
...
00416cb8        (esi - 0x7c)->score_row_widgets[0] = allocate_border(&g_game_base[0xb4c])
...
00416cf0        border_add_text_number((esi - 0x7c)->score_row_widgets[0], *(*(g_game_base + 0x6ffae0) + i_1 + 4))
00416cf8        layout_frontend_widget((esi - 0x7c)->score_row_widgets[0])
00416d2f        (esi - 0x7c)->replay_row_widgets[0] = allocate_border(&g_game_base[0xb4c])
...
0041709a        high_score->cancel_name_button = allocate_border(&g_game_base[0xb4c])
...
004170f8        high_score->submit_name_button = allocate_border(&g_game_base[0xb4c])
...
0041712a        return
0041715c        high_score->back_button = allocate_border(&g_game_base[0xb4c])
...
00417191        high_score->bank_toggle_button = allocate_border(&g_game_base[0xb4c])
