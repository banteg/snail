...
00433070        __builtin_memcpy(arg1 + 4, "\x30\x02\x00\x00\x30\x02\x00\x00\xa0\x00\x00\x00\x50\x00\x00\x00\x20\x03\x00\x00\x00\x05\x00\x00\x00\x05\x00\x00\xf0\x00\x00\x00\xa0\x00\x00\x00\x00\x05\x00\x00", 0x28)
004330b4        *(arg1 + 0x54) = data_4df904 + 0x74618
004330b7        int32_t var_8 = 0
004330bb        int32_t* var_4 = arg1 + 0x16c
004331cc        bool cond:1_1
004330bf        int32_t i = 0
004331a8        while (i s< 5)
004330d3        void* esi_1 = arg1 + (var_8 + i) * 0x3c
...
0043312c        *(*(esi_1 + 0x7c) + 0xc0) = sub_4114b0(0x4f7458, *(arg1 + (i << 2) + 4), 0x142)
00433146        *(*(esi_1 + 0x7c) + 0xc8) = sub_4115d0(0x5000fc, *(arg1 + (i << 2) + 0x18))
...
00433195        if (i == 4)
0043319d        *(*var_4 + 0x14) = 5
004331a4        i += 1
004331bf        cond:1_1 = var_8 + 5 s< 0x2cb
004331c4        var_8 += 5
004331c8        var_4 = &var_4[0x4b]
004331cc        do while (cond:1_1)
004331d2        int32_t* esi_2 = arg1 + 0x2c
004331d5        int32_t i_2 = 5
0043320a        void* result
0043320a        int32_t i_1
004331ee        *esi_2 = allocate_tracked_memory(esi_2[-0xa] * 0x18, "GDX Cache Vertex Buffer")
004331fb        result = allocate_tracked_memory(esi_2[-5] << 1, "GDX Cache Index Buffer")
00433200        esi_2[5] = result
