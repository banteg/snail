...
00413bd3        struct Vec3* vertices = object->vertices
00413bd6        int32_t eax_1 = vertex_index * 3
00413bd9        int32_t object_grouped_vertex_cursor_1 = g_object_grouped_vertex_cursor
00413bdf        void* edx = vertices + (eax_1 << 2)
00413be2        float eax_2 = *(vertices + (eax_1 << 2))
00413be9        float ecx = *(edx + 4)
00413bf0        float edx_1 = *(edx + 8)
00413bf7        int32_t result = 0
00413bfb        if (object_grouped_vertex_cursor_1 s> 0)
00413c0c        float* ecx_1 = &g_object_grouped_vertex_scratch->y
00413c11        if ((object->flags & OBJECT_FLAG_DYNAMIC_VERTICES) == 0)
00413c40        long double x87_r7_4 = fconvert.t((ecx_1 - 4)->x)
...
00413c4e        long double x87_r7_5 = fconvert.t((ecx_1 - 4)->y)
00413c50        long double temp1_1 = fconvert.t(ecx)
...
00413c5b        long double x87_r7_6 = fconvert.t((ecx_1 - 4)->z)
...
00413c69        long double x87_r7_7 = fconvert.t((ecx_1 - 4)->u)
...
00413c81        long double temp6_1 = fconvert.t((ecx_1 - 4)->v)
...
00413c16        if ((ecx_1 - 4)->source_vertex == vertex_index)
00413c18        long double x87_r7_1 = fconvert.t((ecx_1 - 4)->u)
...
00413c30        long double temp4_1 = fconvert.t((ecx_1 - 4)->v)
...
00413cbe        *(&g_object_grouped_vertex_scratch->y + esi_2) = fconvert.s(fconvert.t(ecx))
00413ccb        *(&g_object_grouped_vertex_scratch->z + esi_2) = fconvert.s(fconvert.t(edx_1))
00413cd9        *(&g_object_grouped_vertex_scratch->u + esi_2) = fconvert.s(fconvert.t(u))
00413ced        *(&g_object_grouped_vertex_scratch->v + esi_2) = fconvert.s(fconvert.t(1f) - fconvert.t(v))
...
00413d0f        pack_color_rgba_u8(&g_object_grouped_vertex_scratch->diffuse + esi_2, &object->vertex_colours[vertex_index])
00413d33        *(&g_object_grouped_vertex_scratch->source_vertex + esi_2) = vertex_index
