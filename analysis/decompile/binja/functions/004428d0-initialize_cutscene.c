...
004429ce        eax.b = owner_player_2->__offset(0x41d).b
004429d6        if (eax.b != 0)
004429e6        __builtin_memcpy(&var_140, owner_player_2 + 0x38, 0x40)
004429f3        __builtin_memcpy(&to, owner_player_2 + 0x38, 0x40)
004429f9        set_matrix_rotation_identity(&var_140)
00442a16        linear_interpolate_matrix(presentation_1->owner_player + 0x38, &var_140, &to, 0.970000029f)
00442923        owner_player_2->__offset(0x2dc).d = fconvert.s(fconvert.t(owner_player_2->__offset(0x2e0).d) + fconvert.t(owner_player_2->__offset(0x2dc).d))
00442929        struct Player* owner_player_3 = presentation_1->owner_player
0044292f        long double x87_r7_4 = fconvert.t(owner_player_3->__offset(0x2dc).d)
...
00442942        owner_player_3->__offset(0x2dc).d = 0
00442957        void* __offset(Player, 0x38) eax_2 = presentation_1->owner_player + 0x38
...
00442990        long double x87_r7_8 = (fconvert.t(-0.785398185f) - fconvert.t(presentation_1->owner_player->__offset(0x2dc).d) * fconvert.t(6.28318548f)) * fconvert.t(1.39999998f)
...
00442a16        linear_interpolate_matrix(presentation_1->owner_player + 0x38, &var_140, &to, 0.939999998f)
00442a1b        struct Player* owner_player = presentation_1->owner_player
00442a33        __builtin_memcpy(&presentation_1->live_matrix, owner_player + 0x38, 0x40)
00442a40        presentation_1->live_matrix.position.x = owner_player->__offset(0x2964).d
00442a42        float edx_3 = owner_player->__offset(0x2968).d
00442a45        float alpha
00442a45        __builtin_strncpy(&alpha, "333?", 4)
00442a4a        presentation_1->live_matrix.position.y = edx_3
00442a50        presentation_1->live_matrix.position.z = owner_player->__offset(0x296c).d
...
00442dbc        __builtin_memcpy(&presentation_1->snail_hotspot_source_matrix_b, owner_player_1 + 0x38, 0x40)
00442dc6        presentation_1->snail_hotspot_source_matrix_b.position.x = owner_player_1->__offset(0x2964).d
...
00442e2c        return update_jet_particles(presentation_1->owner_player + 0x2750)
