...
004428db        int32_t ebx
004428db        int32_t var_160 = ebx
004428db        int32_t* esp = &var_160
004428dc        struct PlayerPresentationController* presentation_2 = presentation
004428de        presentation.b = *(result + 0x74621)
004428e6        if (presentation.b == 0)
004428ec        int32_t ebp
004428ec        int32_t var_164 = ebp
004428ed        int32_t esi
004428ed        int32_t var_168_1 = esi
004428ee        int32_t edi
004428ee        int32_t var_16c_1 = edi
004428f5        update_snail_skin_transition(&presentation_2->snail_skin_transition)
004428fa        struct Player* owner_player_2 = presentation_2->owner_player
...
00442a16        presentation_2 = linear_interpolate_matrix(&presentation_2->owner_player->live_matrix, &var_140, &to, 0.970000029f)
...
00442929        struct Player* owner_player_3 = presentation_2->owner_player
...
00442990        long double x87_r7_8 = (fconvert.t(-0.785398185f) - fconvert.t(presentation_2->owner_player->cutscene_pitch_cycle) * fconvert.t(6.28318548f)) * fconvert.t(1.39999998f)
...
00442b35        void* var_170_5 = &var_c0
00442b53        struct TransformMatrix* var_170_8 = &presentation_2->live_matrix
00442b5b        var_80
00442b5b        invert_matrix_from_source(&var_80, rotate_matrix_world_z(&var_c0, fconvert.s(sine(fconvert.s(fconvert.t(presentation_1->wobble.roll_phase) * fconvert.t(6.28318548f))) * fconvert.t(0.0174499992f))))
00442b6a        var_84
00442b6a        multiply_matrix_in_place(&presentation_2->live_matrix, &var_84)
...
00442b85        struct TransformMatrix rhs
00442b85        multiply_matrix_in_place(&presentation_2->live_matrix, &rhs)
...
00442ba0        var_44
00442ba0        multiply_matrix_in_place(&presentation_2->live_matrix, &var_44)
00442bb1        struct TransformMatrix* var_174_6 = &presentation_2->live_matrix
...
00442c27        int32_t ecx_17 = __builtin_memcpy(&presentation_1->cached_cutscene_matrix, &presentation_2->live_matrix, 0x40)
00442c2e        if ((((x87_r7_35 < temp6_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_35, temp6_1) ? 1 : 0) << 0xa | (x87_r7_35 == temp6_1 ? 1 : 0) << 0xe):1.b & 0x41) == 0)
00442c3c        int32_t var_174_8 = ecx_17
00442c42        rotate_matrix_world_y(&presentation_2->live_matrix, fconvert.s(fconvert.t(presentation_1->invincible_shell._pad_90[4].d) * fconvert.t(-2.09439516f)))
...
00442d92        __builtin_memcpy(&presentation_1->weapon_channels[1].live_matrix, &presentation_2->live_matrix, 0x40)
...
00442da7        __builtin_memcpy(&presentation_1->snail_hotspot_source_matrix_a, &presentation_2->live_matrix, 0x40)
