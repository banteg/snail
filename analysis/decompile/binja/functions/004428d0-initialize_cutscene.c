...
00442911        void transform
00442911        void var_100
...
004429d6        if (eax.b != 0)
004429e6        __builtin_memcpy(&transform, ecx_1 + 0x38, 0x40)
004429f3        __builtin_memcpy(&var_100, ecx_1 + 0x38, 0x40)
004429f9        set_matrix_rotation_identity(&transform)
00442a16        linear_interpolate_matrix(*(ebx + 0x100) + 0x38, &transform, &var_100, 0.970000029f)
...
00442960        __builtin_memcpy(&transform, eax_2, 0x40)
0044296d        __builtin_memcpy(&var_100, eax_2, 0x40)
00442973        set_matrix_rotation_identity(&transform)
...
004429b8        rotate_matrix_world_x(&transform, var_15c_1)
00442a16        linear_interpolate_matrix(*(ebx + 0x100) + 0x38, &transform, &var_100, 0.939999998f)
...
00442a45        float var_170_3
00442a45        __builtin_strncpy(&var_170_3, "333?", 4)
00442a4a        *(ebx + 0x6c) = edx_3
00442a50        *(ebx + 0x70) = *(eax_5 + 0x296c)
00442a58        __builtin_memcpy(&transform, ebx + 0x38, 0x40)
00442a68        linear_interpolate_matrix(ebx + 0x38, &transform, ebx + 0xc0, var_170_3)
00442a74        long double x87_r7_9 = fconvert.t(*(ebx + 0x4c))
00442a77        long double temp2_1 = fconvert.t(0f)
00442a77        x87_r7_9 - temp2_1
00442a7f        int32_t var_110
00442a7f        *(ebx + 0x68) = var_110
00442a85        int32_t var_10c
00442a85        *(ebx + 0x6c) = var_10c
00442a8c        int32_t var_108
00442a8c        *(ebx + 0x70) = var_108
00442a8f        int32_t eax_11
...
00442a9e        int32_t* var_170_4 = ebx + 0x68
...
00442b24        void transform_1
00442b24        set_matrix_identity(&transform_1)
00442b35        void* var_170_6 = &transform_1
00442b4e        rotate_matrix_world_z(&transform_1, fconvert.s(sine(fconvert.s(fconvert.t(*(ebx + 0x15bc)) * fconvert.t(6.28318548f))) * fconvert.t(0.0174499992f)))
...
00442b81        float* var_170_11 = &transform_1
00442b82        *(ebx + 0x6c) = fconvert.s(fconvert.t(*(ebx + 0x6c)) + fconvert.t(1.29999995f))
00442b85        multiply_matrix_in_place(ebx + 0x38, var_170_11)
00442b9c        float (* var_170_12)[0x10] = &var_40
00442b9d        *(ebx + 0x6c) = fconvert.s(fconvert.t(*(ebx + 0x6c)) - fconvert.t(1.29999995f))
00442ba0        multiply_matrix_in_place(ebx + 0x38, var_170_12)
00442bb1        float* var_170_13 = ebx + 0x38
...
00442c3c        int32_t var_170_15 = ecx_19
