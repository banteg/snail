...
00436043        level_mode_2, x87control_1 = __ftol(x87control_1, (fconvert.t(game->challenge_difficulty_scalar) * fconvert.t(0.649999976f) + fconvert.t(0.349999994f)) * float.t(ecx_9))
00436043        top = 0
00436048        game->runtime_row_count = level_mode_2
0043604b        level_mode_2.b = game->__offset(0x1b013c).b
00436053        if (level_mode_2.b == 0)
...
00436072        void* __offset(Game, 0xa87c) ecx_11 = &game->__offset(0xa87c).d
...
00435fea        esi_1 = game->runtime_row_count + game->__offset(0xa87c).d
00435fec        i_1 = i_6
00435fec        i_6 -= 1
...
0043612e        ecx_14:1.b = (esi_5 - 0x3bfb08)->__offset(0x3bfb08).d:1.b & 0x5f
...
00436150        int32_t edx_9
00436150        edx_9.b = (esi_5 - 0x3bfb08)->__offset(0x3bfacc).d.b & 0x7f
...
00436161        void* __offset(Game, 0x3bfb0c) eax_19 = var_28
00436165        level_segment_count = 8
0043617d        struct Game* i_3
0043616a        void* __offset(Game, 0x3bfb0c) esi_6 = eax_19
0043616e        eax_19 += 0x54
...
004361ad        level_segment_count = &game->__offset(0xa880).d
004361b3        level_segment_count->_pad_00[0] = 0
004361bc        i_4 += 1
004361bd        level_segment_count = &level_segment_count->__offset(0x4220).d
...
004361e4        int32_t completion_row_start
004361e4        void* __offset(Game, 0x1a7cf8) esi_7
004361e4        if (i_5 != 0)
004361ff        if (i_5 == ebp_1->completion_row_start)
00436201        completion_row_start.b = ebp_1->__offset(0x1b013c).b
00436209        if (i_5 != ebp_1->completion_row_start || completion_row_start.b != 0)
00436221        ebp_1->base_subgame_rate = 1f
00436228        completion_row_start.b = ebp_1->__offset(0x1b013c).b
00436230        if (completion_row_start.b != 1)
004362a4        int32_t eax_24 = var_24
004362a9        var_24 += 1
004362ba        esi_7 = &ebp_1->_pad_00[eax_24 * 0x4220 + 0xa878]
...
0043626b        int32_t eax_22
0043626b        int16_t x87control_2
0043626b        eax_22, x87control_2 = __ftol(x87control_1, st0_2)
00436270        int32_t var_28_1 = eax_22
00436274        unimplemented  {fild st0, dword [esp+0x2c]}
00436278        unimplemented  {fmul st0, dword [ebp+0x48]}
0043627b        int32_t eax_23
0043627b        eax_23, x87control_1 = __ftol(x87control_2, st0_2)
0043627b        top = top_1 + 1
0043628f        esi_7 = &ebp_1->_pad_00[eax_23 * 0x4220 + 0xa878]
...
004362cc        int32_t eax_25 = (esi_7 - 0x1a7cf8)->__offset(0x1a7cfc).d
004362cf        (esi_7 - 0x1a7cf8)->__offset(0x1a7cf8).d = i_5
004362d3        if (eax_25 s< 0)
...
00436313        void* __offset(Game, 0x1a7cf8) edx_17
...
00436354        completion_row_start = (edx_17 - 0x1a7cf8)->__offset(0x1a7cfc).d
...
004363c9        completion_row_start.b = ebp_1->_pad_00[2]
004363ce        if (completion_row_start.b != 0)
...
0043641f        int32_t ecx_35
0043641f        ecx_35:1.b = (*(ebp_1 + (ecx_34 << 2) + 0x5ccac8)):1.b | 1
00436422        *(ebp_1 + (ecx_34 << 2) + 0x5ccac8) = ecx_35
0043642d        if (((*(esi_9 + 0x814)).w:1.b & 0x80) != 0)
00436435        int32_t ecx_36 = i_5 * 0x3d
00436446        int32_t ecx_37
00436446        ecx_37:1.b = (*(ebp_1 + (ecx_36 << 2) + 0x5ccac8)):1.b | 0x80
...
0043647b        int32_t eax_43
0043647b        eax_43.b = (*(ebx_5 + 0x5ccac8)).b | 2
0043647d        *(ebx_5 + 0x5ccac8) = eax_43
...
004364c5        int32_t eax_46
004364c5        eax_46.b = *(esi_9 + 0x82c)
004364c5        eax_46:1.b = *(esi_9 + 0x82d)
004364c5        eax_46:2.b = *(esi_9 + 0x82e)
004364c5        eax_46:3.b = *(esi_9 + 0x82f)
004364c7        *(ebx_5 + 0x5ccb34) = eax_46
004364c9        int32_t eax_47
004364c9        eax_47.b = *(esi_9 + 0x830)
004364c9        eax_47:1.b = *(esi_9 + 0x831)
004364c9        eax_47:2.b = *(esi_9 + 0x832)
004364c9        eax_47:3.b = *(esi_9 + 0x833)
004364cc        *(ebx_5 + 0x5ccb38) = eax_47
...
004364f6        int32_t eax_48
004364f6        eax_48.b = (*(ebx_5 + 0x5ccac8)).b | 8
004364f8        *(ebx_5 + 0x5ccac8) = eax_48
...
0043657b        int32_t eax_55 = *(esi_9 + 0x824)
0043657e        *(ebx_5 + 0x5ccb60) = eax_55.b
0043657e        *(ebx_5 + 0x5ccb61) = eax_55:1.b
0043657e        *(ebx_5 + 0x5ccb62) = eax_55:2.b
0043657e        *(ebx_5 + 0x5ccb63) = eax_55:3.b
00436588        if ((*(esi_9 + 0x814) & 8) != 0)
00436590        int32_t eax_56
00436590        eax_56.b = (*(ebx_5 + 0x5ccac8)).b | 8
00436592        *(ebx_5 + 0x5ccac8) = eax_56
0043659e        *(ebx_5 + 0x5ccb68) = *(esi_9 + 0x844)
004365ab        if ((*(esi_9 + 0x814) & 4) != 0)
004365b3        int32_t eax_57
004365b3        eax_57.b = (*(ebx_5 + 0x5ccac8)).b | 4
004365b5        *(ebx_5 + 0x5ccac8) = eax_57
...
00436650        int32_t eax_59
00436650        eax_59.b = game->_pad_00[2]
00436655        int32_t edx_29
00436655        int32_t ebp_2
00436655        if (eax_59.b == 0)
...
0043668b        int32_t eax_63
0043668b        eax_63.b = (*(esi_11 + 0x3bfb08)).b & 0xe0
0043668f        *(esi_11 + 0x3bfb08) = eax_63 ^ (edx_29 & 7)
...
004366f2        void* __offset(Game, 0x1a7cf8) edx_32
004366f2        edx_32.b = *(var_3c_1 + &level_segment_count_2->_pad_00[ebp_2 << 8] + 0x14)
004366f6        uint8_t eax_68 = normalize_segment_glyph_for_track_flags(game, edx_32.b, completion_row_start_2, var_1c.b)
00436704        struct ColorBGRA8* eax_69
00436704        if (sx.d(eax_68) - 0x20 u> 0x5d)
00436ec0        label_436ec0:
00436ec0        void* __offset(Game, 0x1a7cf8) edx_58
00436ec0        edx_58.b = *(var_3c_1 + &level_segment_count_2->_pad_00[ebp_2 << 8] + 0x14)
00436ec3        int32_t var_58_34 = (var_3c_1 - 0x1a7cf8)->__offset(0x1a7d08).d
...
0043670c        edx_33.b = *(sx.d(eax_68) + &jump_table_437194[0x14])
00436712        switch (edx_33)
00436719        case 0
00436719        *(esi_11 + 0x3bfb04) = 0
00436726        eax_69.b = (*(esi_11 + 0x3bfacc)).b & 0xdf
00436728        *(esi_11 + 0x3bfacc) = eax_69
0043674d        case 1
0043674d        *(esi_11 + 0x3bfb04) = 0x20
0043675a        eax_69.b = (*(esi_11 + 0x3bfacc)).b & 0xdf
0043675c        *(esi_11 + 0x3bfacc) = eax_69
004367f4        case 2
004367f4        set_bod_object(esi_11 + 0x3bfac8, *(data_4df904 + 0x44b34))
004367f9        *(esi_11 + 0x3bfb04) = 0x17
00436806        eax_69.b = (*(esi_11 + 0x3bfacc)).b | 0x20
00436808        *(esi_11 + 0x3bfacc) = eax_69
00436906        case 3
00436906        set_bod_object(esi_11 + 0x3bfac8, *(data_4df904 + 0x447b4))
0043690b        *(esi_11 + 0x3bfb04) = 0x22
00436918        eax_69.b = (*(esi_11 + 0x3bfacc)).b | 0x20
0043691a        *(esi_11 + 0x3bfacc) = eax_69
00436a13        case 4
00436a13        int32_t ecx_90 = var_20 + 1
00436a14        struct ColorBGRA8* ebp_7 = *(esi_11 + 0x3bfacc) & 0xffffffdf
...
00436aab        eax_69.b = ebp_7.b & 0xdf
00436aad        *(esi_11 + 0x3bfacc) = eax_69
00436ab3        *(esi_11 + 0x3bfb04) = 0x16
00436a50        set_bod_object(esi_11 + 0x3bfac8, *(data_4df904 + 0x444dc))
...
00436973        eax_69.b = (*(esi_11 + 0x3bfacc)).b | 0x20
00436975        *(esi_11 + 0x3bfacc) = eax_69
00436933        case 6
00436933        set_bod_object(esi_11 + 0x3bfac8, *(data_4df904 + 0x44124))
00436938        *(esi_11 + 0x3bfb04) = 0x1c
00436945        eax_69.b = (*(esi_11 + 0x3bfacc)).b | 0x20
00436947        *(esi_11 + 0x3bfacc) = eax_69
004369bc        case 7
004369bc        set_bod_object(esi_11 + 0x3bfac8, *(data_4df904 + 0x447b4))
004369c1        *(esi_11 + 0x3bfb04) = 0x15
004369ce        eax_69.b = (*(esi_11 + 0x3bfacc)).b | 0x20
004369d0        *(esi_11 + 0x3bfacc) = eax_69
004368aa        case 8
004368aa        set_bod_object(esi_11 + 0x3bfac8, *(data_4df904 + 0x447b4))
004368af        *(esi_11 + 0x3bfb04) = 1
004368bc        eax_69.b = (*(esi_11 + 0x3bfacc)).b | 0x20
004368be        *(esi_11 + 0x3bfacc) = eax_69
00436e02        case 9
00436e02        if (game->level_mode == 1)
00436e04        unimplemented  {fild st0, dword [esp+0x24]}
00436e0e        int32_t ecx_122
00436e0e        ecx_122:1.b = (*(ebx_5 + 0x5ccac8)):1.b & 0xbf
...
00436e52        int32_t ecx_123
00436e52        ecx_123.b = game->_pad_00[2]
00436e57        if (ecx_123.b != 0)
...
00436ea4        eax_69.b = (*(esi_11 + 0x3bfacc)).b & 0xdf
00436ea6        *(esi_11 + 0x3bfacc) = eax_69
00436eac        *(esi_11 + 0x3bfb04) = 0
00436e82        set_bod_object(esi_11 + 0x3bfac8, *(data_4df904 + 0x44b34))
00436e87        *(esi_11 + 0x3bfb04) = 0xf
00436e94        eax_69.b = (*(esi_11 + 0x3bfacc)).b | 0x20
00436e96        *(esi_11 + 0x3bfacc) = eax_69
00436c76        case 0xb
00436c76        set_bod_object(esi_11 + 0x3bfac8, *(data_4df904 + 0x44d2c))
00436c7d        *(esi_11 + 0x3bfae4) = 0
00436c83        *(esi_11 + 0x3bfae8) = 0
00436c89        *(esi_11 + 0x3bfb04) = 6
00436c96        eax_69.b = (*(esi_11 + 0x3bfacc)).b | 0x20
00436c98        *(esi_11 + 0x3bfacc) = eax_69
004369ea        case 0xc
004369ea        set_bod_object(esi_11 + 0x3bfac8, *(data_4df904 + 0x445f4))
004369ef        *(esi_11 + 0x3bfb04) = 0xe
004369fc        eax_69.b = (*(esi_11 + 0x3bfacc)).b | 0x20
004369fe        *(esi_11 + 0x3bfacc) = eax_69
00436ad0        case 0xd
...
00436b3f        eax_69.b = (*(esi_11 + 0x3bfacc)).b | 0x20
00436b41        *(esi_11 + 0x3bfacc) = eax_69
00436ae1        set_bod_object(esi_11 + 0x3bfac8, *(data_4df904 + 0x44d2c))
00436ae6        *(esi_11 + 0x3bfae4) = 0
00436aec        *(esi_11 + 0x3bfae8) = 0
00436af2        *(esi_11 + 0x3bfb04) = 9
00436aff        eax_69.b = (*(esi_11 + 0x3bfacc)).b | 0x20
00436b01        *(esi_11 + 0x3bfacc) = eax_69
00436b07        *(esi_11 + 0x3bf864) = 0xc
0043676b        case 0xe
0043676b        *(esi_11 + 0x3bfb04) = 0
00436778        int32_t eax_70
00436778        eax_70.b = (*(esi_11 + 0x3bfacc)).b & 0xdf
0043677a        *(esi_11 + 0x3bfacc) = eax_70
00436780        switch_track_mirror(game)
0043687d        case 0xf
0043687d        set_bod_object(esi_11 + 0x3bfac8, *(data_4df904 + 0x44b34))
00436882        *(esi_11 + 0x3bfb04) = 0x13
0043688f        eax_69.b = (*(esi_11 + 0x3bfacc)).b | 0x20
00436891        *(esi_11 + 0x3bfacc) = eax_69
00436798        case 0x10
00436798        set_bod_object(esi_11 + 0x3bfac8, *(data_4df904 + 0x44b34))
0043679d        *(esi_11 + 0x3bfb04) = 0x11
004367aa        eax_69.b = (*(esi_11 + 0x3bfacc)).b | 0x20
004367ac        *(esi_11 + 0x3bfacc) = eax_69
0043698f        case 0x11
0043698f        set_bod_object(esi_11 + 0x3bfac8, *(data_4df904 + 0x44b34))
00436994        *(esi_11 + 0x3bfb04) = 0x19
004369a1        eax_69.b = (*(esi_11 + 0x3bfacc)).b | 0x20
004369a3        *(esi_11 + 0x3bfacc) = eax_69
0043684f        case 0x12
0043684f        set_bod_object(esi_11 + 0x3bfac8, *(data_4df904 + 0x44b34))
00436854        *(esi_11 + 0x3bfb04) = 0x12
00436861        eax_69.b = (*(esi_11 + 0x3bfacc)).b | 0x20
00436863        *(esi_11 + 0x3bfacc) = eax_69
00436ce0        case 0x13
00436ce0        if (eax_68 == 0x50)
00436ce2        *(esi_11 + 0x3bfb04) = 0x1e
00436ced        if (eax_68 == 0x70)
00436cef        *(esi_11 + 0x3bfb04) = 0x1d
00436cfa        int32_t ecx_110 = *(ebx_5 + 0x5ccb68)
00436d05        int32_t eax_93 = ecx_110 << 3
00436d0c        void* ecx_111
00436d0c        if (game->_pad_00[2] == 0)
00436d27        ecx_111 = (eax_93 - ecx_110) * 0x30 + game + 0xff2914
00436d16        ecx_111 = (eax_93 - ecx_110) * 0x30 + game + 0xff29bc
00436d2e        eax_69.b = var_41_1
00436d32        *(esi_11 + 0x3bfb00) = ecx_111
00436d43        *(esi_11 + 0x3bfacc) &= 0xffffffdf
00436d49        if (eax_69.b == 0)
00436d57        var_41_1 = 1
...
00436dbb        if ((*(esi_11 + 0x3bfb00))->__offset(0x48).d s> 0)
00436dc1        char* ecx_121 = ebx_5 + 0x5ccac8
00436dc7        int32_t eax_100
00436dc7        eax_100.b = *ecx_121
00436dc7        eax_100:1.b = ecx_121[1]
00436dc7        eax_100:2.b = ecx_121[2]
00436dc7        eax_100:3.b = ecx_121[3]
00436dcb        if ((eax_100.b & 0x40) == 0)
00436dd9        eax_100.b |= 0x40
00436ddb        *ecx_121 = eax_100.b
00436ddb        ecx_121[1] = eax_100:1.b
00436ddb        ecx_121[2] = eax_100:2.b
00436ddb        ecx_121[3] = eax_100:3.b
00436ddd        *(ecx_121 + 0xa4) = esi_11 + 0x3bfac8
00436dcd        eax_100.b |= 0x80
00436dcf        *ecx_121 = eax_100.b
00436dcf        ecx_121[1] = eax_100:1.b
00436dcf        ecx_121[2] = eax_100:2.b
00436dcf        ecx_121[3] = eax_100:3.b
00436dd1        *(ecx_121 + 0xa8) = esi_11 + 0x3bfac8
00436de9        k += 1
00436dea        ecx_121 = &ecx_121[0xf4]
00436df3        do while (k s< (*(esi_11 + 0x3bfb00))->__offset(0x48).d)
00436733        case 0x14
00436733        *(esi_11 + 0x3bfb04) = 0x23
00436740        eax_69.b = (*(esi_11 + 0x3bfacc)).b & 0xdf
00436742        *(esi_11 + 0x3bfacc) = eax_69
00436cb1        case 0x15
...
00436cd1        eax_69.b = (*(esi_11 + 0x3bfacc)).b | 0x20
00436cd3        *(esi_11 + 0x3bfacc) = eax_69
004367c6        case 0x16
004367c6        set_bod_object(esi_11 + 0x3bfac8, *(data_4df904 + 0x44b34))
004367cb        *(esi_11 + 0x3bfb04) = 0xf
004367d8        eax_69.b = (*(esi_11 + 0x3bfacc)).b | 0x20
004367da        *(esi_11 + 0x3bfacc) = eax_69
00436821        case 0x17
00436821        set_bod_object(esi_11 + 0x3bfac8, *(data_4df904 + 0x44b34))
00436826        *(esi_11 + 0x3bfb04) = 0x10
00436833        eax_69.b = (*(esi_11 + 0x3bfacc)).b | 0x20
00436835        *(esi_11 + 0x3bfacc) = eax_69
004368d8        case 0x18
004368d8        set_bod_object(esi_11 + 0x3bfac8, *(data_4df904 + 0x447b4))
004368dd        *(esi_11 + 0x3bfb04) = 0x21
004368ea        eax_69.b = (*(esi_11 + 0x3bfacc)).b | 0x20
004368ec        *(esi_11 + 0x3bfacc) = eax_69
00436beb        case 0x19
...
00436c5a        eax_69.b = (*(esi_11 + 0x3bfacc)).b | 0x20
00436c5c        *(esi_11 + 0x3bfacc) = eax_69
...
00436c19        eax_69.b = (*(esi_11 + 0x3bfacc)).b | 0x20
00436c1b        *(esi_11 + 0x3bfacc) = eax_69
00436c21        *(esi_11 + 0x3bf864) = 0xb
00436b5d        case 0x1a
00436b5d        if (completion_row_start_2 s<= 0 || *(esi_11 + 0x3bf864) != 3)
00436baf        set_bod_object(esi_11 + 0x3bfac8, *(data_4df904 + 0x44d64))
00436bb4        *(esi_11 + 0x3bfae4) = 0
00436bba        *(esi_11 + 0x3bfae8) = 0
00436bc0        *(esi_11 + 0x3bfb04) = 4
00436bcd        eax_69.b = (*(esi_11 + 0x3bfacc)).b | 0x20
00436bcf        *(esi_11 + 0x3bfacc) = eax_69
...
00436b8c        eax_69.b = (*(esi_11 + 0x3bfacc)).b | 0x20
00436b8e        *(esi_11 + 0x3bfacc) = eax_69
...
00436f04        eax_69.b = *(esi_11 + 0x3bfb04)
00436f10        float var_28_2
00436f10        if (eax_69.b == 0x1d || eax_69.b == 0x1e)
...
00436ff9        eax_69.b = (*(ebx_5 + 0x5ccb7c)).b & 0xdf
00436ffb        unimplemented  {fstp st0, st0}
00436ffb        unimplemented  {fstp st0, st0}
00436ffd        *(ebx_5 + 0x5ccb7c) = eax_69
...
00436fa4        float* eax_107 = get_track_skirt_color(data_4df904 + 0x74618, &var_10)
00436fb4        float ebp_8 = *eax_107
...
00436fb8        int32_t ebp_9 = eax_107[1]
...
00436fbe        int32_t ebp_10 = eax_107[2]
...
00436fc4        int32_t edx_60 = eax_107[3]
...
00436fce        float var_64_3 = *eax_107
00436fd3        int32_t var_60_5 = eax_107[1]
00436fdc        int32_t var_5c_6 = eax_107[2]
00436fdf        int32_t var_58_36 = eax_107[3]
00436fe9        eax_69, x87control_1 = set_object_color(*(ebx_5 + 0x5ccb9c))
...
00436f2a        eax_69.b = *(esi_11 + 0x3bfb04)
00436f3a        if (eax_69.b == 8 || eax_69.b == 9 || eax_69.b == 0xa)
...
00437040        eax_69.b = *(esi_11 + 0x3bfb04)
00437080        if (eax_69.b == 1 || eax_69.b == 0x15 || eax_69.b == 0x14 || eax_69.b == 0x21 || eax_69.b == 0x22 || eax_69.b == 0xf || eax_69.b == 0x10 || eax_69.b == 0x17 || eax_69.b == 0x18 || eax_69.b == 0x19 || eax_69.b == 0x1a || eax_69.b == 0x1b || eax_69.b == 0x12 || eax_69.b == 0x13 || eax_69.b == 0x11)
0043708d        int32_t ecx_133 = completion_row_start_2 & 0x80000007
...
004370a7        if (ecx_133 s< 0)
004370ad        ecx_133 = ((ecx_133 - 1) | 0xfffffff8) + 1
004370ae        int32_t var_18_2 = ecx_133
...
00437100        int32_t* ecx_137 = esi_11 + 0x3bfb0c
00437104        int32_t k_2 = 4
00437135        int32_t k_1
00437109        void* eax_112
00437109        eax_112.b = *ecx_137
00437109        eax_112:1.b = *(ecx_137 + 1)
00437109        eax_112:2.b = *(ecx_137 + 2)
00437109        eax_112:3.b = *(ecx_137 + 3)
0043710f        if (eax_112 != 0)
00437111        *(eax_112 + 0x18) = 0
00437114        *(eax_112 + 0x14) = 0
00437117        *(eax_112 + 0x10) = 0
0043711a        void* eax_113
0043711a        eax_113.b = *ecx_137
0043711a        eax_113:1.b = *(ecx_137 + 1)
0043711a        eax_113:2.b = *(ecx_137 + 2)
0043711a        eax_113:3.b = *(ecx_137 + 3)
00437123        *(eax_113 + 0x10) = *(esi_11 + 0x3bfad8)
00437128        *(eax_113 + 0x14) = *(esi_11 + 0x3bfadc)
0043712e        *(eax_113 + 0x18) = *(esi_11 + 0x3bfae0)
00437131        ecx_137 = &ecx_137[1]
00437134        k_1 = k_2
00437134        k_2 -= 1
...
00437172        if (ebp_1->level_mode == 3)
00437174        completion_row_start.b = var_42
0043717a        if (ebp_1->level_mode != 3 || completion_row_start.b == 0)
0043717c        var_2c += 1
