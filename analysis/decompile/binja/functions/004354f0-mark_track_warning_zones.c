...
004354f9        void* __offset(Game, 0x3bfb04) result = game->runtime_row_count - 1
004354fc        int32_t i_1 = 0
00435500        if (result s> 0)
00435509        result = &game->__offset(0x3bfb04).d
0043550f        void* __offset(Game, 0x3bfb04) result_1 = result
00435511        int32_t j = 0
00435513        void* __offset(Game, 0x3bfb04) result_2 = result_1
00435517        result.b = (result_1 - 0x3bfb04)->:0x3bfb04.b
...
0043555d        void* __offset(Game, 0x3bfb04) var_c_1 = 6
...
004355a0        *(game + (eax_4 << 2) + 0x3bfb08) |= 0x18
004355a2        k += 1
004355ac        i -= 1
004355ad        edi_1 -= 8
