...
00438c44        case 0
00438c44        int32_t eax_1 = game->__offset(0x1270fc8).d
...
00438cef        game->__offset(0x1270fc8).d = 3
...
00438d19        game->__offset(0x1270fc8).d = 1
...
00438d4a        game->__offset(0x1270fc8).d = 2
...
00438da8        game->__offset(0x1270fc8).d = 2
...
00438ee3        int16_t eax_9
00438ee3        eax_9.b = game->selected_level_record_active
00438ee9        void* ecx_26 = data_4df904
00438ef1        long double x87_r7_3
00438ef1        long double temp0_1
00438ef1        if (eax_9.b != 0)
00438ef3        x87_r7_3 = fconvert.t(game->_pad_00[0xc].d)
00438ef6        temp0_1 = fconvert.t(0f)
00438ef6        x87_r7_3 - temp0_1
00438f0f        if (eax_9.b == 0 || (((x87_r7_3 < temp0_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_3, temp0_1) ? 1 : 0) << 0xa | (x87_r7_3 == temp0_1 ? 1 : 0) << 0xe):1.b & 0x40) == 0 || ((*(game->__offset(0x3bbba0).d + 4)).w:1.b & 0x40) == 0)
00438f15        eax_9.b = *(ecx_26 + 0x4f2e0)
00438f1d        if (eax_9.b == 0)
...
00438f7a        void* eax_10
00438f7a        eax_10.w = (x87_r7_4 < temp2_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_4, temp2_1) ? 1 : 0) << 0xa | (x87_r7_4 == temp2_1 ? 1 : 0) << 0xe
00438f7f        if ((eax_10:1.b & 0x41) == 0)
...
00438f90        eax_10.w = (x87_r7_6 < temp3_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_6, temp3_1) ? 1 : 0) << 0xa | (x87_r7_6 == temp3_1 ? 1 : 0) << 0xe
00438f95        if ((eax_10:1.b & 0x41) == 0)
...
00438ff4        eax_12 = __ftol(x87control, fconvert.t(game->__offset(0x3be0e4).d)) + 0x2e
00438ff9        if (eax_12 s> edi_3)
...
00438fcf        eax_12 = __ftol(x87control, fconvert.t(game->__offset(0x3be0e4).d)) + 0x2e
00438ffb        label_438ffb:
00438ffb        game->_pad_00[0x24] = eax_12.b
00438ffb        game->_pad_00[0x25] = eax_12:1.b
00438ffb        game->_pad_00[0x26] = eax_12:2.b
00438ffb        game->_pad_00[0x27] = eax_12:3.b
...
00439004        int32_t eax_16 = game->completion_row_start + 0x14
00439009        if (game->_pad_00[0x24].d s> eax_16)
0043900b        game->_pad_00[0x24] = eax_16.b
0043900b        game->_pad_00[0x25] = eax_16:1.b
0043900b        game->_pad_00[0x26] = eax_16:2.b
0043900b        game->_pad_00[0x27] = eax_16:3.b
...
0043902b        int32_t eax_19
0043902b        eax_19.b = game->_pad_00[(ecx_30 << 2) + 0x5ccac8]
00439034        void* edi_4 = &game->_pad_00[ecx_30 << 2]
00439037        esp_1[6] = edi_4
0043903b        if ((eax_19.b & 2) != 0)
...
00439099        int32_t eax_23
00439099        eax_23:1.b = (*(edi_4 + 0x5ccad0)):1.b | 2
0043909c        *(edi_4 + 0x5ccad0) = eax_23
...
00439110        int16_t eax_28
00439110        eax_28.b = *(edi_6 + 0x3bfb04)
0043911c        if (eax_28.b == 0x1d || eax_28.b == 0x1e)
...
004391bc        int32_t eax_33 = ebp & 0x80000007
004391c1        if (eax_33 s< 0)
004391c7        eax_33 = ((eax_33 - 1) | 0xfffffff8) + 1
004391c8        void* ebx_5 = esp_1[6]
004391cc        esp_1[5] = eax_33
...
00439252        esp_1[5] = 4
004392d9        int32_t j
0043925a        void* eax_39 = *ebx_7
0043925e        if (eax_39 != 0)
0043926c        if (((*(eax_39 + 4)).w:1.b & 2) == 0)
0043927d        *(eax_39 + 8) = &game->__offset(0x355b64).d
00439283        *(eax_39 + 0xc) = game->__offset(0x355b70).d
00439286        game->__offset(0x355b70).d = eax_39
00439289        void* ecx_45 = *(eax_39 + 0xc)
0043928e        if (ecx_45 != 0)
00439290        *(ecx_45 + 8) = eax_39
00439296        int32_t ecx_46
00439296        ecx_46:1.b = (*(eax_39 + 4)):1.b | 2
00439299        *(eax_39 + 4) = ecx_46
0043926e        *(esp_1 - 4) = "List ADDafter"
00439273        report_errorf()
0043929c        int32_t ecx_47 = data_4df904
004392a6        *(esp_1 - 4) = &esp_1[0xf]
004392ad        int32_t* eax_41 = get_track_skirt_color(ecx_47 + 0x74618)
004392b6        int32_t* edx_19 = *ebx_7 + 0x28
004392b9        *edx_19 = *eax_41
004392be        edx_19[1] = eax_41[1]
004392c4        edx_19[2] = eax_41[2]
004392ca        edx_19[3] = eax_41[3]
004392cd        j = esp_1[5]
004392d1        ebx_7 = &ebx_7[1]
004392d5        esp_1[5] = j - 1
004392d9        do while (j != 1)
004392f8        uint32_t eax_43
...
0043930a        eax_43, ecx_34 = spawn_track_health_pickup(game)
...
0043935a        eax_43, ecx_34 = spawn_track_jetpack_pickup(game)
0043935f        eax_43.b = *(edi_6 + 0x3bfb04)
00439367        if (eax_43.b == 0x21)
00439375        *(esp_1 - 4) = &game->__offset(0x3bb764).d
00439376        *(esp_1 - 8) = edi_6 + 0x3bfac8
0043949f        eax_43, ecx_34 = spawn_track_garbage_hazard(game)
0043949f        esp_1 = esp_1
00439399        if ((*(edi_6 + 0x3bfb08) & 0x10) == 0 && (eax_43.b == 1 || eax_43.b == 0x15) && (game->runtime_flags.b & 2) != 0)
0043939f        *(esp_1 - 4) = &data_4a4dbc
004393a4        *(esp_1 - 8) = 0x3f800000
004393a9        long double st0_2
004393a9        st0_2, eax_43, ecx_34 = random_float_below()
...
004393cb        eax_43.w = (x87_r6_4 < st0_2 ? 1 : 0) << 8 | (is_unordered.t(x87_r6_4, st0_2) ? 1 : 0) << 0xa | (x87_r6_4 == st0_2 ? 1 : 0) << 0xe
004393d0        if ((eax_43:1.b & 1) != 0)
004393d6        ecx_34 = esp_1[4]
004393dc        if (ecx_34 != 0)
004393de        eax_43.b = *(edi_6 + 0x3bfab0)
004393f2        if (ecx_34 == 0 || eax_43.b == 1 || eax_43.b == 0x14 || eax_43.b == 0x15 || eax_43.b == 0x20)
004393fb        if (ecx_34 != 7)
004393fd        eax_43.b = *(edi_6 + 0x3bfb58)
00439411        if ((ecx_34 == 7 || eax_43.b == 1 || eax_43.b == 0x14 || eax_43.b == 0x15 || eax_43.b == 0x20) && ebp s>= game->first_block_row_count && ebp s< game->completion_row_start && game->__offset(0x3bb884).d != 2)
00439432        if (game->level_mode == 4)
00439434        *(esp_1 - 4) = &data_4a4db8
00439439        *(esp_1 - 8) = 0x3f800000
0043943e        long double st0_3
0043943e        st0_3, eax_43, ecx_34 = random_float_below()
...
00439457        eax_43.w = (x87_r6_7 < st0_3 ? 1 : 0) << 8 | (is_unordered.t(x87_r6_7, st0_3) ? 1 : 0) << 0xa | (x87_r6_7 == st0_3 ? 1 : 0) << 0xe
0043945c        if (game->level_mode != 4 || (eax_43:1.b & 1) == 0)
00439463        if (game->level_mode == 0)
00439465        *(esp_1 - 4) = &data_4a4db4
0043946a        *(esp_1 - 8) = 0x3f800000
0043946f        long double st0_4
0043946f        st0_4, eax_43, ecx_34 = random_float_below()
...
00439488        eax_43.w = (x87_r6_10 < st0_4 ? 1 : 0) << 8 | (is_unordered.t(x87_r6_10, st0_4) ? 1 : 0) << 0xa | (x87_r6_10 == st0_4 ? 1 : 0) << 0xe
0043948d        if (game->level_mode != 0 || (eax_43:1.b & 1) == 0)
0043949b        *(esp_1 - 4) = &game->__offset(0x3bb764).d
0043949c        *(esp_1 - 8) = edi_6 + 0x3bfac8
0043949f        eax_43, ecx_34 = spawn_track_garbage_hazard(game)
0043949f        esp_1 = esp_1
004394a4        eax_43.b = *(edi_6 + 0x3bfb04)
004394ac        if (eax_43.b != 0x22)
004394e6        if ((*(edi_6 + 0x3bfb08) & 8) == 0 && (eax_43.b == 1 || eax_43.b == 0xf) && game->__offset(0x3bb884).d != 2 && (game->runtime_flags & 0x10000) != 0)
004394e8        *(esp_1 - 4) = &data_4a4db0
004394ed        *(esp_1 - 8) = 0x3f800000
004394f2        long double st0_5
004394f2        st0_5, eax_43, ecx_34 = random_float_below()
...
00439514        eax_43.w = (x87_r6_14 < st0_5 ? 1 : 0) << 8 | (is_unordered.t(x87_r6_14, st0_5) ? 1 : 0) << 0xa | (x87_r6_14 == st0_5 ? 1 : 0) << 0xe
00439523        if ((eax_43:1.b & 1) != 0 && ebp s>= game->first_block_row_count && ebp s< game->completion_row_start)
0043952b        *(esp_1 - 4) = edi_6 + 0x3bfad8
00439532        eax_43, ecx_34 = spawn_salt_hazard(&game->__offset(0x3578c0).d)
...
00439560        eax_43, ecx_34 = spawn_slug_hazard(game)
...
0043965f        eax_43.w = (x87_r7_16 < temp5_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_16, temp5_1) ? 1 : 0) << 0xa | (x87_r7_16 == temp5_1 ? 1 : 0) << 0xe
00439647        if ((ecx_34.b != 2 && ecx_34.b != 3 && ecx_34.b != 4 && ecx_34.b != 5 && ecx_34.b != 6 && ecx_34.b != 7) || (eax_43:1.b & 1) == 0 || ebp s>= game->completion_row_start)
...
004397da        eax_43.w = (x87_r7_21 < temp6_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_21, temp6_1) ? 1 : 0) << 0xa | (x87_r7_21 == temp6_1 ? 1 : 0) << 0xe
004397e4        if ((eax_43:1.b & 1) != 0 && ebp s< game->completion_row_start)
...
0043975a        int16_t eax_69
0043975a        eax_69.b = *(edi_6 + 0x3bfb04)
00439772        if (eax_69.b != 5 && eax_69.b != 6 && eax_69.b != 7)
0043977e        *(esp_1 - 4) = 0
...
00439940        int32_t eax_85 = game->__offset(0x3bba48).d
0043994e        if (eax_85 s> game->__offset(0x355d94).d)
00439950        void* ecx_92 = game->__offset(0x35bb8c).d
00439956        game->__offset(0x355d94).d = eax_85
...
004398ac        sub_44e5b0()
004398ca        void* eax_82 = &game->_pad_00[game->level_mode_arg * 0x1fac0]
004398d3        if (*(eax_82 + 0x944150) != 1)
...
0043991b        esp_1[3]
00439920        return 
004398dc        *(esp_1 - 4) = eax_82 + 0x944158
...
00439984        eax_9.b = game->selected_level_record_persistent
0043998c        if (eax_9.b == 0)
...
004399d9        void* eax_86
004399d9        eax_86.w = (x87_r7_23 < temp1_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_23, temp1_1) ? 1 : 0) << 0xa | (x87_r7_23 == temp1_1 ? 1 : 0) << 0xe
004399de        if ((eax_86:1.b & 0x41) == 0)
