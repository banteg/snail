...
00437e80        long double x87_r7 = fconvert.t(slider)
...
00437eaa        return (fconvert.t(slider) * fconvert.t(0.900000036f) + fconvert.t(0.200000003f)).d
00437e97        return (fconvert.t(1.10000002f)).d
