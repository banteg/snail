...
00439e15        x_1 = fconvert.s(float.t(vector.q) * fconvert.t(0.5f) + fconvert.t(x))
...
00439e5f        vector = fconvert.s(fconvert.t(var_10) - fconvert.t(x_1))
...
00439ed6        shoot_subgoldy(ecx_2, &x_1, &vector)
00439edb        ecx = data_4df904
