...
00439dbb        float eax = arg1->__offset(0x10).d
00439dbe        int32_t var_30_1 = 0
00439dc9        long double x87_r7_4 = fconvert.t(arg1->__offset(0x14).d) + fconvert.t(8f)
00439dd1        float ecx_1 = arg1->__offset(0x18).d
00439dd4        float var_28 = eax
00439dde        float var_18_1 = fconvert.s(x87_r7_4)
00439de9        vector = arg1->__offset(0x40).d u>> 8 & 0xf
00439df5        char* __saved_edi_2 = "Wall2"
00439dff        float var_14_1 = ecx_1
00439e15        var_28 = fconvert.s(float.t(vector.q) * fconvert.t(0.5f) + fconvert.t(eax))
...
00439e5f        vector = fconvert.s(fconvert.t(var_10) - fconvert.t(var_28))
00439e63        float var_18_2 = fconvert.s(fconvert.t(edx_5) - fconvert.t(var_18_1))
00439e6b        long double x87_r7_11 = x87_r7_10 - fconvert.t(ecx_1)
00439e73        float var_14_2 = fconvert.s(x87_r7_11)
...
00439eb0        void* ecx_3 = data_4df904 + 0x3cb118
...
00439ed2        float var_2c_2 = fconvert.s(fconvert.t(var_14_2) * fconvert.t(0.400000006f))
00439ed6        shoot_subgoldy(ecx_3, &var_28, &vector)
00439edb        ecx = data_4df904
00439ee1        long double x87_r7_20 = fconvert.t(arg1->__offset(0x18).d)
...
00439f05        long double x87_r7_21 = fconvert.t(arg1->__offset(0x18).d)
...
00439f73        if (*(arg1->__offset(0x38).d + 0x38) == 0x18)
00439f8c        arg1->__offset(0x20).d = fconvert.s(fconvert.t(arg1->__offset(0x20).d) - fconvert.t(*(ecx + 0x74650)) * fconvert.t(0.0333333351f))
00439f8f        set_color_alpha(arg1 + 0x28, 0.800000012f)
00439f8f        top = 0xffff
00439f94        ecx = data_4df904
00439fa6        float* eax_8 = get_track_skirt_color(ecx + 0x74618, &var_10)
00439faf        int32_t eax_9 = get_track_cell_row_index(arg1)
00439fc2        float* ecx_14 = data_4df904 + eax_9 * 0xf4 + 0x6411b8
00439fcb        *ecx_14 = *eax_8
00439fd0        ecx_14[1] = eax_8[1]
00439fd6        ecx_14[2] = eax_8[2]
00439fdd        ecx_14[3] = eax_8[3]
...
00439ff8        long double temp5_1 = fconvert.t(arg1->__offset(0x18).d)
...
00439f2d        long double x87_r7_22 = fconvert.t(arg1->__offset(0x18).d)
...
00439f52        long double temp7_1 = fconvert.t(arg1->__offset(0x18).d)
