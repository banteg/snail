...
0042c783        float x = arg8->anchor_position.x
0042c785        int32_t esi = *(arg1 + 0x44)
0042c78c        float y = arg8->anchor_position.y
0042c78f        int32_t i = esi - 1
0042c794        int32_t z = arg8->anchor_position.z
0042c797        float z_1 = z
...
0042c7ec        float var_1c_1 = fconvert.s(fconvert.t(z_1) + fconvert.t(*(ecx_1 + 0x38)))
0042c807        long double x87_r7_6 = fconvert.t(arg3) - fconvert.t(fconvert.s(fconvert.t(y) + fconvert.t(*(ecx_1 + 0x34))))
0042c80b        float var_60 = fconvert.s(fconvert.t(arg2) - (fconvert.t(x) + fconvert.t(*(ecx_1 + 0x30))))
...
0042c8eb        float var_4_1 = fconvert.s(fconvert.t(z_1) + fconvert.t(*(ecx_5 + 0x38)))
0042c91a        float var_10_1 = fconvert.s(fconvert.t(arg4) + fconvert.t(arg7))
0042c92e        long double x87_r7_20 = fconvert.t(fconvert.s(fconvert.t(arg3) + fconvert.t(arg6))) - fconvert.t(fconvert.s(fconvert.t(y) + fconvert.t(*(ecx_5 + 0x34))))
0042c932        float var_30 = fconvert.s(fconvert.t(arg5) + fconvert.t(arg2) - (fconvert.t(x) + fconvert.t(*(ecx_5 + 0x30))))
