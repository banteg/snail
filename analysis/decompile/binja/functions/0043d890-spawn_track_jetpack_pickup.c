...
0043d973        void* game_base_1 = g_game_base
0043d97f        void* edx_3 = *(game_base_1 + 0x5ac)
0043d987        if (edx_3 != 0)
0043d995        *(edx_3 + 8) = esi + 0x355e64
0043d998        void* edx_4 = *(game_base_1 + 0x5ac)
0043d99d        *(*(edx_4 + 8) + 0xc) = edx_4
0043d9a4        void* edx_6 = *(*(game_base_1 + 0x5ac) + 8)
0043d9a7        *(game_base_1 + 0x5ac) = edx_6
0043d9a9        *(edx_6 + 8) = 0
0043d989        *(game_base_1 + 0x5ac) = esi + 0x355e64
0043d98b        *(esi + 0x355e6c) = 0
0043d98b        *(esi + 0x355e6d) = 0
0043d98b        *(esi + 0x355e6e) = 0
0043d98b        *(esi + 0x355e6f) = 0
0043d990        *(*(game_base_1 + 0x5ac) + 0xc) = 0
...
0043d9cb        struct Sprite* eax_14 = allocate_sprite(&g_sprite_manager, player->player_slot, 0x7c, 0xffffffff, 0xffffffff)
0043d9d0        *(esi + 0x355ec8) = eax_14
0043d9d6        uint32_t flags = eax_14->flags
0043d9d9        flags:1.b |= 8
0043d9dc        eax_14->flags = flags
...
0043da19        float* edx_10 = *(esi + 0x355ec8) + 0x48
0043da1c        *edx_10 = *(esi + 0x355e74)
0043da21        edx_10[1] = *(esi + 0x355e78)
0043da27        edx_10[2] = *(esi + 0x355e7c)
