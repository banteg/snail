...
0043d998        struct JetPack* first_1 = game_base_1->active_bod_list.first
0043d99d        first_1->bod.bod.list_prev->list_next = first_1
0043d9a4        struct JetPack* list_prev = game_base_1->active_bod_list.first->vtable.56.bod.list_prev
0043d9a7        game_base_1->active_bod_list.first = list_prev
0043d9a9        list_prev->bod.bod.list_prev = nullptr
...
0043d990        game_base_1->active_bod_list.first->vtable.56.bod.list_next = nullptr
...
0043d9d0        jetpack_cursor->jetpack.sprite = eax_13
