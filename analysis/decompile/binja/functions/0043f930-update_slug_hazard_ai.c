...
0043f943        if (*(slot->_pad_84[4].d + 9) != 0)
0043f943        return 
0043f949        uint32_t state = slot->state
0043f952        void* ecx_19
...
0043fce9        if (*(slot->_pad_b4[0xc].d + 0x384) == 1)
...
0043f96d        case 1
0043f96d        if (slot->_pad_b4[0x18] != 0 && data_4b7236 != 0)
0043f96f        int32_t ecx = slot->_pad_b4[0x20].d
0043f975        slot->_pad_b4[0x18] = 0
0043f97b        slot->_pad_b4[0x1c] = ecx.b
0043f97b        slot->_pad_b4[0x1d] = ecx:1.b
0043f97b        slot->_pad_b4[0x1e] = ecx:2.b
0043f97b        slot->_pad_b4[0x1f] = ecx:3.b
0043f981        long double x87_r7_1 = fconvert.t(slot->_pad_b4[0x1c].d)
...
0043f992        int32_t eax_1
0043f992        if ((state:1.b & 0x40) != 0)
0043fa56        slot->_pad_b4[0x30].d = fconvert.s(fconvert.t(slot->_pad_b4[0x34].d) + fconvert.t(slot->_pad_b4[0x30].d))
0043fa5c        long double x87_r7_6 = fconvert.t(slot->_pad_b4[0x34].d)
...
0043fa82        *(slot->sprite + 0x28) = 0
0043faba        store_color4f(slot->sprite + 0x2c, 1f, 1f, 1f, 1f)
0043fabf        long double x87_r6_1 = fconvert.t(slot->_pad_b4[0x30].d)
...
0043faf0        long double x87_r6_3 = fconvert.t(slot->_pad_b4[0x30].d)
...
0043fb03        slot->_pad_b4[0x30] = 0
0043fb03        slot->_pad_b4[0x31] = 0
0043fb03        slot->_pad_b4[0x32] = 0x80
0043fb03        slot->_pad_b4[0x33] = 0x3f
0043fb0d        slot->_pad_b4[0x34] = 0xab
0043fb0d        slot->_pad_b4[0x35] = 0xaa
0043fb0d        slot->_pad_b4[0x36] = 0x2a
0043fb0d        slot->_pad_b4[0x37] = 0xbe
0043fad2        slot->_pad_b4[0x30] = 0
0043fad2        slot->_pad_b4[0x31] = 0
0043fad2        slot->_pad_b4[0x32] = 0
0043fad2        slot->_pad_b4[0x33] = 0
0043fae3        long double st0_1
0043fae3        st0_1, eax_1 = advance_blink_random(data_4df904 + 0x74618)
0043fae8        slot->_pad_b4[0x34].d = fconvert.s(st0_1)
0043f99e        long double x87_r7_3 = fconvert.t(slot->_pad_b4[0x20].d) + fconvert.t(slot->_pad_b4[0x1c].d)
0043f9a4        slot->_pad_b4[0x1c].d = fconvert.s(x87_r7_3)
...
0043fa3f        store_color4f(slot->sprite + 0x2c, 1f, 0f, 0f, 0.99000001f)
0043f9b7        void* sprite_1 = slot->sprite
0043f9bd        slot->_pad_b4[0x1c] = 0
0043f9bd        slot->_pad_b4[0x1d] = 0
0043f9bd        slot->_pad_b4[0x1e] = 0
0043f9bd        slot->_pad_b4[0x1f] = 0
0043f9c3        slot->_pad_b4[0x30] = 0
0043f9c3        slot->_pad_b4[0x31] = 0
0043f9c3        slot->_pad_b4[0x32] = 0x80
0043f9c3        slot->_pad_b4[0x33] = 0x3f
0043f9cd        slot->_pad_b4[0x34] = 0xab
0043f9cd        slot->_pad_b4[0x35] = 0xaa
0043f9cd        slot->_pad_b4[0x36] = 0x2a
0043f9cd        slot->_pad_b4[0x37] = 0xbe
0043f9d7        *(sprite_1 + 0x28) = 0
0043f9f7        store_color4f(slot->sprite + 0x2c, 1f, 1f, 1f, 1f)
0043fa05        set_sprite_texture_ref(slot->sprite, 0x77, 0)
0043fb20        long double x87_r6_5 = fconvert.t(*(slot->_pad_b4[0xc].d + 0x70)) + fconvert.t(1f)
...
0043fb36        if ((eax_1:1.b & 0x41) == 0 && slot->_pad_b4[0x25] == 0)
0043fb38        slot->_pad_b4[0x25] = 1
...
0043fb81        play_slug_voice(slot, 0x1e - __ftol(x87control, float.t(next_math_random_value()) * fconvert.t(-0.000122070312f)))
0043fb86        void* ecx_15 = slot->_pad_b4[0xc].d
...
0043fb9f        if ((eax_1:1.b & 1) != 0 && slot->_pad_b4[0] == 0)
0043fba1        slot->_pad_b4[0] = 1
0043fbaf        if (slot->_pad_b4[0x10].d == 1)
...
0043fbcf        slot->_pad_b4[0x10] = 0
0043fbcf        slot->_pad_b4[0x11] = 0
0043fbcf        slot->_pad_b4[0x12] = 0
0043fbcf        slot->_pad_b4[0x13] = 0
0043fbd5        play_voice_manager(0x751498, 2, 1, 0xffffffff)
0043fbe5        int32_t* eax_7 = slot->sprite + 0x48
0043fbea        *eax_7 = slot->world_position.x
0043fbef        eax_7[1] = slot->world_position.y
0043fbf5        eax_7[2] = slot->world_position.z
0043fbf8        void* ecx_18 = slot->_pad_b4[0xc].d
...
0043fcbc        sub_415ef0(slot->_pad_84[4].d + 0x1270fd4, &slot->world_position.x, 2f, 1, slot)
...
0043fc69        return 
0043fc6a        void* eax_9 = slot->_pad_00[0xc].d
0043fc6f        if (eax_9 != 0)
0043fc74        *(eax_9 + 8) = slot->_pad_00[8].d
0043fc77        void* eax_10 = slot->_pad_00[8].d
0043fc7c        if (eax_10 == 0)
0043fc7c        goto label_43ffdf
0043fc85        *(eax_10 + 0xc) = slot->_pad_00[0xc].d
...
0043feb6        int32_t eax_23 = slot->_pad_84[0].d
0043febf        if (eax_23 == 1)
...
0043fecb        eax_23.w = (x87_r7_20 < temp2_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_20, temp2_1) ? 1 : 0) << 0xa | (x87_r7_20 == temp2_1 ? 1 : 0) << 0xe | 0x3800
0043fed0        if ((eax_23:1.b & 1) != 0)
0043fed2        x87_r7_21 = fneg(x87_r7_21)
0043fef0        slot->velocity.x = fconvert.s(x87_r7_21)
0043fed9        if (eax_23 == 2)
...
0043fee5        eax_23.w = (x87_r7_22 < temp7_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_22, temp7_1) ? 1 : 0) << 0xa | (x87_r7_22 == temp7_1 ? 1 : 0) << 0xe | 0x3800
0043feea        if ((eax_23:1.b & 1) != 0)
...
0043fefa        eax_23.w = (x87_r7_24 < temp6_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_24, temp6_1) ? 1 : 0) << 0xa | (x87_r7_24 == temp6_1 ? 1 : 0) << 0xe
0043feff        int32_t var_14_4
0043feff        if ((eax_23:1.b & 1) == 0)
...
0043ff13        var_14_4 = 0
0043ff17        eax_23.w = (x87_r7_25 < temp9_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_25, temp9_1) ? 1 : 0) << 0xa | (x87_r7_25 == temp9_1 ? 1 : 0) << 0xe
0043ff1c        if ((eax_23:1.b & 0x40) == 0)
0043ff1e        var_14_4 = 1
0043ff01        var_14_4 = 0xffffffff
0043ff2a        void* eax_24 = slot->_pad_84[4].d
...
0043ff43        long double x87_r7_30 = fconvert.t(*(eax_24 + 0x38)) * fconvert.t(0.00833333377f)
...
0043ff5e        slot->_pad_98[0x10].d = fconvert.s(fconvert.t(*(eax_24 + 0x38)) * fconvert.t(0.166666672f))
0043feff        goto label_43ff64
0043ff64        case 3
0043ff64        label_43ff64:
0043ff64        int16_t eax_25 = (slot->_pad_00[4].d).w
0043ff67        slot->state = 0
0043ff73        ecx_19 = data_4df904 + 0x5a8
0043ff7c        if ((eax_25:1.b & 2) == 0)
0043ff83        report_errorf("List remove")
0043ff91        kill_sprite(slot->sprite)
0043ff9c        return 
0043ff9f        if ((eax_25.b & 0x40) != 0)
0043ffa6        report_errorf("List remove NEXTBOD")
0043ffb4        kill_sprite(slot->sprite)
0043ffbf        return 
0043ffc0        void* eax_26 = slot->_pad_00[0xc].d
0043ffc5        if (eax_26 != 0)
0043ffca        *(eax_26 + 8) = slot->_pad_00[8].d
0043ffcd        void* eax_27 = slot->_pad_00[8].d
0043ffd2        if (eax_27 == 0)
0043ffdf        label_43ffdf:
0043ffdf        *(ecx_19 + 4) = slot->_pad_00[0xc].d
0043ffdf        goto label_43ffe2
0043ffd7        *(eax_27 + 0xc) = slot->_pad_00[0xc].d
0043ffe2        label_43ffe2:
0043ffe2        int32_t edx_15 = *(ecx_19 + 8)
0043ffe5        slot->_pad_00[0xc] = edx_15.b
0043ffe5        slot->_pad_00[0xd] = edx_15:1.b
0043ffe5        slot->_pad_00[0xe] = edx_15:2.b
0043ffe5        slot->_pad_00[0xf] = edx_15:3.b
0043ffe8        *(ecx_19 + 8) = slot
0043ffee        void* sprite = slot->sprite
0043fff4        int32_t eax_29
0043fff4        eax_29:1.b = slot->_pad_00[4].d:1.b & 0xfd
0043fff7        slot->_pad_00[4] = eax_29.b
0043fff7        slot->_pad_00[5] = eax_29:1.b
0043fff7        slot->_pad_00[6] = eax_29:2.b
0043fff7        slot->_pad_00[7] = eax_29:3.b
0043fffa        kill_sprite(sprite)
0043fd11        case 4
0043fd11        long double x87_r7_8 = fconvert.t(slot->_pad_b4[8].d) + fconvert.t(slot->_pad_b4[4].d)
0043fd17        long double temp0_1 = fconvert.t(6.28318548f)
0043fd17        x87_r7_8 - temp0_1
0043fd1d        slot->_pad_b4[4].d = fconvert.s(x87_r7_8)
...
0043fd30        slot->_pad_b4[4].d = fconvert.s(x87_r7_8 - fconvert.t(6.28318548f))
0043fd55        slot->world_position.x = fconvert.s(sine(slot->_pad_b4[4].d) * fconvert.t(3f))
0043fd58        long double x87_r7_13 = fconvert.t(slot->world_position.z)
0043fd5b        long double temp5_1 = fconvert.t(*(slot->_pad_b4[0xc].d + 0x70))
0043fd5b        x87_r7_13 - temp5_1
0043fd6b        if ((((x87_r7_13 < temp5_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_13, temp5_1) ? 1 : 0) << 0xa | (x87_r7_13 == temp5_1 ? 1 : 0) << 0xe):1.b & 1) != 0 && slot->_pad_b4[0] == 0)
0043fd6d        slot->_pad_b4[0] = 1
0043fd7d        float* edx_9 = slot->sprite + 0x48
0043fd80        *edx_9 = slot->world_position.x
0043fd85        edx_9[1] = slot->world_position.y
0043fd8b        edx_9[2] = slot->world_position.z
0043fd8e        void* ecx_30 = slot->_pad_b4[0xc].d
...
0043fdff        return 
0043fe00        void* eax_17 = slot->_pad_00[0xc].d
0043fe05        if (eax_17 != 0)
0043fe0a        *(eax_17 + 8) = slot->_pad_00[8].d
0043fe0d        void* eax_18 = slot->_pad_00[8].d
0043fe12        if (eax_18 == 0)
0043fe12        goto label_43ffdf
0043fe1b        *(eax_18 + 0xc) = slot->_pad_00[0xc].d
