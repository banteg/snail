...
0042a602        struct PathTemplateSample* primary_samples_6 = self->primary_samples
0042a60d        int32_t eax_4
0042a60d        eax_4.b = primary_samples_6->center_x.b
0042a60d        eax_4:1.b = primary_samples_6->center_x:1.b
0042a60d        eax_4:2.b = primary_samples_6->center_x:2.b
0042a60d        eax_4:3.b = primary_samples_6->center_x:3.b
0042a613        self->secondary_samples->transform.position.x = eax_4
...
0042a77f        struct PathTemplateSample* primary_samples_7 = self->primary_samples
0042a78c        *(&primary_samples_7->transform.position + i) = *(&primary_samples_7->center_x + i)
...
0042a846        edx_15[2] = 0
0042a849        struct PathTemplateSample* primary_samples_8 = self->primary_samples
0042a86d        float var_2c_1 = fconvert.s(fconvert.t(*(&primary_samples_8->transform.position.y + i)) - fconvert.t(*(primary_samples_8 + i - 0x74)))
0042a877        long double x87_r7_33 = fconvert.t(*(&primary_samples_8->transform.position.z + i)) - fconvert.t(*(primary_samples_8 + i - 0x70))
0042a87e        *(primary_samples_8 + i - 0x88) = fconvert.s(fconvert.t(*(&primary_samples_8->transform.position + i)) - fconvert.t(*(primary_samples_8 + i - 0x78)))
0042a880        *(primary_samples_8 + i - 0x84) = var_2c_1
0042a88b        *(primary_samples_8 + i - 0x80) = fconvert.s(x87_r7_33)
0042a898        normalize_vector(self->primary_samples + i - 0x88)
0042a8a2        void* eax_22 = self->primary_samples + i
0042a8b9        cross_vectors(eax_22 - 0xa8, eax_22 - 0x98, eax_22 - 0x88)
0042a8c1        void* eax_23 = self->primary_samples + i
0042a8d8        cross_vectors(eax_23 - 0x98, eax_23 - 0x88, eax_23 - 0xa8)
...
0042a97b        void* eax_28 = self->secondary_samples + i
0042a992        cross_vectors(eax_28 - 0xa8, eax_28 - 0x98, eax_28 - 0x88)
0042a99a        void* eax_29 = self->secondary_samples + i
0042a9b1        cross_vectors(eax_29 - 0x98, eax_29 - 0x88, eax_29 - 0xa8)
...
0042aa0b        struct PathTemplateSample* primary_samples_9 = self->primary_samples
0042aa2f        float var_14_2 = fconvert.s(fconvert.t(*(edi + primary_samples_9 + 0xdc)) - fconvert.t(*(&primary_samples_9->transform.position.y + edi)))
0042aa36        long double x87_r7_49 = fconvert.t(*(edi + primary_samples_9 + 0xe0)) - fconvert.t(*(&primary_samples_9->transform.position.z + edi))
0042aa3d        *(&primary_samples_9->delta_dir_to_next + edi) = fconvert.s(fconvert.t(*(edi + primary_samples_9 + 0xd8)) - fconvert.t(*(&primary_samples_9->transform.position + edi)))
0042aa3f        *(&primary_samples_9->delta_dir_to_next.y + edi) = var_14_2
0042aa4a        *(&primary_samples_9->delta_dir_to_next.z + edi) = fconvert.s(x87_r7_49)
...
0042aafe        char* ecx_52 = &self->primary_samples[self->segment_count] - 0x28
0042ab12        *ecx_52 = 0
0042ab12        ecx_52[1] = 0
0042ab12        ecx_52[2] = 0
0042ab12        ecx_52[3] = 0
...
0042ab23        ecx_52[8] = 0
0042ab23        ecx_52[9] = 0
0042ab23        ecx_52[0xa] = 0x80
0042ab23        ecx_52[0xb] = 0x3f
0042ab35        int32_t var_10_3 = 0x3f800000
0042ab41        *(&self->primary_samples[self->segment_count] - 0x1c) = 0x3f800000
0042ab57        int32_t* eax_48 = &self->secondary_samples[self->segment_count] - 0x28
0042ab5f        *eax_48 = 0
0042ab65        eax_48[1] = 0
0042ab6a        eax_48[2] = 0x3f800000
...
0042aba9        struct Object* strip_mesh = self->strip_mesh
...
0042abf4        int32_t* eax_60
0042abf4        float ecx_67
0042abf4        if (i_2 == self->segment_count)
0042ac4b        void* eax_61 = primary_samples_4 + i_3
0042ac5c        vertices = arg2
0042aca1        float var_20_2 = fconvert.s(fconvert.t(*(eax_61 - 0x74)) + fconvert.t(fconvert.s(x87_r7_59 * fconvert.t(*(eax_61 - 0xa4)))))
0042aca9        long double x87_r6_20 = fconvert.t(fconvert.s(fconvert.t(*(eax_61 - 0x70)) + fconvert.t(1f))) + x87_r7_59 * fconvert.t(*(eax_61 - 0xa0))
0042acab        eax_60 = &vertices[(width_cells + 1) * i_2 + edi_1]
0042acb3        *eax_60 = fconvert.s(fconvert.t(*(eax_61 - 0x78)) + fconvert.t(fconvert.s(x87_r7_59 * fconvert.t(*(eax_61 - 0xa8)))))
0042acbd        eax_60[1] = var_20_2
0042acc0        ecx_67 = fconvert.s(x87_r6_20)
0042abf6        float* eax_56 = primary_samples_4 + i_3
0042ac1e        float var_14_3 = fconvert.s(fconvert.t(fconvert.s(x87_r7_59 * fconvert.t(eax_56[1]))) + fconvert.t(eax_56[0xd]))
0042ac2b        float var_10_4 = fconvert.s(x87_r7_59 * fconvert.t(eax_56[2]) + fconvert.t(eax_56[0xe]))
0042ac34        eax_60 = &vertices[(width_cells + 1) * i_2 + edi_1]
0042ac3c        *eax_60 = fconvert.s(fconvert.t(fconvert.s(x87_r7_59 * fconvert.t(*eax_56))) + fconvert.t(eax_56[0xc]))
0042ac42        eax_60[1] = var_14_3
0042ac45        ecx_67 = var_10_4
0042acc6        eax_60[2] = ecx_67
...
0042ad0f        int32_t eax_69 = i_3 & 0x80000007
0042ad14        if (eax_69 s< 0)
0042ad1a        eax_69 = ((eax_69 - 1) | 0xfffffff8) + 1
0042ad2e        arg3 = fconvert.s(float.t(eax_69) * fconvert.t(0.125f))
0042ad3c        float var_4c_1 = fconvert.s(float.t(eax_69 + 1) * fconvert.t(0.125f))
...
0042ad79        while (true)
0042ad79        int32_t eax_76 = ecx_71 + ((self->width_cells * i_3 + j) << 1)
0042ad7c        if (ecx_71 != 0)
0042ae38        struct ObjectFaceQuad* facequads_1 = facequads
0042ae43        int16_t* ebp_3 = &facequads_1[eax_76]
0042ae46        *ebp_3 = 0
0042ae4c        ecx_71.w = self->width_cells.w
0042ae50        ecx_71.w += 1
0042ae59        ebp_3[1] = ecx_71.w * i_3.w + j.w + 1
0042ae5d        facequads_1.w = self->width_cells.w
0042ae61        facequads_1.w += 1
0042ae68        ebp_3[2] = facequads_1.w * i_3.w + j.w
...
0042aeb3        *(ebp_3 + 0xc) = get_or_create_texture_ref(&g_texture_refs, texture_path_1, 0, 0)
...
0042ad89        int32_t ecx_73 = eax_76 * 0x30
0042ad90        int16_t* ebp_2 = ecx_73 + facequads
0042ad93        *ebp_2 = 0
0042ad99        eax_76.w = self->width_cells.w
0042ad9d        eax_76.w += 1
0042ada4        ebp_2[1] = eax_76.w * i_3.w + j.w
0042ada8        ecx_73.w = self->width_cells.w
0042adac        ecx_73.w += 1
0042adb8        ebp_2[2] = ecx_73.w * i_3.w + j.w + 1
...
0042adfc        *(ebp_2 + 0xc) = get_or_create_texture_ref(&g_texture_refs, texture_path, 0, 0)
