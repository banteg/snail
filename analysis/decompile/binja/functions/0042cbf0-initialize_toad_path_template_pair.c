...
0042cc71        arg2.d = var_4c + primary_samples_6 + 0x1a
0042cc75        self->segment_count = var_4c + primary_samples_6 + 0x1a
0042cc7c        self->segment_count_f = fconvert.s(float.t(arg2.d))
0042cc7f        struct PathTemplateSample* primary_samples_1 = allocate_path_nodes(self)
0042cc86        self->special_runtime_flag_9c = 0
0042cc8d        arg2.d = 0
...
0042ccdc        void* eax_5 = self->primary_samples + esi
0042ccde        long double x87_r7_2 = float.t(arg2.d)
0042cce8        *(eax_5 + 0x30) = *(eax_5 + 0x90)
...
0042cd4b        esi += 0xa8
0042cd51        cond:2_1 = arg2.d + 1 s< primary_samples_1
0042cd53        arg2.d += 1
0042cd57        do while (cond:2_1)
0042cd5d        primary_samples_6 = primary_samples_1
0042cd63        if (var_4c s> 0)
0042cd70        arg2.d = &primary_samples_6->transform.basis_up.z + 2
...
0042cdd1        long double x87_r7_5 = float.t(arg2.d)
...
0042ce41        esi_4 += 0xa8
0042ce47        int32_t eax_20 = arg2.d + 1
0042ce48        arg2.d = eax_20
0042ce4c        primary_samples_1 = 0xffffffe6 - primary_samples_5 + eax_20
...
0042ceba        float var_40_3 = fconvert.s((fconvert.t(1f) - cosine(fconvert.s(float.t(arg2.d) * fconvert.t(0.241660982f)))) * fconvert.t(0.5f) * fconvert.t(var_48) * fconvert.t(1.57079637f))
...
0042cf04        long double st0_2 = sine(var_40_3)
0042cf23        *(&self->primary_samples->transform.position + ebx_3) = fconvert.s(st0_2 + st0_2 + fconvert.t(var_50))
0042cf2e        *(&self->primary_samples->transform.position.z + ebx_3) = fconvert.s(float.t(arg2.d + primary_samples_5))
...
0042cf51        ecx_26[2] = 0
0042cf57        void* eax_27 = self->primary_samples + ebx_3
0042cf73        float var_2c_1 = fconvert.s(fconvert.t(*(eax_27 + 0x34)) - fconvert.t(*(eax_27 - 0x74)))
0042cf7a        long double x87_r7_24 = fconvert.t(*(eax_27 + 0x38)) - fconvert.t(*(eax_27 - 0x70))
0042cf84        *(eax_27 + 0x20) = fconvert.s(fconvert.t(*(eax_27 + 0x30)) - fconvert.t(*(eax_27 - 0x78)))
0042cf86        *(eax_27 + 0x24) = var_2c_1
0042cf91        *(eax_27 + 0x28) = fconvert.s(x87_r7_24)
0042cf9b        normalize_vector(&self->primary_samples->transform.basis_forward + ebx_3)
0042cfa5        struct Vec3* out = self->primary_samples + ebx_3
0042cfb0        cross_vectors(out, out + 0x10, out + 0x20)
0042cfbb        rotate_matrix_world_z(self->primary_samples + ebx_3, var_40_3)
...
0042cffc        float* eax_32 = &self->secondary_samples->transform.position + ebx_3
0042d000        ebx_3 += 0xa8
0042d00c        *eax_32 = fconvert.s(x87_r7_28 + fconvert.t(*eax_32))
0042d015        eax_32[1] = fconvert.s(fconvert.t(var_20_1) + fconvert.t(eax_32[1]))
0042d01f        eax_32[2] = fconvert.s(fconvert.t(fconvert.s(x87_r6_4)) + fconvert.t(eax_32[2]))
0042d027        cond:3_1 = arg2.d + 1 s< 0x1a
0042d02a        arg2.d += 1
...
0042d137        int32_t* ecx_41 = &self->primary_samples[self->segment_count] - 0x28
0042d14b        *ecx_41 = 0
0042d159        ecx_41[1] = 0
0042d15c        ecx_41[2] = 0x3f800000
0042d16e        int32_t var_28_3 = 0x3f800000
0042d17a        *(&self->primary_samples[self->segment_count] - 0x1c) = 0x3f800000
0042d190        int32_t* eax_52 = &self->secondary_samples[self->segment_count] - 0x28
0042d198        *eax_52 = 0
0042d19e        eax_52[1] = 0
0042d1a3        eax_52[2] = 0x3f800000
0042d1b8        *(&self->secondary_samples[self->segment_count] - 0x1c) = 0x3f800000
0042d1cb        request_object_vertices(self->strip_mesh, (self->width_cells + 1) * (self->segment_count + 1))
0042d1dd        request_object_facequads(self->strip_mesh, (self->width_cells * self->segment_count) << 1)
0042d1e2        struct PathTemplateStripMesh* strip_mesh = self->strip_mesh
0042d1e5        struct ObjectFaceQuad* facequads = strip_mesh->facequads
0042d1e8        struct Vec3* vertices = strip_mesh->vertices
...
0042d22d        long double x87_r7_49 = float.t(arg2.d) - float.t(width_cells_1) * fconvert.t(0.5f)
0042d22f        float* eax_64
0042d22f        float ecx_56
0042d22f        if (i_1 == self->segment_count)
0042d285        void* eax_65 = primary_samples + ebx_4
0042d296        vertices = vertices_1
0042d2db        float var_38_2 = fconvert.s(fconvert.t(*(eax_65 - 0x74)) + fconvert.t(fconvert.s(x87_r7_49 * fconvert.t(*(eax_65 - 0xa4)))))
0042d2e3        long double x87_r6_24 = fconvert.t(fconvert.s(fconvert.t(*(eax_65 - 0x70)) + fconvert.t(1f))) + x87_r7_49 * fconvert.t(*(eax_65 - 0xa0))
0042d2e5        eax_64 = &vertices[(width_cells + 1) * i_1 + esi_9]
0042d2ec        *eax_64 = fconvert.s(fconvert.t(*(eax_65 - 0x78)) + fconvert.t(fconvert.s(x87_r7_49 * fconvert.t(*(eax_65 - 0xa8)))))
0042d2f6        eax_64[1] = var_38_2
0042d2f9        ecx_56 = fconvert.s(x87_r6_24)
0042d231        float* eax_60 = primary_samples + ebx_4
0042d259        float var_2c_3 = fconvert.s(fconvert.t(fconvert.s(x87_r7_49 * fconvert.t(eax_60[1]))) + fconvert.t(eax_60[0xd]))
0042d266        float var_28_4 = fconvert.s(x87_r7_49 * fconvert.t(eax_60[2]) + fconvert.t(eax_60[0xe]))
0042d26f        eax_64 = &vertices[(width_cells + 1) * i_1 + esi_9]
0042d276        *eax_64 = fconvert.s(fconvert.t(fconvert.s(x87_r7_49 * fconvert.t(*eax_60))) + fconvert.t(eax_60[0xc]))
0042d27c        eax_64[1] = var_2c_3
0042d27f        ecx_56 = var_28_4
0042d2ff        eax_64[2] = ecx_56
0042d302        width_cells = self->width_cells
0042d305        esi_9 += 1
0042d306        width_cells_1 = width_cells
0042d30c        arg2.d = esi_9
...
0042d348        int32_t eax_73 = i_2 & 0x80000007
0042d34d        if (eax_73 s< 0)
0042d353        eax_73 = ((eax_73 - 1) | 0xfffffff8) + 1
0042d367        float var_4c_1 = fconvert.s(float.t(eax_73) * fconvert.t(0.125f))
0042d375        float var_54 = fconvert.s(float.t(eax_73 + 1) * fconvert.t(0.125f))
0042d380        int32_t ecx_60 = 0
0042d386        int32_t var_48_1 = 0
0042d390        arg2.d = fconvert.s(float.t(arg2.d) * fconvert.t(0.125f))
0042d39e        float var_50_1 = fconvert.s(float.t(j + 1) * fconvert.t(0.125f))
0042d3b2        while (true)
0042d3b2        int32_t eax_80 = ecx_60 + ((self->width_cells * i_2 + j) << 1)
0042d3b5        if (ecx_60 != 0)
0042d47b        int16_t* edi_5 = &facequads[eax_80]
0042d47e        *edi_5 = 0
0042d483        ecx_60.w = self->width_cells.w
0042d487        ecx_60.w += 1
0042d490        edi_5[1] = ecx_60.w * i_2.w + j.w + 1
0042d494        struct ObjectFaceQuad* eax_88
0042d494        eax_88.w = self->width_cells.w
0042d498        eax_88.w += 1
0042d49f        edi_5[2] = eax_88.w * i_2.w + j.w
0042d4b1        edi_5[3] = (self->width_cells.w + 1) * (i_2.w + 1) + j.w
0042d4c9        edi_5[4] = (self->width_cells.w + 1) * (i_2.w + 1) + j.w + 1
0042d4cd        char* texture_path_1
0042d4cd        if (((j.b ^ i_2.b) & 1) != 0)
0042d55d        texture_path_1 = texture_b
0042d4d7        texture_path_1 = texture_b
0042d4e6        int32_t edx_42 = arg2.d
0042d4ea        *(edi_5 + 0xc) = get_or_create_texture_ref(&data_4b7790, texture_path_1, 0, 0)
0042d4f1        *(edi_5 + 0x10) = var_50_1
0042d4f4        *(edi_5 + 0x14) = var_4c_1
0042d4f9        *(edi_5 + 0x18) = edx_42
0042d502        *(edi_5 + 0x1c) = var_4c_1
0042d509        *(edi_5 + 0x20) = edx_42
0042d50c        *(edi_5 + 0x24) = var_54
0042d511        *(edi_5 + 0x28) = var_50_1
0042d514        *(edi_5 + 0x2c) = var_54
0042d3c9        int16_t* edi_4 = &facequads[eax_80]
0042d3cc        *edi_4 = 0
0042d3d1        eax_80.w = self->width_cells.w
0042d3d5        eax_80.w += 1
0042d3dc        edi_4[1] = eax_80.w * i_2.w + j.w
0042d3e0        int32_t ecx_62
0042d3e0        ecx_62.w = self->width_cells.w
0042d3e4        ecx_62.w += 1
0042d3f0        edi_4[2] = ecx_62.w * i_2.w + j.w + 1
0042d401        edi_4[3] = (self->width_cells.w + 1) * (i_2.w + 1) + j.w + 1
0042d417        edi_4[4] = (self->width_cells.w + 1) * (i_2.w + 1) + j.w
0042d41b        char* texture_path
0042d41b        if (((j.b ^ i_2.b) & 1) != 0)
0042d46a        texture_path = texture_a
0042d421        texture_path = texture_a
0042d434        *(edi_4 + 0xc) = get_or_create_texture_ref(&data_4b7790, texture_path, 0, 0)
0042d43b        *(edi_4 + 0x10) = arg2.d
0042d43e        *(edi_4 + 0x14) = var_4c_1
0042d443        *(edi_4 + 0x18) = var_50_1
0042d44c        *(edi_4 + 0x1c) = var_4c_1
0042d453        *(edi_4 + 0x20) = var_50_1
0042d456        *(edi_4 + 0x24) = var_54
0042d45b        *(edi_4 + 0x28) = arg2.d
0042d45e        *(edi_4 + 0x2c) = var_54
0042d51c        bool cond:12_1 = var_48_1 + 1 s< 2
0042d51f        var_48_1 += 1
0042d523        if (not(cond:12_1))
0042d523        break
0042d3a4        ecx_60 = var_48_1
0042d529        j += 1
0042d532        arg2.d = j
0042d536        do while (j s< self->width_cells)
0042d53f        i_2 += 1
0042d542        do while (i_2 s< self->segment_count)
0042d556        return finalize_path_template_record(self)
