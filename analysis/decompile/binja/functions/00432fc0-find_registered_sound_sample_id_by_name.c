...
00432fd2        RegisteredSoundSampleName* searched = &g_registered_sound_sample_names
00432fe3        if (find_case_insensitive_substring(sample_name, searched) != 0)
0043300e        return i
00432fea        i += 1
00432feb        searched = &searched[1]
