...
00420f8c        uint32_t eax_37 = template_record_2->segment_count * 0x15
00420f98        void* eax_38 = secondary_samples_2 + (eax_37 << 3)
00420f9e        struct Vec3* ecx_35 = &follow_state->source_cell->anchor_position
00420fb7        long double x87_r6_3 = x87_r6_2 * fconvert.t(*(eax_38 - 0x80))
00420fd1        float var_11c_1 = fconvert.s(fconvert.t(*(eax_38 - 0x70)) + fconvert.t(ecx_35->z))
00420fe7        long double x87_r5_9 = fconvert.t(fconvert.s(fconvert.t(*(eax_38 - 0x74)) + fconvert.t(ecx_35->y))) + fconvert.t(fconvert.s(x87_r6_2 * fconvert.t(*(eax_38 - 0x84))))
00420ff2        out_position->x = fconvert.s(fconvert.t(ecx_35->x) + fconvert.t(*(eax_38 - 0x78)) + fconvert.t(fconvert.s(x87_r6_2 * fconvert.t(*(secondary_samples_2 + (eax_37 << 3) - 0x88)))))
...
00420e8e        temp3_1 = fconvert.t((&secondary_samples->delta_length)[edx_15 * 2])
...
00420ece        void* ecx_32
00420ece        if (sample_index_3 != edi)
004210b3        eax_29 = (eax_26 - sample_index_3) * 0x18
004210b6        ecx_32 = template_record_3->primary_samples + eax_29
004210d3        var_168 = fconvert.s(fconvert.t(var_17c) / fconvert.t(*(&template_record_3->secondary_samples->delta_length + eax_29)) * (fconvert.t(*(ecx_32 + 0x138)) - fconvert.t(*(ecx_32 + 0x90))) + fconvert.t(*(ecx_32 + 0x90)))
00420edc        eax_29 = (eax_26 - sample_index_3) * 0x18
00420edf        ecx_32 = template_record_3->primary_samples + eax_29
00420ee7        var_168 = *(ecx_32 + 0x90)
004210d9        float var_180_1
004210d9        if (sample_index_3 != edi)
00421109        var_180_1 = fconvert.s(fconvert.t(var_17c) / fconvert.t(*(&template_record_3->secondary_samples->delta_length + eax_29)) * (fconvert.t(*(ecx_32 + 0x144)) - fconvert.t(*(ecx_32 + 0x9c))) + fconvert.t(*(ecx_32 + 0x9c)))
004210e1        var_180_1 = *(ecx_32 + 0x9c)
0042110f        float radius_1
0042110f        if (sample_index_3 != edi)
0042113f        radius_1 = fconvert.s(fconvert.t(var_17c) / fconvert.t(*(&template_record_3->secondary_samples->delta_length + eax_29)) * (fconvert.t(*(ecx_32 + 0x148)) - fconvert.t(*(ecx_32 + 0xa0))) + fconvert.t(*(ecx_32 + 0xa0)))
00421117        radius_1 = *(ecx_32 + 0xa0)
...
004212ec        void* esi_10 = secondary_samples_3 + eax_29
004212ef        struct TrackRowCell* source_cell = follow_state->source_cell
004212fc        float var_174_2 = fconvert.s(fconvert.t(var_17c) * fconvert.t(*(&secondary_samples_3->delta_dir_to_next + eax_29)) * fconvert.t(var_180_1) + fconvert.t(source_cell->anchor_position.x) + fconvert.t(*(esi_10 + 0x30)))
...
00421501        ecx_70[3] = x_2:3.b
00421507        *(ecx_70 + 4) = var_164.basis_forward.y
0042150e        *(ecx_70 + 8) = var_164.basis_forward.z
...
0042123e        long double x87_r7_43 = fconvert.t((&secondary_samples_1->delta_dir_to_next.z)[ecx_52 * 2]) * fconvert.t(follow_state->progress) + fconvert.t(follow_state->source_cell->anchor_position.z) + fconvert.t((&secondary_samples_1->transform.position.z)[ecx_52 * 2])
...
004216d7        int32_t eax_80 = 0
004216da        out_position_1->x = fconvert.s(fconvert.t(-4f))
004216e7        eax_80.b = follow_state->template_record->side_exit_mode == 0
004216f0        return eax_80
...
00421726        int32_t eax_82 = 0
00421729        out_position_1->x = fconvert.s(fconvert.t(out_position_1->x))
00421736        eax_82.b = follow_state->template_record->side_exit_mode == 0
0042173f        return eax_82
00421708        int32_t eax_81 = 0
0042170b        out_position_1->x = fconvert.s(fconvert.t(4f))
00421718        eax_81.b = follow_state->template_record->side_exit_mode == 0
00421721        return eax_81
