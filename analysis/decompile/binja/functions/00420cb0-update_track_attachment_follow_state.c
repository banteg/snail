...
00420d23        if (sample_index_2 + 1 == template_record_6->_pad_3c[8].d << 1)
00420d30        play_voice_manager(0x751498, 4, 1, 0xffffffff)
00420d35        uint32_t template_record = follow_state->template_record
00420d38        uint32_t ecx
00420d38        ecx.b = *(template_record + 0x9c)
00420d40        if (ecx.b != 0)
00420d46        int32_t eax_5 = *(template_record + 0x44)
00420d49        uint32_t sample_index_4 = follow_state->sample_index
00420d51        if (sample_index_4 != eax_5 - 1)
00420ddb        if (sample_index_4 == eax_5 * 3 s/ 7)
...
00420e76        if (sample_index_2 == template_record_6->_pad_3c[8].d)
...
00420f30        long double x87_r7_12 = fconvert.t(path_factor) * fconvert.t(*(template_record_1->__offset(0x5c).d + template_record_1->_pad_3c[8].d * 0xa8 - 0x1c))
00420f34        motion->z = fconvert.s(x87_r7_12)
00420f37        long double temp4 = fconvert.t(1f)
00420f37        x87_r7_12 - temp4
00420f3d        int32_t eax_32
00420f3d        eax_32.w = (x87_r7_12 < temp4 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_12, temp4) ? 1 : 0) << 0xa | (x87_r7_12 == temp4 ? 1 : 0) << 0xe
00420f42        if ((eax_32:1.b & 0x41) == 0)
...
00421077        out_position->z = fconvert.s(fconvert.t(*(template_record_4->__offset(0x5c).d + template_record_4->_pad_3c[8].d * 0xa8 - 0x70)) + fconvert.t(follow_state->source_cell->anchor_position.z) + fconvert.t(template_record_4->__offset(0x50).d) + fconvert.t(var_180))
00420f68        int32_t var_194_2 = 0xffffffff
00420f6a        int32_t var_198_2 = 0
00420f6c        int32_t var_19c_2 = 0xf
...
00420f8c        int32_t eax_35 = template_record_2->_pad_3c[8].d * 0x15
00420f98        void* eax_36 = ecx_33 + (eax_35 << 3)
00420f9e        struct Vec3* ecx_35 = &follow_state->source_cell->anchor_position
00420fb7        long double x87_r6_3 = x87_r6_2 * fconvert.t(*(eax_36 - 0x80))
00420fd1        float var_11c_1 = fconvert.s(fconvert.t(*(eax_36 - 0x70)) + fconvert.t(ecx_35->z))
00420fe7        long double x87_r5_9 = fconvert.t(fconvert.s(fconvert.t(*(eax_36 - 0x74)) + fconvert.t(ecx_35->y))) + fconvert.t(fconvert.s(x87_r6_2 * fconvert.t(*(eax_36 - 0x84))))
00420ff2        out_position->x = fconvert.s(fconvert.t(ecx_35->x) + fconvert.t(*(eax_36 - 0x78)) + fconvert.t(fconvert.s(x87_r6_2 * fconvert.t(*(ecx_33 + (eax_35 << 3) - 0x88)))))
...
00420e8b        eax_24 = template_record_6->__offset(0x5c).d
00420e8e        long double temp3_1 = fconvert.t(*(eax_24 + (edx_16 << 3) + 0x8c))
00420e8e        x87_r7_7 - temp3_1
00420e95        edx_1 = eax_24 + (edx_16 << 3) + 0x8c
00420e9c        eax_24.w = (x87_r7_7 < temp3_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_7, temp3_1) ? 1 : 0) << 0xa | (x87_r7_7 == temp3_1 ? 1 : 0) << 0xe
00420ea1        do while ((eax_24:1.b & 0x41) == 0)
...
00420ec2        int32_t edi = template_record_3->_pad_3c[8].d - 1
00420ec5        uint32_t eax_26 = sample_index_3 << 3
00420ece        float var_168
00420ece        uint32_t eax_29
00420ece        void* ecx_31
00420ece        if (sample_index_3 != edi)
004210b3        eax_29 = (eax_26 - sample_index_3) * 0x18
004210b6        ecx_31 = template_record_3->__offset(0x58).d + eax_29
004210d3        var_168 = fconvert.s(fconvert.t(var_17c) / fconvert.t(*(template_record_3->__offset(0x5c).d + eax_29 + 0x8c)) * (fconvert.t(*(ecx_31 + 0x138)) - fconvert.t(*(ecx_31 + 0x90))) + fconvert.t(*(ecx_31 + 0x90)))
00420edc        eax_29 = (eax_26 - sample_index_3) * 0x18
00420edf        ecx_31 = template_record_3->__offset(0x58).d + eax_29
00420ee7        var_168 = *(ecx_31 + 0x90)
004210d9        float var_180_1
004210d9        if (sample_index_3 != edi)
00421109        var_180_1 = fconvert.s(fconvert.t(var_17c) / fconvert.t(*(template_record_3->__offset(0x5c).d + eax_29 + 0x8c)) * (fconvert.t(*(ecx_31 + 0x144)) - fconvert.t(*(ecx_31 + 0x9c))) + fconvert.t(*(ecx_31 + 0x9c)))
004210e1        var_180_1 = *(ecx_31 + 0x9c)
0042110f        float var_178
0042110f        if (sample_index_3 != edi)
0042113f        var_178 = fconvert.s(fconvert.t(var_17c) / fconvert.t(*(template_record_3->__offset(0x5c).d + eax_29 + 0x8c)) * (fconvert.t(*(ecx_31 + 0x148)) - fconvert.t(*(ecx_31 + 0xa0))) + fconvert.t(*(ecx_31 + 0xa0)))
...
004212ec        void* esi_10 = ecx_59 + eax_29
004212ef        struct TrackRowCell* source_cell = follow_state->source_cell
004212fc        float var_174_2 = fconvert.s(fconvert.t(var_17c) * fconvert.t(*(ecx_59 + eax_29 + 0x80)) * fconvert.t(var_180_1) + fconvert.t(source_cell->anchor_position.x) + fconvert.t(*(esi_10 + 0x30)))
...
004213b4        int32_t var_194_4 = ecx_64
004213d3        linear_interpolate_matrix(&var_164, &from, &to, fconvert.s(x87_r7_58 / fconvert.t(*(template_record_3->__offset(0x5c).d + eax_29 + 0x8c))))
...
00421497        *ecx_66 = fconvert.s(fconvert.t(fconvert.s(fconvert.t(fconvert.s(x87_r6_24 * fconvert.t(var_164.basis_right.x))) + fconvert.t(var_174_2))) + fconvert.t(fconvert.s(fconvert.t(var_164.basis_up.x) * x87_r7_67)))
004214a3        ecx_66[1] = fconvert.s(x87_r5_23)
004214ae        ecx_66[2] = fconvert.s(x87_r6_26 + x87_r7_68)
004214ba        float* eax_61 = data_4df904 + 0x42fdb4
004214c1        *eax_61 = var_164.basis_right.x
004214c7        eax_61[1] = var_164.basis_right.y
004214ce        eax_61[2] = var_164.basis_right.z
...
00421189        if (sample_index == 0 || sample_index == follow_state->template_record->_pad_3c[8].d - 1)
...
0042121a        int32_t eax_51 = follow_state->template_record->__offset(0x5c).d
00421234        edi_1 = &motion->y
0042123a        float y = var_164.position.y
0042123e        long double x87_r7_43 = fconvert.t(*(eax_51 + (ecx_52 << 3) + 0x88)) * fconvert.t(follow_state->progress) + fconvert.t(follow_state->source_cell->anchor_position.z) + fconvert.t(*(eax_51 + (ecx_52 << 3) + 0x38))
...
004212c2        float* eax_57 = data_4df904 + 0x42fdd4
004212c7        *eax_57 = var_164.basis_forward.x
004212cd        eax_57[1] = var_164.basis_forward.y
004212d4        eax_57[2] = var_164.basis_forward.z
...
00421540        if (sample_index_1 != template_record_5->_pad_3c[8].d - 1)
0042156b        int32_t eax_70 = template_record_5->__offset(0x58).d
00421571        ecx_78 = (ecx_75 - sample_index_1) * 0x18
0042157b        long double x87_r7_71 = fconvert.t(*(eax_70 + ecx_78 + 0x140)) - fconvert.t(*(eax_70 + ecx_78 + 0x98))
00421582        void* ebx_1 = eax_70 + ecx_78
00421585        long double temp5_1 = fconvert.t(3.14159274f)
00421585        x87_r7_71 - temp5_1
0042158b        eax_70.w = (x87_r7_71 < temp5_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_71, temp5_1) ? 1 : 0) << 0xa | (x87_r7_71 == temp5_1 ? 1 : 0) << 0xe | 0x3800
00421590        if ((eax_70:1.b & 0x41) != 0)
0042159a        long double temp6_1 = fconvert.t(-3.14159274f)
0042159a        x87_r7_71 - temp6_1
004215a0        eax_70.w = (x87_r7_71 < temp6_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_71, temp6_1) ? 1 : 0) << 0xa | (x87_r7_71 == temp6_1 ? 1 : 0) << 0xe | 0x3800
004215a5        if ((eax_70:1.b & 1) != 0)
...
004215c5        int32_t eax_72 = template_record_5->__offset(0x58).d
004215d1        long double x87_r7_74 = fconvert.t(*(eax_72 + ecx_78 + 0x13c)) - fconvert.t(*(eax_72 + ecx_78 + 0x94))
004215d8        void* ebx_2 = eax_72 + ecx_78
004215db        long double temp7_1 = fconvert.t(3.14159274f)
004215db        x87_r7_74 - temp7_1
004215e1        eax_72.w = (x87_r7_74 < temp7_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_74, temp7_1) ? 1 : 0) << 0xa | (x87_r7_74 == temp7_1 ? 1 : 0) << 0xe | 0x3800
004215e6        if ((eax_72:1.b & 0x41) != 0)
004215f0        long double temp10_1 = fconvert.t(-3.14159274f)
004215f0        x87_r7_74 - temp10_1
004215f6        eax_72.w = (x87_r7_74 < temp10_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_74, temp10_1) ? 1 : 0) << 0xa | (x87_r7_74 == temp10_1 ? 1 : 0) << 0xe | 0x3800
004215fb        if ((eax_72:1.b & 1) != 0)
...
00421554        follow_state->orientation_b = *(template_record_5->__offset(0x58).d + ecx_78 + 0x98)
00421561        follow_state->orientation_a = *(template_record_5->__offset(0x58).d + ecx_78 + 0x94)
00421631        struct Player* player_3 = follow_state->player
00421641        follow_state->orientation_b = fconvert.s((fconvert.t(follow_state->progress) / fconvert.t(*(template_record_5->__offset(0x5c).d + ecx_78 + 0x8c)) + float.t(sample_index_1)) * fconvert.t(template_record_5->__offset(0x98).d) / float.t(template_record_5->_pad_3c[8].d))
0042164b        int32_t eax_74
...
0042165d        eax_74.w = (x87_r7_82 < temp9_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_82, temp9_1) ? 1 : 0) << 0xa | (x87_r7_82 == temp9_1 ? 1 : 0) << 0xe | 0x3800
00421662        if ((eax_74:1.b & 1) != 0)
...
00421679        eax_74.w = (x87_r7_82 < x87_r7_83 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_82, x87_r7_83) ? 1 : 0) << 0xa | (x87_r7_82 == x87_r7_83 ? 1 : 0) << 0xe
0042167e        if ((eax_74:1.b & 0x41) == 0)
...
0042168d        eax_74.w = (x87_r7_84 < temp11_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_84, temp11_1) ? 1 : 0) << 0xa | (x87_r7_84 == temp11_1 ? 1 : 0) << 0xe
00421692        if ((eax_74:1.b & 0x41) != 0)
...
004216e7        int32_t eax_77
004216e7        eax_77.b = follow_state->template_record->_pad_3c[4].d == 0
004216f0        return eax_77
...
00421736        int32_t eax_79
00421736        eax_79.b = follow_state->template_record->_pad_3c[4].d == 0
0042173f        return eax_79
0042170b        out_position_1->x = fconvert.s(fconvert.t(4f))
00421718        int32_t eax_78
00421718        eax_78.b = follow_state->template_record->_pad_3c[4].d == 0
00421721        return eax_78
...
0042174b        eax_74.w = (x87_r7_92 < temp8 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_92, temp8) ? 1 : 0) << 0xa | (x87_r7_92 == temp8 ? 1 : 0) << 0xe
00421750        if ((eax_74:1.b & 1) != 0)
