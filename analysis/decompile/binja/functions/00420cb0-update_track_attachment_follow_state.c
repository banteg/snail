...
00420f3d        struct PathTemplateSample* eax_31
...
00421077        out_position->z = fconvert.s(fconvert.t(*(&template_record_4->secondary_samples[template_record_4->segment_count] - 0x70)) + fconvert.t(follow_state->source_cell->__offset(0x18).d) + fconvert.t(template_record_4->width_or_scale) + fconvert.t(var_180))
...
00420f98        void* eax_35 = secondary_samples_2 + (eax_34 << 3)
00420f9e        void* __offset(TrackRowCell, 0x10) ecx_34 = follow_state->source_cell + 0x10
00420fb7        long double x87_r6_3 = x87_r6_2 * fconvert.t(*(eax_35 - 0x80))
00420fd1        float var_11c_1 = fconvert.s(fconvert.t(*(eax_35 - 0x70)) + fconvert.t((ecx_34 - 0x10)->__offset(0x18).d))
00420fe7        long double x87_r5_9 = fconvert.t(fconvert.s(fconvert.t(*(eax_35 - 0x74)) + fconvert.t((ecx_34 - 0x10)->__offset(0x14).d))) + fconvert.t(fconvert.s(x87_r6_2 * fconvert.t(*(eax_35 - 0x84))))
00420ff2        out_position->x = fconvert.s(fconvert.t((ecx_34 - 0x10)->__offset(0x10).d) + fconvert.t(*(eax_35 - 0x78)) + fconvert.t(fconvert.s(x87_r6_2 * fconvert.t(*(secondary_samples_2 + (eax_34 << 3) - 0x88)))))
...
004210d3        var_168 = fconvert.s(fconvert.t(var_17c) / fconvert.t(*(&template_record_3->secondary_samples->delta_length + eax_28)) * (fconvert.t(*(ecx_31 + 0x138)) - fconvert.t(*(ecx_31 + 0x90))) + fconvert.t(*(ecx_31 + 0x90)))
...
00421109        var_180_1 = fconvert.s(fconvert.t(var_17c) / fconvert.t(*(&template_record_3->secondary_samples->delta_length + eax_28)) * (fconvert.t(*(ecx_31 + 0x144)) - fconvert.t(*(ecx_31 + 0x9c))) + fconvert.t(*(ecx_31 + 0x9c)))
004210e1        var_180_1 = *(ecx_31 + 0x9c)
0042110f        float var_178
0042110f        if (sample_index_3 != edi)
0042113f        var_178 = fconvert.s(fconvert.t(var_17c) / fconvert.t(*(&template_record_3->secondary_samples->delta_length + eax_28)) * (fconvert.t(*(ecx_31 + 0x148)) - fconvert.t(*(ecx_31 + 0xa0))) + fconvert.t(*(ecx_31 + 0xa0)))
00421117        var_178 = *(ecx_31 + 0xa0)
00421147        float var_154
00421147        float var_150
00421147        float var_14c
...
004212fc        float var_174_2 = fconvert.s(fconvert.t(var_17c) * fconvert.t(*(&secondary_samples_3->delta_dir_to_next + eax_28)) * fconvert.t(var_180_1) + fconvert.t(source_cell->__offset(0x10).d) + fconvert.t(*(esi_10 + 0x30)))
00421314        float var_170_2 = fconvert.s(fconvert.t(var_17c) * fconvert.t(*(esi_10 + 0x84)) * fconvert.t(var_180_1) + fconvert.t(source_cell->__offset(0x14).d) + fconvert.t(*(esi_10 + 0x34)))
00421328        float var_16c_2 = fconvert.s(fconvert.t(var_17c) * fconvert.t(*(esi_10 + 0x88)) + fconvert.t(source_cell->__offset(0x18).d) + fconvert.t(*(esi_10 + 0x38)))
0042132c        if (sample_index_3 != edi)
00421349        float var_c0[0xc]
00421349        __builtin_memcpy(&var_c0, esi_10, 0x40)
0042134b        long double x87_r7_58 = fconvert.t(var_17c)
0042136f        int32_t var_88_1 = 0
0042137a        int32_t var_8c_1 = 0
00421385        int32_t var_90_1 = 0
00421390        int32_t var_48_1 = 0
...
004214e1        *edx_38 = var_154
004214e7        edx_38[1] = var_150
004214ee        edx_38[2] = var_14c
004214fb        int32_t* ecx_70 = data_4df904 + 0x42fdd4
00421501        *ecx_70 = var_144
...
0042123e        long double x87_r7_43 = fconvert.t((&secondary_samples_1->delta_dir_to_next.z)[ecx_51 * 2]) * fconvert.t(follow_state->progress) + fconvert.t(follow_state->source_cell->__offset(0x18).d) + fconvert.t((&secondary_samples_1->transform.position.z)[ecx_51 * 2])
...
004212a9        *ecx_56 = var_154
004212af        ecx_56[1] = var_150
004212b6        ecx_56[2] = var_14c
004212c2        int32_t* eax_55 = data_4df904 + 0x42fdd4
004212c7        *eax_55 = var_144
004212cd        eax_55[1] = var_140
004212d4        eax_55[2] = var_13c
0042151c        follow_state->orientation_c = var_154
00421523        follow_state->orientation_d = var_150
00421526        struct PathTemplate* template_record_5 = follow_state->template_record
00421529        follow_state->orientation_e = var_14c
...
004215c2        follow_state->orientation_b = fconvert.s(fconvert.t(follow_state->progress) / fconvert.t(*(&template_record_5->secondary_samples->delta_length + ecx_78)) * x87_r7_71 + fconvert.t(*(ebx_1 + 0x98)))
...
0042161f        follow_state->orientation_a = fconvert.s(fconvert.t(follow_state->progress) / fconvert.t(*(&template_record_5->secondary_samples->delta_length + ecx_78)) * x87_r7_74 + fconvert.t(*(ebx_2 + 0x94)))
...
0042165d        eax_70.w = (x87_r7_82 < temp9_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_82, temp9_1) ? 1 : 0) << 0xa | (x87_r7_82 == temp9_1 ? 1 : 0) << 0xe | 0x3800
00421662        if ((eax_70:1.b & 1) != 0)
...
00421679        eax_70.w = (x87_r7_82 < x87_r7_83 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_82, x87_r7_83) ? 1 : 0) << 0xa | (x87_r7_82 == x87_r7_83 ? 1 : 0) << 0xe
0042167e        if ((eax_70:1.b & 0x41) == 0)
...
0042168d        eax_70.w = (x87_r7_84 < temp11_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_84, temp11_1) ? 1 : 0) << 0xa | (x87_r7_84 == temp11_1 ? 1 : 0) << 0xe
00421692        if ((eax_70:1.b & 0x41) != 0)
...
004216e7        int32_t eax_73
004216e7        eax_73.b = follow_state->template_record->side_exit_mode == 0
004216f0        return eax_73
...
00421736        int32_t eax_75
00421736        eax_75.b = follow_state->template_record->side_exit_mode == 0
0042173f        return eax_75
0042170b        out_position_1->x = fconvert.s(fconvert.t(4f))
00421718        int32_t eax_74
00421718        eax_74.b = follow_state->template_record->side_exit_mode == 0
00421721        return eax_74
...
0042174b        eax_70.w = (x87_r7_92 < temp8 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_92, temp8) ? 1 : 0) << 0xa | (x87_r7_92 == temp8 ? 1 : 0) << 0xe
00421750        if ((eax_70:1.b & 1) != 0)
