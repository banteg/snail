...
0043a5b7        struct JetParticleSlot (* esi)[0x1e] = &sub_hover->particle_slots
...
0043a5e5        enum SpriteFlag flags = eax_1->flags
...
0043a63f        struct tColour* ecx_4 = &(esi - 0x20)->particle_slots[0].sprite->color
0043a642        esi = &(*esi)[1]
0043a645        i = i_1
0043a645        i_1 -= 1
...
0043a660        (esi - 0x20)->player->body.bod.color.r = 0
