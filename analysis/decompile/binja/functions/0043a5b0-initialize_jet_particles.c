...
0043a621        __builtin_memset((esi - 0x20)->particle_slots[0].sprite + 0x60, 0, 0x1c)
0043a626        int32_t* eax_5 = (esi - 0x20)->particle_slots[0].sprite + 0x54
0043a629        eax_5[2] = 0
0043a62c        eax_5[1] = 0
0043a62f        *eax_5 = 0
...
0043a63f        int32_t* ecx_4 = (esi - 0x20)->particle_slots[0].sprite + 0x2c
0043a642        esi = &(*esi)[1]
0043a645        i = i_1
0043a645        i_1 -= 1
