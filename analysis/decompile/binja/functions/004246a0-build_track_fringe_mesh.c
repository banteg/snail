...
00424743        void* __offset(Vec3, 0x14) esi = generated_mesh->vertices + 0x14
...
0042477d        struct Vec3* generated_row = esi - 0x14
...
004247c3        (esi - 0x14)->__offset(0xc).d = *eax_18
004247c8        (esi - 0x14)->__offset(0x10).d = eax_18[1]
004247ce        (esi - 0x14)->__offset(0x14).d = eax_18[2]
004247f1        struct Vec3 vector
004247f1        vector.x = fconvert.s(fconvert.t((esi - 0x14)->__offset(0xc).d) - fconvert.t(generated_row->x))
004247f9        vector.y = fconvert.s(fconvert.t((esi - 0x14)->__offset(0x10).d) - fconvert.t((esi - 0x14)->y))
00424805        vector.z = fconvert.s(fconvert.t((esi - 0x14)->__offset(0x14).d) - fconvert.t((esi - 0x14)->z))
00424809        normalize_vector(&vector)
0042484d        float var_3c_1 = fconvert.s(fconvert.t(fconvert.s(fconvert.t(vector.y) * fconvert.t(0.400000006f))) + fconvert.t((esi - 0x14)->__offset(0x10).d))
00424855        long double x87_r7_15 = fconvert.t(fconvert.s(fconvert.t(vector.z) * fconvert.t(0.400000006f))) + fconvert.t((esi - 0x14)->__offset(0x14).d)
0042485b        generated_row->x = fconvert.s(fconvert.t(vector.x) * fconvert.t(0.400000006f) + fconvert.t((esi - 0x14)->__offset(0xc).d))
0042485d        generated_row->y = var_3c_1
00424868        generated_row->z = fconvert.s(x87_r7_15)
00424883        int32_t* eax_27 = &self->bod.object->vertices[(self->width_cells + 1) * var_68 + var_64_1]
0042488a        *(esi + 4) = *eax_27
0042488f        *(esi + 8) = eax_27[1]
00424899        *(esi + 0xc) = eax_27[2]
004248b3        int32_t* edx_17 = &self->bod.object->vertices[(self->width_cells + 1) * var_68 + width_cells_1]
004248b8        (esi - 0x14)->__offset(0x24).d = *edx_17
004248bd        (esi - 0x14)->__offset(0x28).d = edx_17[1]
004248c3        (esi - 0x14)->__offset(0x2c).d = edx_17[2]
004248e8        vector.x = fconvert.s(fconvert.t((esi - 0x14)->__offset(0x24).d) - fconvert.t(*(esi + 4)))
004248ec        vector.y = fconvert.s(fconvert.t((esi - 0x14)->__offset(0x28).d) - fconvert.t((esi - 0x14)->__offset(0x1c).d))
004248fc        vector.z = fconvert.s(fconvert.t((esi - 0x14)->__offset(0x2c).d) - fconvert.t((esi - 0x14)->__offset(0x20).d))
...
0042493f        float var_24_1 = fconvert.s(fconvert.t(out.g) + fconvert.t((esi - 0x14)->__offset(0x28).d))
00424947        long double x87_r7_30 = fconvert.t(out.b) + fconvert.t((esi - 0x14)->__offset(0x2c).d)
0042494e        *(esi + 4) = fconvert.s(fconvert.t(vector.x) * fconvert.t(0.400000006f) + fconvert.t((esi - 0x14)->__offset(0x24).d))
00424951        *(esi + 8) = var_24_1
00424958        long double x87_r7_31 = fconvert.t(clamp_side)
0042495f        long double temp1_1 = fconvert.t(-1f)
0042495f        x87_r7_31 - temp1_1
00424969        *(esi + 0xc) = fconvert.s(x87_r7_30)
...
004249ed        return
004249fc        uint16_t* esi_1 = &facequads->vertex_0
00424abd        bool cond:1_1
00424a16        (esi_1 - 2)->texture_ref = get_or_create_texture_ref(&g_texture_refs, texture_path, nullptr, 0)
00424a1b        int16_t ebp_6 = (var_68_1 << 2).w
00424a31        (esi_1 - 2)->vertex_0 = ebp_6 + 5
00424a34        (esi_1 - 2)->vertex_1 = (var_68_1 << 2).w + 4
00424a3b        (esi_1 - 2)->vertex_2 = ebp_6
00424a3f        (esi_1 - 2)->vertex_3 = ebp_6 + 1
00424a48        (esi_1 - 2)->uv[3].v = 0f
00424a4b        (esi_1 - 2)->uv[0].u = 0x3f000000
00424a4e        (esi_1 - 2)->uv[0].v = 0f
00424a51        __builtin_memcpy(&esi_1[0xb], "\x00\x00\x00\x3f\x00\x00\x80\x3f\x00\x00\x00\x3f\x00\x00\x80\x3f\x00\x00\x00\x3f", 0x14)
00424a6e        (esi_1 - 2)->__offset(0x3c).d = get_or_create_texture_ref(&g_texture_refs, texture_path, nullptr, 0)
00424a77        (esi_1 - 2)->__offset(0x32).w = ebp_6 + 6
00424a7e        (esi_1 - 2)->__offset(0x34).w = ebp_6 + 7
00424a85        (esi_1 - 2)->__offset(0x36).w = ebp_6 + 3
00424a89        (esi_1 - 2)->__offset(0x38).w = ebp_6 + 2
00424a92        (esi_1 - 2)->__offset(0x58).d = 0x3f000000
00424a95        (esi_1 - 2)->__offset(0x5c).d = 0x3f800000
00424a98        (esi_1 - 2)->__offset(0x40).d = 0x3f000000
00424a9b        (esi_1 - 2)->__offset(0x44).d = 0x3f800000
00424aa0        (esi_1 - 2)->__offset(0x48).d = 0x3f000000
00424aa3        (esi_1 - 2)->__offset(0x4c).d = 0
00424aa6        (esi_1 - 2)->__offset(0x50).d = 0x3f000000
00424aa9        (esi_1 - 2)->__offset(0x54).d = 0
00424ab4        esi_1 = &esi_1[0x30]
