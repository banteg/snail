...
0044ae59        struct FontGlyphV0Cursor* glyph_v0_cursor = &g_font_sheets[0].v0[font_sheet_dword_offset]
0044afa5        bool cond:0_1
0044ae71        font_id.d = fconvert.s(fconvert.t(glyph_v0_cursor->glyph_width) / fconvert.t(g_font_sheets[font_id_1].line_marker_y))
...
0044aeb9        (*bod_object_cursor)->facequads->texture_ref = (&g_font_sheets[0].texture_ref_a)[font_sheet_dword_offset + glyph_v0_cursor->texture_page]
0044aec7        (*bod_object_cursor)->facequads->uv[0].u = glyph_v0_cursor->__offset(0xfffffffffffffe00).d
0044aed5        (*bod_object_cursor)->facequads->uv[0].v = fconvert.s(fconvert.t(1f) - fconvert.t(g_font_sheets[font_id_1].line_step))
0044aee5        (*bod_object_cursor)->facequads->uv[1].u = glyph_v0_cursor->v0
0044aef3        (*bod_object_cursor)->facequads->uv[1].v = fconvert.s(fconvert.t(1f) - fconvert.t(g_font_sheets[font_id_1].line_step))
0044af03        (*bod_object_cursor)->facequads->uv[2].u = glyph_v0_cursor->v0
0044af11        (*bod_object_cursor)->facequads->uv[2].v = fconvert.s(fconvert.t(1f) - fconvert.t(g_font_sheets[font_id_1].line_marker_fraction))
0044af25        (*bod_object_cursor)->facequads->uv[3].u = glyph_v0_cursor->__offset(0xfffffffffffffe00).d
0044af33        (*bod_object_cursor)->facequads->uv[3].v = fconvert.s(fconvert.t(1f) - fconvert.t(g_font_sheets[font_id_1].line_marker_fraction))
...
0044af7e        glyph_v0_cursor = &glyph_v0_cursor->next_glyph_v0
...
0044af97        scale_cursor[-1] = font_id.d
