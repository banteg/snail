...
0040a939        if ((*(ebp_1 + 0x5bc) & 2) == 0 && i_8 != 0)
...
0040a989        int32_t i_7 = i_8
0040a990        struct RenderableBod** post_cursor = &(&g_post_sprite_bods)[i_8]
0040a997        i_8 = 0
0040a99f        var_7c += i_7
