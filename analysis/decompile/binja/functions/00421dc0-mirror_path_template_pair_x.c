...
00421ea5        float* ecx_17 = self->primary_samples + eax_4
00421eaf        *ecx_17 = fconvert.s(fconvert.t(*ecx_17) * fconvert.t(-1f))
...
00421ef0        int32_t* ecx_22 = &source_1->primary_samples->delta_dir_to_next + eax_4
00421ef7        int32_t* esi_6 = &self->primary_samples->delta_dir_to_next + eax_4
00421f00        *esi_6 = *ecx_22
00421f05        esi_6[1] = ecx_22[1]
00421f0b        esi_6[2] = ecx_22[2]
...
00421f53        float* ecx_29 = self->secondary_samples + eax_4
00421f5d        i += 1
00421f5e        *ecx_29 = fconvert.s(fconvert.t(*ecx_29) * fconvert.t(-1f))
...
00421f9f        int32_t* ecx_34 = &source_1->secondary_samples->delta_dir_to_next + eax_4
00421fa6        int32_t* esi_11 = &self->secondary_samples->delta_dir_to_next + eax_4
00421faf        *esi_11 = *ecx_34
00421fb4        esi_11[1] = ecx_34[1]
00421fba        esi_11[2] = ecx_34[2]
...
00421fcd        float* ecx_36 = &secondary_samples_3->delta_dir_to_next + eax_4
00421fd4        eax_4 += 0xa8
00421fd9        *ecx_36 = fconvert.s(x87_r7_26)
00421fe5        *(eax_4 + self->secondary_samples - 0x1c) = *(eax_4 + source_1->secondary_samples - 0x1c)
00421fee        do while (i s< self->segment_count)
00422003        request_object_vertices(self->bod.object, (self->segment_count + 1) * (self->width_cells + 1))
00422015        request_object_facequads(self->bod.object, (self->segment_count * self->width_cells) << 1)
0042201a        struct Object* object_1 = self->bod.object
0042201d        source = nullptr
0042202c        if ((object_1->flags & OBJECT_FLAG_USE_VERTEX_COLOURS) != 0)
0042202e        request_object_vertex_colours(object_1)
00422033        object_1 = self->bod.object
00422039        source = object_1->vertex_colours
0042203d        struct ObjectFaceQuad* facequads = object_1->facequads
00422040        struct Vec3* vertices = object_1->vertices
...
0042205b        int32_t ecx_45 = 0
0042205f        if (width_cells s>= 0)
00422074        float* eax_12 = ((width_cells + 1) * i_1 + ecx_45) * 0xc
0042207c        *(eax_12 + vertices) = fconvert.s(fneg(fconvert.t(*(source_1->bod.object->vertices + eax_12))))
0042207f        self->width_cells
00422098        vertices[(self->:0x54.d + 1) * i_1 + ecx_45].y = source_1->bod.object->vertices[(self->:0x54.d + 1) * i_1 + ecx_45].y
0042209c        self->width_cells
004220b5        vertices[(self->:0x54.d + 1) * i_1 + ecx_45].z = source_1->bod.object->vertices[(self->:0x54.d + 1) * i_1 + ecx_45].z
004220c3        if ((self->bod.object->flags & OBJECT_FLAG_USE_VERTEX_COLOURS) != 0)
004220db        int32_t* esi_15 = &source_1->bod.object->vertex_colours[(self->:0x54.d + 1) * i_1 + ecx_45]
004220dd        int32_t* eax_31 = (((self->width_cells + 1) * i_1 + ecx_45) << 4) + source
...
004220fc        ecx_45 += 1
004220ff        do while (ecx_45 s<= width_cells)
00422108        i_1 += 1
...
00422165        __builtin_memcpy(eax_36, &source_1->bod.object->facequads[i_2 + ((self->:0x54.d * var_8 + source) << 1)], 0x30)
0042216d        int16_t ecx_53 = *(eax_36 + 2)
00422171        *(eax_36 + 2) = *(eax_36 + 4)
00422175        *(eax_36 + 4) = ecx_53
0042217f        i_2 += 1
00422180        int16_t ecx_55 = *(eax_36 + 6)
00422184        *(eax_36 + 6) = *(eax_36 + 8)
00422188        *(eax_36 + 8) = ecx_55
...
004221b3        source = &source->bod.bod.vtable + 1
004221b7        do while (&source->bod.bod.vtable + 1 s< self->width_cells)
