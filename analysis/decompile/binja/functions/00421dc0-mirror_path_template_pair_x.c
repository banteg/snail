...
004220dd        int32_t* eax_31 = &source->_pad_00[((self->width_cells + 1) * i_1 + ecx_44) << 4]
...
00422124        uint32_t width_cells_1 = self->width_cells
00422127        __builtin_memset(&source, 0, 4)
00422131        if (width_cells_1 s> 0)
...
0042217f        i_2 += 1
00422180        int16_t ecx_52 = *(eax_35 + 6)
00422184        *(eax_35 + 6) = *(eax_35 + 8)
00422188        *(eax_35 + 8) = ecx_52
0042218f        long double x87_r7_29 = fconvert.t(*(eax_35 + 0x10))
00422195        *(eax_35 + 0x10) = fconvert.s(fconvert.t(*(eax_35 + 0x18)))
00422198        *(eax_35 + 0x18) = fconvert.s(x87_r7_29)
0042219b        long double x87_r7_30 = fconvert.t(*(eax_35 + 0x20))
004221a1        *(eax_35 + 0x20) = fconvert.s(fconvert.t(*(eax_35 + 0x28)))
004221a4        *(eax_35 + 0x28) = fconvert.s(x87_r7_30)
004221b1        cond:2_1 = &source->_pad_00[1] s< self->width_cells
