...
00424ae7        set_bod_object(arg1 + 0x60, add_object_to_list(0x4b7648))
00424aec        struct PathTemplateStripMesh* mesh = *(arg1 + 0x84)
00424af2        enum PathTemplateStripMeshFlags flags = mesh->flags
00424af5        mesh->_pad_14[0] = 5
00424af5        mesh->_pad_14[1] = 0
00424af5        mesh->_pad_14[2] = 0
00424af5        mesh->_pad_14[3] = 0
00424b02        mesh->flags = flags | PATH_TEMPLATE_STRIP_MESH_FLAG_IMPORTED_X_MESH
00424b12        request_object_vertices(mesh, (*(arg1 + 0x44) << 2) + 6)
00424b21        request_object_facequads(mesh, *(arg1 + 0x44) * 2 + 1)
00424b29        struct Vec3* vertices = mesh->vertices
00424b2c        struct ObjectFaceQuad* facequads = mesh->facequads
00424b2f        int32_t i = 0
00424b33        struct Vec3* vertices_1 = vertices
00424b37        if (*(arg1 + 0x44) s>= 0)
00424b3d        void* __offset(Vec3, 0x14) edi_1 = vertices + 0x14
00424b54        int32_t* edx_2 = *(*(arg1 + 0x24) + 0x38) + ((*(arg1 + 0x54) + 1) * i + 1) * 0xc
00424b59        (edi_1 - 0x14)->x = *edx_2
00424b5e        (edi_1 - 0x14)->y = edx_2[1]
00424b64        (edi_1 - 0x14)->z = edx_2[2]
00424b7a        int32_t* eax_16 = *(*(arg1 + 0x24) + 0x38) + (*(arg1 + 0x54) + 1) * i * 0xc
...
00424c27        int32_t ecx_9 = *(arg1 + 0x54)
00424c3b        int32_t* ecx_11 = *(*(arg1 + 0x24) + 0x38) + ((ecx_9 + 1) * i + ecx_9) * 0xc - 0xc
00424c41        (edi_1 - 0x14)->__offset(0x18).d = *ecx_11
00424c46        (edi_1 - 0x14)->__offset(0x1c).d = ecx_11[1]
00424c4c        (edi_1 - 0x14)->__offset(0x20).d = ecx_11[2]
00424c4f        int32_t ecx_13 = *(arg1 + 0x54)
00424c66        int32_t* eax_31 = *(*(arg1 + 0x24) + 0x38) + ((ecx_13 + 1) * i + ecx_13) * 0xc
...
00424d1b        do while (i s<= *(arg1 + 0x44))
...
00424e07        int32_t ecx_25 = *(arg1 + 0x44)
00424e14        float* eax_45 = &vertices[ecx_25 * 4]
00424e24        float* ecx_28 = ((ecx_25 * 3 + 3) << 4) + vertices
...
00424e76        *ecx_28 = fconvert.s((fconvert.t(*eax_45) - fconvert.t(eax_45[-0xc])) * fconvert.t(0.400000006f) + fconvert.t(*eax_45))
00424e78        ecx_28[1] = var_20_2
00424e83        ecx_28[2] = fconvert.s(x87_r7_38)
00424e8f        void* eax_50 = &vertices[*(arg1 + 0x44) * 4]
...
00424f01        int32_t eax_52 = *(arg1 + 0x44)
00424f0e        int32_t* edx_22 = ((eax_52 * 3 + 3) << 4) + vertices
00424f15        int32_t* eax_55 = &vertices[eax_52 * 4]
00424f17        *eax_55 = *edx_22
00424f1c        eax_55[1] = edx_22[1]
00424f24        eax_55[2] = edx_22[2]
00424f32        void* edi_3 = &vertices[*(arg1 + 0x44) * 4]
