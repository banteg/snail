...
00428000        self->__offset(0x3c).b = 0
00428004        self->__offset(0x40).d = 0
00428007        self->__offset(0x54).d = arg3
0042800a        int16_t x87control
0042800a        int32_t eax_1 = __ftol(x87control, fconvert.t(arg2) * fconvert.t(6.28318548f))
00428025        self->__offset(0x50).d = 0x3f800000
...
00428045        self->__offset(0x9c).b = 0
0042804b        arg3 = 0
0042804f        void* i = nullptr
0042811d        while (i s< 0x3f0)
00428065        *(&self->primary_samples->center_x + i) = fconvert.s(fneg(float.t(self->__offset(0x54).d) * fconvert.t(0.5f) - fconvert.t(4f)))
...
004280d5        set_matrix_identity(i + self->__offset(0x5c).d)
004280eb        *(i + self->__offset(0x5c).d + 0x30) = *(&self->primary_samples->center_x + i)
004280f2        *(i + self->__offset(0x5c).d + 0x34) = 0x3efae148
00428101        *(i + self->__offset(0x5c).d + 0x38) = fconvert.s(fconvert.t(fconvert.s(x87_r7_9)))
00428108        i += 0xa8
00428115        *(i + self->__offset(0x5c).d - 0x1c) = 0x3f800000
00428119        arg3 += 1
0042812a        arg3 = eax_1 + 6
0042813f        int32_t edi_1 = (eax_1 + 6) * 0xa8
00428144        int32_t var_40 = edi_1
00428220        int32_t i_1
00428160        *(&self->primary_samples->center_x + edi_1) = fconvert.s(fneg(fconvert.t(4f) - float.t(self->__offset(0x54).d) * fconvert.t(0.5f)))
...
004281d2        set_matrix_identity(edi_1 + self->__offset(0x5c).d)
004281e8        *(edi_1 + self->__offset(0x5c).d + 0x30) = *(&self->primary_samples->center_x + edi_1)
004281ef        *(edi_1 + self->__offset(0x5c).d + 0x34) = 0x3efae148
004281fe        *(edi_1 + self->__offset(0x5c).d + 0x38) = fconvert.s(fconvert.t(fconvert.s(x87_r7_15)))
00428209        *(edi_1 + self->__offset(0x5c).d + 0x8c) = 0x3f800000
00428210        edi_1 += 0xa8
...
004283f4        __builtin_memcpy(ebx + self->__offset(0x5c).d, ebx + self->primary_samples, 0x40)
...
0042842a        float* eax_32 = ebx + self->__offset(0x5c).d + 0x30
0042842e        ebx += 0xa8
...
004284cc        int32_t edx_30 = self->__offset(0x5c).d
004284f0        float var_38_2 = fconvert.s(fconvert.t(*(edi_4 + edx_30 + 0xdc)) - fconvert.t(*(edi_4 + edx_30 + 0x34)))
004284f7        long double x87_r7_65 = fconvert.t(*(edi_4 + edx_30 + 0xe0)) - fconvert.t(*(edi_4 + edx_30 + 0x38))
004284fe        *(edi_4 + edx_30 + 0x80) = fconvert.s(fconvert.t(*(edi_4 + edx_30 + 0xd8)) - fconvert.t(*(edi_4 + edx_30 + 0x30)))
00428500        *(edi_4 + edx_30 + 0x84) = var_38_2
0042850b        *(edi_4 + edx_30 + 0x88) = fconvert.s(x87_r7_65)
00428520        i_2 += 1
00428521        *(edi_4 + self->__offset(0x5c).d + 0x8c) = fconvert.s(normalize_vector(edi_4 + self->__offset(0x5c).d + 0x80))
0042852b        edi_4 += 0xa8
...
004285bc        int32_t* ecx_46 = self->__offset(0x5c).d + self->segment_count * 0xa8 - 0x28
004285c8        *ecx_46 = 0
004285ce        ecx_46[1] = 0
004285d1        ecx_46[2] = 0x3f800000
004285e6        *(self->__offset(0x5c).d + self->segment_count * 0xa8 - 0x1c) = 0x3f800000
004285f9        request_object_vertices(self->_pad_00[0x24].d, (self->__offset(0x54).d + 1) * (self->segment_count + 1))
0042860b        request_object_facequads(self->_pad_00[0x24].d, (self->__offset(0x54).d * self->segment_count) << 1)
00428610        void* eax_57 = self->_pad_00[0x24].d
00428613        int32_t edx_38 = *(eax_57 + 0x5c)
00428616        int32_t ebx_1 = *(eax_57 + 0x38)
00428620        int32_t i_3 = 0
00428622        int32_t var_40_1 = ebx_1
00428628        if (self->segment_count s>= 0)
0042862e        int32_t esi_4 = 0
00428630        int32_t ecx_54 = self->__offset(0x54).d
00428633        float edi_5 = 0f
00428637        arg2 = 0f
0042863b        arg3 = ecx_54
0042863f        if (ecx_54 s>= 0)
...
0042865d        float* eax_64
0042865d        float ecx_58
0042865d        if (i_3 == self->segment_count)
004286b3        void* eax_65 = primary_samples_1 + esi_4
004286c4        ebx_1 = var_40_1
00428709        float var_38_3 = fconvert.s(fconvert.t(*(eax_65 - 0x74)) + fconvert.t(fconvert.s(x87_r7_68 * fconvert.t(*(eax_65 - 0xa4)))))
00428711        long double x87_r6_32 = fconvert.t(fconvert.s(fconvert.t(*(eax_65 - 0x70)) + fconvert.t(1f))) + x87_r7_68 * fconvert.t(*(eax_65 - 0xa0))
00428713        eax_64 = ebx_1 + ((ecx_54 + 1) * i_3 i+ edi_5) * 0xc
0042871a        *eax_64 = fconvert.s(fconvert.t(*(eax_65 - 0x78)) + fconvert.t(fconvert.s(x87_r7_68 * fconvert.t(*(eax_65 - 0xa8)))))
00428724        eax_64[1] = var_38_3
00428727        ecx_58 = fconvert.s(x87_r6_32)
0042865f        float* eax_60 = primary_samples_1 + esi_4
00428687        float var_2c_3 = fconvert.s(fconvert.t(fconvert.s(x87_r7_68 * fconvert.t(eax_60[1]))) + fconvert.t(eax_60[0xd]))
00428694        float var_28_3 = fconvert.s(x87_r7_68 * fconvert.t(eax_60[2]) + fconvert.t(eax_60[0xe]))
0042869d        eax_64 = ebx_1 + ((ecx_54 + 1) * i_3 i+ edi_5) * 0xc
004286a4        *eax_64 = fconvert.s(fconvert.t(fconvert.s(x87_r7_68 * fconvert.t(*eax_60))) + fconvert.t(eax_60[0xc]))
004286aa        eax_64[1] = var_2c_3
004286ad        ecx_58 = var_28_3
0042872d        eax_64[2] = ecx_58
00428730        ecx_54 = self->__offset(0x54).d
00428733        edi_5 += 1
00428734        arg3 = ecx_54
0042873a        arg2 = edi_5
0042873e        do while (edi_5 s<= ecx_54)
00428747        i_3 += 1
00428748        esi_4 += 0xa8
...
0042876a        arg2 = 0f
0042876e        if (self->__offset(0x54).d s> 0)
00428776        int32_t eax_73 = i_4 & 0x80000007
0042877b        if (eax_73 s< 0)
00428781        eax_73 = ((eax_73 - 1) | 0xfffffff8) + 1
00428795        arg3 = fconvert.s(float.t(eax_73) * fconvert.t(0.125f))
004287a3        float var_50_1 = fconvert.s(float.t(eax_73 + 1) * fconvert.t(0.125f))
004287ae        int32_t ecx_62 = 0
...
004287e0        while (true)
004287e0        int32_t eax_80 = ecx_62 + ((self->__offset(0x54).d * i_4 + j) << 1)
004287e3        if (ecx_62 != 0)
004288a9        int16_t* ebx_4 = eax_80 * 0x30 + edx_38
004288ac        *ebx_4 = 0
004288b1        ecx_62.w = self->__offset(0x54).w
004288b5        ecx_62.w += 1
004288be        ebx_4[1] = ecx_62.w * i_4.w + j.w + 1
004288c2        int32_t eax_88
004288c2        eax_88.w = self->__offset(0x54).w
004288c6        eax_88.w += 1
004288cd        ebx_4[2] = eax_88.w * i_4.w + j.w
004288df        ebx_4[3] = (self->__offset(0x54).w + 1) * (i_4.w + 1) + j.w
004288f7        ebx_4[4] = (self->__offset(0x54).w + 1) * (i_4.w + 1) + j.w + 1
004288fb        char* texture_path_1
004288fb        char* arg5
004288fb        if (((j.b ^ i_4.b) & 1) != 0)
00428991        texture_path_1 = arg5
00428908        texture_path_1 = arg5
0042891b        *(ebx_4 + 0xc) = get_or_create_texture_ref(&data_4b7790, texture_path_1, 0, 0)
00428922        *(ebx_4 + 0x10) = var_54_1
00428925        *(ebx_4 + 0x14) = arg3
0042892a        *(ebx_4 + 0x18) = arg2
00428933        *(ebx_4 + 0x1c) = arg3
0042893a        *(ebx_4 + 0x20) = arg2
0042893d        *(ebx_4 + 0x24) = var_50_1
00428942        *(ebx_4 + 0x28) = var_54_1
00428945        *(ebx_4 + 0x2c) = var_50_1
004287f7        int16_t* ebx_3 = eax_80 * 0x30 + edx_38
004287fa        *ebx_3 = 0
004287ff        eax_80.w = self->__offset(0x54).w
00428803        eax_80.w += 1
0042880a        ebx_3[1] = eax_80.w * i_4.w + j.w
0042880e        int32_t ecx_64
0042880e        ecx_64.w = self->__offset(0x54).w
00428812        ecx_64.w += 1
0042881e        ebx_3[2] = ecx_64.w * i_4.w + j.w + 1
0042882f        ebx_3[3] = (self->__offset(0x54).w + 1) * (i_4.w + 1) + j.w + 1
00428845        ebx_3[4] = (self->__offset(0x54).w + 1) * (i_4.w + 1) + j.w
00428849        char* texture_path
00428849        if (((j.b ^ i_4.b) & 1) != 0)
00428898        texture_path = texture_b
0042884f        texture_path = texture_b
00428862        *(ebx_3 + 0xc) = get_or_create_texture_ref(&data_4b7790, texture_path, 0, 0)
00428869        *(ebx_3 + 0x10) = arg2
0042886c        *(ebx_3 + 0x14) = arg3
00428871        *(ebx_3 + 0x18) = var_54_1
0042887a        *(ebx_3 + 0x1c) = arg3
00428881        *(ebx_3 + 0x20) = var_54_1
00428884        *(ebx_3 + 0x24) = var_50_1
00428889        *(ebx_3 + 0x28) = arg2
0042888c        *(ebx_3 + 0x2c) = var_50_1
0042894d        bool cond:10_1 = var_4c_2 + 1 s< 2
00428950        var_4c_2 += 1
00428954        if (not(cond:10_1))
00428954        break
004287d2        ecx_62 = var_4c_2
0042895a        j += 1
00428963        arg2 = j
00428967        do while (j s< self->__offset(0x54).d)
00428970        i_4 += 1
