...
00428713        eax_63 = &vertices[(width_cells + 1) * i_3 i+ turns_1]
...
0042869d        eax_63 = &vertices[(width_cells + 1) * i_3 i+ turns_1]
...
00428795        width_cells_ = fconvert.s(float.t(eax_72) * fconvert.t(0.125f))
...
0042891b        *(ebx_3 + 0xc) = get_or_create_texture_ref(&g_texture_refs, texture_path_1, 0, 0)
00428922        *(ebx_3 + 0x10) = var_54_1
00428925        *(ebx_3 + 0x14) = width_cells_
0042892a        *(ebx_3 + 0x18) = turns
00428933        *(ebx_3 + 0x1c) = width_cells_
0042893a        *(ebx_3 + 0x20) = turns
...
00428862        *(ebx_2 + 0xc) = get_or_create_texture_ref(&g_texture_refs, texture_path, 0, 0)
00428869        *(ebx_2 + 0x10) = turns
0042886c        *(ebx_2 + 0x14) = width_cells_
00428871        *(ebx_2 + 0x18) = var_54_1
0042887a        *(ebx_2 + 0x1c) = width_cells_
00428881        *(ebx_2 + 0x20) = var_54_1
00428884        *(ebx_2 + 0x24) = var_50_1
00428889        *(ebx_2 + 0x28) = turns
