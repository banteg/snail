...
00441563        struct SaltStateStrideCursor* salt_state_cursor = &manager->slots[0].state
0044156c        while (salt_state_cursor->state != SALT_STATE_INACTIVE)
0044156e        eax += 1
0044156f        salt_state_cursor = &salt_state_cursor[1]
...
00441645        salt->body.bod.bod.list_flags |= 0x200
00441649        return
