...
004407b9        g_game_base->options.active = 0
004407c0        struct GameRoot* game_base_1 = g_game_base
004407cb        game_base_1->options.previous_frontend_state = game_base_1->players[0].frontend_state
...
0044083f        game_base_2->exit_controller.previous_frontend_state = game_base_2->players[0].frontend_state
00440845        struct GameRoot* game_base_3 = g_game_base
00440858        if (game_base_3->subgame.level_mode == 7)
0044085a        game_base_3->exit_controller.state = 7
00440869        if (game_base_3->subgame.selected_level_record_persistent != 1)
00440877        game_base_3->exit_controller.state = 2
0044086b        game_base_3->exit_controller.state = 3
