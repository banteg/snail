...
0043d718        float world_x = cell_1->world_x
0043d71b        float world_z = cell_1->world_z
0043d72a        float world_x_1 = world_x
0043d72e        float var_8 = fconvert.s(fconvert.t(cell_1->floor_height) + fconvert.t(0.600000024f))
0043d736        *(esi + 0x356010) = world_x
0043d73c        *(esi + 0x356014) = var_8
0043d73f        *(esi + 0x356018) = world_z
