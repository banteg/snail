...
0043d718        int32_t ecx = cell_1->__offset(0x10).d
0043d71b        int32_t edx_1 = cell_1->__offset(0x18).d
0043d72a        int32_t var_c = ecx
0043d72e        float var_8 = fconvert.s(fconvert.t(cell_1->__offset(0x14).d) + fconvert.t(0.600000024f))
0043d736        *(esi + 0x356010) = ecx
0043d73c        *(esi + 0x356014) = var_8
0043d73f        *(esi + 0x356018) = edx_1
0043d751        if (((*(esi + 0x356004)).w:1.b & 2) == 0)
0043d762        void* edx_3 = data_4df904
0043d76e        void* edx_4 = *(edx_3 + 0x5ac)
0043d776        if (edx_4 != 0)
0043d784        *(edx_4 + 8) = esi + 0x356000
0043d787        void* edx_5 = *(edx_3 + 0x5ac)
0043d78c        *(*(edx_5 + 8) + 0xc) = edx_5
0043d791        cell_1 = cell
0043d795        void* edx_7 = *(*(edx_3 + 0x5ac) + 8)
0043d798        *(edx_3 + 0x5ac) = edx_7
0043d79a        *(edx_7 + 8) = 0
0043d778        *(edx_3 + 0x5ac) = esi + 0x356000
0043d77a        *(esi + 0x356008) = edx_4
0043d77f        *(*(edx_3 + 0x5ac) + 0xc) = edx_4
0043d7a4        int32_t ecx_5
0043d7a4        ecx_5:1.b = (*(esi + 0x356004)):1.b | 2
0043d7a7        *(esi + 0x356004) = ecx_5
...
0043d7ce        int32_t ecx_7
0043d7ce        ecx_7:1.b = eax_7[1]:1.b | 8
0043d7d1        eax_7[1] = ecx_7
...
0043d810        int32_t* ecx_10 = *(esi + 0x356064) + 0x48
0043d813        *ecx_10 = *(esi + 0x356010)
0043d818        ecx_10[1] = *(esi + 0x356014)
0043d81e        ecx_10[2] = *(esi + 0x356018)
