...
0044ab15        struct tColour* entry_color = result + &g_font_queue[0].color
0044ab1c        entry_color->r = color->r
0044ab21        entry_color->g = color->g
0044ab27        entry_color->b = color->b
0044ab2a        float a = color->a
0044ab2d        g_font_queue_count = font_queue_count_1 + 1
0044ab33        entry_color->a = a
