...
0041a36e        struct TgaImageView* image = replacement->texture_ref
...
0041a390        ecx.w = image->width
0041a394        int32_t edx = 0
0041a39a        edx.w = image->height
0041a39e        source = fconvert.s(float.t(eax_1))
0041a3b4        struct Vec3* sample_cursor = source_1->vertices
...
0041a428        ecx_1.w = image->height
0041a42c        edx_1.w = image->width
0041a438        int32_t eax_6 = 0
0041a43a        eax_6.b = image->bits_per_pixel
0041a43d        int32_t edx_2 = 0
0041a442        void* ecx_6 = ((ecx_1 - eax_4 - 1) * edx_1 + eax_5) * (eax_6 u>> 3)
0041a445        edx_2.b = *(ecx_6 + image + 0x13)
0041a449        void* eax_8 = ecx_6 + image
...
0041a48c        sample_cursor = &sample_cursor[1]
0041a493        sample_cursor->__offset(0xfffffffffffffff8).d = fconvert.s(x87_r5_10 * fconvert.t(scale) + fconvert.t(base))
