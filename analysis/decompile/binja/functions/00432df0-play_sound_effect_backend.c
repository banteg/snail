...
00432e4e        play_registered_sound_sample_backend(sample_id, fconvert.s(fconvert.t(g_audio_backend_sfx_normalization_scale) * fconvert.t(gain)), pitch)
00432e53        return
00432e25        int32_t sample_id_3 = sample_id
00432e2f        play_registered_sound_sample_scaled(sample_id, fconvert.s(fconvert.t(g_audio_backend_sfx_normalization_scale) * fconvert.t(gain)))
00432e34        return
00432e68        int32_t sample_id_1 = sample_id
00432e72        play_registered_sound_sample_scaled_panned(sample_id, fconvert.s(fconvert.t(g_audio_backend_sfx_normalization_scale) * fconvert.t(gain)), -1f, pan)
00432e77        return
