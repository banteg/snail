...
0044827a        char* eax_3 = find_case_insensitive_substring("Name:'", &file_buffer)
00448284        if (eax_3 == 0)
...
004482a3        char* edx_3 = &row_count_cursor[-0x11] - eax_5 - 0x40
004482a6        *(edx_3 + eax_5) = i_1
004482a9        i_1 = *(eax_5 + 1)
004482ac        eax_5 += 1
004482b0        do while (i_1 != 0x27)
004482bf        char* eax_6 = find_case_insensitive_substring("Data:", &file_buffer)
004482c9        if (eax_6 == 0)
...
004482e6        char* data_line_cursor = advance_to_next_crlf_line(eax_7)
004482ed        void* eax_35
004482ed        if (data_line_cursor == 0)
00448877        eax_35 = &(&__saved_edi)[segment_index * 0x20 + 0x53c]
...
004483a8        char* parse_cursor_1 = find_case_insensitive_substring("3DModel=", &option_text)
004483b2        parse_cursor = parse_cursor_1
004483b6        if (parse_cursor_1 != 0)
004483ca        char* parse_cursor_2 = &find_case_insensitive_substring("=", parse_cursor_1)[1]
004483cb        parse_cursor = parse_cursor_2
004483cf        char mesh_name[0x80]
004483cf        char* mesh_name_cursor = &mesh_name
004483d6        char mesh_char = *parse_cursor_2
004483db        while (mesh_char != 0x2e)
004483dd        *mesh_name_cursor = mesh_char
004483df        mesh_name_cursor = &mesh_name_cursor[1]
004483e0        parse_cursor_2 = &parse_cursor_2[1]
004483e1        parse_cursor = parse_cursor_2
004483e5        mesh_char = *parse_cursor_2
...
00448473        char* parse_cursor_3 = find_case_insensitive_substring("Velocity=", &option_text)
0044847d        parse_cursor = parse_cursor_3
00448481        if (parse_cursor_3 != 0)
00448489        char* eax_16 = find_case_insensitive_substring("=", parse_cursor_3)
00448495        int32_t edx_13 = row_stride_anchor->row.flags | 8
0044849e        parse_cursor = &eax_16[1]
004484a2        row_stride_anchor->row.flags = edx_13
004484b1        parse_cursor = find_case_insensitive_substring("(", &eax_16[1])
...
004484ee        char* parse_cursor_4 = find_case_insensitive_substring("Parcel=", &option_text)
004484f8        parse_cursor = parse_cursor_4
004484fc        if (parse_cursor_4 != 0)
0044850d        row_stride_anchor->row.flags |= 1
00448519        parse_cursor = &find_case_insensitive_substring("=", parse_cursor_4)[1]
00448522        int32_t eax_21 = parse_next_signed_int(&parse_cursor)
00448527        char* parse_cursor_15 = parse_cursor
0044852b        row_stride_anchor->row.parcel_set_id = eax_21
00448542        parse_cursor = &find_case_insensitive_substring("(", parse_cursor_15)[1]
...
0044857e        char* parse_cursor_5 = find_case_insensitive_substring("Path=", &option_text)
00448588        parse_cursor = parse_cursor_5
0044858c        if (parse_cursor_5 != 0)
0044859c        char* parse_cursor_6 = &find_case_insensitive_substring("=", parse_cursor_5)[1]
0044859d        parse_cursor = parse_cursor_6
004485a1        char path_name[0x40]
004485a1        char* path_name_cursor = &path_name
004485a5        char path_char = *parse_cursor_6
004485aa        while (path_char s>= 0x20)
004485ac        *path_name_cursor = path_char
004485ae        path_name_cursor = &path_name_cursor[1]
004485af        parse_cursor_6 = &parse_cursor_6[1]
004485b0        parse_cursor = parse_cursor_6
004485b4        path_char = *parse_cursor_6
004485cc        *path_name_cursor = 0
004485ce        int32_t eax_25 = find_segment_path_index_by_name(&g_game_base->subgame.path_manager, &path_name)
...
0044860f        char* parse_cursor_7 = find_case_insensitive_substring("NoFall", &option_text)
00448619        parse_cursor = parse_cursor_7
0044861d        if (parse_cursor_7 != 0)
0044861f        int32_t flags_3 = row_stride_anchor->row.flags
00448625        flags_3:1.b |= 1
00448628        row_stride_anchor->row.flags = flags_3
00448638        char* parse_cursor_8 = find_case_insensitive_substring("Ring=None", &option_text)
00448642        parse_cursor = parse_cursor_8
00448646        if (parse_cursor_8 != 0)
00448648        int32_t flags_4 = row_stride_anchor->row.flags
0044864e        flags_4:1.b |= 2
00448651        row_stride_anchor->row.flags = flags_4
00448661        char* parse_cursor_9 = find_case_insensitive_substring("Ring=Normal", &option_text)
0044866b        parse_cursor = parse_cursor_9
0044866f        if (parse_cursor_9 != 0)
00448671        int32_t flags_5 = row_stride_anchor->row.flags
00448677        flags_5:1.b |= 4
0044867a        row_stride_anchor->row.flags = flags_5
0044868a        char* parse_cursor_10 = find_case_insensitive_substring("Ring=PowerUp", &option_text)
00448694        parse_cursor = parse_cursor_10
00448698        if (parse_cursor_10 != 0)
...
004486b3        char* parse_cursor_11 = find_case_insensitive_substring("Ring=Explode", &option_text)
004486bd        parse_cursor = parse_cursor_11
004486c1        if (parse_cursor_11 != 0)
004486c3        int32_t flags_7 = row_stride_anchor->row.flags
004486c9        flags_7:1.b |= 8
004486cc        row_stride_anchor->row.flags = flags_7
004486dc        char* parse_cursor_12 = find_case_insensitive_substring("Ring=Slow", &option_text)
004486e6        parse_cursor = parse_cursor_12
004486ea        if (parse_cursor_12 != 0)
...
00448705        char* parse_cursor_13 = find_case_insensitive_substring("RingSpeed=", &option_text)
0044870f        parse_cursor = parse_cursor_13
00448713        if (parse_cursor_13 == 0)
00448757        *(tracks_after_stack_probe + (flattened_row_index + 0x28) * 0x38) = 0
00448726        parse_cursor = &find_case_insensitive_substring("=", parse_cursor_13)[1]
00448742        *(tracks_after_stack_probe + (flattened_row_index + 0x28) * 0x38) = fconvert.s(parse_next_float32(&parse_cursor))
00448764        char* parse_cursor_14 = find_case_insensitive_substring("JetPack=Off", &option_text)
0044876e        parse_cursor = parse_cursor_14
00448772        if (parse_cursor_14 != 0)
...
004488d1        eax_35 = &(&__saved_edi)[segment_index_spill * 0x20 + 0x53c]
