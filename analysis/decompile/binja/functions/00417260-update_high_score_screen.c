...
0041744f        widget_flags_1 = *(edx_12 + 0x6ffae4)
...
004174c1        void* eax_20 = data_4df904
004174ce        *(eax_20 + 0x1066bec) = *(eax_20 + 0x6ffae0) + edi_1
004174da        *(data_4df904 + 0x1066be8) = 1
004174e5        *(data_4df904 + 0x1066be9) = 1
004174f1        *(data_4df904 + 0x1066bf0) = 0x12
004174fb        void* eax_22 = data_4df904
00417509        *(eax_22 + 0x74658) = *(*(eax_22 + 0x1066bec) + 0x2c)
0041750f        edx_12 = data_4df904
00417519        ebp_1 += 1
0041751d        edi_1 += 0x1fac0
00417523        screen_1 = &screen_1->mode
00417527        widget_flags_1 = *(edx_12 + 0x6ffae4)
...
004172d3        rstrcpy_checked_ascii(*(data_4df904 + 0x6ffae0) + selected_rank * 0x1fac0 + 0x54, &screen->name_row_widgets[selected_rank]->_pad_00[0x2cc])
004172f1        rstrcpy_checked_ascii(data_4df904 + 0x1a4, &screen->name_row_widgets[screen->selected_rank]->_pad_00[0x2cc])
