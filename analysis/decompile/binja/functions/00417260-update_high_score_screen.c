...
004172d3        rstrcpy_checked_ascii(&g_game_base->subgame.sub_high_score.active_record_bank[selected_rank].player_name, &high_score->name_row_widgets[selected_rank]->text_buffer.raw)
004172f1        rstrcpy_checked_ascii(&g_game_base->players[0].player_name, &high_score->name_row_widgets[high_score->selected_rank]->text_buffer.raw)
00417309        rstrcpy_checked_ascii(&g_runtime_config.last_entered_player_name, &high_score->name_row_widgets[high_score->selected_rank]->text_buffer.raw)
...
00417320        enum FrontendWidgetFlag widget_flags = submit_name_button->widget_flags
...
00417346        enum FrontendWidgetFlag widget_flags_1 = cancel_name_button->widget_flags
...
0041737d        mini_delete_high_score_entry(&g_game_base->subgame.sub_high_score, high_score->selected_rank)
...
00417391        enum FrontendWidgetFlag widget_flags_2 = bank_toggle_button->widget_flags
...
004173ca        g_runtime_config.high_score_selected_bank = high_score->selected_bank
...
004173e2        enum FrontendWidgetFlag widget_flags_3 = back_button->widget_flags
...
004173fe        if (mode == 1)
00417408        g_game_base->players[0].frontend_state = 0xa
00417417        g_game_base->players[0].redispatch_requested = 1
0041741d        destroy_high_score_screen(high_score)
00417426        return
00417429        if (mode == 0)
00417431        g_game_base->players[0].frontend_state = 4
0041743d        destroy_high_score_screen(high_score)
00417446        return
00417447        struct GameRoot* game_base_3 = g_game_base
...
004174c1        struct GameRoot* game_base_1 = g_game_base
004174ce        game_base_1->subgame.selected_level_record = game_base_1->subgame.sub_high_score.active_record_bank + edi_1
004174da        g_game_base->subgame.selected_level_record_active = 1
004174e5        g_game_base->subgame.selected_level_record_persistent = 1
004174f1        g_game_base->subgame.selected_level_record_cursor = 0x12
004174fb        struct GameRoot* game_base_2 = g_game_base
00417509        game_base_2->subgame.level_mode = game_base_2->subgame.selected_level_record->replay_mode_id
