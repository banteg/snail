...
004418ee        sub_lazer->body.transform.position.z = fconvert.s(fconvert.t(sub_lazer->velocity.z) + fconvert.t(sub_lazer->body.transform.position.z))
004418f1        long double x87_r7_9 = fconvert.t(sub_lazer->body.transform.position.y)
...
0044194e        x87_r7_11 = fconvert.t(sub_lazer->body.transform.position.y)
...
004419f7        float var_3c_1 = fconvert.s(fconvert.t(sub_lazer->velocity.z) + fconvert.t(sub_lazer->body.transform.position.z))
004419fd        eax_10 = is_point_inside_track_attachment(primary_attachment_cell->attachment_template_record, fconvert.s(fconvert.t(sub_lazer->velocity.x) + fconvert.t(sub_lazer->body.transform.position.x)), fconvert.s(fconvert.t(sub_lazer->velocity.x) * fconvert.t(1.04999995f)), primary_attachment_cell)
...
00441aa8        float var_3c_2 = fconvert.s(fconvert.t(sub_lazer->velocity.z) + fconvert.t(sub_lazer->body.transform.position.z))
00441ab2        if (is_point_inside_track_attachment(secondary_attachment_cell->attachment_template_record, fconvert.s(fconvert.t(sub_lazer->velocity.x) + fconvert.t(sub_lazer->body.transform.position.x)), fconvert.s(fconvert.t(sub_lazer->velocity.x) * fconvert.t(1.04999995f)), secondary_attachment_cell) != 0)
...
0044185e        list_next->list_prev = sub_lazer->body.bod.bod.list_prev
00441861        struct BodNode* list_prev = sub_lazer->body.bod.bod.list_prev
00441866        if (list_prev == 0)
00441873        ecx_2->first = sub_lazer->body.bod.bod.list_next
0044186b        list_prev->list_next = sub_lazer->body.bod.bod.list_next
