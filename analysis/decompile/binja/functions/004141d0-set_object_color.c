...
004141f6        if ((object->flags & OBJECT_FLAG_RENDER_BUFFERS_READY) == 0)
004141f6        return
00414200        struct ObjectVertexBuffer* vertex_buffer = object->render_buffers->vertex_buffer
0041421a        struct ObjectRenderVertex* locked_vertices
0041421a        vertex_buffer->vtbl->Lock(vertex_buffer, 0, g_object_grouped_vertex_cursor * 0x18, &locked_vertices, 0)
00414223        int32_t i = 0
00414227        if (object->grouped_vertex_count s> 0)
0041422a        int32_t render_vertex_byte_offset = 0
...
00414234        i += 1
00414235        *(&locked_vertices->diffuse + render_vertex_byte_offset) = edx_3
0041423f        render_vertex_byte_offset += 0x18
