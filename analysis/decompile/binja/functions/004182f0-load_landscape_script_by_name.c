...
00418383        return 0
004183aa        rstrcpy_checked_ascii(arg1 + *(arg1 + 0x5a0) * 0x124 + 0x5a8, arg2)
...
00418460        set_color_black(arg1 + *(arg1 + 0x5a0) * 0x124 + 0x6b4)
...
0041857e        sprintf(arg1 + eax_21 * 0x124 + 0x62d, "Backgrounds/%s.tga")
...
00418625        rstrcpy_checked_ascii(&texture_path_1, arg1 + *(arg1 + 0x5a0) * 0x124 + 0x62d)
00418643        char texture_path
00418643        rstrcpy_checked_ascii(&texture_path, arg1 + *(arg1 + 0x5a0) * 0x124 + 0x62d)
00418655        char* eax_37 = &texture_path_1
...
0041868a        char* eax_38 = &texture_path
0041868e        if (not(cond:2_1))
00418690        eax_38 = &eax_38[1]
00418694        do while (*eax_38 != 0x2e)
00418696        __builtin_strncpy(eax_38, "_B.tga", 7)
004186d4        register_sprite_texture(&texture_path_1, *(arg1 + *(arg1 + 0x5a0) * 0x124 + 0x628), 0x400)
004186fd        register_sprite_texture(&texture_path, *(arg1 + *(arg1 + 0x5a0) * 0x124 + 0x628) + 1, 0x400)
...
004187a5        (*ecx_24)[2] = 0
004187c0        *(arg1 + *(arg1 + 0x5a0) * 0x124 + 0x6b0) = load_or_reuse_cached_x_mesh(&game_base_1->directx_loader, &mesh_name)
...
00418836        *(arg1 + *(arg1 + 0x5a0) * 0x124 + 0x6c4) = fconvert.s(parse_next_float32(&cursor))
