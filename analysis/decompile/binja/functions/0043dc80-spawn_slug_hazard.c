...
0043dce9        long double x87_r7_1 = fconvert.t(cell->__offset(0x14).d) + fconvert.t(1.70000005f)
0043dcef        int32_t edx_1 = cell->__offset(0x10).d
0043dcf2        int32_t eax_2 = cell->__offset(0x18).d
0043dcf9        *(esi + 0x356408) = edx_1
0043dcfb        int32_t var_c = edx_1
0043dd0b        *(esi + 0x35640c) = fconvert.s(x87_r7_1)
0043dd16        *(esi + 0x356410) = eax_2
...
0043dd61        void* edx_6 = data_4df904 + 0x5a8
0043dd71        if ((*(esi + 0x3563a5) & 2) == 0)
0043dd82        *(esi + 0x3563ac) = &game->__offset(0x3bb764).d
0043dd88        if (*(edx_6 + 4) != &game->__offset(0x3bb764).d)
...
0043ddc7        int32_t* eax_8 = allocate_sprite(&data_790f30, player->__offset(0x380).d, 0x76, 0xffffffff, 0xffffffff)
0043ddcc        *(esi + 0x35644c) = eax_8
0043ddd5        int32_t ecx_11
0043ddd5        ecx_11:1.b = eax_8[1]:1.b | 8
0043ddd8        eax_8[1] = ecx_11
...
0043de26        int32_t* eax_11 = *(esi + 0x35644c) + 0x48
0043de29        *eax_11 = *(esi + 0x356408)
0043de2e        eax_11[1] = *(esi + 0x35640c)
0043de34        eax_11[2] = *(esi + 0x356410)
...
0043de76        int32_t eax_13
0043de76        eax_13:1.b = (*(esi + 0x3563a4)):1.b & 0xef
0043de79        *(esi + 0x3563a4) = eax_13
0043de7f        *(esi + 0x356478) = 0
0043de85        *(esi + 0x356479) = 0
0043de8b        *(esi + 0x35647c) = 0
0043de91        *(esi + 0x356480) = 0x3d088889
0043de9b        long double x87_r6_3 = fconvert.t(cell->__offset(0x18).d)
0043de9e        long double temp1 = fconvert.t(game->__offset(0x1270fcc).d)
0043de9e        x87_r6_3 - temp1
0043dea4        eax_13.w = (x87_r6_3 < temp1 ? 1 : 0) << 8 | (is_unordered.t(x87_r6_3, temp1) ? 1 : 0) << 0xa | (x87_r6_3 == temp1 ? 1 : 0) << 0xe | 0x3800
0043dea9        if ((eax_13:1.b & 0x41) == 0)
