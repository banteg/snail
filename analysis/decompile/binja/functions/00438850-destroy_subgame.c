...
00438a34        *(ecx_11 + 4) = (esi_3 - 0x35908c)->__offset(0x35908c).d
00438a2d        *(eax_17 + 0xc) = (esi_3 - 0x35908c)->__offset(0x35908c).d
00438a3d        (esi_3 - 0x35908c)->__offset(0x35908c).d = *(ecx_11 + 8)
00438a3f        *(ecx_11 + 8) = esi_3 - 0xc
...
00438aa0        *(ecx_14 + 8) = game->__offset(0xff7bcc).d
00438aa3        void* ecx_15 = game->__offset(0xff7bcc).d
00438aa8        if (ecx_15 == 0)
00438ab5        *(edx_10 + 4) = game->__offset(0xff7bd0).d
00438aad        *(ecx_15 + 0xc) = game->__offset(0xff7bd0).d
00438abb        game->__offset(0xff7bd0).d = *(edx_10 + 8)
00438abe        *(edx_10 + 8) = &game->__offset(0xff7bc4).d
