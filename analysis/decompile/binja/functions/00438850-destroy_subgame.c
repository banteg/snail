...
004388d4        struct BodNode** esi_1 = &game->sub_lazers.slots[0].body.bod.bod.list_next
...
00438918        struct BodNode* list_next = (esi_1 - 0x356b0c)->sub_lazers.slots[0].body.bod.bod.list_next
0043891c        if (list_next != 0)
00438921        list_next->list_prev = (esi_1 - 0x356b0c)->sub_lazers.slots[0].body.bod.bod.list_prev
00438924        struct BodNode* list_prev = (esi_1 - 0x356b0c)->sub_lazers.slots[0].body.bod.bod.list_prev
00438929        if (list_prev == 0)
00438934        ecx_7->first = (esi_1 - 0x356b0c)->sub_lazers.slots[0].body.bod.bod.list_next
0043892d        list_prev->list_next = (esi_1 - 0x356b0c)->sub_lazers.slots[0].body.bod.bod.list_next
...
00438954        struct BodNode** esi_2 = &game->salt_hazards.slots[0].body.bod.bod.list_next
...
00438998        struct BodNode* list_next_1 = (esi_2 - 0x3578cc)->salt_hazards.slots[0].body.bod.bod.list_next
0043899c        if (list_next_1 != 0)
004389a1        list_next_1->list_prev = (esi_2 - 0x3578cc)->salt_hazards.slots[0].body.bod.bod.list_prev
004389a4        struct BodNode* list_prev_1 = (esi_2 - 0x3578cc)->salt_hazards.slots[0].body.bod.bod.list_prev
004389a9        if (list_prev_1 == 0)
004389b4        ecx_9->first = (esi_2 - 0x3578cc)->salt_hazards.slots[0].body.bod.bod.list_next
004389ad        list_prev_1->list_next = (esi_2 - 0x3578cc)->salt_hazards.slots[0].body.bod.bod.list_next
...
00438a34        ecx_11->first = (esi_3 - 0x35908c)->banners.slots[0].bod.bod.list_next
...
00438abb        game->barrier.bod.bod.list_next = edx_17->free_top
00438abe        edx_17->free_top = &game->barrier
...
00438b66        struct FrontendWidget** life_stock_widget_cursor = &game->life_stock_widgets
00438b6c        int32_t i_7 = 9
00438b89        int32_t i_3
00438b80        kill_border(&g_game_base->border_manager, *life_stock_widget_cursor)
00438b85        life_stock_widget_cursor = &life_stock_widget_cursor[1]
00438b88        i_3 = i_7
00438b88        i_7 -= 1
