...
0044aa2c        struct tColour* entry_color = result + &g_font_queue[0].color
0044aa33        entry_color->r = color->r
0044aa38        entry_color->g = color->g
0044aa3e        entry_color->b = color->b
0044aa41        float a = color->a
0044aa45        g_font_queue_count = font_queue_count_1 + 1
0044aa4b        entry_color->a = a
