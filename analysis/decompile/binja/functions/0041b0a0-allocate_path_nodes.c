...
0041b0db        struct PathTemplateSample* result = allocate_tracked_memory(segment_count * 0xa8, "Path Ball nodes")
0041b0e3        self->secondary_samples = result
0041b0e7        return result
