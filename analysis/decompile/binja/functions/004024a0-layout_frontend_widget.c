...
00402590        slider_value_widget->texture_hit_x = (ebx_1 - 0x238)->layout_left
...
00402654        long double x87_r7_16 = fconvert.t(slider_value_widget->texture_hit_x) - fconvert.t((ebx_1 - 0x238)->layout_left)
...
00402685        slider_value_widget->layout_anchor_y = fconvert.s(fconvert.t(slider_value_widget->texture_hit_y) - fconvert.t((edi_1 - 0x23c)->layout_top) + fconvert.t(slider_value_widget->layout_anchor_y))
