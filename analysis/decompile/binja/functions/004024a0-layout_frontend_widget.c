...
004024b6        while (true)
004024b6        enum FrontendWidgetFlag eax_4 = slider_value_widget->widget_flags
004024bf        float* out_x
004024bf        float* out_y
004024bf        if ((eax_4:1.b & 8) != 0)
004024c7        float layout_top = slider_value_widget->layout_top
004024cd        out_x = &slider_value_widget->layout_left
...
004024fa        out_x = &slider_value_widget->layout_left
00402500        out_y = &slider_value_widget->layout_top
00402506        slider_value_widget->layout_width = slider_value_widget->authored_width
0040250c        (out_x - 0x238)->layout_left = authored_left
0040250e        eax_4 = slider_value_widget->authored_height
00402511        (out_y - 0x23c)->layout_top = authored_top
00402513        slider_value_widget->layout_height = eax_4
0040258e        float layout_top_1 = (out_y - 0x23c)->layout_top
00402590        slider_value_widget->texture_hit_x = (out_x - 0x238)->layout_left
00402596        enum FrontendWidgetFlag widget_flags = slider_value_widget->widget_flags
004025a2        slider_value_widget->texture_hit_y = layout_top_1
004025a8        int32_t eax_12
004025a8        if ((widget_flags & 0x20000000) == 0)
004025b6        long double x87_r7_3 = fconvert.t((out_x - 0x238)->layout_left) + fconvert.t(slider_value_widget->hot_padding) + fconvert.t(slider_value_widget->layout_width)
004025bc        long double temp0_1 = fconvert.t(640f)
004025bc        x87_r7_3 - temp0_1
004025c7        if ((((x87_r7_3 < temp0_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_3, temp0_1) ? 1 : 0) << 0xa | (x87_r7_3 == temp0_1 ? 1 : 0) << 0xe):1.b & 0x41) != 0)
004025e5        long double x87_r7_8 = fconvert.t((out_x - 0x238)->layout_left) - fconvert.t(slider_value_widget->hot_padding)
004025eb        long double temp1_1 = fconvert.t(0f)
004025eb        x87_r7_8 - temp1_1
004025f6        if ((((x87_r7_8 < temp1_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_8, temp1_1) ? 1 : 0) << 0xa | (x87_r7_8 == temp1_1 ? 1 : 0) << 0xe):1.b & 1) != 0)
004025fe        slider_value_widget->texture_hit_x = slider_value_widget->hot_padding
004025db        slider_value_widget->texture_hit_x = fconvert.s(fconvert.t(640f) - fconvert.t(slider_value_widget->hot_padding) - fconvert.t(slider_value_widget->layout_width))
0040260a        long double x87_r7_10 = fconvert.t(slider_value_widget->hot_padding) + fconvert.t((out_y - 0x23c)->layout_top)
0040260c        long double temp2_1 = fconvert.t(480f)
0040260c        x87_r7_10 - temp2_1
00402617        if ((((x87_r7_10 < temp2_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_10, temp2_1) ? 1 : 0) << 0xa | (x87_r7_10 == temp2_1 ? 1 : 0) << 0xe):1.b & 0x41) != 0)
0040262f        long double x87_r7_14 = fconvert.t((out_y - 0x23c)->layout_top) - fconvert.t(slider_value_widget->hot_padding)
00402635        long double temp3_1 = fconvert.t(0f)
00402635        x87_r7_14 - temp3_1
00402640        if ((((x87_r7_14 < temp3_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_14, temp3_1) ? 1 : 0) << 0xa | (x87_r7_14 == temp3_1 ? 1 : 0) << 0xe):1.b & 1) != 0)
...
0040268b        long double x87_r7_21 = fconvert.t(slider_value_widget->texture_hit_x)
00402691        (out_x - 0x238)->layout_left = fconvert.s(x87_r7_21)
00402693        long double x87_r6_3 = fconvert.t(slider_value_widget->texture_hit_y)
0040269d        (out_y - 0x23c)->layout_top = fconvert.s(x87_r6_3)
0040269f        if (eax_12 != 0)
...
00402713        if ((widget_flags & 0x20000000) != 0 || eax_12 == 0)
00402784        return
00402727        slider_value_widget->slider_more_widget->layout_top = fconvert.s(fconvert.t(slider_value_widget->texture_hit_y) + fconvert.t(33f))
00402733        layout_frontend_widget(slider_value_widget->slider_more_widget)
0040274a        slider_value_widget->slider_less_widget->layout_top = fconvert.s(fconvert.t(slider_value_widget->texture_hit_y) + fconvert.t(33f))
00402756        layout_frontend_widget(slider_value_widget->slider_less_widget)
0040276d        slider_value_widget->slider_value_widget->layout_anchor_y = fconvert.s(fconvert.t(slider_value_widget->texture_hit_y) + fconvert.t(49f))
