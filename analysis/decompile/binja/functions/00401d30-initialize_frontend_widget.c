...
00402336        widget->slider_less_widget = allocate_border(data_4df904 + 0xb4c)
...
00402377        initialize_frontend_sprite_button(widget->slider_less_widget, (widget->widget_flags & 0x800000) | 0x20400814, 0x2a, fconvert.s(fconvert.t(*(data_4df904 + 0x440fc)) + fconvert.t(458f)), var_104_1, eax_30, 0f, 4)
00402389        border_sprite_extend(widget->slider_less_widget, 0x2c, 0x2b, 0x2d, 1)
0040239a        void* eax_32 = allocate_border(data_4df904 + 0xb4c)
004023ba        widget->_pad_6f8[0x1c] = eax_32.b
004023ba        widget->_pad_6f8[0x1d] = eax_32:1.b
004023ba        widget->_pad_6f8[0x1e] = eax_32:2.b
004023ba        widget->_pad_6f8[0x1f] = eax_32:3.b
...
004023f7        initialize_frontend_sprite_button(widget->_pad_6f8[0x1c].d, (widget->widget_flags & 0x800000) | 0x20400814, 0x26, fconvert.s(fconvert.t(*(data_4df904 + 0x440fc)) + fconvert.t(118f)), var_104_1, eax_33, 0f, 4)
00402409        border_sprite_extend(widget->_pad_6f8[0x1c].d, 0x28, 0x27, 0x29, 0)
0040243a        widget->slider_more_widget = allocate_border(data_4df904 + 0xb4c)
...
00402469        initialize_frontend_widget(widget->slider_more_widget, &__dos_header, "00%", 0x15, 0f, fconvert.s(fconvert.t(widget->layout_anchor_y) + fconvert.t(40f)), color_14, 2, 0f)
