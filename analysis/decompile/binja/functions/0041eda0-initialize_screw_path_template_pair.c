...
0041f4f3        eax_65 = &vertices[(width_cells + 1) * i_2 + curve_source_1]
...
0041f47c        eax_65 = &vertices[(width_cells + 1) * i_2 + curve_source_1]
...
0041f576        width_cells_ = fconvert.s(float.t(eax_74) * fconvert.t(0.125f))
...
0041f5bf        while (true)
0041f5c9        int32_t edx_39 = (ecx_68 + ((self->width_cells * i_3 + j) << 1)) * 0x30
0041f5ce        int16_t* edi_6 = edx_39 + facequads
0041f5d1        *edi_6 = 0
0041f5d6        if (ecx_68 != 0)
0041f67c        edx_39.w = self->width_cells.w
0041f682        edx_39.w += 1
0041f68d        edi_6[1] = edx_39.w * i_3.w + j.w + 1
0041f691        ecx_68.w = self->width_cells.w
0041f695        ecx_68.w += 1
0041f69f        edi_6[2] = ecx_68.w * i_3.w + j.w
0041f6ae        edi_6[3] = (self->width_cells.w + 1) * (i_3.w + 1) + j.w
0041f6c5        edi_6[4] = (self->width_cells.w + 1) * (i_3.w + 1) + j.w + 1
0041f6c9        char* texture_path_1
0041f6c9        if (((j.b ^ i_3.b) & 1) != 0)
0041f759        texture_path_1 = texture_b
0041f6d3        texture_path_1 = texture_b
0041f6e6        *(edi_6 + 0xc) = get_or_create_texture_ref(&g_texture_refs, texture_path_1, 0, 0)
0041f6ed        *(edi_6 + 0x10) = var_50_1
0041f6f0        *(edi_6 + 0x14) = width_cells_
0041f6f5        *(edi_6 + 0x18) = curve_source
0041f6fe        *(edi_6 + 0x1c) = width_cells_
0041f705        *(edi_6 + 0x20) = curve_source
0041f708        *(edi_6 + 0x24) = var_4c_2
0041f70d        *(edi_6 + 0x28) = var_50_1
0041f710        *(edi_6 + 0x2c) = var_4c_2
0041f5dc        ecx_68.w = self->width_cells.w
0041f5e2        ecx_68.w += 1
0041f5eb        edi_6[1] = ecx_68.w * i_3.w + j.w
0041f5ef        edx_39.w = self->width_cells.w
0041f5f3        edx_39.w += 1
0041f5fc        edi_6[2] = edx_39.w * i_3.w + j.w + 1
0041f610        edi_6[3] = (self->width_cells.w + 1) * (i_3.w + 1) + j.w + 1
0041f626        edi_6[4] = (self->width_cells.w + 1) * (i_3.w + 1) + j.w
0041f62a        char* texture_path
0041f62a        if (((j.b ^ i_3.b) & 1) != 0)
0041f679        texture_path = texture_a
0041f630        texture_path = texture_a
0041f643        *(edi_6 + 0xc) = get_or_create_texture_ref(&g_texture_refs, texture_path, 0, 0)
0041f64a        *(edi_6 + 0x10) = curve_source
0041f64d        *(edi_6 + 0x14) = width_cells_
0041f652        *(edi_6 + 0x18) = var_50_1
0041f65b        *(edi_6 + 0x1c) = width_cells_
0041f662        *(edi_6 + 0x20) = var_50_1
0041f665        *(edi_6 + 0x24) = var_4c_2
0041f66a        *(edi_6 + 0x28) = curve_source
0041f66d        *(edi_6 + 0x2c) = var_4c_2
