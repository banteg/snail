...
0040505d        add_subgoldy_score(data_4df904 + 0x42fd7c, SUBGOLDY_SCORE_PARCEL_DELIVER, 0)
...
00405098        add_subgoldy_score(data_4df904 + 0x42fd7c, SUBGOLDY_SCORE_BONUS, controller->bonus_score)
