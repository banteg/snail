...
004431da        struct cRSubGame* owner_subgame_3 = parcel->owner_subgame
...
00443257        struct Sprite* sprite_7 = parcel->sprite
00443277        sprite_7->position.y = fconvert.s(sine(fconvert.s(fconvert.t(parcel->bob_phase) * fconvert.t(6.28318548f))) * fconvert.t(0.300000012f) + fconvert.t(sprite_7->position.y))
...
00443299        struct Sprite* sprite_6 = parcel->sprite
004432a6        sprite_6->facing_angle = fconvert.s(fconvert.t(owner_player->follow_state.orientation_b) + fconvert.t(sprite_6->facing_angle))
004432b8        case PARCEL_STATE_COLLECT_PENDING
004432b8        struct cRSubGame* owner_subgame_4 = owner_subgame_3
...
004432c7        struct cRSubGame* owner_subgame = parcel->owner_subgame
...
00443317        vector = struct Vec3 {
    .x = fconvert.s(fconvert.t(owner_subgame->player.presentation.snail_hotspots_world[0xb].x) - fconvert.t(parcel->position.x))
    .y = fconvert.s(fconvert.t(owner_subgame->player.presentation.snail_hotspots_world[0xb].y) - fconvert.t(parcel->position.y))
    .z = fconvert.s(fconvert.t(owner_subgame->player.presentation.snail_hotspots_world[0xb].z) - fconvert.t(parcel->position.z))
}
0044331b        long double st0_3 = vector_magnitude(&vector)
00443320        struct cRSubGame* owner_subgame_1 = parcel->owner_subgame
00443323        parcel->state = PARCEL_STATE_COLLECTING
0044332a        parcel->target_distance = fconvert.s(st0_3)
0044334a        float var_14_2 = fconvert.s(fconvert.t(parcel->position.y) - fconvert.t(owner_subgame_1->player.presentation.snail_hotspots_world[0xb].y))
00443351        long double x87_r7_31 = fconvert.t(parcel->position.z) - fconvert.t(owner_subgame_1->player.presentation.snail_hotspots_world[0xb].z)
...
00443362        parcel->travel_dir.y = var_14_2
00443369        parcel->travel_dir.z = var_10_2
...
004433b8        float var_14_3 = fconvert.s(fconvert.t(fconvert.s(x87_r6_2 * fconvert.t(parcel->travel_dir.y))) + fconvert.t(eax_13->y))
004433bc        long double x87_r6_4 = x87_r6_2 * fconvert.t(parcel->travel_dir.z) + fconvert.t(eax_13->z)
004433c3        parcel->position.x = fconvert.s(fconvert.t(fconvert.s(x87_r6_2 * fconvert.t(parcel->travel_dir.x))) + fconvert.t(eax_13->x))
004433c5        parcel->position.y = var_14_3
004433c8        struct Sprite* sprite = parcel->sprite
004433d9        parcel->position.z = fconvert.s(x87_r6_4)
004433e2        sprite->size_end = fconvert.s(x87_r7_35 * fconvert.t(0.600000024f) + fconvert.t(0.400000006f))
004433e5        struct Sprite* sprite_1 = parcel->sprite
004433e8        float size_end = sprite_1->size_end
004433eb        sprite_1->size_start = size_end
...
0044340c        struct Vec3* eax_16 = &parcel->owner_subgame->player.presentation.body.transform.basis_up
00443458        parcel->sprite->position.x.12 = struct Vec3 {
    .x = fconvert.s(fconvert.t(fconvert.s(x87_r7_41 * fconvert.t(eax_16->x))) + fconvert.t(parcel->position.x))
    .y = fconvert.s(fconvert.t(fconvert.s(x87_r7_41 * fconvert.t(eax_16->y))) + fconvert.t(parcel->position.y))
    .z = fconvert.s(x87_r7_41 * fconvert.t(eax_16->z) + fconvert.t(parcel->position.z))
}
...
00443475        struct Sprite* sprite_3 = parcel->sprite
00443478        parcel->state = PARCEL_STATE_INACTIVE
0044347b        kill_sprite(sprite_3)
...
004434b7        int32_t eax_21 = next_math_random_value()
004434c0        parcel->delivery_offset.z = 0f
004434dc        parcel->delivery_offset.y = fconvert.s((float.t(eax_21) - fconvert.t(16384f)) * fconvert.t(9.15527344e-05f) + fconvert.t(1f))
004434e2        label_4434e2:
004434e2        struct cRSubGame* owner_subgame_2 = parcel->owner_subgame
00443505        float var_14_5 = fconvert.s(fconvert.t(owner_subgame_2->completion.widget_world.y) - fconvert.t(owner_subgame_2->player.presentation.snail_hotspots_world[0xb].y))
0044350f        long double x87_r7_58 = fconvert.t(owner_subgame_2->completion.widget_world.z) - fconvert.t(owner_subgame_2->player.presentation.snail_hotspots_world[0xb].z)
...
0044351d        struct Sprite* sprite_4 = parcel->sprite
00443520        vector.y = var_14_5
0044352f        long double x87_r7_60 = fconvert.t(parcel->progress) * fconvert.t(0.600000024f)
00443535        vector.z = fconvert.s(x87_r7_58)
0044353f        sprite_4->size_end = fconvert.s(x87_r7_60 + fconvert.t(0.400000006f))
00443542        struct Sprite* sprite_2 = parcel->sprite
00443548        sprite_2->size_start = sprite_2->size_end
0044354e        long double x87_r7_62 = fconvert.t(parcel->progress)
00443557        struct Vec3* eax_24 = &parcel->owner_subgame->player.presentation.snail_hotspots_world[0xb]
00443583        float var_14_6 = fconvert.s(fconvert.t(fconvert.s(fconvert.t(vector.y) * x87_r7_62)) + fconvert.t(eax_24->y))
00443591        float* eax_26 = &parcel->sprite->position
00443594        float var_10_6 = fconvert.s(x87_r7_62 * fconvert.t(vector.z) + fconvert.t(eax_24->z))
00443598        *eax_26 = fconvert.s(fconvert.t(fconvert.s(fconvert.t(vector.x) * x87_r7_62)) + fconvert.t(eax_24->x))
0044359e        float var_38_5 = var_10_6
0044359f        *&eax_26[1] = var_14_6
004435a2        *&eax_26[2] = var_10_6
004435b1        long double st0_6 = sine(fconvert.s(fconvert.t(parcel->progress) * fconvert.t(3.14159274f)))
004435c4        struct Vec3* eax_28 = &parcel->sprite->position
...
004435e3        eax_28->x = fconvert.s(fconvert.t(fconvert.s(st0_6 * fconvert.t(parcel->delivery_offset.x))) + fconvert.t(eax_28->x))
004435ec        eax_28->y = fconvert.s(fconvert.t(var_8_4) + fconvert.t(eax_28->y))
004435f2        eax_28->z = fconvert.s(x87_r7_68 + fconvert.t(eax_28->z))
...
00443619        struct Sprite* sprite_5 = parcel->sprite
0044361c        parcel->state = PARCEL_STATE_INACTIVE
0044361f        kill_sprite(sprite_5)
