...
004332bb        int32_t* eax_9 = &arg1[esi_1 * 0x4b + 0x24]
004332c4        __builtin_memset(&var_28, 0, 0x28)
004332cc        arg1->__offset(0xa7ec).d = fconvert.s(float.t(var_40) * fconvert.t(24f))
004332de        int32_t i_3 = 5
004332ef        int32_t i
004332e9        *eax_9 = arg1->__offset(0xa7ec).d
...
0043330d        int32_t* eax_10 = arg1->__offset(0x54).d
00433310        void* edx_7 = *(eax_10 + ebp_1)
00433315        if (edx_7 != 0)
00433319        int32_t var_60_1 = 0
00433349        int32_t var_18
00433349        int32_t var_4
00433349        sub_433960(arg1, var_4c, *(edx_7 + 0x24), edi_1 + eax_10 + 0x3bfad8, arg1->__offset(0x3c).d, &var_18, arg1->__offset(0x50).d, &var_4, arg1->__offset(0x14).d, (arg1->__offset(0x28).d).b, arg1->b.d)
00433373        **(arg1[esi_1 * 0x4b + 0x5b].b.d + 0xd0) = *(*(*(*(arg1->__offset(0x54).d + ebp_1) + 0x24) + 0x5c) + 0xc)
00433378        *(arg1->__offset(0x54).d + ebp_1) = 0
00433383        ebp_1 += 4
00433386        cond:2_1 = var_44_1 != 1
00433387        var_44_1 -= 1
0043338b        do while (cond:2_1)
0043338d        int32_t edx_12 = arg1->__offset(0x54).d
...
0043341d        int32_t edx_17 = arg1->__offset(0x54).d
...
0043351b        sub_433960(arg1, var_4c, *(eax_26 + 0x3bfaec), eax_26 + 0x3bfad8, arg1->__offset(0x2c).d, &var_28, arg1->__offset(0x40).d, &var_14, arg1->__offset(0x4).d, (arg1->__offset(0x18).d).b, var_64_3)
0043352a        ecx_23 = *(*(edi_1 + arg1->__offset(0x54).d + 0x3bfaec) + 0x5c)
00433536        eax_24 = arg1[esi_1 * 0x4b + 0x1f].b.d
0043353a        goto label_4335d0
0043347e        label_43347e:
0043347e        int32_t var_24
0043347e        int32_t var_10
0043347e        sub_433960(arg1, var_4c, *(eax_26 + 0x3bfaec), eax_26 + 0x3bfad8, arg1->__offset(0x30).d, &var_24, arg1->__offset(0x44).d, &var_10, arg1->__offset(0x8).d, (arg1->__offset(0x1c).d).b, var_64_3)
0043348d        ecx_23 = *(*(edi_1 + arg1->__offset(0x54).d + 0x3bfaec) + 0x5c)
00433499        eax_24 = arg1[esi_1 * 0x4b + 0x2e].b.d
004334a0        goto label_4335d0
004334af        char eax_31 = is_floor_cache_tile_family(edi_1 + arg1->__offset(0x54).d + 0x3bfac8)
004334b6        int32_t ebp_3
004334b6        if (eax_31 != 0)
004334bf        eax_26 = arg1->__offset(0x54).d + edi_1
...
00433550        if (is_ramp_cache_tile_family(edi_1 + arg1->__offset(0x54).d + 0x3bfac8) != 0)
00433559        void* eax_39 = arg1->__offset(0x54).d + edi_1
0043356d        if ((*(eax_39 + 0x3bfb08) & 0x4000) == 0x4000)
00433576        int32_t var_60_5 = 0
004335a5        int32_t var_1c
004335a5        int32_t var_8
004335a5        sub_433960(arg1, var_4c, *(eax_39 + 0x3bfaec), eax_39 + 0x3bfad8, arg1->__offset(0x38).d, &var_1c, arg1->__offset(0x4c).d, &var_8, arg1->__offset(0x10).d, (arg1->__offset(0x24).d).b, var_48)
004335ba        ecx_23 = *(*(edi_1 + arg1->__offset(0x54).d + 0x3bfaec) + 0x5c)
004335c0        eax_24 = arg1[esi_1 * 0x4b + 0x4c].b.d
004335c0        goto label_4335d0
004333b4        int32_t var_60_2 = 1
004333e3        int32_t var_20
004333e3        int32_t var_c
004333e3        sub_433960(arg1, var_4c, *(eax_19 + 0x3bfaec), eax_19 + 0x3bfad8, arg1->__offset(0x34).d, &var_20, arg1->__offset(0x48).d, &var_c, arg1->__offset(0xc).d, (arg1->__offset(0x20).d).b, var_48)
004333f2        ecx_23 = *(*(edi_1 + arg1->__offset(0x54).d + 0x3bfaec) + 0x5c)
004333fe        eax_24 = arg1[esi_1 * 0x4b + 0x3d].b.d
004335d0        label_4335d0:
004335d0        **(eax_24 + 0xd0) = *(ecx_23 + 0xc)
004335d2        int32_t ecx_49 = arg1->__offset(0x54).d
...
00433614        if (temp1_1 == 0x17 || var_4c == *(arg1->__offset(0x54).d + 0x54) - 1)
0043361d        void* __offset(ColorBGRA8, 0x4) edi_2 = &arg1[1]
00433620        void* __offset(ColorBGRA8, 0x4) var_44_2 = edi_2
00433624        int32_t var_3c_2 = 0
00433632        int32_t* ebp_4 = &arg1[esi_1 * 0x4b + 0x1f]
00433646        while (true)
0043364e        int32_t* eax_52 = *(*(*ebp_4 + 0xc0) + 8)
0043365d        int32_t var_34
0043365d        (*(*eax_52 + 0x2c))(eax_52, 0, (edi_2 - 4)->__offset(0x4).d * 0x18, &var_34, 0)
00433673        int32_t* eax_54 = **(*ebp_4 + 0xc8)
0043367d        int32_t var_30
0043367d        (*(*eax_54 + 0x2c))(eax_54, 0, (edi_2 - 4)->__offset(0x18).d << 1, &var_30, 0)
0043368c        int32_t ecx_58 = (edi_2 - 4)->__offset(0x4).d * 0x18
00433694        int32_t esi_4
00433694        int32_t edi_4
00433694        edi_4, esi_4 = __builtin_memcpy(var_34, (edi_2 - 4)->__offset(0x2c).d, ecx_58 u>> 2 << 2)
0043369f        __builtin_memcpy(edi_4, esi_4, ecx_58 & 3)
004336ab        int32_t ecx_63 = (var_44_2 - 4)->__offset(0x18).d << 1
004336b2        int32_t esi_6
004336b2        int32_t edi_6
004336b2        edi_6, esi_6 = __builtin_memcpy(var_30, (var_44_2 - 4)->__offset(0x40).d, ecx_63 u>> 2 << 2)
