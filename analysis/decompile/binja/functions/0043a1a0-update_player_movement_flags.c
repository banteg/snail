...
0043a1a3        uint32_t movement_flag_selector = player->movement_flag_selector
0043a1a9        player->movement_flags = 0
0043a1b6        if (movement_flag_selector u> 8)
0043a288        player->movement_flags = 0x81
0043a292        player->movement_rate_scalar = 0.0666666701f
0043a1bc        switch (movement_flag_selector)
0043a1c3        case 0
0043a1c3        player->movement_flags = 1
0043a1cd        player->movement_rate_scalar = 0.0740740746f
0043a1dc        case 1
0043a1dc        player->movement_flags = 2
0043a1e6        player->movement_rate_scalar = 0.0740740746f
0043a1f5        case 2
0043a1f5        player->movement_flags = 4
0043a1ff        player->movement_rate_scalar = 0.0740740746f
0043a20e        case 3
0043a20e        player->movement_flags = 8
0043a218        player->movement_rate_scalar = 0.111111104f
0043a224        case 4
0043a224        player->movement_flags = 0x10
0043a22e        player->movement_rate_scalar = 0.111111104f
0043a23a        case 5
0043a23a        player->movement_flags = 0x20
0043a292        player->movement_rate_scalar = 0.0666666701f
0043a246        case 6
0043a246        player->movement_flags = 0x40
0043a250        player->movement_rate_scalar = 0.13333334f
0043a25c        case 7
0043a25c        player->movement_flags = 0xc0
0043a266        player->movement_rate_scalar = 0.13333334f
0043a272        case 8
0043a272        player->movement_flags = 0x90
0043a27c        player->movement_rate_scalar = 0.111111104f
...
0043a2b3        set_snail_weapon(&player->__offset(0x2984).d, movement_flags)
