...
00432d7b        char* bytes = load_file_bytes_from_archive_or_fs(path_1, g_music_memory_buffer, &path)
00432d8e        if (path s>= 0x64000)
00432d95        report_errorf("Music buffer overflow Increase RSHELL_MUSIC_MEMORY_BUFFER_SIZE")
00432db2        return play_music_stream_from_bytes(&g_audio_backend, path_1, bytes, path, 1)
