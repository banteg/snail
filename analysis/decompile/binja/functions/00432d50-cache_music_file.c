...
00432dbf        return ensure_music_stream_from_path(0x753c58, path, 1)
00432d5a        char* path_1 = path
00432d64        char result = prepare_music_stream_reload_if_path_changed(0x753c58, path_1)
...
00432db2        return play_music_stream_from_bytes(0x753c58, path_1, eax, path, 1)
