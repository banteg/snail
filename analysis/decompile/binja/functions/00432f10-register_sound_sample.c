...
00432f6c        load_registered_sound_sample_from_path(&g_audio_backend, path_1, g_registered_sound_sample_count, normalization_class)
00432f20        path_1 = path
00432f2b        load_file_bytes_from_archive_or_fs(path_1, g_music_memory_buffer, &path)
00432f4f        load_registered_sound_sample_from_bytes(&g_audio_backend, g_music_memory_buffer, path, g_registered_sound_sample_count, normalization_class)
