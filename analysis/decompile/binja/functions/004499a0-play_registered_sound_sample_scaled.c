...
004499eb        volume = ftol(x87control, fconvert.t(1f) * fconvert.t(100f))
00449a01        return g_bass_sample_play_ex(g_registered_sound_sample_handles[arg1], 0, 0xffffffff, volume, 0, 0xffffffff)
...
004499eb        volume = ftol(x87control, fconvert.t(arg2) * fconvert.t(100f))
00449a01        return g_bass_sample_play_ex(g_registered_sound_sample_handles[arg1], 0, 0xffffffff, volume, 0, 0xffffffff)
