...
0041a545        facequads->texture_ref = get_or_create_texture_ref(&g_texture_refs, texture_path, nullptr, 0)
...
0041a69a        struct BackdropTileVertexCursorView* vertex_z_cursor = &vertices->z
0041a69d        int32_t i_1 = 4
0041a9ef        int32_t i
0041a6a5        if (edge_selector - 1 u<= 6)
0041a6ab        switch (edge_selector)
0041a6b2        case 1
0041a6b2        long double x87_r7_20 = fconvert.t(vertex_z_cursor->x)
...
0041a6c6        long double x87_r7_21 = fconvert.t(vertex_z_cursor->z)
...
0041a6d9        long double x87_r7_22 = fconvert.t(vertex_z_cursor->x)
...
0041a6ef        long double x87_r7_23 = fconvert.t(vertex_z_cursor->x)
...
0041a718        vertex_z_cursor->x = fconvert.s(fconvert.t(vertex_z_cursor->x) - float.t(row_selector) * fconvert.t(0.200000003f))
0041a71b        long double x87_r7_27 = fconvert.t(vertex_z_cursor->z)
...
0041a741        long double x87_r7_31 = fconvert.t(vertex_z_cursor->z)
...
0041a768        vertex_z_cursor->z = fconvert.s(fconvert.t(vertex_z_cursor->z) - float.t(row_selector) * fconvert.t(0.200000003f))
0041a73a        vertex_z_cursor->z = fconvert.s(fconvert.t(vertex_z_cursor->z) - float.t(0xffffffff) * fconvert.t(0.200000003f))
0041a76f        case 2
0041a76f        long double x87_r7_35 = fconvert.t(vertex_z_cursor->x)
...
0041a783        long double x87_r7_36 = fconvert.t(vertex_z_cursor->z)
...
0041a796        long double x87_r7_37 = fconvert.t(vertex_z_cursor->x)
...
0041a7ac        long double x87_r7_38 = fconvert.t(vertex_z_cursor->x)
...
0041a7d5        vertex_z_cursor->x = fconvert.s(fconvert.t(vertex_z_cursor->x) - float.t(row_selector) * fconvert.t(0.200000003f))
0041a7d8        long double x87_r7_42 = fconvert.t(vertex_z_cursor->z)
...
0041a7fe        long double x87_r7_46 = fconvert.t(vertex_z_cursor->z)
...
0041a825        vertex_z_cursor->z = fconvert.s(fconvert.t(vertex_z_cursor->z) - float.t(row_selector) * fconvert.t(0.200000003f))
0041a7f7        vertex_z_cursor->z = fconvert.s(fconvert.t(vertex_z_cursor->z) - float.t(0xffffffff) * fconvert.t(0.200000003f))
0041a82c        case 3
0041a82c        long double x87_r7_50 = fconvert.t(vertex_z_cursor->x)
...
0041a840        long double x87_r7_51 = fconvert.t(vertex_z_cursor->z)
...
0041a853        long double x87_r7_52 = fconvert.t(vertex_z_cursor->x)
...
0041a869        long double x87_r7_53 = fconvert.t(vertex_z_cursor->x)
...
0041a892        vertex_z_cursor->x = fconvert.s(fconvert.t(vertex_z_cursor->x) - float.t(row_selector) * fconvert.t(0.200000003f))
0041a895        long double x87_r7_57 = fconvert.t(vertex_z_cursor->z)
...
0041a8bb        long double x87_r7_61 = fconvert.t(vertex_z_cursor->z)
...
0041a8e2        vertex_z_cursor->z = fconvert.s(fconvert.t(vertex_z_cursor->z) - float.t(row_selector) * fconvert.t(0.200000003f))
0041a8b4        vertex_z_cursor->z = fconvert.s(fconvert.t(vertex_z_cursor->z) - float.t(0xffffffff) * fconvert.t(0.200000003f))
0041a8e9        case 4
0041a8e9        long double x87_r7_65 = fconvert.t(vertex_z_cursor->x)
...
0041a8fd        long double x87_r7_66 = fconvert.t(vertex_z_cursor->z)
...
0041a910        long double x87_r7_67 = fconvert.t(vertex_z_cursor->x)
...
0041a926        long double x87_r7_68 = fconvert.t(vertex_z_cursor->x)
...
0041a94f        vertex_z_cursor->x = fconvert.s(fconvert.t(vertex_z_cursor->x) - float.t(row_selector) * fconvert.t(0.200000003f))
0041a952        long double x87_r7_72 = fconvert.t(vertex_z_cursor->z)
...
0041a975        long double x87_r7_76 = fconvert.t(vertex_z_cursor->z)
...
0041a99c        vertex_z_cursor->z = fconvert.s(fconvert.t(vertex_z_cursor->z) - float.t(row_selector) * fconvert.t(0.200000003f))
0041a971        vertex_z_cursor->z = fconvert.s(fconvert.t(vertex_z_cursor->z) - float.t(0xffffffff) * fconvert.t(0.200000003f))
0041a9a0        case 5
0041a9a0        long double x87_r7_80 = fconvert.t(vertex_z_cursor->x)
...
0041a9c2        long double x87_r7_82 = fconvert.t(vertex_z_cursor->z)
...
0041a9d3        long double x87_r7_83 = fconvert.t(vertex_z_cursor->y)
0041a9d8        long double x87_r7_84
0041a9d8        if (vertex_z_cursor->z != 0x3f000000)
0041a9e2        x87_r7_84 = x87_r7_83 + fconvert.t(0.600000024f)
0041a9da        x87_r7_84 = x87_r7_83 + fconvert.t(0.5f)
0041a9e8        vertex_z_cursor->y = fconvert.s(x87_r7_84)
0041a9b2        case 7
0041a9b2        long double x87_r7_81 = fconvert.t(vertex_z_cursor->x)
...
0041a9eb        vertex_z_cursor = &vertex_z_cursor[1]
0041a9ee        i = i_1
0041a9ee        i_1 -= 1
