...
0044a384        st0_1, horizontal_align = measure_font_text_width(entry->text, entry->font_id, entry->text_scale)
...
0044a3b6        st0_2, horizontal_align = measure_font_text_width(entry->text, entry->font_id, entry->text_scale)
...
0044a3e0        st0_3, horizontal_align = measure_font_text_width(entry->text, entry->font_id, entry->text_scale)
0044a3f3        cursor_x = fconvert.s(fconvert.t(entry->anchor_x) + fconvert.t(320f) - st0_3)
0044a3f9        char* text = entry->text
...
0044a481        long double x87_r7_13 = sine(fconvert.s(fconvert.t(g_font_wave_phase_a) + fconvert.t(var_38))) * fconvert.t(entry->text_wave_amplitude)
...
0044a4c4        eax_7, x87control_2 = ftol(x87control_1, fconvert.t(fconvert.s(x87_r7_13 + x87_r7_13)) + fconvert.t(cursor_x))
0044a4d1        float x0 = fconvert.s(float.t(eax_7))
0044a4d8        int32_t eax_8
0044a4d8        int16_t x87control_3
0044a4d8        eax_8, x87control_3 = ftol(x87control_2, x87_r7_20 + fconvert.t(entry->y0))
...
0044a5c8        draw_textured_quad_immediate((&g_font_sheets[0].texture_ref_a)[ebx_1 + ecx_9], fconvert.s(fconvert.t(var_34_1) + fconvert.t(x0)), fconvert.s(fconvert.t(var_34_1) + fconvert.t(y0)), 0f, 0f, 0f, 0f, 0f, 0f, fconvert.s(fconvert.t(g_font_sheets[0].glyph_width[ecx_16]) * fconvert.t(entry->text_scale) * fconvert.t(g_font_sheets[font_id_1].spacing_scale)), fconvert.s(fconvert.t(g_font_sheets[font_id_1].line_marker_y) * fconvert.t(entry->text_scale) * fconvert.t(g_font_sheets[font_id_1].spacing_scale)), u0, line_step, u1, line_marker_fraction, color_1, 2, 0f)
...
0044a65a        x87control_3 = draw_textured_quad_immediate((&g_font_sheets[0].texture_ref_a)[eax_16 + ecx_9], x0, y0, 0f, 0f, 0f, 0f, 0f, 0f, fconvert.s(fconvert.t(g_font_sheets[0].glyph_width[eax_16 + eax_4]) * fconvert.t(entry->text_scale) * fconvert.t(g_font_sheets[font_id_2].spacing_scale)), fconvert.s(fconvert.t(g_font_sheets[font_id_2].line_marker_y) * fconvert.t(entry->text_scale) * fconvert.t(g_font_sheets[font_id_2].spacing_scale)), u0, line_step, u1, line_marker_fraction, &entry->color, 1, 0f)
...
0044a6b1        cursor_x = fconvert.s(float.t(horizontal_align_1) * fconvert.t(g_font_sheets[font_id_3].width_scale) * fconvert.t(g_font_sheets[font_id_3].spacing_scale) * fconvert.t(entry->text_scale) + fconvert.t(cursor_x))
0044a6c2        return
