...
0044a43a        float edx_5 = g_font_sheets[0].u0[eax_4 + font_id * 0x20a]
0044a444        float edx_6 = g_font_sheets[0].v0[eax_4 + font_id * 0x20a]
...
0044a4d1        float var_1c_3 = fconvert.s(float.t(eax_7))
...
0044a4e8        float var_20_2 = fconvert.s(float.t(eax_8))
...
0044a552        struct Color4f* eax_12 = set_color_rgba(&color, 0f, 0f, 0f, 0.800000012f)
...
0044a5c8        draw_textured_quad_immediate((&g_font_sheets[0].texture_ref_a)[ebx_1 + ecx_9], fconvert.s(fconvert.t(var_34_1) + fconvert.t(var_1c_3)), fconvert.s(fconvert.t(var_34_1) + fconvert.t(var_20_2)), 0f, 0f, 0f, 0f, 0f, 0f, fconvert.s(fconvert.t(g_font_sheets[0].glyph_width[ecx_16]) * fconvert.t(entry_1->text_scale) * fconvert.t(g_font_sheets[font_id_1].spacing_scale)), fconvert.s(fconvert.t(g_font_sheets[font_id_1].line_marker_y) * fconvert.t(entry_1->text_scale) * fconvert.t(g_font_sheets[font_id_1].spacing_scale)), edx_5, line_step, edx_6, line_marker_fraction, eax_12, 2, 0f)
0044a5cd        text = text_1
0044a5d4        int32_t font_id_2 = entry_1->font_id
0044a5f7        int32_t ecx_21 = font_id_2 * 0x828
0044a618        int32_t eax_17 = font_id_2 * 0x20a
0044a61b        int32_t var_68_3 = ecx_21
0044a62c        int32_t var_6c_3 = ecx_21
0044a65a        x87control_3 = draw_textured_quad_immediate((&g_font_sheets[0].texture_ref_a)[eax_17 + ecx_9], var_1c_3, var_20_2, 0f, 0f, 0f, 0f, 0f, 0f, fconvert.s(fconvert.t(g_font_sheets[0].glyph_width[eax_17 + eax_4]) * fconvert.t(entry_1->text_scale) * fconvert.t(g_font_sheets[font_id_2].spacing_scale)), fconvert.s(fconvert.t(g_font_sheets[font_id_2].line_marker_y) * fconvert.t(entry_1->text_scale) * fconvert.t(g_font_sheets[font_id_2].spacing_scale)), edx_5, line_step, edx_6, line_marker_fraction, &entry_1->color, 1, 0f)
