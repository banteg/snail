...
00433f4f        int32_t eax_2 = (esi - 0x64)->slots[0]._pad_00[4].d
00433f54        if ((0x200 & eax_2) == 0)
00433f5b        report_errorf("List remove")
00433f67        if ((eax_2.b & 0x40) == 0)
00433f78        void* eax_3 = (esi - 0x64)->slots[0]._pad_00[0xc].d
00433f7c        if (eax_3 != 0)
00433f81        *(eax_3 + 8) = (esi - 0x64)->slots[0]._pad_00[8].d
00433f84        void* eax_4 = (esi - 0x64)->slots[0]._pad_00[8].d
00433f89        if (eax_4 == 0)
00433f94        *(ecx + 4) = (esi - 0x64)->slots[0]._pad_00[0xc].d
00433f8d        *(eax_4 + 0xc) = (esi - 0x64)->slots[0]._pad_00[0xc].d
