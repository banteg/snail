...
0040939c        float eax_7 = *(ecx_8 + 0x20)
...
004093ca        var_60_1 = eax_7
004093e7        void* var_64_1 = ecx_8
004093f2        draw_galaxy_line(0x99, fconvert.s(x87_r7_5), var_60_1, var_5c_2, eax_7, 4f, &color_1)
...
00409432        color_1.r = *(edx_3 + arg1 + 0x109b4)
00409439        color_1.g = *(edx_3 + arg1 + 0x109b8)
0040943d        int32_t ecx_13 = *(edx_3 + arg1 + 0x109bc)
00409440        color_1.b = ecx_13
00409447        color_1.r = 0x3f800000
0040944f        color_1.a = *(edx_3 + arg1 + 0x109c0)
...
0040948c        color_2, ecx_13 = set_color_rgba(&color, 1f, i_1, i_1, 0.99000001f)
...
00409505        queue_axis_aligned_textured_quad_uv(0x97, fconvert.s(fconvert.t(*(arg1 + 0x1c)) - fconvert.t(16f)), fconvert.s(fconvert.t(*(arg1 + 0x20)) - fconvert.t(16f)), 32f, 32f, 0x1000000, color_2, i_1, i_1, 1f, 1f, 0xf, i_1)
...
0040965a        struct tColour* var_78_6 = &color_1
0040966d        struct tColour* var_7c_5 = &color_1
00409672        queue_axis_aligned_textured_quad_uv(i_3 + 0x8b, fconvert.s(fconvert.t(*ebp) - fconvert.t(128f)), fconvert.s(fconvert.t(ebp[1]) - fconvert.t(128f)), 256f, 256f, 0x1000000, &color_1, 0f, 0f, 1f, 1f, 0xf, 0f)
0040967a        i_3 += 1
...
004096bc        void* ecx_22 = *(arg1 + 0x10f8c)
004096c5        long double x87_r7_26 = fconvert.t(*(ecx_22 + 0x4c)) - fconvert.t(*(ecx_22 + 0x220))
...
004096e3        long double x87_r7_29 = fconvert.t(*(ecx_22 + 0x54)) + fconvert.t(*(ecx_22 + 0x220)) + fconvert.t(*(ecx_22 + 0x4c))
...
004096f4        long double x87_r7_31 = fconvert.t(*(ecx_22 + 0x50)) - fconvert.t(*(ecx_22 + 0x220))
...
0040970b        long double x87_r7_34 = fconvert.t(*(ecx_22 + 0x58)) + fconvert.t(*(ecx_22 + 0x50)) + fconvert.t(*(ecx_22 + 0x220))
...
0040972e        int32_t* ecx_24 = arg1 + 0x2cc
0040973a        if (i_4 != *(arg1 + 0x10f80))
00409744        *ecx_24 = 0
0040973c        *ecx_24 = 0x3f800000
00409750        i_4 += 1
00409751        ecx_24 = &ecx_24[0xa8]
...
004097ab        int32_t ecx_28 = *(arg1 + 0x10f80) * 0x2a0
004097ba        int32_t edx_10 = *(ecx_28 + arg1 + 0x24)
004097bd        color.r = fconvert.s(fconvert.t(*(ecx_28 + arg1 + 0x1c)) - fconvert.t(authored_x))
004097cc        color.b = edx_10
004097d0        vector.x = color.r
004097d4        vector.z = edx_10
004097d8        color.g = fconvert.s(fconvert.t(*(ecx_28 + arg1 + 0x20)) - fconvert.t(authored_y))
...
00409802        if ((((st0_1 < temp5_1 ? 1 : 0) << 8 | (is_unordered.t(st0_1, temp5_1) ? 1 : 0) << 0xa | (st0_1 == temp5_1 ? 1 : 0) << 0xe):1.b & 1) != 0 && *(arg1 + 0x10f84) == 0)
...
00409845        int32_t ecx_31 = edi_2[-2]
00409848        color.b = ecx_31
0040984c        color.r = fconvert.s(fconvert.t(edi_2[-4]) - fconvert.t(authored_x))
0040985b        vector.z = ecx_31
00409863        vector.x = color.r
00409867        color.g = fconvert.s(fconvert.t(edi_2[-3]) - fconvert.t(authored_y))
...
004098ec        void* ecx_33 = *(arg1 + 0x10f74)
004098f2        int32_t eax_46 = *(ecx_33 + 0x1a0)
004098fa        if ((eax_46.b & 0x20) != 0)
004098fc        eax_46.b &= 0xdf
004098fe        *(ecx_33 + 0x1a0) = eax_46
...
00409944        return 0
00409959        int32_t edx_13 = *(arg1 + 8)
0040995e        int32_t eax_51
0040995e        void* ecx_36
0040995e        if (edx_13 == 1)
00409960        ecx_36 = *(arg1 + 0x10f9c)
00409966        eax_51 = *(ecx_36 + 0x1a0)
0040996e        if (edx_13 == 1 && (eax_51.b & 0x20) != 0)
00409970        eax_51.b &= 0xdf
00409972        *(ecx_36 + 0x1a0) = eax_51
0040997a        destroy_galaxy(arg1)
0040998b        *(*(arg1 + 0x10f70) + 0x44) = *(arg1 + 0x10f80)
0040998e        void* eax_53 = *(arg1 + 0x10f70)
004099a2        load_frontend_level_by_mode_and_index(eax_53 + 0xa874, *(eax_53 + 0x40), *(eax_53 + 0x44))
004099a7        void* esi_1 = *(arg1 + 0x10f70)
004099be        if (*(esi_1 + 0x40) == 0 && *(esi_1 + 0x1270fc8) == 1)
004099d0        return 2
00409a5a        return 1
004099d1        void* ecx_40 = *(arg1 + 0x10fa0)
004099d7        int32_t eax_56 = *(ecx_40 + 0x1a0)
004099df        if ((eax_56.b & 0x20) != 0)
004099e1        eax_56.b &= 0xdf
004099e3        *(ecx_40 + 0x1a0) = eax_56
004099eb        destroy_galaxy(arg1)
004099fc        *(*(arg1 + 0x10f70) + 0x44) = *(arg1 + 0x10f80)
004099ff        void* eax_58 = *(arg1 + 0x10f70)
00409a13        load_frontend_level_by_mode_and_index(eax_58 + 0xa874, *(eax_58 + 0x40), *(eax_58 + 0x44))
00409a1e        *(*(arg1 + 0x10f70) + 0xff25d0) = 1
00409a25        void* eax_59 = *(arg1 + 0x10f70)
00409a4b        *(eax_59 + 0xff25d4) = *(arg1 + 0x10f80) * 0x1fac0 + eax_59 + 0x944150
00409a5a        return 1
00409a69        if (game_base_2->fade.state == 0 && *(arg1 + 4) != 1)
00409a6b        int32_t eax_62 = *(arg1 + 0x10f84)
00409a73        if (eax_62 != 1)
00409a88        if (eax_62 != 2 || (game_base_2->players[0].game_input->input.pressed_buttons & 0x4000) == 0)
00409ad4        if (eax_62 == 0 && (game_base_2->players[0].game_input->input.pressed_buttons & 0x4000) != 0 && edx_13 == 1 && g_runtime_config.highest_galaxy_route_index s> 1)
00409ad8        close_galaxy_route(arg1)
00409ae4        play_sound_effect(8)
00409a90        if (i_6 != *(arg1 + 0x10f80))
00409a95        if (edx_13 == 1)
00409a99        close_galaxy_route(arg1)
00409aa1        open_galaxy_route(arg1, i_6)
00409ae4        play_sound_effect(8)
00409aaa        if (edx_13 == 0)
