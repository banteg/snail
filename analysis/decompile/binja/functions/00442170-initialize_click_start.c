...
004421f3        void* ecx_5
004421f3        if ((0x200 & eax_2) == 0)
00442209        void** eax_4 = data_4df904 + 0x5ac
0044220e        void* ecx_6 = *eax_4
00442212        if (ecx_6 != 0)
00442220        *(ecx_6 + 8) = arg1
00442223        void* ecx_7 = *eax_4
00442229        *(*(ecx_7 + 8) + 0xc) = ecx_7
0044222f        ecx_5 = *(*eax_4 + 8)
00442232        *eax_4 = ecx_5
00442234        *(ecx_5 + 8) = 0
00442214        *eax_4 = arg1
00442216        *(arg1 + 8) = 0
0044221b        *(*eax_4 + 0xc) = 0
