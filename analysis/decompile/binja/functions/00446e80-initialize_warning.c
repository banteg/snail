...
00446eb5        struct tColour* color_1 = set_color_rgba(&color, 1f, 1f, 1f, 0.999000013f)
00446ecf        initialize_frontend_sprite_button(warning->border, 0x400802, 0x5e, 288f, 64f, color_1, 0f, 4)
