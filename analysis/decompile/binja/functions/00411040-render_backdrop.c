...
0041118e        texture_id = *(edi + 0x3c)
004112a3        arg1 = queue_textured_quad_corners(texture_id, x0, y0, x1, y1, x2, y2, x3, y3, 0, 0, 0x8000000, color, u0, v0, u1, v1, 0, 0f)
