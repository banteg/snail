...
004218b5        struct Vec3* flight_position_overflow = &state->shot->flight_transform.position
...
004218ea        float special_scalar_2
004218ea        special_scalar_2.b = position->x.b
004218ea        special_scalar_2:1.b = position->x:1.b
...
0042197b        float special_scalar_1 = special_scalar
0042197f        position->x.b = special_scalar_1.b
0042197f        position->x:1.b = special_scalar_1:1.b
0042197f        position->x:2.b = special_scalar_1:2.b
0042197f        position->x:3.b = special_scalar_1:3.b
00421984        struct Vec3* flight_position_terminal = &state->shot->flight_transform.position
0042198d        flight_position_terminal->x = special_scalar_1
00421992        flight_position_terminal->y = position->y
0042199d        flight_position_terminal->z = position->z
004219a6        return 3
...
00421860        float center_x
00421860        int32_t eax_14
00421860        if (sample_index_1 != edi)
004219ff        eax_14 = (eax_11 - sample_index_1) * 0x18
00421a02        struct PathTemplateSamplePairCursorView* primary_sample_pair = template_record_1->primary_samples + eax_14
00421a1f        center_x = fconvert.s(fconvert.t(var_f0) / fconvert.t(*(&template_record_1->secondary_samples->delta_length + eax_14)) * (fconvert.t(primary_sample_pair->next.center_x) - fconvert.t(primary_sample_pair->current.center_x)) + fconvert.t(primary_sample_pair->current.center_x))
0042186e        eax_14 = (eax_11 - sample_index_1) * 0x18
00421879        center_x = (template_record_1->primary_samples + eax_14)->current.center_x
00421a25        float lateral_scale
00421a25        struct PathTemplateSamplePairCursorView* primary_sample_pair_rejoined
00421a25        if (sample_index_1 != edi)
00421a55        lateral_scale = fconvert.s(fconvert.t(var_f0) / fconvert.t(*(&template_record_1->secondary_samples->delta_length + eax_14)) * (fconvert.t(primary_sample_pair_rejoined->next.lateral_scale) - fconvert.t(primary_sample_pair_rejoined->current.lateral_scale)) + fconvert.t(primary_sample_pair_rejoined->current.lateral_scale))
00421a2d        lateral_scale = primary_sample_pair_rejoined->current.lateral_scale
00421a5b        if (sample_index_1 != edi)
00421a8b        special_scalar = fconvert.s(fconvert.t(var_f0) / fconvert.t(*(&template_record_1->secondary_samples->delta_length + eax_14)) * (fconvert.t(primary_sample_pair_rejoined->next.special_scalar) - fconvert.t(primary_sample_pair_rejoined->current.special_scalar)) + fconvert.t(primary_sample_pair_rejoined->current.special_scalar))
00421a63        special_scalar = primary_sample_pair_rejoined->current.special_scalar
00421a93        struct TransformMatrix var_c0
00421a93        struct Vec3* output_position
00421a93        float* velocity_1
00421a93        float* position_1
...
00421ba9        __builtin_memcpy(&from, secondary_sample, 0x40)
00421bcd        struct TransformMatrix to
00421bcd        int32_t ecx_23 = __builtin_memcpy(&to, &template_record_1->secondary_samples[sample_index_1 + 1], 0x40)
00421be5        __builtin_memset(&from.position, 0, 0xc)
00421c06        __builtin_memset(&to.position, 0, 0xc)
00421c14        int32_t var_108_2 = ecx_23
...
00421c6b        var_c0.basis_right = struct Vec3 {
    .x = fconvert.s(fconvert.t(var_c0.basis_right.x) * fconvert.t(lateral_scale))
    .y = fconvert.s(fconvert.t(var_c0.basis_right.y) * fconvert.t(lateral_scale))
    .z = fconvert.s(fconvert.t(var_c0.basis_right.z) * fconvert.t(lateral_scale))
}
00421c75        state->vertical_offset = fconvert.s(fconvert.t(velocity_1[1]) + fconvert.t(state->vertical_offset))
00421c7a        long double x87_r7_50 = fconvert.t(*position_1) - fconvert.t(center_x)
...
00421ac0        compute_kind42_attachment_transform(template_record_1, special_scalar, fconvert.s(fconvert.t(*position_1) - fconvert.t(center_x)), 0.49000001f, &var_c0, &special_scalar)
00421ad4        int32_t ecx_17 = state->sample_index * 0x15
...
00421af7        long double x87_r7_24 = fconvert.t((&secondary_samples->delta_dir_to_next.z)[ecx_17 * 2]) * fconvert.t(state->progress) + fconvert.t(state->source_cell->anchor_position.z) + fconvert.t((secondary_samples + (ecx_17 << 3))->transform.position.z)
...
00421b25        long double x87_r6_36 = fconvert.t(velocity_1[1]) + fconvert.t(state->vertical_offset)
...
00421d3f        long double x87_r7_54 = fconvert.t(*position_1) - fconvert.t(center_x)
...
00421daf        *position_1 = fconvert.s(fconvert.t(*position_1) + fconvert.t(*velocity_1))
00421dbc        return 0
00421d72        int32_t eax_40
00421d72        eax_40.b = output_position->x.b
00421d72        eax_40:1.b = output_position->x:1.b
00421d72        eax_40:2.b = output_position->x:2.b
00421d72        eax_40:3.b = output_position->x:3.b
00421d74        struct Vec3* flight_position_side_exit = &state->shot->flight_transform.position
00421d7a        state->active = 0
00421d80        flight_position_side_exit->x = eax_40
00421d85        flight_position_side_exit->y = output_position->y
00421d8b        int32_t result = 0
00421d8d        flight_position_side_exit->z = output_position->z
