...
004218ea        float edx_2
004218ea        edx_2.b = position->x.b
004218ea        edx_2:1.b = position->x:1.b
004218ea        edx_2:2.b = position->x:2.b
004218ea        edx_2:3.b = position->x:3.b
004218ec        var_ec = edx_2
...
0042198d        flight_position_terminal->x = eax_25
...
00421b5c        float var_e4_2 = fconvert.s(fconvert.t(var_f0) * fconvert.t(*(&secondary_samples_1->delta_dir_to_next + eax_14)) * fconvert.t(var_f4) + fconvert.t(secondary_sample->transform.position.x) + fconvert.t(source_cell->anchor_position.x))
00421b74        float var_e0_2 = fconvert.s(fconvert.t(var_f0) * fconvert.t(secondary_sample->delta_dir_to_next.y) * fconvert.t(var_f4) + fconvert.t(secondary_sample->transform.position.y) + fconvert.t(source_cell->anchor_position.y))
...
00421bcd        int32_t ecx_24 = __builtin_memcpy(&to, &template_record_1->secondary_samples[sample_index_1 + 1], 0x40)
00421be5        __builtin_memset(&from.position, 0, 0xc)
00421c06        __builtin_memset(&to.position, 0, 0xc)
00421c14        int32_t var_108_2 = ecx_24
...
00421dbc        return 0
00421d72        int32_t eax_41
00421d72        eax_41.b = output_position->x.b
00421d72        eax_41:1.b = output_position->x:1.b
00421d72        eax_41:2.b = output_position->x:2.b
00421d72        eax_41:3.b = output_position->x:3.b
00421d74        struct Vec3* flight_position_side_exit = &state->shot->flight_transform.position
00421d7a        state->active = 0
00421d80        flight_position_side_exit->x = eax_41
