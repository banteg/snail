...
004408cd        float* blink_sample_cursor = &runtime->blink_random_samples
004408d3        int32_t i_1 = 0x18
00440904        int32_t result
00440904        int32_t i
004408d8        result = next_math_random_value()
004408e1        blink_sample_cursor = &blink_sample_cursor[1]
004408e8        i = i_1
004408e8        i_1 -= 1
00440901        blink_sample_cursor[-1] = fconvert.s(fconvert.t(1f) / ((float.t(result) * fconvert.t(3.05175781e-05f) + fconvert.t(1f)) * fconvert.t(60f)))
