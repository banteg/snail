...
0043a3b0        float var_8_1 = fconvert.s(fconvert.t(gauge->progress_step) + fconvert.t(gauge->progress))
...
0043a3d5        struct Player* ecx = gauge->player
0043a3e2        long double x87_r7_4 = float.t(gauge->game->completion_row_start - 5)
0043a3e6        long double temp4_1 = fconvert.t(ecx->live_matrix.position.z)
...
0043a441        long double x87_r7_12 = fconvert.t(var_8_1) - fconvert.t(gauge->progress_step)
...
0043a4b3        struct Player* var_14_3 = ecx
