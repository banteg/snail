...
00406e62        read_current_display_resolution(&g_current_display_width, &g_current_display_height)
00406e6a        g_authored_view_width = 640f
00406e74        g_authored_view_height = 480f
00406e7e        g_game_initialization_pending = 1
...
00406ee6        if (g_game_initialization_pending != 0)
...
00406f7e        g_game_initialization_pending = 0
00406f84        g_frame_render_requested = 0
...
00406fdb        g_current_frame_timestamp_seconds = fconvert.s(float.t(timeGetTime().q) * fconvert.t(0.00100000005f))
00406fed        x87_r7_7 = fconvert.t(g_frame_time_accumulator) + fconvert.t(g_current_frame_timestamp_seconds) - fconvert.t(g_previous_frame_timestamp_seconds)
...
00407006        long double x87_r7_9 = fconvert.t(g_current_frame_timestamp_seconds) - fconvert.t(g_previous_frame_timestamp_seconds)
00407012        g_previous_frame_timestamp_seconds = g_current_frame_timestamp_seconds
0040701e        g_frame_time_accumulator = fconvert.s(x87_r7_9 + fconvert.t(g_frame_time_accumulator))
00407024        long double x87_r7_11 = fconvert.t(g_frame_time_accumulator)
...
00407037        g_frame_time_accumulator = 0.416666657f
00407041        long double x87_r7_12 = fconvert.t(g_frame_time_accumulator)
00407047        long double temp5_1 = fconvert.t(0f)
00407047        x87_r7_12 - temp5_1
0040704d        g_fixed_update_abort_requested = 0
00407053        g_current_frame_update_steps = 0f
00407062        if ((((x87_r7_12 < temp5_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_12, temp5_1) ? 1 : 0) << 0xa | (x87_r7_12 == temp5_1 ? 1 : 0) << 0xe):1.b & 0x41) == 0)
0040706e        while (g_fixed_update_abort_requested == 0)
00407076        if (edi != 0)
00407076        break
00407088        g_current_frame_update_steps = fconvert.s(fconvert.t(g_current_frame_update_steps) + fconvert.t(1f))
00407094        long double x87_r7_16 = fconvert.t(g_frame_time_accumulator) - fconvert.t(0.0166666675f)
0040709a        g_frame_time_accumulator = fconvert.s(x87_r7_16)
004070a0        long double temp6_1 = fconvert.t(0f)
004070a0        x87_r7_16 - temp6_1
004070a6        long double x87_r7_17 = fconvert.t(g_frame_time_accumulator)
...
004070d5        long double x87_r7_18 = fconvert.t(g_frame_time_accumulator)
...
004070c2        g_frame_time_accumulator = 0f
...
00407196        g_frame_render_requested = 1
...
00407140        g_frame_render_requested = 1
00407147        if (eax_20.b != 0)
00407149        sub_407490()
004071bb        long double x87_r7_19 = fconvert.t(g_frame_time_accumulator)
...
004071cc        break
004071d8        long double x87_r7_21 = fconvert.t(g_main_loop_frame_count) * fconvert.t(g_mean_update_steps_per_frame)
004071de        g_fixed_update_abort_requested = 0
004071e4        long double x87_r7_22 = x87_r7_21 + fconvert.t(g_current_frame_update_steps)
004071f6        g_main_loop_frame_count = fconvert.s(fconvert.t(g_main_loop_frame_count) + fconvert.t(1f))
00407202        g_mean_update_steps_per_frame = fconvert.s(x87_r7_22 / fconvert.t(g_main_loop_frame_count))
00407213        if (g_main_loop_exit_requested != 0)
00407213        break
00407217        if (edi != 0)
00407217        break
...
004072c6        g_game_initialization_pending = 1
004072cd        g_main_loop_exit_requested = 0
