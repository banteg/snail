...
0043b242        int32_t game_60 = player_1->__offset(0x40c).d
...
0043b36a        eax_6.b = player_1->__offset(0x440).b
...
0043b483        eax_6.b = player_1->__offset(0x440).b
...
0043b53e        *(game_58 + (ecx_23 << 1) + 0xfd2b80) = eax_12
...
0043b617        *(game_4 + (edx_11 << 1) + 0xfd2b84) |= 1
...
0043b640        *(game_5 + (game_12 << 1) + 0xfd2b84) |= 2
...
0043b685        *(game_3 + (ecx_32 << 1) + 0xfd2b84) |= 4
...
0043b6a9        player_1->__offset(0x410).d = 0
...
0043b6c8        player_1->__offset(0x410).d = 0
0043b6d2        game_3.b = player_1->__offset(0x84).b
...
0043b710        struct Game* eax_27 = *(game_59 + (eax_26 << 2) + 0x5ccbb8)
0043b734        if (eax_27 s> 0 && eax_27 != player_1->__offset(0x1e8).d && eax_27 s< game_59->__offset(0xa874).d + 1)
0043b73a        player_1->__offset(0x1e8).d = eax_27
0043b75b        int32_t ecx_37
0043b75b        ecx_37.b = *(*(game_59 + (eax_26 << 2) + 0x5ccbb8) * 0x4220 + player_1->game + 0xa670)
0043b764        if (ecx_37.b != 0)
0043b76a        player_1->__offset(0x1ec).d = 2
0043b796        player_1->__offset(0x1fc).d = *(game_59 + (eax_26 << 2) + 0x5ccbb8) * 0x4220 + player_1->game + 0xa670
0043b79c        player_1->__offset(0x1f0).d = 0
...
0043b837        struct Player* eax_33 = *(*(game_59 + (eax_26 << 2) + 0x5ccbb8) * 0x4220 + player_1->game + 0xa874)
0043b841        if (eax_33 != 0xffffffff)
0043b843        var_54 = eax_33
0043b84d        play_voice_manager(0x751498, 0xd, 2, var_54)
0043b858        var_54 = 1
0043b866        enqueue_tip_message(data_4df904 + 0x12e6f58, &player_1->__offset(0x1ec).d, var_54)
...
0043b93b        player_1->__offset(0x418).d = fconvert.s(unimplemented  {fstp dword [ebp+0x418], st0})
...
0043b956        player_1->__offset(0x418).d = 0x3f800000
0043b967        if (player_1->movement_state == 2)
0043b969        player_1->__offset(0x418).d = 0
...
0043b8f8        player_1->__offset(0x418).d = fconvert.s(unimplemented  {fstp dword [ebp+0x418], st0})
...
0043bafb        player_1->__offset(0x410).d = 0
...
0043bb1a        player_1->__offset(0x410).d = 0
0043bb24        eax_27.b = player_1->__offset(0x440).b
...
0043bbb5        player_1->__offset(0x418).d = fconvert.s(unimplemented  {fstp dword [ebp+0x418], st0})
...
0043bbd3        long double temp23_1 = fconvert.t(player_1->__offset(0x2738).d)
...
0043bbe9        player_1->__offset(0x2738).d = fconvert.s(unimplemented  {fstp dword [ebp+0x2738], st0})
...
0043bb78        if (get_track_grid_cell_at_world_position(game_17, var_54)->__offset(0x3c).b == 0x13)
0043bb78        goto label_43bb9a
0043bb81        if (player_1->__offset(0x3c4).d == 2)
...
0043bbf6        if (player_1->__offset(0x275c).d == 1)
...
0043bc13        player_1->__offset(0x418).d = fconvert.s(unimplemented  {fstp dword [ebp+0x418], st0})
0043bc13        unimplemented  {fstp dword [ebp+0x418], st0}
0043bc19        unimplemented  {fstp st0, st0}
0043bc19        unimplemented  {fstp st0, st0}
0043bc1b        eax_27.b = player_1->__offset(0x1e4).b
...
0043bc40        player_1->__offset(0x418).d = fconvert.s(unimplemented  {fstp dword [ebp+0x418], st0})
...
0043bc61        player_1->__offset(0x414).d = fconvert.s(unimplemented  {fstp dword [ebp+0x414], st0})
...
0043bc82        player_1->__offset(0x410).d = fconvert.s(unimplemented  {fstp dword [ebp+0x410], st0})
0043bc82        unimplemented  {fstp dword [ebp+0x410], st0}
0043bc82        int16_t top_66 = top_13
0043bc88        eax_27.b = player_1->__offset(0x41c).b
...
0043bd07        if (((*(player_1->game + get_track_cell_row_index(cell) * 0xf4 + 0x5ccac8)).w:1.b & 1) == 0 && player_1->__offset(0x275c).d == 0)
...
0043bd28        player_1->__offset(0x418).d = fconvert.s(unimplemented  {fstp dword [ebp+0x418], st0})
...
0043bda3        var_54 = *(player_1->game + eax_47 * 0xf4 + 0x5ccb6c)
...
0043bdf0        cell_1, x87control_1 = try_enter_track_attachment_from_swept_motion(*(*(player_1->game + eax_53 * 0xf4 + 0x5ccb6c) + 0x38), eax_51, eax_52, ecx_76, var_3c_1, var_38_1, var_34_1, var_54)
...
0043be78        var_54 = *(player_1->game + eax_56 * 0xf4 + 0x5ccb70)
...
0043bec5        cell_1, x87control_1 = try_enter_track_attachment_from_swept_motion(*(*(player_1->game + eax_60 * 0xf4 + 0x5ccb70) + 0x38), x, y_1, z_1, var_3c_2, var_38_2, var_34_2, var_54)
...
0043bf1a        player_1->__offset(0x1e4).b = 0
...
0043bf65        player_1->__offset(0x414).d = 0
...
0043bfb4        eax_62.b = cell->_pad_3d[0]
...
0043c01b        if (game_20->__offset(0x40).d == 3)
...
0043c050        var_54 = player_1->__offset(0x414).d
0043c057        start_squidge_y(&player_1->squidge, var_54)
0043c05c        player_1->__offset(0x1e4).b = 0
0043c063        player_1->__offset(0x414).d = 0
...
0043c087        cell_1.b = player_1->__offset(0x84).b
...
0043bcad        player_1->__offset(0x418).d = fconvert.s(unimplemented  {fstp dword [ebp+0x418], st0})
...
0043c0b7        player_1->__offset(0x1dc).d = fconvert.s(unimplemented  {fst dword [ebp+0x1dc], st0})
...
0043c0ca        player_1->__offset(0x1dc).d = 0
...
0043c36f        player_1->__offset(0x414).d = fconvert.s(unimplemented  {fstp dword [ebp+0x414], st0})
...
0043c3b6        var_54 = player_1->__offset(0x414).d
...
0043c3d8        player_1->__offset(0x414).d = fconvert.s(unimplemented  {fstp dword [ebp+0x414], st0})
...
0043c3f1        player_1->__offset(0x1e4).b = 1
...
0043c316        player_1->__offset(0x414).d = fconvert.s(unimplemented  {fstp dword [ebp+0x414], st0})
...
0043c2f3        player_1->__offset(0x414).d = fconvert.s(unimplemented  {fstp dword [ebp+0x414], st0})
...
0043c28a        player_1->__offset(0x1dc).d = player_1->__offset(0x1e0).d
0043c290        player_1->game
0043c296        unimplemented  {fld st0, dword [eax+0x38]}
0043c299        unimplemented  {fmul st0, dword [0x497270]}
0043c29f        player_1->__offset(0x414).d = fconvert.s(unimplemented  {fstp dword [ebp+0x414], st0})
...
0043c25b        player_1->__offset(0x1e4).b = 0
0043c262        player_1->__offset(0x414).d = 0
...
0043b987        float path_factor = player_1->__offset(0x418).d
0043b993        var_54 = &player_1->__offset(0x410).d
...
0043b9e9        player_1->__offset(0x418).d = fconvert.s(unimplemented  {fstp dword [ebp+0x418], st0})
...
0043ba24        player_1->__offset(0x418).d = fconvert.s(unimplemented  {fstp dword [ebp+0x418], st0})
...
0043ba45        player_1->__offset(0x414).d = fconvert.s(unimplemented  {fstp dword [ebp+0x414], st0})
...
0043ba62        player_1->__offset(0x410).d = fconvert.s(unimplemented  {fstp dword [esi], st0})
...
0043ba7d        player_1->__offset(0x414).d = fconvert.s(unimplemented  {fstp dword [ebp+0x414], st0})
...
0043ba9a        player_1->__offset(0x410).d = 0
...
0043bab9        player_1->__offset(0x410).d = 0
0043c403        update_warning(&player_1->__offset(0x3f4).d)
0043c408        struct TrackRowCell* game_6
0043c408        game_6.b = player_1->__offset(0x41c).b
0043c410        float x_5
0043c410        if (game_6.b != 0)
0043c510        player_1->__offset(0x328).d = 0
...
0043c510        player_1->__offset(0x328).d = 0
0043c482        player_1->__offset(0x418).d = 0
...
0043c4e2        player_1->__offset(0x328).d = fconvert.s(unimplemented  {fst dword [ebp+0x328], st0})
...
0043c4f5        player_1->__offset(0x328).d = 0
...
0043c698        player_1->__offset(0x1d4).d = fconvert.s(unimplemented  {fst dword [ebp+0x1d4], st0})
...
0043c6ab        player_1->__offset(0x1d4).d = 0
...
0043ca46        game_6.b = player_1->__offset(0x41c).b
...
0043ca94        player_1->__offset(0x418).d = fconvert.s(unimplemented  {fstp dword [ebp+0x418], st0})
...
0043c6de        game_6.b = player_1->__offset(0x440).b
0043c6e6        if (game_6.b == 0)
0043c6f0        if (game_50->__offset(0x40).d == 4)
...
0043c715        advance_timer_counters(&player_1->__offset(0x2e8).d, var_54)
0043c720        player_1->__offset(0x444).d = 0
0043c726        player_1->__offset(0x448).d = 0x3c888889
0043c730        player_1->__offset(0x44e).b = 0
...
0043c7e5        player_1->__offset(0x418).d = fconvert.s(unimplemented  {fst dword [ebp+0x418], st0})
...
0043c7f8        player_1->__offset(0x418).d = 0
0043c7fe        unimplemented  {fld st0, dword [ebp+0x2748]}
0043c804        unimplemented  {fadd dword [ebp+0x2744]}
0043c80a        player_1->__offset(0x2744).d = fconvert.s(unimplemented  {fst dword [ebp+0x2744], st0})
...
0043c81d        player_1->__offset(0x2744).d = 0
...
0043c835        player_1->__offset(0x444).d = fconvert.s(unimplemented  {fstp dword [ebp+0x444], st0})
0043c835        unimplemented  {fstp dword [ebp+0x444], st0}
0043c83b        game_51->__offset(0x1270fc8).d = 2
...
0043c858        game_6.b = player_1->__offset(0x44e).b
0043c860        if (game_6.b == 0)
0043c862        var_54 = 0xffffffff
0043c86d        player_1->__offset(0x44e).b = 1
...
0043c892        int32_t ecx_119 = game_6->_pad_3d[3].d
...
0043c8ba        player_1->__offset(0x444).d = 0x40a33333
0043c8c6        if (game_6->__offset(0x12727ec).d == 5)
0043c8c8        player_1->__offset(0x444).d = 0x40a33333
...
0043c8e7        game_6 = game_52->__offset(0x40).d
0043c8f9        if ((game_6 == 0 || game_6 == 1) && game_52->__offset(0x12727ec).d != 5)
0043c8fb        unimplemented  {fld st0, dword [ebp+0x444]}
0043c901        unimplemented  {fsub st0, dword [ebp+0x448]}
0043c907        player_1->__offset(0x444).d = fconvert.s(unimplemented  {fstp dword [ebp+0x444], st0})
...
0043c95b        flush_row_event_display(game_7 + 0x12727d8)
0043c960        struct Game* game_53 = player_1->game
0043c969        struct Game* game_8
0043c969        if (game_53->__offset(0x40).d != 0)
0043c9c6        var_54 = 1
0043c9c8        game_8 = complete_subgame(game_53, var_54.b)
0043c97d        if (game_53->__offset(0x44).d == *(data_4df904 + 0x12d4644) - 1)
0043c97f        var_54 = 1
...
0043c9d7        if (game_57->__offset(0x40).d == 7)
...
0043cad8        update_jetpack_gauge(&player_1->__offset(0x2750).d)
0043cae5        if (player_1->__offset(0x440).b != 0)
...
0043cb1e        update_damage_gauge(&player_1->__offset(0x3c4).d)
...
0043cbf0        player_1->__offset(0x3dc).d = eax_82 i- 1
...
0043ccd8        update_nuke(&player_1->__offset(0x150).d)
0043ccc5        player_1->__offset(0x374).d = 0
0043cccb        uninit_nuke(&player_1->__offset(0x150).d)
...
0043ce50        player_1->__offset(0x414).d = fconvert.s(unimplemented  {fst dword [ebp+0x414], st0})
...
0043ce6b        player_1->__offset(0x414).d = fconvert.s(unimplemented  {fstp dword [ebp+0x414], st0})
...
0043ce96        player_1->__offset(0x434).d = fconvert.s(unimplemented  {fst dword [ebp+0x434], st0})
...
0043cea9        eax_91.b = player_1->__offset(0x44c).b
...
0043cec8        player_1->__offset(0x44c).b = 1
...
0043cf4b        player_1->__offset(0x330).d = fconvert.s(unimplemented  {fst dword [ebp+0x330], st0})
...
0043cf6e        player_1->__offset(0x330).d = 0
...
0043cf96        long double temp63_1 = fconvert.t(player_1->__offset(0x418).d)
...
0043cfa3        long double temp67_1 = fconvert.t(player_1->__offset(0x418).d)
...
0043d090        eax_93.b = player_1->__offset(0x440).b
...
0043d1fa        show_times_up_message(game_11 + 0x1272828)
0043d20b        game = update_times_up(player_1->game + 0x1272828)
0043b143        if (*(data_4df904 + 0x1b8) != 9)
0043b14f        update_damage_gauge(&player_1->__offset(0x3c4).d)
0043b15a        update_progress_bar()
0043b165        update_warning(&player_1->__offset(0x3f4).d)
