...
00410914        case 0
00410914        source = update_new_game_menu(data_4df904 + 0x4f2dc)
004108ba        case 1
004108ba        *(arg1 + 0x94) = 0
004108c0        capture_mouse_cursor(arg1 + 0x16c)
004108cb        *(data_4df904 + 0x4f2dc) = 0
004108dd        source = initialize_new_game_menu(data_4df904 + 0x4f2dc)
004108ed        case 2
...
00410836        source = update_subgame(data_4df904 + 0x74618)
00410836        case 0xb
00410836        source = update_subgame(data_4df904 + 0x74618)
00410850        case 0xc
00410850        source = initialize_intro_screen(data_4df904 + 0x4f400, "Intro/Intro.txt")
00410855        *(arg1 + 0x94) = 0xd
00410870        case 0xd
00410870        source = update_intro_screen(data_4df904 + 0x4f400)
0041088b        case 0xe
0041088b        source = initialize_intro_screen(data_4df904 + 0x4f400, "Intro/Credits.txt")
00410890        *(arg1 + 0x94) = 0xf
004108aa        case 0xf
004108aa        source = update_intro_screen(data_4df904 + 0x4f400)
004109f1        case 0x12
004109f1        source = initialize_high_score_screen(data_4df904 + 0x12e6e50, data_4df9c0, 0xffffffff)
004109f6        *(arg1 + 0x94) = 0x13
00410a11        case 0x13
00410a11        source = update_high_score_screen(data_4df904 + 0x12e6e50)
00410a1b        case 0x14
00410a1b        void* eax_9 = data_4df904
00410a34        source = initialize_high_score_screen(eax_9 + 0x12e6e50, *(eax_9 + 0x314), *(eax_9 + 0x310))
00410a39        *(arg1 + 0x94) = 0x15
00410a53        case 0x15
00410a53        source = update_high_score_screen(data_4df904 + 0x12e6e50)
00410a63        case 0x19
00410a63        *(data_4df904 + 0x38) = 1
00410a7b        case 0x1a
00410a7b        source = destroy_subgame(data_4df904 + 0x74618)
...
00410abc        source = initialize_subgame(data_4df904 + 0x74618)
...
00410afa        source = update_thanks_for_playing_screen(data_4df904 + 0x12d4624)
00410afa        case 0x1e
00410afa        source = update_thanks_for_playing_screen(data_4df904 + 0x12d4624)
00410b01        case 0x1f
00410b01        *(arg1 + 0x94) = 0x20
00410b13        initialize_help_screen(data_4df904 + 0x12d4620)
00410b24        source = update_help_screen(data_4df904 + 0x12d4620)
00410b24        case 0x20
00410b24        source = update_help_screen(data_4df904 + 0x12d4620)
