...
00423f30        self->__offset(0x3c).b = 0
00423f34        self->__offset(0x40).d = 0
00423f37        self->__offset(0x54).d = arg3
00423f3a        int16_t x87control
00423f3a        int32_t eax_1 = __ftol(x87control, fconvert.t(arg2) * fconvert.t(1.04615045f))
00423f56        self->__offset(0x50).d = 0x3f800000
...
00423f71        allocate_path_template_samples(self)
00423f76        uint32_t segment_count = self->segment_count
00423f79        self->__offset(0x9c).b = 0
00423f81        arg3 = 0
...
00423ffd        set_matrix_identity(i + self->__offset(0x5c).d)
00424013        *(i + self->__offset(0x5c).d + 0x30) = *(&self->primary_samples->center_x + i)
0042401a        *(i + self->__offset(0x5c).d + 0x34) = 0x3efae148
00424029        *(i + self->__offset(0x5c).d + 0x38) = fconvert.s(fconvert.t(fconvert.s(x87_r7_5)))
00424030        i += 0xa8
0042403d        *(i + self->__offset(0x5c).d - 0x1c) = 0x3f800000
00424041        arg3 += 1
0042404f        arg3 = 0
...
0042413f        set_matrix_identity(edi + self->__offset(0x5c).d)
00424152        *(edi + self->__offset(0x5c).d + 0x30) = *(&self->primary_samples->center_x + edi)
00424169        *(edi + self->__offset(0x5c).d + 0x38) = fconvert.s(sine(var_1c_2) * fconvert.t(var_24_1) + fconvert.t(7f))
00424186        *(edi + self->__offset(0x5c).d + 0x34) = fconvert.s(fconvert.t(arg2) - cosine(var_1c_2) * fconvert.t(var_24_1))
...
004241f8        int32_t* eax_25 = edi + self->__offset(0x5c).d
004241fe        *eax_25 = 0x3f800000
00424204        eax_25[1] = 0
00424207        eax_25[2] = 0
0042420d        *(edi + self->__offset(0x5c).d + 0x10) = 0
00424214        void* eax_27 = self->__offset(0x5c).d + edi
00424219        *(eax_27 + 0x14) = fconvert.s(fconvert.t(arg2) - fconvert.t(*(eax_27 + 0x34)))
0042421c        int32_t ecx_23 = self->__offset(0x5c).d
0042422c        *(edi + ecx_23 + 0x18) = fconvert.s(fconvert.t(7f) - fconvert.t(*(edi + ecx_23 + 0x38)))
00424236        normalize_vector(edi + self->__offset(0x5c).d + 0x10)
0042423e        struct Vec3* lhs_1 = self->__offset(0x5c).d + edi
...
004242d4        int32_t ecx_31 = self->__offset(0x5c).d
004242f8        float var_14_1 = fconvert.s(fconvert.t(*(edi_1 + ecx_31 + 0xdc)) - fconvert.t(*(edi_1 + ecx_31 + 0x34)))
004242ff        long double x87_r7_48 = fconvert.t(*(edi_1 + ecx_31 + 0xe0)) - fconvert.t(*(edi_1 + ecx_31 + 0x38))
00424306        *(edi_1 + ecx_31 + 0x80) = fconvert.s(fconvert.t(*(edi_1 + ecx_31 + 0xd8)) - fconvert.t(*(edi_1 + ecx_31 + 0x30)))
00424308        *(edi_1 + ecx_31 + 0x84) = var_14_1
00424313        *(edi_1 + ecx_31 + 0x88) = fconvert.s(x87_r7_48)
00424328        i_1 += 1
00424329        *(edi_1 + self->__offset(0x5c).d + 0x8c) = fconvert.s(normalize_vector(edi_1 + self->__offset(0x5c).d + 0x80))
00424333        edi_1 += 0xa8
0042433b        do while (i_1 s< self->segment_count)
00424350        request_object_vertices(self->_pad_00[0x24].d, (self->__offset(0x54).d + 1) * (self->segment_count + 1))
00424362        request_object_facequads(self->_pad_00[0x24].d, (self->__offset(0x54).d * self->segment_count) << 1)
00424367        void* eax_42 = self->_pad_00[0x24].d
0042436a        int32_t i_2 = 0
0042436c        arg3 = 0
00424370        int32_t edx_26 = *(eax_42 + 0x38)
00424377        int32_t edx_27 = *(eax_42 + 0x5c)
0042437d        int32_t var_20_1 = edx_27
00424383        if (self->segment_count s>= 0)
00424389        int32_t var_28_1 = 0
0042438d        int32_t ecx_40 = self->__offset(0x54).d
00424390        float edi_2 = 0f
00424394        arg2 = 0f
00424398        int32_t var_24_2 = ecx_40
0042439c        if (ecx_40 s>= 0)
004243b1        float* eax_45 = self->primary_samples + var_28_1
004243b3        i_2 = arg3
004243bd        long double x87_r7_51 = float.t(arg2) - float.t(var_24_2) * fconvert.t(0.5f)
004243e5        float var_8_2 = fconvert.s(fconvert.t(fconvert.s(x87_r7_51 * fconvert.t(eax_45[1]))) + fconvert.t(eax_45[0xd]))
004243f2        float var_4_2 = fconvert.s(x87_r7_51 * fconvert.t(eax_45[2]) + fconvert.t(eax_45[0xe]))
004243f6        int32_t eax_48 = (ecx_40 + 1) * i_2 i+ edi_2
004243f8        edi_2 += 1
004243f9        arg2 = edi_2
00424404        float* ecx_42 = edx_26 + eax_48 * 0xc
0042440b        *ecx_42 = fconvert.s(fconvert.t(fconvert.s(x87_r7_51 * fconvert.t(*eax_45))) + fconvert.t(eax_45[0xc]))
00424411        ecx_42[1] = var_8_2
00424418        ecx_42[2] = var_4_2
0042441b        ecx_40 = self->__offset(0x54).d
00424420        var_24_2 = ecx_40
00424424        do while (edi_2 s<= ecx_40)
00424431        i_2 += 1
0042443a        arg3 = i_2
...
0042445c        arg2 = 0f
00424460        if (self->__offset(0x54).d s> 0)
00424468        int32_t eax_57 = i_3 & 0x80000007
0042446d        if (eax_57 s< 0)
00424473        eax_57 = ((eax_57 - 1) | 0xfffffff8) + 1
00424487        arg3 = fconvert.s(float.t(eax_57) * fconvert.t(0.125f))
00424495        float var_28_2 = fconvert.s(float.t(eax_57 + 1) * fconvert.t(0.125f))
004244a4        int32_t ecx_45 = 0
004244aa        int32_t var_24_3 = 0
004244b4        arg2 = fconvert.s(float.t(arg2) * fconvert.t(0.125f))
004244c2        float var_2c_1 = fconvert.s(float.t(j + 1) * fconvert.t(0.125f))
004244dc        while (true)
004244dc        int32_t eax_65 = ecx_45 + ((self->__offset(0x54).d * i_3 + j) << 1)
004244df        if (ecx_45 != 0)
004245b0        int16_t* ebp_2 = eax_65 * 0x30 + edx_27
004245b3        *ebp_2 = 0
004245b9        ecx_45.w = self->__offset(0x54).w
004245bd        ecx_45.w += 1
004245c6        ebp_2[1] = ecx_45.w * i_3.w + j.w + 1
004245ca        int32_t eax_75
004245ca        eax_75.w = self->__offset(0x54).w
004245ce        eax_75.w += 1
004245d5        ebp_2[2] = eax_75.w * i_3.w + j.w
004245e7        ebp_2[3] = (self->__offset(0x54).w + 1) * (i_3.w + 1) + j.w
004245ff        ebp_2[4] = (self->__offset(0x54).w + 1) * (i_3.w + 1) + j.w + 1
...
004244eb        int16_t* ebp_1 = eax_65 * 0x30 + edx_27
004244ee        *ebp_1 = 0
004244f4        edx_27.w = self->__offset(0x54).w
004244f8        edx_27.w += 1
004244ff        ebp_1[1] = edx_27.w * i_3.w + j.w
00424503        eax_65.w = self->__offset(0x54).w
00424507        eax_65.w += 1
00424513        ebp_1[2] = eax_65.w * i_3.w + j.w + 1
00424524        ebp_1[3] = (self->__offset(0x54).w + 1) * (i_3.w + 1) + j.w + 1
00424533        ebp_1[4] = (self->__offset(0x54).w + 1) * (i_3.w + 1) + j.w
...
00424652        bool cond:9_1 = var_24_3 + 1 s< 2
00424655        var_24_3 += 1
00424659        if (not(cond:9_1))
00424659        break
004244c8        ecx_45 = var_24_3
004244cc        edx_27 = var_20_1
0042465f        j += 1
00424666        edx_27 = var_20_1
0042466c        arg2 = j
00424670        do while (j s< self->__offset(0x54).d)
0042467b        i_3 += 1
0042467e        do while (i_3 s< self->segment_count)
00424692        return finalize_path_template(self)
