...
00439bcb        uint8_t tile_type = arg1->tile_type
00439bdb        if (tile_type == 0x1d || tile_type == 0x1e)
...
00439c71        int16_t flags_a = (arg1->flags_a).w
00439c77        if ((flags_a:1.b & 2) != 0)
00439c81        void* ecx_8 = data_4df904 + 0x5a8
00439c87        if ((flags_a.b & 0x40) == 0)
00439c98        uint32_t flags_b = arg1->flags_b
00439c9d        if (flags_b != 0)
00439ca2        *(flags_b + 8) = arg1->_pad_08
00439ca5        uint8_t _pad_08[0x4] = arg1->_pad_08
00439caa        if (_pad_08 == 0)
00439cb7        *(ecx_8 + 4) = arg1->flags_b
00439caf        *(_pad_08 + 0xc) = arg1->flags_b
00439cbd        arg1->flags_b = *(ecx_8 + 8)
00439cc0        *(ecx_8 + 8) = arg1
00439cc3        arg1->flags_a &= 0xfffffdff
00439c8e        report_errorf("List remove NEXTBOD")
00439cc6        int32_t* esi_1 = &arg1->_pad_44
