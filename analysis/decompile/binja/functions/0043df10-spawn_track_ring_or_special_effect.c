...
0043df1b        enum SubRingState* ecx = &game->ring_effects.slots[0].state
0043df24        while ((ecx - 0x35b80c)->ring_effects.slots[0].state != SUB_RING_STATE_INACTIVE)
0043df26        eax += 1
0043df27        ecx = &ecx[0x7e]
0043df30        if (eax s>= 2)
0043df39        return
0043df5c        void* esi = game + eax * 0x1f8
...
0043df8b        enum SubRingKind requested_kind_1 = requested_kind
0043df8f        *(esi + 0x35b810) = player
0043df98        if (requested_kind_1 == SUB_RING_KIND_NORMAL_DEFAULT)
...
0043dfdd        requested_kind_1 = SUB_RING_KIND_SLOW_DEFAULT
...
0043dfe7        if (requested_kind_1 u<= SUB_RING_KIND_POWER_UP_AUTHORED)
0043dfed        label_43dfed:
0043dfed        switch (requested_kind_1)
0043dffe        case SUB_RING_KIND_UNKNOWN_0
...
0043e068        case SUB_RING_KIND_UNKNOWN_1
...
0043e0ce        case SUB_RING_KIND_EXPLODE_RAMP
...
0043e231        *(esi + 0x35b96c) = fconvert.s(random_float_below(1f) * fconvert.t(6.28318548f))
0043e237        *(esi + 0x35b970) = var_10
0043e138        case SUB_RING_KIND_SLOW_DEFAULT
...
0043e1a6        *(esi + 0x35b96c) = fconvert.s(random_float_below(1f) * fconvert.t(6.28318548f))
0043e1ac        *(esi + 0x35b970) = var_10
0043e1c1        case SUB_RING_KIND_NORMAL_DEFAULT
...
0043e231        *(esi + 0x35b96c) = fconvert.s(random_float_below(1f) * fconvert.t(6.28318548f))
0043e237        *(esi + 0x35b970) = var_10
0043e246        case SUB_RING_KIND_NORMAL_AUTHORED
...
0043e2c1        case SUB_RING_KIND_EXPLODE_AUTHORED
...
0043e346        *(esi + 0x35b96c) = fconvert.s(random_float_below(1f) * fconvert.t(6.28318548f))
0043e365        *(esi + 0x35b970) = fconvert.s(fconvert.t(1f) / (fconvert.t(ring_speed) * fconvert.t(60f)) * fconvert.t(game->subgame_rate) * fconvert.t(6.28318548f))
0043e303        case SUB_RING_KIND_SLOW_AUTHORED
...
0043e346        *(esi + 0x35b96c) = fconvert.s(random_float_below(1f) * fconvert.t(6.28318548f))
0043e365        *(esi + 0x35b970) = fconvert.s(fconvert.t(1f) / (fconvert.t(ring_speed) * fconvert.t(60f)) * fconvert.t(game->subgame_rate) * fconvert.t(6.28318548f))
0043e28b        case SUB_RING_KIND_POWER_UP_AUTHORED
...
0043e3ff        struct SubRing** eax_31 = &g_game_base->active_bod_list.first
...
0043e411        (*eax_31)->bod.list_next = nullptr
