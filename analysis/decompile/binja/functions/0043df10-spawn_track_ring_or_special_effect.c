...
0043dfa4        long double st0_1 = random_float_below(1f, "RT")
...
0043dfc3        long double st0_2 = random_float_below(1f, "RT2")
...
0043e02d        slot_cursor->ring.body.transform.position.x = x_4
0043e037        slot_cursor->ring.body.transform.position.y = var_8_1
0043e03a        slot_cursor->ring.body.transform.position.z = fconvert.s(x87_r7_13)
0043e042        long double x87_r7_15 = random_float_below(1f, "RR") - fconvert.t(0.5f)
0043e055        slot_cursor->ring.body.transform.position.x = fconvert.s((x87_r7_15 + x87_r7_15) * fconvert.t(3f))
0043e231        slot_cursor->ring.active_phase = fconvert.s(random_float_below(1f, "RR1") * fconvert.t(6.28318548f))
...
0043e0a2        slot_cursor->ring.body.transform.position.x.12 = struct Vec3 {
    .x = x
    .y = fconvert.s(fconvert.t(cell->anchor_position.y) + fconvert.t(2.5f))
    .z = fconvert.s(fconvert.t(cell->anchor_position.z) + fconvert.t(6f))
}
0043e0aa        long double x87_r7_23 = random_float_below(1f, "RR2") - fconvert.t(0.5f)
0043e0bd        slot_cursor->ring.body.transform.position.x = fconvert.s((x87_r7_23 + x87_r7_23) * fconvert.t(3f))
0043e1a6        slot_cursor->ring.active_phase = fconvert.s(random_float_below(1f, "RR3") * fconvert.t(6.28318548f))
...
0043e0fd        slot_cursor->ring.body.transform.position.x = x_5
0043e107        slot_cursor->ring.body.transform.position.y = var_8_3
0043e10a        slot_cursor->ring.body.transform.position.z = fconvert.s(x87_r7_29)
0043e112        long double x87_r7_31 = random_float_below(1f, "RR4") - fconvert.t(0.5f)
0043e125        slot_cursor->ring.body.transform.position.x = fconvert.s((x87_r7_31 + x87_r7_31) * fconvert.t(3f))
0043e231        slot_cursor->ring.active_phase = fconvert.s(random_float_below(1f, "RR5") * fconvert.t(6.28318548f))
0043e237        slot_cursor->ring.active_phase_step = default_phase_step
0043e146        case 3
0043e146        float x_1 = cell->anchor_position.x
0043e14e        float x_12 = x_1
0043e172        slot_cursor->ring.body.transform.position.x.12 = struct Vec3 {
    .x = x_1
    .y = fconvert.s(fconvert.t(cell->anchor_position.y) + fconvert.t(2.5f))
    .z = fconvert.s(fconvert.t(cell->anchor_position.z) + fconvert.t(6f))
}
0043e17a        long double x87_r7_39 = random_float_below(1f, "RR6") - fconvert.t(0.5f)
0043e18d        slot_cursor->ring.body.transform.position.x = fconvert.s((x87_r7_39 + x87_r7_39) * fconvert.t(3f))
0043e1a6        slot_cursor->ring.active_phase = fconvert.s(random_float_below(1f, "RR7") * fconvert.t(6.28318548f))
0043e1ac        slot_cursor->ring.active_phase_step = default_phase_step
0043e1d4        case 4
...
0043e1f0        slot_cursor->ring.body.transform.position.x = x_6
0043e1fa        slot_cursor->ring.body.transform.position.y = var_8_5
0043e1fd        slot_cursor->ring.body.transform.position.z = fconvert.s(x87_r7_47)
0043e205        long double x87_r7_49 = random_float_below(1f, "RR8") - fconvert.t(0.5f)
0043e218        slot_cursor->ring.body.transform.position.x = fconvert.s((x87_r7_49 + x87_r7_49) * fconvert.t(3f))
0043e231        slot_cursor->ring.active_phase = fconvert.s(random_float_below(1f, "RR9") * fconvert.t(6.28318548f))
0043e237        slot_cursor->ring.active_phase_step = default_phase_step
0043e246        case 5
...
0043e270        slot_cursor->ring.body.transform.position.x = x_2
0043e276        slot_cursor->ring.body.transform.position.y = var_8_6
0043e279        slot_cursor->ring.body.transform.position.z = z_2
0043e346        slot_cursor->ring.active_phase = fconvert.s(random_float_below(1f, "RR10") * fconvert.t(6.28318548f))
...
0043e2eb        slot_cursor->ring.body.transform.position.x = x_3
0043e2f1        slot_cursor->ring.body.transform.position.y = var_8_8
0043e2f4        slot_cursor->ring.body.transform.position.z = z_3
0043e346        slot_cursor->ring.active_phase = fconvert.s(random_float_below(1f, "RR12") * fconvert.t(6.28318548f))
0043e365        slot_cursor->ring.active_phase_step = fconvert.s(fconvert.t(1f) / (fconvert.t(ring_speed) * fconvert.t(60f)) * fconvert.t(game->subgame_rate) * fconvert.t(6.28318548f))
0043e303        case 7
...
0043e31b        slot_cursor->ring.body.transform.position.x:3.b = x_8:3.b
...
0043e2a3        slot_cursor->ring.body.transform.position.x:3.b = x_7:3.b
...
0043e3ad        long double st0_11 = random_float_below(1f, "RT1")
...
0043e3e7        if ((0x200 & slot_cursor->ring.body.bod.bod.list_flags) == 0)
