...
0040a310        if (is_mouse_captured(arg1 + 0x290).b != 0)
...
0040a3d5        if (esi_1 != 0)
0040a3da        int32_t eax_2
0040a3da        eax_2.b = esi_1[1].b | 0x40
0040a3dc        esi_1[1] = eax_2
0040a3e3        (**edi_1)()
0040a3e9        edi_1 = esi_1
0040a3ee        var_14 += 1
0040a3f2        if (esi_1 == 0)
0040a3f2        break
0040a3f7        int32_t eax_4
0040a3f7        eax_4.b = esi_1[1].b & 0xbf
0040a3f9        esi_1[1] = eax_4
0040a40a        (**(arg1 + 0x124))()
