...
00409b23        struct Vec3 vector = struct Vec3 {
    .z = 0
    .x = fconvert.s(fconvert.t(x1) - fconvert.t(x0))
    .y = fconvert.s(fconvert.t(y1) - fconvert.t(y0))
}
...
00409bc3        queue_textured_quad_corners(texture_id, fconvert.s(fconvert.t(x0) - x87_r7_8), fconvert.s(fconvert.t(y0) - x87_r6_2), fconvert.s(fconvert.t(x1) - x87_r7_8), fconvert.s(fconvert.t(y1) - x87_r6_2), fconvert.s(x87_r7_8 + fconvert.t(x1)), fconvert.s(x87_r6_2 + fconvert.t(y1)), fconvert.s(x87_r7_8 + fconvert.t(x0)), fconvert.s(x87_r6_2 + fconvert.t(y0)), 0f, 0f, 0x1000000, color, 0f, 0f, 1f, 1f, 0xf, 0f)
00409bcb        return
