...
00431ea0        if (**cursor != 0x20)
00431eb6        char* ecx_6
00431ea4        char ecx_4 = **cursor
00431ea9        if (ecx_4 == 0xd)
00431ea9        break
00431eab        *out_1 = ecx_4
00431eaf        out_1 = &out_1[1]
00431eb0        ecx_6 = &(*cursor)[1]
00431eb1        *cursor = ecx_6
00431eb6        do while (*ecx_6 != 0x20)
00431eb8        *out_1 = 0
00431ebb        return
