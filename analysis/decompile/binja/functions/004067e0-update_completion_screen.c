...
00406934        complete_subgame(g_game_base + 0x74618, 1)
00406939        void* game_base_3 = g_game_base
00406945        if (*(game_base_3 + 0x30d) != 1)
00406996        destroy_completion_screen(prompt)
004069a6        uninit_pause_menu(g_game_base + 0x7462c)
004069b2        *(g_game_base + 0x74621) = 0
004069bd        set_sprite_manager_paused(&g_sprite_manager, 0)
004069ce        destroy_subgame(g_game_base + 0x74618)
004069d3        void* game_base_5 = g_game_base
004069d9        int32_t eax_7 = *(game_base_5 + 0x74658)
004069e7        if (eax_7 == 4 || eax_7 == 1)
004069fe        initialize_subgame(game_base_5 + 0x74618)
004069e9        *(game_base_5 + 0x1b8) = 2
0040694f        prompt->previous_frontend_state = *(game_base_3 + 0x1b8)
00406952        destroy_completion_screen(prompt)
00406962        uninit_pause_menu(g_game_base + 0x7462c)
0040696e        *(g_game_base + 0x74621) = 0
00406979        set_sprite_manager_paused(&g_sprite_manager, 0)
0040698a        destroy_subgame(g_game_base + 0x74618)
00406a54        case 1
...
00406a80        uninit_pause_menu(g_game_base + 0x7462c)
00406a91        *(g_game_base + 0x74621) = 0
00406a97        set_sprite_manager_paused(&g_sprite_manager, 0)
00406aa7        destroy_subgame(g_game_base + 0x74618)
00406aac        void* game_base_4 = g_game_base
00406ab7        *(game_base_4 + 0x1b8) = *(game_base_4 + 0x1066bf0)
00406ac2        case 2
...
00406aee        destroy_subgame(g_game_base + 0x74618)
00406af8        *(g_game_base + 0x1b8) = 2
00406a08        case 5
...
00406a33        uninit_pause_menu(g_game_base + 0x7462c)
00406a3f        *(g_game_base + 0x74621) = 0
00406a4a        set_sprite_manager_paused(&g_sprite_manager, 0)
00406aee        destroy_subgame(g_game_base + 0x74618)
00406af8        *(g_game_base + 0x1b8) = 2
00406b10        case 6
00406b10        update_new_game_menu(g_game_base + 0x4f2dc)
...
00406820        *(g_game_base + 0x38) = 3
00406838        case 8
00406838        update_main_menu(g_game_base + 0x4f324)
...
0040685d        g_game_base
00406869        destroy_main_menu()
0040686e        void* game_base_1 = g_game_base
00406876        if (*(game_base_1 + 0x38) == 0)
0040687c        *(game_base_1 + 0x38) = 1
00406893        case 9
00406893        update_galaxy(g_game_base + 0x12d4638)
...
004068bd        destroy_galaxy(g_game_base + 0x12d4638)
004068d0        complete_subgame(g_game_base + 0x74618, 1)
004068d5        void* game_base_2 = g_game_base
004068e1        if (*(game_base_2 + 0x30d) != 1)
004068e1        goto label_406add
004068ef        prompt->previous_frontend_state = *(game_base_2 + 0x1b8)
004068f2        destroy_completion_screen(prompt)
00406903        destroy_subgame(g_game_base + 0x74618)
...
00406b73        *(g_game_base + 0x1b8) = prompt->previous_frontend_state
00406b80        *(g_game_base + 0x568) = 0
