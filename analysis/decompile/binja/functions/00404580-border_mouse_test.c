...
00404583        struct GameRoot* game_base_1 = g_game_base
0040458e        if (eax.b == 0)
004046af        long double x87_r7_17 = fconvert.t(widget->layout_left) - fconvert.t(widget->target_padding)
004046b5        long double temp0_1 = fconvert.t(game_base_1->players[0].mouse_cursor.saved_x)
...
004046d4        long double temp2_1 = fconvert.t(game_base_1->players[0].mouse_cursor.saved_x)
...
004046ed        long double temp4_1 = fconvert.t(game_base_1->players[0].mouse_cursor.saved_y)
...
0040470c        long double temp6_1 = fconvert.t(game_base_1->players[0].mouse_cursor.saved_y)
...
00404719        eax.b = 1
0040471e        return 1
00404594        long double x87_r7 = fconvert.t(game_base_1->players[0].mouse_cursor.saved_x)
...
004045b7        long double temp3_1 = fconvert.t(game_base_1->players[0].mouse_cursor.saved_x)
...
004045c8        long double x87_r7_3 = fconvert.t(game_base_1->players[0].mouse_cursor.saved_y)
...
004045eb        long double temp7_1 = fconvert.t(game_base_1->players[0].mouse_cursor.saved_y)
...
0040464e        eax_2, x87control_1 = ftol(x87control, float.t(esi_1) * fconvert.t(var_8_1))
00404653        int32_t ebx_1 = 0
00404655        int32_t edi_1 = eax_2
00404657        ebx_1.w = mask->height
00404667        int32_t eax_3 = ftol(x87control_1, float.t(ebx_1) * fconvert.t(var_4_1))
...
004046a1        if (*((esi_1 * eax_3 + edi_1 + 6) * 3 + mask) == 0)
004046a3        char* eax_5
004046a3        eax_5.b = 1
004046a8        return 1
0040471f        eax.b = 0
