...
00428fc1        eax_49 = &vertices[(width_cells + 1) * i_2 + width_cells_2]
...
00428f4b        eax_49 = &vertices[(width_cells + 1) * i_2 + width_cells_2]
...
004291d8        *(edi_5 + 0x18) = width_cells_
004291e1        *(edi_5 + 0x1c) = var_54_1
004291e8        *(edi_5 + 0x20) = width_cells_
004291eb        *(edi_5 + 0x24) = var_4c_1
004291f0        *(edi_5 + 0x28) = var_50_1
004291f3        *(edi_5 + 0x2c) = var_4c_1
0042909e        int32_t ecx_55 = eax_65 * 0x30
004290a5        int16_t* edi_4 = ecx_55 + facequads
004290a8        *edi_4 = 0
...
00429117        *(edi_4 + 0x10) = width_cells_
...
00429137        *(edi_4 + 0x28) = width_cells_
