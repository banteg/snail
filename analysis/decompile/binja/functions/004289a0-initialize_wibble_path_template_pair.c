...
004289d6        allocate_path_nodes(self)
...
00429157        int16_t* edi_5 = eax_65 * 0x30 + facequads
0042915a        *edi_5 = 0
...
004291c9        *(edi_5 + 0xc) = get_or_create_texture_ref(&data_4b7790, texture_path_1, 0, 0)
...
004290a5        int16_t* edi_4 = eax_65 * 0x30 + facequads
004290a8        *edi_4 = 0
...
00429110        *(edi_4 + 0xc) = get_or_create_texture_ref(&data_4b7790, texture_path, 0, 0)
...
00429235        return finalize_path_template_record(self)
