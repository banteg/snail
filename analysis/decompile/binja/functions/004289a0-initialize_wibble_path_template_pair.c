...
00428a3e        struct PathTemplateSample* primary_samples_5 = self->primary_samples
00428a41        primary_samples_5->delta_length.b = 0
00428a41        primary_samples_5->delta_length:1.b = 0
00428a41        primary_samples_5->delta_length:2.b = 0x80
00428a41        primary_samples_5->delta_length:3.b = 0x3f
...
00428a6e        struct PathTemplateSample* secondary_samples = self->secondary_samples
00428a71        secondary_samples->delta_length.b = 0
00428a71        secondary_samples->delta_length:1.b = 0
00428a71        secondary_samples->delta_length:2.b = 0x80
00428a71        secondary_samples->delta_length:3.b = 0x3f
...
00428c34        edx_13[2] = 0
00428c37        struct PathTemplateSample* primary_samples_6 = self->primary_samples
00428c59        float var_2c_1 = fconvert.s(fconvert.t(*(&primary_samples_6->transform.position.y + i)) - fconvert.t(*(primary_samples_6 + i - 0x74)))
00428c60        long double x87_r7_22 = fconvert.t(*(&primary_samples_6->transform.position.z + i)) - fconvert.t(*(primary_samples_6 + i - 0x70))
00428c6a        *(&primary_samples_6->transform.basis_forward + i) = fconvert.s(fconvert.t(*(&primary_samples_6->transform.position + i)) - fconvert.t(*(primary_samples_6 + i - 0x78)))
00428c6c        *(&primary_samples_6->transform.basis_forward.y + i) = var_2c_1
00428c77        *(&primary_samples_6->transform.basis_forward.z + i) = fconvert.s(x87_r7_22)
...
00428cab        struct PathTemplateSample* primary_samples_7 = self->primary_samples
00428cb1        texture_a_2 = &texture_a_2[1]
00428cb9        long double x87_r7_26 = fconvert.t(*(&primary_samples_7->transform.basis_up + i)) * fconvert.t(0.49000001f)
00428cc7        texture_a = texture_a_2
00428cd1        float var_20_1 = fconvert.s(fconvert.t(*(&primary_samples_7->transform.basis_up.y + i)) * fconvert.t(0.49000001f))
00428cd8        long double x87_r6_11 = fconvert.t(*(&primary_samples_7->transform.basis_up.z + i)) * fconvert.t(0.49000001f)
...
00428d20        struct PathTemplateSample* primary_samples_8 = self->primary_samples
00428d44        float var_2c_2 = fconvert.s(fconvert.t(*(primary_samples_8 + esi_4 + 0xdc)) - fconvert.t(*(&primary_samples_8->transform.position.y + esi_4)))
00428d4b        long double x87_r7_37 = fconvert.t(*(primary_samples_8 + esi_4 + 0xe0)) - fconvert.t(*(&primary_samples_8->transform.position.z + esi_4))
00428d52        *(&primary_samples_8->delta_dir_to_next + esi_4) = fconvert.s(fconvert.t(*(primary_samples_8 + esi_4 + 0xd8)) - fconvert.t(*(&primary_samples_8->transform.position + esi_4)))
00428d54        *(&primary_samples_8->delta_dir_to_next.y + esi_4) = var_2c_2
00428d5f        *(&primary_samples_8->delta_dir_to_next.z + esi_4) = fconvert.s(x87_r7_37)
...
00428d7b        struct PathTemplateSample* secondary_samples_1 = self->secondary_samples
00428d9f        float var_38_2 = fconvert.s(fconvert.t(*(secondary_samples_1 + esi_4 + 0xdc)) - fconvert.t(*(&secondary_samples_1->transform.position.y + esi_4)))
00428da6        long double x87_r7_44 = fconvert.t(*(secondary_samples_1 + esi_4 + 0xe0)) - fconvert.t(*(&secondary_samples_1->transform.position.z + esi_4))
00428dad        *(&secondary_samples_1->delta_dir_to_next + esi_4) = fconvert.s(fconvert.t(*(secondary_samples_1 + esi_4 + 0xd8)) - fconvert.t(*(&secondary_samples_1->transform.position + esi_4)))
00428daf        *(&secondary_samples_1->delta_dir_to_next.y + esi_4) = var_38_2
00428dba        *(&secondary_samples_1->delta_dir_to_next.z + esi_4) = fconvert.s(x87_r7_44)
00428dcf        i_1 += 1
...
00428e13        char* ecx_32 = &self->primary_samples[self->segment_count] - 0x28
00428e27        *ecx_32 = 0
00428e27        ecx_32[1] = 0
00428e27        ecx_32[2] = 0
00428e27        ecx_32[3] = 0
...
00428e38        ecx_32[8] = 0
00428e38        ecx_32[9] = 0
00428e38        ecx_32[0xa] = 0x80
00428e38        ecx_32[0xb] = 0x3f
...
00428ebe        struct Object* strip_mesh = self->strip_mesh
...
00428fd5        ecx_47 = fconvert.s(x87_r6_31)
...
00428f5b        ecx_47 = var_28_4
00428fdb        eax_49[2] = ecx_47
...
0042908e        while (true)
0042908e        int32_t eax_65 = ecx_51 + ((self->width_cells * i_3 + j) << 1)
00429091        if (ecx_51 != 0)
0042914c        struct ObjectFaceQuad* facequads_1 = facequads
00429157        int16_t* edi_5 = &facequads_1[eax_65]
0042915a        *edi_5 = 0
0042915f        ecx_51.w = self->width_cells.w
00429163        ecx_51.w += 1
0042916c        edi_5[1] = ecx_51.w * i_3.w + j.w + 1
00429170        facequads_1.w = self->width_cells.w
00429174        facequads_1.w += 1
0042917b        edi_5[2] = facequads_1.w * i_3.w + j.w
...
0042909e        int32_t ecx_53 = eax_65 * 0x30
004290a5        int16_t* edi_4 = ecx_53 + facequads
004290a8        *edi_4 = 0
004290ad        eax_65.w = self->width_cells.w
004290b1        eax_65.w += 1
004290b8        edi_4[1] = eax_65.w * i_3.w + j.w
004290bc        ecx_53.w = self->width_cells.w
004290c0        ecx_53.w += 1
004290cc        edi_4[2] = ecx_53.w * i_3.w + j.w + 1
