...
00417901        struct SubHighScoreTimeTrialRouteCursor* time_trial_route_cursor = bank + route_index * 0x1fac0
00417903        long double temp1_1 = fconvert.t(time_trial_route_cursor->record.score_or_time.total_seconds)
...
00417910        x87_r7_2 = fconvert.t(time_trial_route_cursor->record.score_or_time.total_seconds)
...
00417930        __builtin_memcpy(&time_trial_route_cursor->record, record, 0x1fac0)
00417932        time_trial_route_cursor->record.route_or_rank_index = route_index
0041793c        return
