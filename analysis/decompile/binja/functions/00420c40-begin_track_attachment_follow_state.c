...
00420c4e        struct PathTemplate* eax = source_cell->__offset(0x38).d
00420c51        follow_state->source_cell = source_cell
00420c54        follow_state->template_record = eax
00420c5b        follow_state->sample_index = 0
00420c68        follow_state->progress = fconvert.s(fconvert.t(world_position->z) - fconvert.t(source_cell->__offset(0x18).d))
...
00420c7a        int32_t eax_2 = get_track_cell_row_index(source_cell)
00420c8e        struct PathTemplate* template_record = follow_state->template_record
00420c99        template_record->installed_heading_delta = *(data_4df904 + eax_2 * 0xf4 + 0x64118c)
