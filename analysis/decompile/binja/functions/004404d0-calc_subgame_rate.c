...
004405f3        return
004404e5        long double x87_r7_2 = fconvert.t(game->player.body.transform.position.z) / float.t(game->completion_row_start)
...
00440548        x87_r7_7 = x87_r7_2 * fconvert.t(0.550000012f) + fconvert.t(game->rate_or_level_arg.base_rate)
00440527        if (level_mode != 4)
00440548        x87_r7_7 = x87_r7_2 * fconvert.t(0.200000003f) + fconvert.t(game->rate_or_level_arg.base_rate)
00440532        x87_r7_7 = x87_r7_2 * fconvert.t(0.400000006f) + fconvert.t(game->rate_or_level_arg.base_rate) + fconvert.t(0.200000003f)
0044054b        enum DamageGuageState state = game->player.damage_gauge.state
...
00440572        long double x87_r7_9 = fconvert.t(game->player.damage_gauge.display_fill)
...
00440585        x87_r7_10 = fconvert.t(game->player.damage_gauge.display_fill)
...
004405c8        x87_r7_11 = (fconvert.t(1f) - sine(fconvert.s(fconvert.t(game->player.damage_gauge.display_fill) * fconvert.t(12.566371f) + fconvert.t(1.57079637f)))) * fconvert.t(0.5f) * fconvert.t(game_1)
00440598        x87_r7_11 = fconvert.t(game_1)
004405cf        game->subgame_rate = fconvert.s(x87_r7_11 + fconvert.t(game->subgame_rate))
004405d9        if (game->player.sub_hover.state == SUB_HOVER_STATE_ACTIVE)
004405ea        game->subgame_rate = fconvert.s(fconvert.t(game->player.sub_hover.warning_intensity_latch) * fconvert.t(0.5f) + fconvert.t(game->subgame_rate))
004405f8        return
