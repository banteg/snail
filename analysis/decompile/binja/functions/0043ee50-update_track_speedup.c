...
0043ef0e        uint16_t list_flags_1 = (speedup->list_flags).w
...
0043ef61        return
0043ef62        struct SubSpeedUp* list_next_1 = speedup->list_next
0043ef67        if (list_next_1 != 0)
0043ef6c        list_next_1->list_prev = speedup->list_prev
0043ef6f        struct SubSpeedUp* list_prev_1 = speedup->list_prev
0043ef74        if (list_prev_1 == 0)
0043ef81        label_43ef81:
0043ef81        ecx_1->first = speedup->list_next
0043ef81        goto label_43ef87
0043ef79        list_prev_1->list_next = speedup->list_next
0043ef87        label_43ef87:
0043ef87        speedup->list_next = ecx_1->free_top
0043ef8a        ecx_1->free_top = speedup
0043ef8d        uint32_t list_flags_2 = speedup->list_flags
0043ef90        struct Sprite* sprite = speedup->sprite
0043ef96        list_flags_2:1.b &= 0xfd
0043ef99        speedup->list_flags = list_flags_2
0043ef9c        kill_sprite(sprite)
0043ee77        if (state == 2)
0043ee7d        uint16_t list_flags = (speedup->list_flags).w
...
0043eed0        return
0043eed1        struct SubSpeedUp* list_next = speedup->list_next
0043eed6        if (list_next != 0)
0043eedb        list_next->list_prev = speedup->list_prev
0043eede        struct SubSpeedUp* list_prev = speedup->list_prev
0043eee3        if (list_prev == 0)
0043eee3        goto label_43ef81
0043eeec        list_prev->list_next = speedup->list_next
