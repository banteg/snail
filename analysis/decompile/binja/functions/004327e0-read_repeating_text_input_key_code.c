...
004329fa        uint8_t eax_26 = is_key_down(0x2a)
00432a04        uint8_t eax_27
00432a04        if (eax_26 == 0)
00432a08        eax_27 = is_key_down(0x36)
00432a12        if (eax_26 != 0 || eax_27 != 0)
00432a14        ebx.b -= 0x20
00432a17        value = ebx.b
004329f6        if (ebx.b != 0)
...
00432cbc        if (ascii_upper_if_lowercase(value) != ascii_upper_if_lowercase(g_text_input_last_repeat_code))
