...
0042f87e        i += 1
0042f87f        *(eax_4 + object->vertex_colours) = 0x3f800000
0042f885        *(&object->vertex_colours->g + eax_4) = 0x3f800000
0042f88c        *(&object->vertex_colours->b + eax_4) = 0x3f800000
0042f893        eax_4 = &eax_4[4]
0042f898        do while (i s< object->vertex_count)
0042f89c        return
