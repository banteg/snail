...
0044432d        runtime_row_count_1 = game + (ecx << 2)
00444331        *(runtime_row_count_1 + &data_5ccac8) = *(&game->runtime_rows + (ecx << 2)) | 0x11
00444343        *(runtime_row_count_1 + &data_5ccb5c) = fconvert.s(fconvert.t(*(runtime_row_count_1 + &data_5ccb5c)) + fconvert.t(1f))
00444350        if ((*(runtime_row_count_1 + &data_5ccac8) & 0x20) != 0)
0044435e        *(runtime_row_count_1 + &data_5ccb58) = fconvert.s(fconvert.t(*(runtime_row_count_1 + &data_5ccb58)) * fconvert.t(-1f))
0044436d        if (((*(runtime_row_count_1 + &data_5ccac8)).w:1.b & 0x40) != 0)
0044437f        *(runtime_row_count_1 + &data_5ccb60) = fconvert.s(float.t(out_angle) + fconvert.t(*(runtime_row_count_1 + &data_5ccb60)) + fconvert.t(0.5f))
...
00444402        eax_7, x87control_1 = ftol(x87control_1, fconvert.t(esi_1[0x26]))
