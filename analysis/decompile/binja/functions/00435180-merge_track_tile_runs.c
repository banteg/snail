...
00435185        void* esi = arg1
00435187        int32_t i = 0
00435189        void* var_c = esi
00435192        if (*(esi + 0x54) s> 0)
00435194        int32_t* eax_1 = esi + 0x3bfb08
0043519a        int32_t j_1 = 8
004351ae        int32_t j
0043519f        int32_t ebp_1 = *eax_1
004351a1        eax_1 = &eax_1[0x15]
004351aa        j = j_1
004351aa        j_1 -= 1
004351ab        eax_1[-0x15] = ebp_1 | 0x6000
004351ae        do while (j != 1)
004351b3        i += 1
004351b6        do while (i s< *(esi + 0x54))
004351b8        int32_t result = *(esi + 0x54)
004351bb        int32_t var_10 = 0
004351c5        if (result s> 0)
004351d3        int32_t* var_4_1 = esi + 0x5ccb7c
004351d7        int32_t* ebx_1 = esi + 0x3bfb08
004353d4        bool cond:3_1
004351dd        int32_t i_2 = 0
004351df        int32_t i_6 = 0
004351ee        while (true)
004351ee        char eax_3 = is_slide_cache_tile_family(&ebx_1[-0x10])
004351f5        int16_t eax_4
004351f5        if (eax_3 != 0)
004351fb        eax_4 = (*ebx_1).w
...
004353f4        eax_20:1.b = (*ebx_1):1.b & 0xf1
...
0043541b        edx_5 = &edx_5[0x54]
0043541e        eax_20:1.b |= 1
00435421        esi_5 += 1
00435422        i_7 += 1
00435423        *ebx_1 = eax_20
00435428        if (i_7 s>= 8)
00435428        break
0043542d        if (esi_5 s> 1)
0043544d        set_bod_object(&ebx_1[-0x10], *(data_4df904 + esi_5 * 0x38 + 0x445bc))
00435459        int32_t edx_7
00435459        edx_7:1.b = (*ebx_1):1.b & 0xf0
00435461        int32_t i_10 = esi_5 - 1
00435464        *ebx_1 = (esi_5 & 0xf) << 8 | edx_7
00435466        if (i_10 s> 0)
00435485        void* eax_25 = var_c + (i_10 + (var_10 << 3) + i_2) * 0x54 + 0x3bfb08
...
004354ba        eax_26:1.b = (*ebx_1):1.b & 0xdf
004354bd        *ebx_1 = eax_26
004354c5        if (*(esi + 0x40) != 2)
004354df        eax_26:1.b &= 0xbf
004354e2        *ebx_1 = eax_26
004354d5        set_bod_object(&ebx_1[-0x10], *(data_4df904 + 0x44124))
004352cf        eax_10 = (*ebx_1).w
004352dc        if ((eax_10:1.b & 0x80) != 0 || (eax_10.b & 0x40) != 0)
004352d4        goto label_4353e2
004352e2        int32_t esi_2 = 0
004352e7        if (i_2 s< 8)
004352ed        int32_t* edi_4 = ebx_1
004352f9        if (is_floor_cache_tile_family(&edi_4[-0x10]) == 0)
004352f9        break
004352fb        int16_t eax_12 = (*edi_4).w
...
00435318        if (esi_2 s> 1)
00435334        set_bod_object(&ebx_1[-0x10], *(data_4df904 + esi_2 * 0x38 + 0x44afc))
00435339        int32_t i_9 = esi_2 - 1
0043533c        if (i_9 s> 0)
0043535b        void* eax_17 = var_c + (i_9 + (var_10 << 3) + i_6) * 0x54 + 0x3bfb08
...
0043537d        i_2 = i_6
0043520e        int32_t esi_1 = 0
00435213        if (i_2 s< 8)
00435219        int32_t i_4 = i_2
0043521b        char* ecx_2 = &ebx_1[-1]
0043521e        eax_4.b = *ecx_2
00435232        if (eax_4.b != 1 && eax_4.b != 0x15 && eax_4.b != 0x1b && eax_4.b != 0x21 && eax_4.b != 0x22)
00435232        break
00435234        eax_4 = (*(ecx_2 + 4)).w
...
00435252        if (esi_1 s> 1)
00435272        set_bod_object(&ebx_1[-0x10], *(data_4df904 + esi_1 * 0x38 + 0x4477c))
00435277        int32_t i_8 = esi_1 - 1
0043527a        if (i_8 s> 0)
00435299        void* eax_9 = var_c + (i_8 + (var_10 << 3) + i_2) * 0x54 + 0x3bfb08
...
0043538c        if ((var_4_1[-0x2d].b & 4) != 0)
00435397        ebx_1[-0xf] &= 0xfffffddd
0043539c        int32_t edx_4
0043539c        edx_4:1.b = (*ebx_1):1.b & 0xbf
0043539f        *ebx_1 = edx_4
004353a6        *var_4_1 &= 0xffffffdf
004353a8        i_2 += 1
...
004353cb        result = *(esi + 0x54)
004353ce        cond:3_1 = var_10 + 1 s< result
004353d0        var_10 += 1
004353d4        do while (cond:3_1)
004353e1        return result
