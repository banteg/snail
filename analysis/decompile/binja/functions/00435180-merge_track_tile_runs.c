...
004353e2        char eax_21 = (ebx_1 + 0xf8)->:0x3bfb04.b
004353e5        void* __offset(Game, 0x3bfb04) edx_5 = ebx_1 - 4
004353ea        if (eax_21 == 0xe)
004353f0        int32_t eax_22 = (ebx_1 - 0x3bfb08)->__offset(0x3bfb08).d
004353f2        int32_t esi_4 = 0
004353f4        eax_22:1.b &= 0xf1
004353f7        eax_22:1.b |= 1
004353fd        (ebx_1 - 0x3bfb08)->__offset(0x3bfb08).d = eax_22
004353ff        if (i_2 s< 8)
00435401        int32_t i_7 = i_2
00435406        while ((edx_5 - 0x3bfb04)->:0x3bfb04.b == 0xe)
00435416        if ((eax_22 & 0x4000) != 0x4000)
00435416        break
00435418        eax_22:1.b &= 0xf1
0043541b        edx_5 += 0x54
0043541e        eax_22:1.b |= 1
00435421        esi_4 += 1
00435422        i_7 += 1
00435423        (ebx_1 - 0x3bfb08)->__offset(0x3bfb08).d = eax_22
00435428        if (i_7 s>= 8)
00435428        break
0043542d        if (esi_4 s> 1)
0043544d        set_bod_object(ebx_1 - 0x40, *(g_game_base + esi_4 * 0x38 + 0x445bc))
00435452        int32_t edx_7 = (ebx_1 - 0x3bfb08)->__offset(0x3bfb08).d
00435459        edx_7:1.b &= 0xf0
00435461        int32_t i_10 = esi_4 - 1
00435464        (ebx_1 - 0x3bfb08)->__offset(0x3bfb08).d = (esi_4 & 0xf) << 8 | edx_7
00435466        if (i_10 s> 0)
00435485        void* eax_27 = &game_2->_pad_00[(i_10 + (var_10 << 3) + i_2) * 0x54 + 0x3bfb08]
004354a5        int32_t i_1
0043548c        int32_t ecx_33 = *(eax_27 - 0x3c)
0043548f        eax_27 -= 0x54
00435495        *(eax_27 + 0x18) = ecx_33 & 0xffffffdf
004354a1        i_1 = i_10
004354a1        i_10 -= 1
004354a2        *(eax_27 + 0x54) &= 0xffff9fff
004354a5        do while (i_1 != 1)
004354b2        if (eax_21 == 0 || eax_21 == 0x23)
004354b8        int32_t eax_28 = (ebx_1 - 0x3bfb08)->__offset(0x3bfb08).d
004354ba        eax_28:1.b &= 0xdf
004354bd        (ebx_1 - 0x3bfb08)->__offset(0x3bfb08).d = eax_28
004354c5        if (game_1->level_mode != 2)
004354df        eax_28:1.b &= 0xbf
004354e2        (ebx_1 - 0x3bfb08)->__offset(0x3bfb08).d = eax_28
004354d5        set_bod_object(ebx_1 - 0x40, *(g_game_base + 0x44124))
004352cf        int16_t eax_11 = ((ebx_1 - 0x3bfb08)->__offset(0x3bfb08).d).w
004352dc        if ((eax_11:1.b & 0x80) != 0 || (eax_11.b & 0x40) != 0)
...
004352f9        break
004352fb        int16_t eax_13 = ((edi_4 - 0x3bfb08)->__offset(0x3bfb08).d).w
00435300        if ((eax_13:1.b & 0x80) != 0)
00435300        break
00435305        if ((eax_13:1.b & 0x40) == 0)
00435305        break
00435309        if ((eax_13.b & 0x60) != 0)
00435309        break
0043530b        esi_1 += 1
0043530c        edi_4 += 0x54
0043530f        i_2 += 1
...
00435334        set_bod_object(ebx_1 - 0x40, *(g_game_base + esi_1 * 0x38 + 0x44afc))
00435339        int32_t i_9 = esi_1 - 1
0043533c        if (i_9 s> 0)
0043535b        void* eax_18 = &game_2->_pad_00[(i_9 + (var_10 << 3) + i_6) * 0x54 + 0x3bfb08]
0043537b        int32_t i_3
00435362        int32_t ebp_3 = *(eax_18 - 0x3c)
00435365        eax_18 -= 0x54
0043536b        *(eax_18 + 0x18) = ebp_3 & 0xffffffdf
00435377        i_3 = i_9
00435377        i_9 -= 1
00435378        *(eax_18 + 0x54) &= 0xffff9fff
0043537b        do while (i_3 != 1)
0043537d        i_2 = i_6
0043520e        int32_t esi = 0
00435213        if (i_2 s< 8)
00435219        int32_t i_4 = i_2
0043521b        char* ecx_2 = ebx_1 - 4
0043521e        char eax_5 = *ecx_2
00435232        if (eax_5 != 1 && eax_5 != 0x15 && eax_5 != 0x1b && eax_5 != 0x21 && eax_5 != 0x22)
00435232        break
00435234        eax_4.b = ecx_2[4]
00435234        eax_4:1.b = ecx_2[5]
00435234        eax_4:2.b = ecx_2[6]
00435234        eax_4:3.b = ecx_2[7]
...
00435252        if (esi s> 1)
00435272        set_bod_object(ebx_1 - 0x40, *(g_game_base + esi * 0x38 + 0x4477c))
00435277        int32_t i_8 = esi - 1
0043527a        if (i_8 s> 0)
00435299        void* eax_10 = &game_2->_pad_00[(i_8 + (var_10 << 3) + i_2) * 0x54 + 0x3bfb08]
004352b9        int32_t i_5
004352a0        int32_t ecx_9 = *(eax_10 - 0x3c)
004352a3        eax_10 -= 0x54
004352a9        *(eax_10 + 0x18) = ecx_9 & 0xffffffdf
004352b5        i_5 = i_8
004352b5        i_8 -= 1
004352b6        *(eax_10 + 0x54) &= 0xffff9fff
004352b9        do while (i_5 != 1)
0043538c        if (((var_4_1 - 0x5ccb7c)->:0x5ccac8.b & 4) != 0)
00435397        (ebx_1 - 0x3bfb08)->__offset(0x3bfacc).d &= 0xfffffddd
0043539a        int32_t edx_4 = (ebx_1 - 0x3bfb08)->__offset(0x3bfb08).d
