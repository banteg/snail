...
00404920        void* eax_32 = data_4df904
00404929        char ebx = arg3.b
00404932        int32_t ecx = *(eax_32 + 0x74658)
0040493c        if (ecx != 0)
00404959        if (ecx == 1)
0040495f        ecx.b = *(eax_32 + 0x1066be8)
...
00404969        void* ecx_1 = *(eax_32 + 0x1066bec)
...
00404c1e        edi_5, esi_4 = __builtin_memcpy(edi_3 - 1, edi_1 - ecx_26, ecx_26 u>> 2 << 2)
