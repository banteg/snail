...
00444d1d        if (player->attachment_exit_pending == 0 && player->_pad_41c == 0 && player->__offset(0x2d8).b == 0)
...
00444dc6        long double x87_r7_8 = fconvert.t(player->hover_progress)
...
00444ddf        player->hover_progress = player->hover_progress_target
...
00444ec2        i_1 += 0xb0
00444eda        struct GarbageHazardRuntime* i_2 = player->game->active_garbage_hazards
00444ee2        while (i_2 != 0)
00444eee        if (i_2->state == 1)
00444f15        long double x87_r7_21 = fconvert.t(i_2->world_position.z) - fconvert.t(player->__offset(0x296c).d)
00444f1f        vector.x = fconvert.s(fconvert.t(i_2->world_position.x) - fconvert.t(player->__offset(0x2964).d))
00444f23        vector.y = fconvert.s(fconvert.t(i_2->world_position.y) - fconvert.t(player->__offset(0x2968).d))
...
00445025        int32_t ecx_14 = *(&game_9->slug_hazards[0].state + i_3)
...
00445137        *(&game_1->slug_hazards[0]._pad_b4[0x25] + i_3) = 1
00445152        int32_t eax_18 = __ftol(x87control, float.t(next_math_random_value()) * fconvert.t(-6.10351562e-05f))
0044516c        x87control = play_slug_voice(&player->game->slug_hazards + i_3, 0x22 - eax_18)
...
00445265        if (*(&game_5->track_parcels[0].state + i_4) == 1)
00445277        vector_2.x = fconvert.s(fconvert.t(*(eax_22 + 0x125e490)) - fconvert.t(player->__offset(0x2964).d))
0044528b        vector_2.y = fconvert.s(fconvert.t(*(eax_22 + 0x125e494)) - fconvert.t(player->__offset(0x2968).d))
00445295        long double x87_r7_56 = fconvert.t(*(eax_22 + 0x125e498)) - fconvert.t(player->__offset(0x296c).d)
...
00445306        *(&player->game->track_parcels[0].state + i_4) = 4
...
00445339        uint32_t parcel_target_count = game_2->parcel_target_count
...
0044537b        if (*(&game_6->health_pickups[0].state + i_5) == 1)
0044538d        vector.x = fconvert.s(fconvert.t(*(eax_27 + 0x356010)) - fconvert.t(player->__offset(0x2964).d))
004453a1        vector.y = fconvert.s(fconvert.t(*(eax_27 + 0x356014)) - fconvert.t(player->__offset(0x2968).d))
004453b5        vector_1.x = vector.x
004453b9        vector_1.y = vector.y
004453bd        vector.z = fconvert.s(fconvert.t(*(eax_27 + 0x356018)) - fconvert.t(player->__offset(0x296c).d))
...
00445499        vector.x = fconvert.s(fconvert.t(game_3->__offset(0x355e18).d) - fconvert.t(player->__offset(0x2964).d))
004454ad        vector.y = fconvert.s(fconvert.t(game_3->__offset(0x355e1c).d) - fconvert.t(player->__offset(0x2968).d))
004454c1        vector_1.x = vector.x
004454c5        vector_1.y = vector.y
004454c9        vector.z = fconvert.s(fconvert.t(game_3->__offset(0x355e20).d) - fconvert.t(player->__offset(0x296c).d))
...
00445568        if (game_4->jetpack_pickup.state == 1)
0044557a        vector.x = fconvert.s(fconvert.t(game_4->jetpack_pickup.world_position.x) - fconvert.t(player->__offset(0x2964).d))
0044558e        vector.y = fconvert.s(fconvert.t(game_4->jetpack_pickup.world_position.y) - fconvert.t(player->__offset(0x2968).d))
004455a2        vector_1.x = vector.x
004455a6        vector_1.y = vector.y
004455aa        vector.z = fconvert.s(fconvert.t(game_4->jetpack_pickup.world_position.z) - fconvert.t(player->__offset(0x296c).d))
...
004455f3        player->game->jetpack_pickup.state = 2
...
00445639        vector_2.x = fconvert.s(fconvert.t(*(eax_36 + 0x35b7f4)) - fconvert.t(player->__offset(0x2964).d))
00445649        vector_2.y = fconvert.s(fconvert.t(*(eax_36 + 0x35b7f8)) - fconvert.t(player->__offset(0x2968).d))
00445653        long double x87_r7_96 = fconvert.t(*(eax_36 + 0x35b7fc)) - fconvert.t(player->__offset(0x296c).d)
...
004456b4        eax_39.b = player->completion_handoff_active
...
004456dd        player->velocity.z = fconvert.s(fconvert.t(game_7->track_center_x) * fconvert.t(0.5f))
...
004457ab        int32_t eax_45 = player->__offset(0x404).d
004457b4        if (eax_45 s< 0xa)
004457c0        if ((game_8->runtime_flags.b & 0x10) != 0 && game_8->level_mode != 3)
004457c3        player->__offset(0x404).d = eax_45 + 1
004457d4        play_voice_manager(0x751498, 5, 1, 0xffffffff)
004457d9        uint32_t movement_flag_selector_1 = player->movement_flag_selector
...
0044571b        uint32_t movement_flag_selector = player->movement_flag_selector
...
004457a4        initialize_nuke(&player->__offset(0x150).d)
0044581d        i_6 += 0x1f8
00445836        return
