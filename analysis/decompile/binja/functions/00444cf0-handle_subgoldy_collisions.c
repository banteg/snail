...
00445025        int32_t ecx_14 = *(i_3 + player->game + 0x356420)
...
00445048        float var_54_4 = fconvert.s(unimplemented  {fstp dword [esp+0x30], st0})
...
00445058        float var_50_4 = fconvert.s(unimplemented  {fstp dword [esp+0x34], st0})
...
00445070        vector.x = var_54_4
00445074        vector.y = var_50_4
00445078        float var_4c_4 = fconvert.s(unimplemented  {fst dword [esp+0x38], st0})
...
00445086        vector.z = var_4c_4
0044508a        float eax_13
...
0044509e        float var_74_2 = fconvert.s(unimplemented  {fst dword [esp+0x10], st0})
...
00445104        float var_44_1 = fconvert.s(unimplemented  {fstp dword [esp+0x40], st0})
00445104        unimplemented  {fstp dword [esp+0x40], st0}
0044510c        unimplemented  {fmul st0, dword [0x4974b8]}
00445112        player->velocity.y = var_44_1
00445115        float var_40_1 = fconvert.s(unimplemented  {fstp dword [esp+0x44], st0})
00445115        unimplemented  {fstp dword [esp+0x44], st0}
0044511d        player->velocity.z = var_40_1
...
00445144        int32_t var_70_1 = next_math_random_value()
...
0044516c        x87control = play_slug_voice(&player->game->_pad_00[i_3 + 0x3563a0], 0x22 - eax_18)
...
0044518f        float var_30_1 = fconvert.s(unimplemented  {fstp dword [esp+0x5c], st0})
...
00445199        float var_2c_1 = fconvert.s(unimplemented  {fstp dword [esp+0x60], st0})
...
004451ab        vector_2.x = fconvert.s(unimplemented  {fstp dword [esp+0x50], st0})
...
004451c8        vector_2.y = fconvert.s(unimplemented  {fstp dword [esp+0x58], st0})
004451c8        unimplemented  {fstp dword [esp+0x58], st0}
004451d0        unimplemented  {fadd dword [esi+0x296c]}
004451d6        float y = vector_2.y
004451e5        vector_2.z = fconvert.s(unimplemented  {fstp dword [esp+0x60], st0})
...
00445277        vector_2.x = fconvert.s(unimplemented  {fstp dword [esp+0x48], st0})
...
0044528b        vector_2.y = fconvert.s(unimplemented  {fstp dword [esp+0x4c], st0})
...
004452a7        vector_2.z = fconvert.s(unimplemented  {fst dword [esp+0x50], st0})
...
00445339        int32_t var_88_3 = game->__offset(0x1b01e0).d
0044533a        int32_t var_8c_1 = ebx_2
00445346        sub_48b32c(game->__offset(0x35bb94).d + 0x2cc, "%i/%i")
0044534e        i_4 += 0x8c
...
0044538d        vector.x = fconvert.s(unimplemented  {fstp dword [esp+0x18], st0})
...
004453a1        vector.y = fconvert.s(unimplemented  {fstp dword [esp+0x1c], st0})
...
004453bd        vector.z = fconvert.s(unimplemented  {fstp dword [esp+0x20], st0})
...
00445416        normalize_vector(&vector_1)
...
00445455        health_collect_particles(player, &player->game->_pad_00[i_5 + 0x356000])
...
00445499        vector.x = fconvert.s(unimplemented  {fstp dword [esp+0x18], st0})
...
004454ad        vector.y = fconvert.s(unimplemented  {fstp dword [esp+0x1c], st0})
...
004454c9        vector.z = fconvert.s(unimplemented  {fstp dword [esp+0x20], st0})
...
0044551e        normalize_vector(&vector_1)
...
0044557a        vector.x = fconvert.s(unimplemented  {fstp dword [esp+0x18], st0})
...
0044558e        vector.y = fconvert.s(unimplemented  {fstp dword [esp+0x1c], st0})
...
004455aa        vector.z = fconvert.s(unimplemented  {fstp dword [esp+0x20], st0})
...
004455db        normalize_vector(&vector_1)
...
00445614        struct Game* game_2 = player->game
00445621        result = i_6 + game_2
00445627        if (*(i_6 + game_2 + 0x35b80c) == 1)
0044562d        unimplemented  {fld st0, dword [eax+0x35b7f4]}
00445633        unimplemented  {fsub st0, dword [esi+0x2964]}
00445639        vector_2.x = fconvert.s(unimplemented  {fstp dword [esp+0x48], st0})
...
00445649        vector_2.y = fconvert.s(unimplemented  {fstp dword [esp+0x4c], st0})
...
00445669        vector_2.z = fconvert.s(unimplemented  {fst dword [esp+0x50], st0})
...
0044568d        normalize_vector(&vector_4)
...
004456f7        struct Game* game_1 = player->game
004456fd        result = *(i_6 + game_1 + 0x35b814)
00445710        int32_t eax_39
00445710        if (result == 4 || result == 5)
004457ab        int32_t eax_40 = player->_pad_3c4[0x40].d
004457b4        if (eax_40 s< 0xa)
004457c0        if ((game_1->runtime_flags.b & 0x10) != 0 && game_1->level_mode != 3)
004457c3        player->_pad_3c4[0x40] = (eax_40 + 1).b
004457c3        player->_pad_3c4[0x41] = (eax_40 + 1):1.b
004457c3        player->_pad_3c4[0x42] = (eax_40 + 1):2.b
004457c3        player->_pad_3c4[0x43] = (eax_40 + 1):3.b
...
0044580d        play_sound_effect(eax_39 + 1)
...
00445792        int32_t ecx_56 = player->_pad_374[4].d
00445798        player->_pad_374[0] = ecx_56.b
00445798        player->_pad_374[1] = ecx_56:1.b
00445798        player->_pad_374[2] = ecx_56:2.b
00445798        player->_pad_374[3] = ecx_56:3.b
