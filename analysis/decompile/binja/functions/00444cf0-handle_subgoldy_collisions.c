...
00444dc6        long double x87_r7_8 = fconvert.t(player->_pad_14d[0x87].d)
...
00444dd9        int32_t ecx_2 = player->_pad_14d[0x8b].d
00444ddf        player->_pad_14d[0x87] = ecx_2.b
...
0044501f        struct Game* game_8 = player->game
00445025        int32_t ecx_14 = *(i_3 + game_8 + 0x356420)
0044502c        void* eax_13 = i_3 + game_8
...
004450e9        long double x87_r7_41 = fconvert.t(game->track_center_x)
...
00445137        *(i_3 + player->game + 0x356479) = 1
00445152        int32_t eax_19 = __ftol(x87control, float.t(next_math_random_value()) * fconvert.t(-6.10351562e-05f))
0044516c        x87control = play_slug_voice(i_3 + player->game + 0x3563a0, 0x22 - eax_19)
...
004451f1        firework_shoot(&x, player->_pad_374[0xc].d, 1.28919459e-43f, 1.12103877e-43f)
0044523f        i_3 += 0xec
...
004452b9        float eax_24
004452b9        eax_24.w = (x87_r7_56 < temp25_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_56, temp25_1) ? 1 : 0) << 0xa | (x87_r7_56 == temp25_1 ? 1 : 0) << 0xe
004452be        if ((eax_24:1.b & 1) != 0)
...
00445339        int32_t var_88_3 = game_1->__offset(0x1b01e0).d
0044533a        int32_t var_8c_1 = ebx_2
00445346        sub_48b32c(game_1->__offset(0x35bb94).d + 0x2cc, "%i/%i")
0044534e        i_4 += 0x8c
00445475        struct Vec3 vector_1
00445367        void* i_5 = nullptr
00445475        while (i_5 s< 0x3a0)
00445369        struct Game* game_5 = player->game
0044536f        void* eax_28 = i_5 + game_5
0044537b        if (*(i_5 + game_5 + 0x356038) == 1)
0044538d        vector.x = fconvert.s(fconvert.t(*(eax_28 + 0x356010)) - fconvert.t(player->cached_camera_target_world.x))
004453a1        vector.y = fconvert.s(fconvert.t(*(eax_28 + 0x356014)) - fconvert.t(player->cached_camera_target_world.y))
004453b5        vector_1.x = vector.x
004453b9        vector_1.y = vector.y
004453bd        vector.z = fconvert.s(fconvert.t(*(eax_28 + 0x356018)) - fconvert.t(player->cached_camera_target_world.z))
004453c1        long double x87_r7_64 = fconvert.t(player->live_matrix.position.y)
004453c4        long double temp0_1 = fconvert.t(0.49000001f)
004453c4        x87_r7_64 - temp0_1
004453ce        vector_1.z = vector.z
004453d2        float eax_29
004453d2        eax_29.w = (x87_r7_64 < temp0_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_64, temp0_1) ? 1 : 0) << 0xa | (x87_r7_64 == temp0_1 ? 1 : 0) << 0xe
004453d7        if ((eax_29:1.b & 1) == 0)
004453dd        long double x87_r7_65 = fconvert.t(vector.z)
004453e1        long double temp1_1 = fconvert.t(1f)
004453e1        x87_r7_65 - temp1_1
004453e7        eax_29.w = (x87_r7_65 < temp1_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_65, temp1_1) ? 1 : 0) << 0xa | (x87_r7_65 == temp1_1 ? 1 : 0) << 0xe
004453ec        if ((eax_29:1.b & 1) != 0)
...
004453fc        eax_29.w = (x87_r7_66 < temp3_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_66, temp3_1) ? 1 : 0) << 0xa | (x87_r7_66 == temp3_1 ? 1 : 0) << 0xe | 0x3800
00445401        if ((eax_29:1.b & 1) != 0)
00445403        x87_r7_67 = fneg(x87_r7_67)
00445405        long double temp6_1 = fconvert.t(0.400000006f)
00445405        x87_r7_67 - temp6_1
0044540b        eax_29.w = (x87_r7_67 < temp6_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_67, temp6_1) ? 1 : 0) << 0xa | (x87_r7_67 == temp6_1 ? 1 : 0) << 0xe
00445410        if ((eax_29:1.b & 1) != 0)
...
00445499        vector.x = fconvert.s(fconvert.t(game_2->__offset(0x355e18).d) - fconvert.t(player->cached_camera_target_world.x))
004454ad        vector.y = fconvert.s(fconvert.t(game_2->__offset(0x355e1c).d) - fconvert.t(player->cached_camera_target_world.y))
004454c1        vector_1.x = vector.x
004454c5        vector_1.y = vector.y
004454c9        vector.z = fconvert.s(fconvert.t(game_2->__offset(0x355e20).d) - fconvert.t(player->cached_camera_target_world.z))
004454cd        long double x87_r7_75 = fconvert.t(player->live_matrix.position.y)
004454d0        long double temp2_1 = fconvert.t(0.49000001f)
004454d0        x87_r7_75 - temp2_1
004454da        vector_1.z = vector.z
004454de        float eax_32
004454de        eax_32.w = (x87_r7_75 < temp2_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_75, temp2_1) ? 1 : 0) << 0xa | (x87_r7_75 == temp2_1 ? 1 : 0) << 0xe
004454e3        if ((eax_32:1.b & 1) == 0)
004454e5        long double x87_r7_76 = fconvert.t(vector.z)
004454e9        long double temp5_1 = fconvert.t(1f)
004454e9        x87_r7_76 - temp5_1
004454ef        eax_32.w = (x87_r7_76 < temp5_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_76, temp5_1) ? 1 : 0) << 0xa | (x87_r7_76 == temp5_1 ? 1 : 0) << 0xe
004454f4        if ((eax_32:1.b & 1) != 0)
...
00445504        eax_32.w = (x87_r7_77 < temp10_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_77, temp10_1) ? 1 : 0) << 0xa | (x87_r7_77 == temp10_1 ? 1 : 0) << 0xe | 0x3800
00445509        if ((eax_32:1.b & 1) != 0)
0044550b        x87_r7_78 = fneg(x87_r7_78)
0044550d        long double temp16_1 = fconvert.t(0.400000006f)
0044550d        x87_r7_78 - temp16_1
00445513        eax_32.w = (x87_r7_78 < temp16_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_78, temp16_1) ? 1 : 0) << 0xa | (x87_r7_78 == temp16_1 ? 1 : 0) << 0xe
00445518        if ((eax_32:1.b & 1) != 0)
...
00445556        player->velocity.z = fconvert.s(fconvert.t(player->game->track_center_x) * fconvert.t(0.5f))
0044555c        struct Game* game_3 = player->game
00445568        if (game_3->__offset(0x355e9c).d == 1)
0044557a        vector.x = fconvert.s(fconvert.t(game_3->__offset(0x355e74).d) - fconvert.t(player->cached_camera_target_world.x))
0044558e        vector.y = fconvert.s(fconvert.t(game_3->__offset(0x355e78).d) - fconvert.t(player->cached_camera_target_world.y))
004455a2        vector_1.x = vector.x
004455a6        vector_1.y = vector.y
004455aa        vector.z = fconvert.s(fconvert.t(game_3->__offset(0x355e7c).d) - fconvert.t(player->cached_camera_target_world.z))
004455ae        long double x87_r7_88 = fconvert.t(player->live_matrix.position.y)
004455b1        long double temp4_1 = fconvert.t(0.49000001f)
004455b1        x87_r7_88 - temp4_1
004455bb        vector_1.z = vector.z
004455bf        float eax_35
004455bf        eax_35.w = (x87_r7_88 < temp4_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_88, temp4_1) ? 1 : 0) << 0xa | (x87_r7_88 == temp4_1 ? 1 : 0) << 0xe
004455c4        if ((eax_35:1.b & 1) == 0)
004455c6        long double x87_r7_89 = fconvert.t(vector.z)
004455ca        long double temp9_1 = fconvert.t(1f)
004455ca        x87_r7_89 - temp9_1
004455d0        eax_35.w = (x87_r7_89 < temp9_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_89, temp9_1) ? 1 : 0) << 0xa | (x87_r7_89 == temp9_1 ? 1 : 0) << 0xe
004455d5        if ((eax_35:1.b & 1) != 0)
...
00445614        struct Game* game_9 = player->game
00445621        result = i_6 + game_9
00445627        if (*(i_6 + game_9 + 0x35b80c) == 1)
00445639        vector_2.x = fconvert.s(fconvert.t(*(result + 0x35b7f4)) - fconvert.t(player->cached_camera_target_world.x))
00445649        vector_2.y = fconvert.s(fconvert.t(*(result + 0x35b7f8)) - fconvert.t(player->cached_camera_target_world.y))
00445653        long double x87_r7_96 = fconvert.t(*(result + 0x35b7fc)) - fconvert.t(player->cached_camera_target_world.z)
...
0044567e        result.w = (x87_r7_96 < temp14_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_96, temp14_1) ? 1 : 0) << 0xa | (x87_r7_96 == temp14_1 ? 1 : 0) << 0xe
00445683        if ((result:1.b & 1) != 0)
0044568d        long double st0_9
0044568d        st0_9, result = normalize_vector(&vector_4)
00445692        long double temp18_1 = fconvert.t(0.980000019f)
00445692        st0_9 - temp18_1
00445698        result.w = (st0_9 < temp18_1 ? 1 : 0) << 8 | (is_unordered.t(st0_9, temp18_1) ? 1 : 0) << 0xa | (st0_9 == temp18_1 ? 1 : 0) << 0xe
0044569d        if ((result:1.b & 1) != 0)
004456a9        *(i_6 + player->game + 0x35b80c) = 2
004456b4        struct Game* eax_37
004456b4        eax_37.b = player->completion_handoff_active.b
004456bc        if (eax_37.b == 0)
004456be        struct Game* game_6 = player->game
004456c4        int32_t eax_38 = *(i_6 + game_6 + 0x35b814)
004456d2        if (eax_38 == 3 || eax_38 == 7)
004456ec        player->velocity.z = -0.100000001f
004456f2        play_sound_effect(0x2b)
004456dd        player->velocity.z = fconvert.s(fconvert.t(game_6->track_center_x) * fconvert.t(0.5f))
004456f7        struct Game* game_7 = player->game
...
004457fb        eax_41 = player->movement_flag_selector - 1
004457ff        if (eax_41 s> 6)
004457ff        goto label_445801
0044580d        play_sound_effect(eax_41 + 1)
00445818        result = add_subgoldy_score(player, 2, 0)
...
0044573d        eax_41 = player->movement_flag_selector - 1
00445741        if (eax_41 s<= 6)
0044580d        play_sound_effect(eax_41 + 1)
00445818        result = add_subgoldy_score(player, 2, 0)
...
00445763        result = play_sound_effect(1)
00445775        if (result == 2 || result == 6)
00445781        add_subgoldy_score(player, 2, 0)
0044578d        play_sound_effect(0x2a)
00445792        int32_t ecx_53 = player->_pad_374[4].d
00445798        player->_pad_374[0] = ecx_53.b
00445798        player->_pad_374[1] = ecx_53:1.b
00445798        player->_pad_374[2] = ecx_53:2.b
00445798        player->_pad_374[3] = ecx_53:3.b
004457a4        result = initialize_nuke(&player->_pad_14d[3])
0044581d        i_6 += 0x1f8
