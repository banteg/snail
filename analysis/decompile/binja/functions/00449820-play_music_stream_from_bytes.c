...
00449875        BassHandle stream_handle = g_bass_stream_create_file(1, bytes, 0, byte_count, 0)
0044987d        g_active_music_stream = stream_handle
00449882        if (stream_handle != 0)
0044988a        if (play_mode == 0)
004498a7        int32_t eax_3 = g_bass_stream_play(stream_handle, 0, 0)
004498ae        backend->music_stream_active = 1
004498b5        return eax_3
00449891        int32_t eax_2 = g_bass_stream_play(stream_handle, 0, 4)
