...
0042040c        struct Vec3* primary_up = i_1 + self->primary_samples - 0x98
0042041f        primary_up->x = 0
00420425        primary_up->y = 1f
00420428        primary_up->z = 0f
...
00420484        struct PathTemplateSample* primary_sample_cursor_first = i_1 + self->primary_samples
...
004204a3        struct PathTemplateSample* primary_sample_cursor_second = i_1 + self->primary_samples
...
004204d6        struct Vec3* secondary_up = self->secondary_samples + i_1 - 0x98
004204e9        secondary_up->x = 0
004204ef        secondary_up->y = 1f
004204f2        secondary_up->z = 0f
004204f8        void* eax_25 = self->secondary_samples + i_1
...
00420549        struct PathTemplateSample* secondary_sample_cursor_first = self->secondary_samples + i_1
...
00420569        struct PathTemplateSample* secondary_sample_cursor_second = self->secondary_samples + i_1
...
004205ca        void* eax_31 = self->primary_samples + edi_1
...
004206b7        struct Vec3* primary_terminal_delta = &self->primary_samples[self->segment_count] - 0x28
004206cb        primary_terminal_delta->x = 0
004206e1        primary_terminal_delta->y = 0f
004206e4        primary_terminal_delta->z = 1f
004206fc        *(&self->primary_samples[self->segment_count] - 0x1c) = self->width_or_scale
00420712        struct Vec3* secondary_terminal_delta = &self->secondary_samples[self->segment_count] - 0x28
0042071e        secondary_terminal_delta->x = 0
00420724        secondary_terminal_delta->y = 0f
00420727        secondary_terminal_delta->z = 1f
...
00420991        g = 0f
00420999        r = 0f
0042099b        struct Vec3* previous_row_vertex = &vertices[(edi_2 - 1) * width_cells + i_3]
0042099e        struct Vec3* terminal_vertex = &vertices[width_cells * edi_2 + i_3]
...
004209b9        int32_t ecx_73 = (self->width_cells * edi_2 + i_3) * 3
...
00420810        float var_38_3 = fconvert.s(fconvert.t(var_80_2) * fconvert.t(primary_mesh_sample->transform.basis_up.y))
0042081b        float var_34_3 = fconvert.s(fconvert.t(var_80_2) * fconvert.t(primary_mesh_sample->transform.basis_up.z))
...
0042086c        float var_48_2 = fconvert.s(fconvert.t(var_80_2) * fconvert.t(primary_mesh_sample_reloaded->transform.basis_right.x))
00420877        float var_44_2 = fconvert.s(fconvert.t(var_80_2) * fconvert.t(primary_mesh_sample_reloaded->transform.basis_right.y))
00420882        float var_40_2 = fconvert.s(fconvert.t(var_80_2) * fconvert.t(primary_mesh_sample_reloaded->transform.basis_right.z))
...
004208fd        float var_8_1 = fconvert.s(fconvert.t(fconvert.s(fconvert.t(fconvert.s(fconvert.t(var_44_2) * st0_6)) + fconvert.t(primary_position->y))) + fconvert.t(fconvert.s(fconvert.t(var_38_3) * st0_5)))
0042090f        float var_4_1 = fconvert.s(fconvert.t(fconvert.s(st0_6 * fconvert.t(var_40_2) + fconvert.t(primary_position->z))) + fconvert.t(fconvert.s(fconvert.t(var_34_3) * st0_5)))
00420932        long double x87_r7_72 = fconvert.t(fconvert.s(float.t(var_80_1) * fconvert.t(6.28318548f) / float.t(segment_count_2)))
00420948        struct Vec3* vertex = &vertices[self->width_cells * edi_2 + i_3]
0042094f        vertex->x = fconvert.s(fconvert.t(fconvert.s(fconvert.t(var_48_2) * st0_6)) + fconvert.t(primary_position->x) + fconvert.t(fconvert.s(fconvert.t(var_3c_3) * st0_5)))
00420955        vertex->y = var_8_1
00420958        vertex->z = var_4_1
...
004209e7        int32_t edx_47 = (self->width_cells * edi_2 + i_3) * 3
...
00420ab7        while (true)
00420abd        int32_t ecx_85 = (edx_50 + ((self->width_cells * i_3 + j) << 1)) * 0x30
...
00420b33        face->vertex_1 = i_3.w * self->width_cells.w + j.w
00420b3e        face->vertex_2 = (i_3.w + 1) * self->width_cells.w + j.w
00420b4c        self->width_cells
00420b51        face->vertex_3 = (mods.dp.d(sx.q(j_1), self->width_cells)).w + (i_3.w + 1) * self->width_cells.w
00420acb        edx_50.w = i_3.w
00420ad1        edx_50.w *= self->width_cells.w
00420ad8        face->vertex_0 = edx_50.w + j.w
00420aee        face->vertex_1 = (mods.dp.d(sx.q(j_3), self->width_cells)).w + i_3.w * self->width_cells.w
00420b00        face->vertex_2 = (mods.dp.d(sx.q(j_1), self->width_cells)).w + (i_3.w + 1) * self->width_cells.w
00420b0b        face->vertex_3 = (i_3.w + 1) * self->width_cells.w + j.w
...
00420bd3        face->uv[0].v = var_80_3
00420bd8        face->uv[1].u = fconvert.s(x87_r7_90)
00420bdf        face->uv[1].v = var_80_3
...
00420baf        face->uv[0].v = var_80_3
00420bb6        face->uv[1].u = fconvert.s(x87_r6_20)
00420bb9        face->uv[1].v = var_80_3
