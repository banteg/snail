...
004209a3        *edx_49 = *eax_70
004209a8        edx_49[1] = eax_70[1]
004209ae        edx_49[2] = eax_70[2]
...
004209e7        int32_t edx_50 = (self->width_cells * edi_2 + i_3) * 3
004209ea        long double x87_r7_79 = fconvert.t((&vertices->y)[edx_50])
...
00420a07        (&vertices->y)[edx_50] = fconvert.s(fconvert.t((&vertices->y)[edx_50]) * fconvert.t(0.300000012f))
...
00420ab7        while (true)
00420abd        int32_t ecx_86 = (edx_53 + ((self->width_cells * i_3 + j) << 1)) * 0x30
00420ac0        int16_t* edi_4 = facequads + ecx_86
00420ac4        *edi_4 = 0
