...
0041a22c        facequads->flags.w = 0
0041a22f        facequads->flags:2.w = 0
0041a233        facequads->vertex_index_a = 1
0041a239        facequads->vertex_index_b = 3
0041a23f        facequads->vertex_index_c = 2
0041a245        struct TextureRef* eax_1 = get_or_create_texture_ref(&data_4b7790, arg2, 0, 0)
0041a254        facequads->_pad_0a.d = eax_1
0041a25c        long double x87_r7_4 = (fconvert.t(arg3) + fconvert.t(1f)) * fconvert.t(-0.125f)
0041a262        eax_1->flags |= 2
0041a269        facequads->v0 = 0f
0041a26c        facequads->v1 = 0f
0041a26f        facequads->u2 = 0f
0041a272        facequads->u3 = 0f
0041a275        facequads->texture_ref = fconvert.s(x87_r7_4)
0041a278        facequads->v2 = fconvert.s(x87_r7_4)
0041a27b        facequads->u0 = 0.125f
0041a27e        facequads->u1 = 0.125f
