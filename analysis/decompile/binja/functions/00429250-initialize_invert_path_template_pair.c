...
004292ee        struct PathTemplateSample* primary_samples_5 = self->primary_samples
004292f1        primary_samples_5->delta_length.b = 0
004292f1        primary_samples_5->delta_length:1.b = 0
004292f1        primary_samples_5->delta_length:2.b = 0x80
004292f1        primary_samples_5->delta_length:3.b = 0x3f
...
0042931e        struct PathTemplateSample* secondary_samples = self->secondary_samples
00429321        secondary_samples->delta_length.b = 0
00429321        secondary_samples->delta_length:1.b = 0
00429321        secondary_samples->delta_length:2.b = 0x80
00429321        secondary_samples->delta_length:3.b = 0x3f
...
004294c5        edx_13[2] = 0
004294c8        struct PathTemplateSample* primary_samples_6 = self->primary_samples
004294ea        float var_2c_1 = fconvert.s(fconvert.t(*(&primary_samples_6->transform.position.y + i)) - fconvert.t(*(primary_samples_6 + i - 0x74)))
004294f1        long double x87_r7_18 = fconvert.t(*(&primary_samples_6->transform.position.z + i)) - fconvert.t(*(primary_samples_6 + i - 0x70))
004294fb        *(&primary_samples_6->transform.basis_forward + i) = fconvert.s(fconvert.t(*(&primary_samples_6->transform.position + i)) - fconvert.t(*(primary_samples_6 + i - 0x78)))
004294fd        *(&primary_samples_6->transform.basis_forward.y + i) = var_2c_1
00429508        *(&primary_samples_6->transform.basis_forward.z + i) = fconvert.s(x87_r7_18)
...
0042953c        struct PathTemplateSample* primary_samples_7 = self->primary_samples
00429542        texture_a_3 += 1
0042954a        long double x87_r7_22 = fconvert.t(*(&primary_samples_7->transform.basis_up + i)) * fconvert.t(0.49000001f)
00429558        texture_a = texture_a_3
00429562        float var_20_1 = fconvert.s(fconvert.t(*(&primary_samples_7->transform.basis_up.y + i)) * fconvert.t(0.49000001f))
00429569        long double x87_r6_11 = fconvert.t(*(&primary_samples_7->transform.basis_up.z + i)) * fconvert.t(0.49000001f)
...
004295b1        struct PathTemplateSample* primary_samples_8 = self->primary_samples
004295d5        float var_2c_2 = fconvert.s(fconvert.t(*(primary_samples_8 + esi_3 + 0xdc)) - fconvert.t(*(&primary_samples_8->transform.position.y + esi_3)))
004295dc        long double x87_r7_33 = fconvert.t(*(primary_samples_8 + esi_3 + 0xe0)) - fconvert.t(*(&primary_samples_8->transform.position.z + esi_3))
004295e3        *(&primary_samples_8->delta_dir_to_next + esi_3) = fconvert.s(fconvert.t(*(primary_samples_8 + esi_3 + 0xd8)) - fconvert.t(*(&primary_samples_8->transform.position + esi_3)))
004295e5        *(&primary_samples_8->delta_dir_to_next.y + esi_3) = var_2c_2
004295f0        *(&primary_samples_8->delta_dir_to_next.z + esi_3) = fconvert.s(x87_r7_33)
...
0042960c        struct PathTemplateSample* secondary_samples_1 = self->secondary_samples
00429630        float var_38_2 = fconvert.s(fconvert.t(*(secondary_samples_1 + esi_3 + 0xdc)) - fconvert.t(*(&secondary_samples_1->transform.position.y + esi_3)))
00429637        long double x87_r7_40 = fconvert.t(*(secondary_samples_1 + esi_3 + 0xe0)) - fconvert.t(*(&secondary_samples_1->transform.position.z + esi_3))
0042963e        *(&secondary_samples_1->delta_dir_to_next + esi_3) = fconvert.s(fconvert.t(*(secondary_samples_1 + esi_3 + 0xd8)) - fconvert.t(*(&secondary_samples_1->transform.position + esi_3)))
00429640        *(&secondary_samples_1->delta_dir_to_next.y + esi_3) = var_38_2
0042964b        *(&secondary_samples_1->delta_dir_to_next.z + esi_3) = fconvert.s(x87_r7_40)
00429660        i_1 += 1
...
004296a4        char* ecx_32 = &self->primary_samples[self->segment_count] - 0x28
004296b8        *ecx_32 = 0
004296b8        ecx_32[1] = 0
004296b8        ecx_32[2] = 0
004296b8        ecx_32[3] = 0
...
004296c9        ecx_32[8] = 0
004296c9        ecx_32[9] = 0
004296c9        ecx_32[0xa] = 0x80
004296c9        ecx_32[0xb] = 0x3f
...
0042974f        struct Object* strip_mesh = self->strip_mesh
...
0042979c        float* eax_49
0042979c        float ecx_47
...
00429866        ecx_47 = fconvert.s(x87_r6_31)
...
004297ec        ecx_47 = var_28_4
0042986c        eax_49[2] = ecx_47
...
0042991f        while (true)
0042991f        int32_t eax_65 = ecx_51 + ((self->width_cells * i_3 + j) << 1)
00429922        if (ecx_51 != 0)
004299dd        struct ObjectFaceQuad* facequads_1 = facequads
004299e8        int16_t* edi_5 = &facequads_1[eax_65]
004299eb        *edi_5 = 0
004299f0        ecx_51.w = self->width_cells.w
004299f4        ecx_51.w += 1
004299fd        edi_5[1] = ecx_51.w * i_3.w + j.w + 1
00429a01        facequads_1.w = self->width_cells.w
00429a05        facequads_1.w += 1
00429a0c        edi_5[2] = facequads_1.w * i_3.w + j.w
...
00429a5a        *(edi_5 + 0xc) = get_or_create_texture_ref(&g_texture_refs, texture_path_1, 0, 0)
...
0042992f        int32_t ecx_53 = eax_65 * 0x30
00429936        int16_t* edi_4 = ecx_53 + facequads
00429939        *edi_4 = 0
0042993e        eax_65.w = self->width_cells.w
00429942        eax_65.w += 1
00429949        edi_4[1] = eax_65.w * i_3.w + j.w
0042994d        ecx_53.w = self->width_cells.w
00429951        ecx_53.w += 1
0042995d        edi_4[2] = ecx_53.w * i_3.w + j.w + 1
...
004299a1        *(edi_4 + 0xc) = get_or_create_texture_ref(&g_texture_refs, texture_path, 0, 0)
