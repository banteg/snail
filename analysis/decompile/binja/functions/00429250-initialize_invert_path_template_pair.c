...
004294c2        edx_13[1] = width_cells_
004294c5        edx_13[2] = 0
...
00429852        eax_49 = &vertices[(width_cells + 1) * i_2 + width_cells_3]
...
004297dc        eax_49 = &vertices[(width_cells + 1) * i_2 + width_cells_3]
...
00429a69        *(edi_5 + 0x18) = width_cells_
00429a72        *(edi_5 + 0x1c) = var_54_1
00429a79        *(edi_5 + 0x20) = width_cells_
00429a7c        *(edi_5 + 0x24) = var_4c_1
00429a81        *(edi_5 + 0x28) = var_50_1
00429a84        *(edi_5 + 0x2c) = var_4c_1
0042992f        int32_t ecx_55 = eax_65 * 0x30
00429936        int16_t* edi_4 = ecx_55 + facequads
00429939        *edi_4 = 0
...
004299a8        *(edi_4 + 0x10) = width_cells_
...
004299c8        *(edi_4 + 0x28) = width_cells_
