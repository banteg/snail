...
004444e4        return
004444ea        struct cRSubLoc* cell = (&game->runtime_rows[0].primary_attachment_cell)[eax + ecx * 0x14]
004444f3        struct cRPath* attachment_template_record = cell->attachment_template_record
...
004445f1        *position = struct Vec3 {
    .x = fconvert.s(fconvert.t(fconvert.s(fconvert.t(eax_6[0xc]) + fconvert.t(cell->anchor_position.x) + fconvert.t(fconvert.s(x87_r6_6 * fconvert.t(*eax_6))))) + fconvert.t(fconvert.s(x87_r7_2 * fconvert.t(eax_6[4]))))
    .y = fconvert.s(fconvert.t(fconvert.s(fconvert.t(fconvert.s(fconvert.t(eax_6[0xd]) + fconvert.t(cell->anchor_position.y))) + fconvert.t(fconvert.s(x87_r6_6 * fconvert.t(eax_6[1]))))) + fconvert.t(fconvert.s(x87_r7_2 * fconvert.t(eax_6[5]))))
    .z = fconvert.s(x87_r6_6 * fconvert.t(eax_6[2]) + fconvert.t(fconvert.s(fconvert.t(eax_6[0xe]) + fconvert.t(cell->anchor_position.z))) + x87_r7_2 * fconvert.t(eax_6[6]))
}
004445fa        return
