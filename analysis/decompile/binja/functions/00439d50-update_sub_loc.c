...
00439d5c        return
00439d62        char* game_base_1 = g_game_base
00439d68        uint16_t eax_1
00439d68        eax_1.b = game_base_1[0x74621]
...
00439e3f        out.r = *(game_base_1 + 0x42fde4)
00439e43        out.g = *(game_base_1 + 0x42fde8)
00439e5f        var_34.x = fconvert.s(fconvert.t(out.r) - fconvert.t(origin.x))
00439e6b        long double x87_r7_11 = st0_2 + fconvert.t(8f) + fconvert.t(*(game_base_1 + 0x42fdec)) - fconvert.t(origin.z)
...
00439ed6        shoot_subgoldy(&g_game_base[0x3cb118], &origin, &var_34)
00439edb        game_base_1 = g_game_base
...
00439f4a        var_34.x = *(game_base_1 + 0x74670) - 5
