...
0043f6f0        uint32_t flags = eax_3->flags
0043f6f3        eax_3->progress = 0f
0043f6fc        eax_3->flags = flags | 0x802
0043f6ff        eax_3->corner_scale = fconvert.s(unimplemented  {fstp dword [esi+0x88], st0})
...
0043f739        eax_3->progress_step = fconvert.s(unimplemented  {fstp dword [esi+0x6c], st0})
...
0043f75c        set_color_grayscale(&eax_3->color, intensity)
0043f761        unimplemented  {fld st0, dword [esp+0x10]}
0043f765        unimplemented  {fmul st0, dword [0x4973d8]}
0043f76b        eax_3->size_start = fconvert.s(unimplemented  {fstp dword [esi+0x60], st0})
...
0043f778        eax_3->size_end = fconvert.s(unimplemented  {fstp dword [esi+0x64], st0})
...
0043f794        eax_3->gravity_step = fconvert.s(unimplemented  {fstp dword [esi+0x78], st0})
...
0043f81c        eax_3->velocity.x = var_30_1
...
0043f82a        eax_3->velocity.y = var_2c_1
...
0043f835        unimplemented  {fstp st0, st0}
0043f837        eax_3->velocity.z = var_28_1
...
0043f885        eax_3->position.x = var_24_1
...
0043f892        eax_3->position.z = var_1c_1
