...
0043f4de        *(self->sprite + 0x7c) = fconvert.s(fconvert.t(self->owner->__offset(0x370).d) + fconvert.t(self->sprite_y_offset))
0043f4e1        result = self->owner
0043f4ee        if (result->_pad_50[0x334] == 1)
0043f4f0        void* sprite = self->sprite
0043f4ff        *(sprite + 0x7c) = fconvert.s(fconvert.t(result->_pad_50[0x350].d) + fconvert.t(*(sprite + 0x7c)))
...
0043f256        long double temp1_1 = fconvert.t(owner->__offset(0x2980).d)
...
0043f271        long double x87_r7_2 = fconvert.t(owner->__offset(0x374).d)
...
0043f486        long double temp5_1 = fconvert.t(owner_1->__offset(0x2980).d)
