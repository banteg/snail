...
0044671d        dispatch_cutscene_animation(ecx, 9, to.b, var_fc_1)
00446722        void* ecx_1 = *arg1
00446725        int32_t var_fc_2 = 0xffffffff
00446727        to = nullptr
0044672b        dispatch_cutscene_animation(ecx_1, 9, to.b, var_fc_2)
00446730        void* ecx_2 = *arg1
00446733        int32_t var_fc_3 = 0xffffffff
00446735        to = nullptr
00446738        dispatch_cutscene_animation(ecx_2, 1, to.b, var_fc_3)
...
00446b58        int32_t var_fc_19 = 0xffffffff
00446b59        to = 1
00446b5c        arg1[3] = 7
00446b63        arg1[2] = 0xffffffff
00446b66        dispatch_cutscene_animation(ecx_31, 8, to.b, var_fc_19)
00446b6b        void* ecx_32 = *arg1
00446b6e        int32_t var_fc_20 = 0xffffffff
00446b6f        to = nullptr
00446b73        dispatch_cutscene_animation(ecx_32, 9, to.b, var_fc_20)
00446b78        void* ecx_33 = *arg1
00446b7b        int32_t var_fc_21 = 0xffffffff
00446b7c        to = nullptr
00446b80        dispatch_cutscene_animation(ecx_33, 9, to.b, var_fc_21)
...
00446bda        edx_13.b = to_1 == *(ecx_35 + 0x2247f8)
00446bdd        int32_t var_dc
00446bdd        var_dc.b = edx_13.b
00446be6        to = to_1
00446bfe        initialize_completion_screen(ecx_35 + 0x12e6df0, to, var_dc)
00446beb        if (eax_19 == 1)
00446bf0        int32_t var_fc_22 = 1
00446bf7        to = *(arg1[1] + 0x4338)
00446bfe        initialize_completion_screen(ecx_35 + 0x12e6df0, to, var_fc_22)
...
00446c1b        void* eax_21 = *arg1
00446c2b        var_c0.position.x = *(eax_21 + 0x1840)
00446c32        var_c0.position.y = *(eax_21 + 0x1844)
00446c39        var_c0.position.z = *(eax_21 + 0x1848)
00446c69        float eax_23 = arg1[0x14]
00446caa        float var_e8_3 = fconvert.s((fconvert.t(*(eax_21 + 0x1888)) - fconvert.t(var_c0.position.x)) * fconvert.t(eax_23) + fconvert.t(var_c0.position.x))
00446cba        float var_fc_24 = var_e8_3
00446cbb        transform.position.x = var_e8_3
00446cd2        transform.position.y = fconvert.s(fconvert.t(var_c0.position.y) + fconvert.t(fconvert.s(fconvert.t(fconvert.s(fconvert.t(*(eax_21 + 0x188c)) - fconvert.t(var_c0.position.y))) * fconvert.t(eax_23))))
00446cea        transform.position.z = fconvert.s(fconvert.t(var_c0.position.z) + fconvert.t(fconvert.s(fconvert.t(fconvert.s(fconvert.t(*(eax_21 + 0x1890)) - fconvert.t(var_c0.position.z))) * fconvert.t(eax_23))))
...
00446d43        int32_t var_fc_27 = __builtin_memcpy(&var_c0, *(*arg1 + 0x100) + 0x200, 0x40)
...
00446dac        void* eax_25 = *arg1
00446dbe        arg1[0x10] = *(eax_25 + 0x1888)
00446dc3        arg1[0x11] = *(eax_25 + 0x188c)
00446dc9        arg1[0x12] = *(eax_25 + 0x1890)
00446dce        look_at_point(&arg1[4], eax_25 + 0x68)
00446dd3        void* ecx_51 = *arg1
00446dd6        eax_1 = *(ecx_51 + 0x140)
00446dde        if (eax_1 == 0)
00446de0        int32_t var_fc_30 = 0xffffffff
00446de2        to = nullptr
00446de6        eax_1 = dispatch_cutscene_animation(ecx_51, 9, to.b, var_fc_30)
...
004467d5        int32_t ecx_8 = *eax_5
004467d7        var_c0.position.x = ecx_8
004467db        int32_t var_fc_5 = ecx_8
004467e2        var_c0.position.y = eax_5[1]
004467e9        var_c0.position.z = eax_5[2]
...
00446832        int32_t var_fc_8 = __builtin_memcpy(&transform, *(*arg1 + 0x100) + 0x200, 0x40)
...
0044694e        int32_t var_fc_10 = 0xffffffff
0044694f        to = 1
00446952        arg1[2] = 0xffffffff
00446955        dispatch_cutscene_animation(ecx_16, 7, to.b, var_fc_10)
0044695a        int32_t var_fc_11 = 0xffffffff
0044695b        to = 2
00446964        arg1[3] = 0xb
0044696b        arg1[0x14] = 0
00446972        arg1[0x15] = 0x3c088889
00446979        arg1[0x16].b = 1
0044697c        play_voice_manager(0x751498, 3, to, var_fc_11)
...
004469c2        int32_t var_fc_12 = ecx_20
004469c3        transform.position.y = ecx_20
...
00446a41        int32_t var_fc_15 = __builtin_memcpy(&var_c0, *(*arg1 + 0x100) + 0x200, 0x40)
...
00446b0c        ecx_29.b = *(eax_1 + 0x44d)
00446b14        if (ecx_29.b == 0)
00446b1a        int32_t var_fc_18 = 0xffffffff
00446b1c        to = 2
00446b25        int32_t eax_16 = play_voice_manager(0x751498, 0xb, to, var_fc_18)
