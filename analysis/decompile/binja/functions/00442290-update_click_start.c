...
00442346        if (controller->hide_prompt == 0 && ((game_base_1->players[0].game_input->input.pressed_buttons).w:1.b & 0x40) != 0)
00442346        goto label_442358
00442322        if ((game_base_1->subgame.selected_level_record->run_records[game_base_1->subgame.replay_update_cursor].flags.b & 0x20) != 0)
00442358        label_442358:
00442358        controller->player->startup_track_index = game_base_1->subgame.replay_update_cursor
...
00442381        (&game_base_3->subgame.current_high_score_record.run_records[0].flags)[eax_4].b |= 0x20
...
004424cb        ecx_9->first = controller->list_next
004424c3        list_prev->list_next = controller->list_next
004424d1        controller->list_next = ecx_9->free_top
004424d4        ecx_9->free_top = controller
