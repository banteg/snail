...
0044e83e        if ((flags.w:1.b & 8) == 0 && texture_list->count s> 0)
0044e840        char (* left)[0x80] = &texture_list->entries[0].name
0044e84f        if (strings_equal_case_insensitive(left, texture_path) != 0)
0044e8f1        return &texture_list->entries[i]
0044e857        i += 1
0044e858        left = &(*left)[0xa4]
...
0044e890        texture_list->entries[texture_list->count].flags = 0
0044e8a0        texture_list->entries[texture_list->count].flags = 0x400
0044e8b4        texture_list->entries[texture_list->count].texture_ref = payload
