...
0043b09b        vector.y = fconvert.s(fconvert.t(game_base_1->players[0].transform.position.y) - fconvert.t(player->body.transform.position.y))
0043b0a3        vector.x = fconvert.s(fconvert.t(game_base_1->players[0].transform.position.x) - fconvert.t(player->body.transform.position.x))
0043b0af        vector.z = fconvert.s(fconvert.t(game_base_1->players[0].transform.position.z) - fconvert.t(player->body.transform.position.z))
...
0043b103        play_sound_effect_scaled(edi_1, var_1c_4)
0043b10d        return
0043b114        play_sound_effect(edi_1)
0043b11e        return
