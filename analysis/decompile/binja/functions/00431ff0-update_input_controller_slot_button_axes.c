...
00431ff6        enum InputButtonFlag buttons
00431ff6        if (arg1 != 0)
0043205d        (&g_input_controller_slot0.buttons)[arg1 * 0xe] = arg2
00432063        *(arg1 * 0x38 + &g_input_controller_slot0) = arg3
0043206d        (&g_input_controller_slot0.axis_y)[arg1 * 0xe] = arg4
...
004320bf        buttons = g_input_controller_slot1.buttons
004320cd        g_input_controller_slot1.authored_x = fconvert.s((x87_r7_4 + fconvert.t(1f)) * fconvert.t(320f))
004320d3        if ((arg2.b & 0xf0) != 0)
004320d5        buttons:1.b |= 0x40
004320d8        g_input_controller_slot1.buttons = buttons
004320dd        return buttons
004320de        buttons:1.b &= 0xbf
004320e1        g_input_controller_slot1.buttons = buttons
...
00432004        buttons = arg2
00432010        g_input_controller_slot0.buttons |= buttons
00432016        buttons.w = (x87_r7 < temp1_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7, temp1_1) ? 1 : 0) << 0xa | (x87_r7 == temp1_1 ? 1 : 0) << 0xe
0043201b        if ((buttons:1.b & 0x40) != 0)
00432021        g_input_controller_slot0.axis_x = arg3
...
00432033        buttons.w = (x87_r7_1 < temp3_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r7_1, temp3_1) ? 1 : 0) << 0xa | (x87_r7_1 == temp3_1 ? 1 : 0) << 0xe
00432038        if ((buttons:1.b & 0x40) != 0)
00432042        g_input_controller_slot0.axis_y = arg4
004320e6        return buttons
