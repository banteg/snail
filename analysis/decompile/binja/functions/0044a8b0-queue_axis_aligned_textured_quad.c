...
0044a92f        struct tColour* entry_color = result + &g_font_queue[0].color
0044a936        entry_color->r = color->r
0044a93b        entry_color->g = color->g
0044a941        entry_color->b = color->b
0044a944        float a = color->a
0044a947        g_font_queue_count = font_queue_count_1 + 1
0044a94d        entry_color->a = a
