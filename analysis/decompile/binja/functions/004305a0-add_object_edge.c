...
004306cb        g_object_edge_build_edges[g_object_edge_build_count].vertex_b = vertex_b_1
...
0043074c        g_object_edge_build_edges[g_object_edge_build_count].length = fconvert.s(normalize_vector(&vector))
0043075e        float* eax_33 = &g_object_edge_build_edges[g_object_edge_build_count].direction
...
00430601        int32_t* ebp = &g_object_edge_build_edges->vertex_b
00430604        while (true)
00430607        int32_t eax_6 = (ebp - 8)->vertex_a * 3
...
00430642        int32_t eax_14 = (ebp - 8)->vertex_b * 3
...
004307c3        *(&g_object_edge_build_edges->normal_b + esi_2) = normal_index
...
004307dd        char* ecx_14 = &facequad_normals[*(&object_edge_build_edges_4->normal_a + esi_2)]
...
004307fb        int32_t* eax_38 = &facequad_normals[*(&object_edge_build_edges_4->normal_b + esi_2)]
...
00430849        st0_3 = dot_vector(&var_c, &g_object_edge_build_edges->direction + esi_2)
...
00430872        i += 1
00430873        void* esi_3 = eax_45 + object_edge_build_edges_3 + 0x24
00430877        void* edi_5 = eax_45 + object_edge_build_edges_3
0043087f        eax_45 = &eax_45[9]
