...
00425b0b        struct PathTemplateSample* primary_samples_3 = self->primary_samples
00425b15        int32_t eax_6
00425b15        eax_6.b = primary_samples_3->center_x.b
00425b15        eax_6:1.b = primary_samples_3->center_x:1.b
00425b15        eax_6:2.b = primary_samples_3->center_x:2.b
00425b15        eax_6:3.b = primary_samples_3->center_x:3.b
00425b1b        self->secondary_samples->transform.position.x = eax_6
...
00425b7f        struct PathTemplateSample* primary_samples_5 = self->primary_samples
00425b82        long double x87_r7_5 = float.t(&texture_a[1])
00425b94        (&primary_samples_5->transform.position)[&texture_a[1] * 0xe].x = (&primary_samples_5->center_x)[&texture_a[1] * 0x2a]
...
00425bc2        (&self->secondary_samples->transform.position)[&texture_a[1] * 0xe].x = (&self->primary_samples->center_x)[&texture_a[1] * 0x2a]
...
00425cc8        struct PathTemplateSample* primary_samples_6 = self->primary_samples
00425ccb        ebp += 1
00425cda        long double x87_r7_26 = float.t(ebp)
00425cde        *(&primary_samples_6->transform.position + edi_3) = *(&primary_samples_6->center_x + edi_3)
...
00425d6c        edx_15[2] = 0
00425d6f        struct PathTemplateSample* primary_samples_4 = self->primary_samples
00425d93        float var_2c_1 = fconvert.s(fconvert.t(*(&primary_samples_4->transform.position.y + edi_3)) - fconvert.t(*(primary_samples_4 + edi_3 - 0x74)))
00425d9d        long double x87_r7_35 = fconvert.t(*(&primary_samples_4->transform.position.z + edi_3)) - fconvert.t(*(primary_samples_4 + edi_3 - 0x70))
00425da4        *(primary_samples_4 + edi_3 - 0x88) = fconvert.s(fconvert.t(*(&primary_samples_4->transform.position + edi_3)) - fconvert.t(*(primary_samples_4 + edi_3 - 0x78)))
00425da6        *(primary_samples_4 + edi_3 - 0x84) = var_2c_1
00425db1        *(primary_samples_4 + edi_3 - 0x80) = fconvert.s(x87_r7_35)
...
0042601d        char* ecx_52 = &self->secondary_samples[self->segment_count] - 0x28
00426025        *ecx_52 = 0
00426025        ecx_52[1] = 0
00426025        ecx_52[2] = 0
00426025        ecx_52[3] = 0
...
00426030        ecx_52[8] = 0
00426030        ecx_52[9] = 0
00426030        ecx_52[0xa] = 0x80
00426030        ecx_52[0xb] = 0x3f
...
0042606f        struct Object* strip_mesh = self->strip_mesh
...
00426171        eax_63 = &vertices[(width_cells + 1) * i_1 + edi_5]
...
004260fa        eax_63 = &vertices[(width_cells + 1) * i_1 + edi_5]
...
0042620d        int32_t ecx_68 = 0
00426213        arg2 = 0
0042621d        arg3 = fconvert.s(float.t(arg3) * fconvert.t(0.125f))
0042622b        arg5 = fconvert.s(float.t(j + 1) * fconvert.t(0.125f))
0042623f        while (true)
0042623f        int32_t eax_79 = ecx_68 + ((self->width_cells * i_2 + j) << 1)
00426242        if (ecx_68 != 0)
004262fe        float eax_87 = arg4
00426309        int16_t* ebp_3 = eax_79 * 0x30 i+ eax_87
0042630c        *ebp_3 = 0
00426312        ecx_68.w = self->width_cells.w
00426316        ecx_68.w += 1
0042631f        ebp_3[1] = ecx_68.w * i_2.w + j.w + 1
00426323        eax_87.w = self->width_cells.w
00426327        eax_87.w += 1
0042632e        ebp_3[2] = eax_87.w * i_2.w + j.w
...
00426256        int16_t* ebp_2 = ecx_70 i+ arg4
00426259        *ebp_2 = 0
0042625f        eax_79.w = self->width_cells.w
00426263        eax_79.w += 1
0042626a        ebp_2[1] = eax_79.w * i_2.w + j.w
0042626e        ecx_70.w = self->width_cells.w
00426272        ecx_70.w += 1
0042627e        ebp_2[2] = ecx_70.w * i_2.w + j.w + 1
