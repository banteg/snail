...
0043aaed        list_flags:1.b |= 8
0043aaf2        player->presentation.body.bod.bod.list_flags = list_flags
0043aaf8        player->presentation.body.render_animation_manager = &player->presentation.anim_manager
0043aafe        initialize_anim_manager(&player->presentation.anim_manager)
0043ab09        player->presentation.anim_manager.state = 1
...
0043ab52        ecx_10:1.b |= 8
0043ab55        player->presentation.jetpack_channel.body.bod.bod.list_flags = ecx_10
0043ab5b        player->presentation.jetpack_channel.selected_state = 0
0043ab63        player->presentation.jetpack_channel.body.render_animation_manager = &player->presentation.jetpack_channel.anim_manager
0043ab69        initialize_anim_manager(&player->presentation.jetpack_channel.anim_manager)
0043ab74        player->presentation.jetpack_channel.anim_manager.state = 1
...
0043abbf        edx_4:1.b |= 8
0043abc2        player->presentation.weapon_channels[0].body.bod.bod.list_flags = edx_4
0043abc8        player->presentation.weapon_channels[0].selected_state = 0
0043abce        player->presentation.weapon_channels[0].body.render_animation_manager = &player->presentation.weapon_channels[0].anim_manager
0043abd4        initialize_anim_manager(&player->presentation.weapon_channels[0].anim_manager)
0043abdf        player->presentation.weapon_channels[0].anim_manager.state = 1
...
0043ac25        list_flags_1.b &= 0xdf
0043ac27        list_flags_1:1.b |= 8
0043ac2a        player->presentation.weapon_channels[1].body.bod.bod.list_flags = list_flags_1
0043ac30        player->presentation.weapon_channels[1].selected_state = 0
0043ac38        player->presentation.weapon_channels[1].body.render_animation_manager = &player->presentation.weapon_channels[1].anim_manager
0043ac3e        initialize_anim_manager(&player->presentation.weapon_channels[1].anim_manager)
0043ac49        player->presentation.weapon_channels[1].anim_manager.state = 1
...
0043ac92        ecx_21:1.b |= 8
0043ac95        player->presentation.weapon_channels[2].body.bod.bod.list_flags = ecx_21
0043ac9b        player->presentation.weapon_channels[2].selected_state = 0
0043aca3        player->presentation.weapon_channels[2].body.render_animation_manager = &player->presentation.weapon_channels[2].anim_manager
0043aca9        initialize_anim_manager(&player->presentation.weapon_channels[2].anim_manager)
0043acb4        player->presentation.weapon_channels[2].anim_manager.state = 1
0043acc0        player->presentation.weapon_channels[2].anim_manager.target_model = &player->presentation.weapon_channels[2]
...
0043ad7e        player->body.transform.position.x = 0
0043ad81        player->body.transform.position.y = 0f
0043ad84        player->cached_camera_target_world.x = 0
0043ad86        player->body.transform.position.z = 4f
0043ad8d        float z = player->body.transform.position.z
0043ad90        player->last_ring_spawn_z = 0f
...
0043adb5        player->presentation.__offset(0x15bc).d = 0
0043adbb        player->presentation.__offset(0x15c0).d = 0x3bbc5264
0043adc5        player->presentation.__offset(0x15c4).d = 0
0043adcb        player->presentation.__offset(0x15c8).d = 0x3bde0163
...
0043ae16        eax_8 = &game_base_1->game_inputs[1].input
0043ae05        if (&game_base_1->game_inputs == 0)
0043ae1d        eax_8 = nullptr
...
0043ae83        int32_t player_slot_1 = player->player_slot
0043ae93        player->body.bod.bod.list_flags |= 0x20
...
0043aeac        initialize_jetpack_gauge(&player->sub_hover, player_slot_1)
...
0043aef3        player->boost_one_tick = 0
0043aef9        player->lives = 0
0043af08        player->game->camera_snap_requested = 1
0043af0d        return
