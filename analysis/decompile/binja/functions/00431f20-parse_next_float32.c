...
00431f2d        char eax_1 = *edx_1
00431f31        if (eax_1 == 0x2b)
00431f31        break
00431f35        if (eax_1 == 0x2e)
00431f35        break
00431f3d        if (eax_1 s>= 0x30 && eax_1 s<= 0x39)
00431f3d        break
00431f42        *cursor = &edx_1[1]
00431f47        do while (edx_1[1] != 0x2d)
00431f49        char* eax_2 = *cursor
00431f4e        long double x87_r7
00431f4e        if (*eax_2 != 0x2d)
00431f5b        x87_r7 = fconvert.t(1f)
00431f50        x87_r7 = fconvert.t(-1f)
00431f57        *cursor = &eax_2[1]
00431f61        long double x87_r6 = fconvert.t(0f)
00431f67        long double x87_r5 = fconvert.t(0f)
00431f6d        while (true)
00431f6d        char* edx_2 = *cursor
00431f6f        int16_t eax_3
00431f6f        eax_3.b = *edx_2
00431f7b        if ((eax_3.b s< 0x30 || eax_3.b s> 0x39) && eax_3.b != 0x2e)
00431fb1        long double temp1 = fconvert.t(0f)
00431fb1        x87_r5 - temp1
00431fbc        if ((((x87_r5 < temp1 ? 1 : 0) << 8 | (is_unordered.t(x87_r5, temp1) ? 1 : 0) << 0xa | (x87_r5 == temp1 ? 1 : 0) << 0xe | 0x2800):1.b & 0x40) != 0)
00431fc0        x87_r5 = fconvert.t(1f)
00431fcc        return (x87_r7 * x87_r5 * x87_r6).d
00431f7f        if (eax_3.b != 0x2e)
00431f99        *cursor = &edx_2[1]
00431fa7        x87_r6 = float.t(sx.d(eax_3.b) - 0x30) + x87_r6 * fconvert.t(10f)
