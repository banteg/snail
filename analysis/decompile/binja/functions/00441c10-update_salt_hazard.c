...
00441c2b        if (state == SALT_STATE_ACTIVE)
...
00441d24        long double temp4_1 = fconvert.t(salt->owner_game->player.active_window_min_z)
...
00441d31        salt->state = SALT_STATE_RECYCLE_PENDING
00441c32        if (state == 2)
...
00441c58        salt->state = SALT_STATE_INACTIVE
00441c63        return
00441c66        if ((list_flags.b & 0x40) != 0)
00441c6d        report_errorf("List remove NEXTBOD")
00441c75        salt->state = SALT_STATE_INACTIVE
00441c80        return
...
00441caf        salt->state = SALT_STATE_INACTIVE
