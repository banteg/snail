...
00441d43        int32_t visibility_mode = banner->visibility_mode
00441d49        bool c0_1
00441d49        bool c2_1
00441d49        bool c3_1
00441d49        if (visibility_mode == 0)
00441d62        long double x87_r7_3 = fconvert.t(banner->owner_player->body.transform.position.z)
...
00441d70        uint32_t list_flags = banner->bod.bod.list_flags
00441d73        if ((((c0_1 ? 1 : 0) << 8 | (c2_1 ? 1 : 0) << 0xa | (c3_1 ? 1 : 0) << 0xe):1.b & 1) == 0)
00441d79        list_flags.b &= 0xdf
00441d75        list_flags.b |= 0x20
00441d7b        banner->bod.bod.list_flags = list_flags
00441d4c        if (visibility_mode == 1)
00441d54        long double x87_r7_2 = fconvert.t(banner->bod.position.z) - fconvert.t(banner->owner_player->body.transform.position.z)
...
00441d81        long double x87_r7_5 = fconvert.t(banner->phase_step) + fconvert.t(banner->phase)
00441d84        long double temp3 = fconvert.t(1f)
00441d84        x87_r7_5 - temp3
00441d8a        banner->phase = fconvert.s(x87_r7_5)
...
00441d9a        banner->phase = fconvert.s(x87_r7_5 - fconvert.t(1f))
00441daa        struct Banner* banner_1 = banner
00441dbc        banner->bod.position.y = fconvert.s(sine(fconvert.s(fconvert.t(banner->phase) * fconvert.t(6.28318548f))) * fconvert.t(0.25999999f))
00441dc0        return
