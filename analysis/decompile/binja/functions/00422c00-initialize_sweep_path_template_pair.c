...
004232f5        eax_59 = &vertices[(width_cells + 1) * i_3 + width_cells_3]
...
0042327e        eax_59 = &vertices[(width_cells + 1) * i_3 + width_cells_3]
...
0042348d        int16_t* ebp_2 = &facequads_1[eax_75]
00423490        *ebp_2 = 0
...
004234b2        ebp_2[2] = facequads_1.w * i_4.w + j.w
...
00423500        *(ebp_2 + 0xc) = get_or_create_texture_ref(&g_texture_refs, texture_path_1, 0, 0)
00423507        *(ebp_2 + 0x10) = var_50_1
0042350a        *(ebp_2 + 0x14) = var_54_1
0042350f        *(ebp_2 + 0x18) = width_cells_
00423518        *(ebp_2 + 0x1c) = var_54_1
0042351f        *(ebp_2 + 0x20) = width_cells_
00423522        *(ebp_2 + 0x24) = var_4c_1
00423527        *(ebp_2 + 0x28) = var_50_1
0042352a        *(ebp_2 + 0x2c) = var_4c_1
004233d3        int32_t ecx_73 = eax_75 * 0x30
004233da        int16_t* ebp_1 = ecx_73 + facequads
004233dd        *ebp_1 = 0
...
00423446        *(ebp_1 + 0xc) = get_or_create_texture_ref(&g_texture_refs, texture_path, 0, 0)
0042344d        *(ebp_1 + 0x10) = width_cells_
...
0042346d        *(ebp_1 + 0x28) = width_cells_
