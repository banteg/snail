...
0042dd01        height = fconvert.s(float.t(eax_74) * fconvert.t(0.125f))
0042dd0f        length = fconvert.s(float.t(eax_74 i+ 1) * fconvert.t(0.125f))
...
0042dd4c        while (true)
0042dd4c        int32_t eax_81 = ecx_68 + ((self->width_cells * i_2 + j) << 1)
...
0042de82        int32_t edx_47 = centered.d
0042de86        *(ebp_4 + 0xc) = get_or_create_texture_ref(&g_texture_refs, texture_path_1, 0, 0)
0042de8d        *(ebp_4 + 0x10) = width_cells_
0042de90        *(ebp_4 + 0x14) = height
0042de95        *(ebp_4 + 0x18) = edx_47
0042de9e        *(ebp_4 + 0x1c) = height
0042dea5        *(ebp_4 + 0x20) = edx_47
0042dea8        *(ebp_4 + 0x24) = length
0042dead        *(ebp_4 + 0x28) = width_cells_
0042deb0        *(ebp_4 + 0x2c) = length
0042dd5c        int32_t ecx_70 = eax_81 * 0x30
0042dd63        int16_t* ebp_3 = ecx_70 + facequads
0042dd66        *ebp_3 = 0
...
0042ddd6        *(ebp_3 + 0x10) = centered.d
0042ddd9        *(ebp_3 + 0x14) = height
0042ddde        *(ebp_3 + 0x18) = width_cells_
0042dde7        *(ebp_3 + 0x1c) = height
0042ddee        *(ebp_3 + 0x20) = width_cells_
0042ddf1        *(ebp_3 + 0x24) = length
0042ddf6        *(ebp_3 + 0x28) = centered.d
0042ddf9        *(ebp_3 + 0x2c) = length
