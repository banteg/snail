...
0042d594        int32_t eax_1 = ftol(x87control, fconvert.t(arg4))
...
0042d5ce        struct PathTemplateSample* primary_samples_3 = self->primary_samples
0042d5d1        primary_samples_3->center_x.b = 0
0042d5d1        primary_samples_3->center_x:1.b = 0
0042d5d1        primary_samples_3->center_x:2.b = 0
0042d5d1        primary_samples_3->center_x:3.b = 0
0042d5f4        self->primary_samples->rotation_scalar_98 = 0f
0042d5fa        struct PathTemplateSample* primary_samples_4 = self->primary_samples
0042d5fd        primary_samples_4->rotation_scalar_94.b = 0
0042d5fd        primary_samples_4->rotation_scalar_94:1.b = 0
0042d5fd        primary_samples_4->rotation_scalar_94:2.b = 0
0042d5fd        primary_samples_4->rotation_scalar_94:3.b = 0
...
0042d63d        struct PathTemplateSample* primary_samples_5 = self->primary_samples
0042d643        int32_t eax_8
0042d643        eax_8.b = primary_samples_5->center_x.b
0042d643        eax_8:1.b = primary_samples_5->center_x:1.b
0042d643        eax_8:2.b = primary_samples_5->center_x:2.b
0042d643        eax_8:3.b = primary_samples_5->center_x:3.b
0042d649        self->secondary_samples->transform.position.x = eax_8
0042d653        self->secondary_samples->transform.position.y = 0.49000001f
0042d65d        bool cond:0 = arg5 == 0
...
0042d861        int32_t* eax_24 = edi_7 + self->primary_samples - 0xa8
0042d874        *eax_24 = 0x3f800000
0042d87a        eax_24[1] = 0
0042d87d        eax_24[2] = 0
0042d880        struct PathTemplateSample* primary_samples_6 = self->primary_samples
0042d8a4        float var_2c_1 = fconvert.s(fconvert.t(*(&primary_samples_6->transform.position.y + edi_7)) - fconvert.t(*(edi_7 + primary_samples_6 - 0x74)))
0042d8ae        long double x87_r7_30 = fconvert.t(*(&primary_samples_6->transform.position.z + edi_7)) - fconvert.t(*(edi_7 + primary_samples_6 - 0x70))
0042d8b5        *(edi_7 + primary_samples_6 - 0x88) = fconvert.s(fconvert.t(*(&primary_samples_6->transform.position + edi_7)) - fconvert.t(*(edi_7 + primary_samples_6 - 0x78)))
0042d8b7        *(edi_7 + primary_samples_6 - 0x84) = var_2c_1
0042d8c2        *(edi_7 + primary_samples_6 - 0x80) = fconvert.s(x87_r7_30)
0042d8cf        normalize_vector(edi_7 + self->primary_samples - 0x88)
0042d8d7        void* eax_28 = self->primary_samples + edi_7
0042d8ef        cross_vectors(eax_28 - 0x98, eax_28 - 0x88, eax_28 - 0xa8)
0042d90b        char* ecx_29 = self->secondary_samples + edi_7 - 0xa8
0042d91e        *ecx_29 = 0
0042d91e        ecx_29[1] = 0
0042d91e        ecx_29[2] = 0x80
0042d91e        ecx_29[3] = 0x3f
0042d924        ecx_29[4] = 0
0042d924        ecx_29[5] = 0
0042d924        ecx_29[6] = 0
0042d924        ecx_29[7] = 0
0042d927        ecx_29[8] = 0
0042d927        ecx_29[9] = 0
0042d927        ecx_29[0xa] = 0
0042d927        ecx_29[0xb] = 0
0042d92d        void* eax_31 = self->secondary_samples + edi_7
0042d94b        float var_14_1 = fconvert.s(fconvert.t(*(eax_31 + 0x34)) - fconvert.t(*(eax_31 - 0x74)))
0042d955        long double x87_r7_38 = fconvert.t(*(eax_31 + 0x38)) - fconvert.t(*(eax_31 - 0x70))
0042d95c        *(eax_31 - 0x88) = fconvert.s(fconvert.t(*(eax_31 + 0x30)) - fconvert.t(*(eax_31 - 0x78)))
0042d95e        *(eax_31 - 0x84) = var_14_1
0042d969        *(eax_31 - 0x80) = fconvert.s(x87_r7_38)
0042d976        normalize_vector(self->secondary_samples + edi_7 - 0x88)
0042d97e        void* eax_34 = self->secondary_samples + edi_7
0042d996        cross_vectors(eax_34 - 0x98, eax_34 - 0x88, eax_34 - 0xa8)
0042d9bf        edi_7 += 0xa8
...
0042d9e4        void* eax_38 = self->primary_samples + edi_8
0042da02        float var_14_2 = fconvert.s(fconvert.t(*(eax_38 + 0xdc)) - fconvert.t(*(eax_38 + 0x34)))
0042da09        long double x87_r7_46 = fconvert.t(*(eax_38 + 0xe0)) - fconvert.t(*(eax_38 + 0x38))
0042da10        *(eax_38 + 0x80) = fconvert.s(fconvert.t(*(eax_38 + 0xd8)) - fconvert.t(*(eax_38 + 0x30)))
0042da12        *(eax_38 + 0x84) = var_14_2
0042da1d        *(eax_38 + 0x88) = fconvert.s(x87_r7_46)
...
0042db2a        char* ecx_50 = &self->secondary_samples[self->segment_count] - 0x28
0042db32        *ecx_50 = 0
0042db32        ecx_50[1] = 0
0042db32        ecx_50[2] = 0
0042db32        ecx_50[3] = 0
...
0042db3d        ecx_50[8] = 0
0042db3d        ecx_50[9] = 0
0042db3d        ecx_50[0xa] = 0x80
0042db3d        ecx_50[0xb] = 0x3f
...
0042db7c        struct Object* strip_mesh = self->strip_mesh
...
0042dbc7        int32_t* eax_65
0042dbc7        float ecx_61
0042dbc7        if (i_1 == self->segment_count)
0042dc1e        void* eax_66 = primary_samples_2 + i_2
0042dc2f        vertices = arg2
0042dc74        float var_20_2 = fconvert.s(fconvert.t(*(eax_66 - 0x74)) + fconvert.t(fconvert.s(x87_r7_56 * fconvert.t(*(eax_66 - 0xa4)))))
0042dc7c        long double x87_r6_20 = fconvert.t(fconvert.s(fconvert.t(*(eax_66 - 0x70)) + fconvert.t(1f))) + x87_r7_56 * fconvert.t(*(eax_66 - 0xa0))
0042dc7e        eax_65 = &vertices[(width_cells + 1) * i_1 + edi_9]
0042dc86        *eax_65 = fconvert.s(fconvert.t(*(eax_66 - 0x78)) + fconvert.t(fconvert.s(x87_r7_56 * fconvert.t(*(eax_66 - 0xa8)))))
0042dc90        eax_65[1] = var_20_2
0042dc93        ecx_61 = fconvert.s(x87_r6_20)
0042dbc9        float* eax_61 = primary_samples_2 + i_2
0042dbf1        float var_14_3 = fconvert.s(fconvert.t(fconvert.s(x87_r7_56 * fconvert.t(eax_61[1]))) + fconvert.t(eax_61[0xd]))
0042dbfe        float var_10_4 = fconvert.s(x87_r7_56 * fconvert.t(eax_61[2]) + fconvert.t(eax_61[0xe]))
0042dc07        eax_65 = &vertices[(width_cells + 1) * i_1 + edi_9]
0042dc0f        *eax_65 = fconvert.s(fconvert.t(fconvert.s(x87_r7_56 * fconvert.t(*eax_61))) + fconvert.t(eax_61[0xc]))
0042dc15        eax_65[1] = var_14_3
0042dc18        ecx_61 = var_10_4
0042dc99        eax_65[2] = ecx_61
...
0042dce2        float eax_74 = i_2 & 0x80000007
0042dce7        if (eax_74 s< 0)
0042dced        eax_74 = ((eax_74 i- 1) | 0xfffffff8) + 1
0042dd01        arg3 = fconvert.s(float.t(eax_74) * fconvert.t(0.125f))
0042dd0f        arg4 = fconvert.s(float.t(eax_74 i+ 1) * fconvert.t(0.125f))
0042dd1a        int32_t ecx_65 = 0
...
0042dd4c        while (true)
0042dd4c        int32_t eax_81 = ecx_65 + ((self->width_cells * i_2 + j) << 1)
0042dd4f        if (ecx_65 != 0)
0042de0b        struct ObjectFaceQuad* facequads_1 = facequads
0042de16        int16_t* ebp_4 = &facequads_1[eax_81]
0042de19        *ebp_4 = 0
0042de1f        ecx_65.w = self->width_cells.w
0042de23        ecx_65.w += 1
0042de2c        ebp_4[1] = ecx_65.w * i_2.w + j.w + 1
0042de30        facequads_1.w = self->width_cells.w
0042de34        facequads_1.w += 1
0042de3b        ebp_4[2] = facequads_1.w * i_2.w + j.w
...
0042de86        *(ebp_4 + 0xc) = get_or_create_texture_ref(&g_texture_refs, texture_path_1, 0, 0)
...
0042dd5c        int32_t ecx_67 = eax_81 * 0x30
0042dd63        int16_t* ebp_3 = ecx_67 + facequads
0042dd66        *ebp_3 = 0
0042dd6c        eax_81.w = self->width_cells.w
0042dd70        eax_81.w += 1
0042dd77        ebp_3[1] = eax_81.w * i_2.w + j.w
0042dd7b        ecx_67.w = self->width_cells.w
0042dd7f        ecx_67.w += 1
0042dd8b        ebp_3[2] = ecx_67.w * i_2.w + j.w + 1
...
0042ddcf        *(ebp_3 + 0xc) = get_or_create_texture_ref(&g_texture_refs, texture_path, 0, 0)
