...
00403f40        if ((owner_widget->widget_flags & 0x20000) != 0)
...
00403c82        if ((owner_widget_1->widget_flags & 0x20000) == 0)
...
00403caa        if (owner_widget_1->text_alignment == 0)
00403cd0        anchor_x = fconvert.s(fconvert.t(owner_widget_1->layout_width) * fconvert.t(0.5f) + fconvert.t(owner_widget_1->layout_anchor_x) - fconvert.t(320f))
00403cb2        anchor_x = owner_widget_1->anchor_x
...
00403d56        initialize_frontend_widget(tooltip->tooltip_widget, 2, tooltip, 7, *(eax_5 + 0x29c), fconvert.s(fconvert.t(*(eax_5 + 0x2a0)) + fconvert.t(64f)), color_4, 1, anchor_x)
...
00403e1e        initialize_frontend_widget(tooltip->tooltip_widget, 2, tooltip, 7, owner_widget_2->layout_anchor_x, fconvert.s(fconvert.t(owner_widget_2->layout_anchor_y) - fconvert.t(owner_widget_2->current_padding)), color_5, text_alignment, anchor_x_1)
...
00403e7c        y = fconvert.s(fconvert.t(owner_widget_4->layout_anchor_y) + fconvert.t(owner_widget_4->layout_height) + fconvert.t(owner_widget_4->current_padding))
00403e7f        layout_anchor_x = owner_widget_4->layout_anchor_x
...
00403dcd        y = fconvert.s(fconvert.t(owner_widget_3->layout_anchor_y) + fconvert.t(owner_widget_3->layout_height) + fconvert.t(owner_widget_3->current_padding))
00403dd0        layout_anchor_x = owner_widget_3->layout_anchor_x
