...
00442b1b        struct TransformMatrix var_40
00442b1b        __builtin_memcpy(&var_40, &snail->body.transform, 0x40)
00442b24        struct TransformMatrix transform
00442b24        set_matrix_identity(&transform)
00442b35        struct TransformMatrix* var_170_5 = &transform
00442b4e        rotate_matrix_local_z(&transform, fconvert.s(sine(fconvert.s(fconvert.t(snail->wobble.roll_phase) * fconvert.t(6.28318548f))) * fconvert.t(0.0174499992f)))
...
00442b81        struct TransformMatrix* rhs = &transform
00442b82        snail->body.transform.position.y = fconvert.s(fconvert.t(snail->body.transform.position.y) + fconvert.t(1.29999995f))
00442b85        multiply_matrix_assign(&snail->body.transform, rhs)
00442b9c        struct TransformMatrix* rhs_1 = &var_40
00442b9d        snail->body.transform.position.y = fconvert.s(fconvert.t(snail->body.transform.position.y) - fconvert.t(1.29999995f))
00442ba0        multiply_matrix_assign(&snail->body.transform, rhs_1)
00442bb1        struct TransformMatrix* var_170_10 = &snail->body.transform
00442bb5        long double st0_2 = sine(fconvert.s(fconvert.t(snail->wobble.lift_phase) * fconvert.t(6.28318548f)))
00442bf7        float var_148_1 = fconvert.s(fconvert.t(fconvert.s(st0_2 * fconvert.t(snail->body.transform.basis_up.y))) * fconvert.t(0.0299999993f))
00442bfb        long double x87_r7_33 = st0_2 * fconvert.t(snail->body.transform.basis_up.z) * fconvert.t(0.0299999993f)
...
00442dda        build_snail_world_hotspots(snail)
