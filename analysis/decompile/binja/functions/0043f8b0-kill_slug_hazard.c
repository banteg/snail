...
0043f8b0        struct SlugHazardRuntime* slot_1 = slot
0043f8bb        if (slot->state != 1)
0043f8bb        return 
0043f8df        int16_t x87control
0043f8df        play_slug_voice(slot, 0x1c - __ftol(x87control, float.t(next_math_random_value()) * fconvert.t(-6.10351562e-05f)))
0043f8e4        long double x87_r7_3 = fconvert.t(slot->world_position.x)
