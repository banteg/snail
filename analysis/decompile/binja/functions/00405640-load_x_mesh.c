...
00405688        int32_t var_248_1 = arg1
00405689        var_24c = "X/%s"
00405692        var_250 = &var_200
00405661        int32_t edi_1 = arg1
00405663        int32_t i = 0xffffffff
00405668        int32_t var_248 = arg1
00405669        while (i != 0)
00405669        bool cond:0_1 = 0 != *edi_1
00405669        edi_1 += 1
00405669        i -= 1
00405669        if (not(cond:0_1))
00405669        break
00405673        if (*(not.d(i) - 1 + arg1 - 1) == 0x32)
...
004056ca        if (eax_3 == 0)
004056d0        char (* var_248_3)[0x100] = &var_200
...
004056ff        if (eax_4 == 0)
00405705        char (* var_248_5)[0x100] = &var_200
...
0040573a        if (eax_6 == 0)
00405740        char (* var_248_7)[0x100] = &var_200
...
00405775        if (eax_8 == 0)
0040577b        char (* var_248_9)[0x100] = &var_200
...
004057d8        char (* var_248_11)[0x100] = &var_200
...
0040580a        char (* var_248_13)[0x100] = &var_200
...
00405840        char (* var_248_15)[0x100] = &var_200
...
0040585f        request_object_facequads(arg2, facequad_count)
00405867        request_object_vertices(arg2, vertex_count)
...
004058ed        *(ebx_2 + arg2->vertices) = fconvert.s(parse_next_float32(&var_234))
004058fd        *(&arg2->vertices->y + ebx_2) = fconvert.s(parse_next_float32(&var_234))
0040590c        *(&arg2->vertices->z + ebx_2) = fconvert.s(parse_next_float32(&var_234))
...
0040592f        char (* var_248_21)[0x100] = &var_200
...
00405953        *(esi_1 + arg2->facequads) = 0
...
004059a7        struct ObjectFaceQuad* facequads = arg2->facequads
004059aa        ebx_4 = 0
004059ac        *(esi_1 + facequads) |= 0x80
0040599c        ebx_4 = sub_44e710(&var_234)
0040599e        eax_24 = var_220_1
004059c7        *(&arg2->facequads->u2 + esi_1) = eax_16[eax_22 * 2]
004059d6        *(&arg2->facequads->v2 + esi_1) = eax_16[eax_22 * 2 + 1]
004059e5        *(&arg2->facequads->u1 + esi_1) = eax_16[eax_23 * 2]
004059f4        *(&arg2->facequads->v1 + esi_1) = eax_16[eax_23 * 2 + 1]
004059ff        *(&arg2->facequads->u0 + esi_1) = eax_16[eax_24 * 2]
00405a0a        *(&arg2->facequads->v0 + esi_1) = eax_16[eax_24 * 2 + 1]
00405a15        *(&arg2->facequads->u3 + esi_1) = eax_16[ebx_4 * 2]
00405a25        *(&arg2->facequads->v3 + esi_1) = eax_16[ebx_4 * 2 + 1]
00405a31        esi_1 = &esi_1[0x18]
00405a34        *(esi_1 + arg2->facequads - 0x24) = get_or_create_texture_ref(&data_4b7790, "X/snail-turbo.tga", 0, 0)
00405a3b        struct ObjectFaceQuad* ecx_14
00405a3b        ecx_14.w = eax_22.w
00405a40        int32_t* eax_29 = *(esi_1 + arg2->facequads - 0x24)
00405a46        int32_t edx_16
00405a46        edx_16:1.b = (*eax_29):1.b | 0x10
00405a49        *eax_29 = edx_16
00405a4e        *(esi_1 + arg2->facequads - 0x2a) = ecx_14.w
00405a56        struct ObjectFaceQuad* eax_30
00405a56        eax_30.w = eax_23.w
00405a5b        *(esi_1 + arg2->facequads - 0x2c) = eax_30.w
00405a63        struct ObjectFaceQuad* edx_17
00405a63        edx_17.w = var_220_1.w
00405a68        *(esi_1 + arg2->facequads - 0x2e) = edx_17.w
00405a70        *(esi_1 + arg2->facequads - 0x28) = ebx_4.w
...
00405ac2        char (* var_248_25)[0x100] = &var_200
...
00405b15        char (* var_248_27)[0x100] = &var_200
...
00405b77        if ((arg3 & 2) == 0)
00405b7d        char (* var_248_29)[0x100] = &var_200
...
00405c62        i_3 = i_4
00405c62        i_4 -= 1
00405c63        *(esi_5 + arg2->facequads - 0x24) = eax_37[sx.d(sub_44e710(&var_22c))]
