...
00443a55        int32_t* eax_14 = (*(ecx_3 + &g_parcel_set_buckets.candidate_count) << 4) + ecx_3 + &(*g_parcel_set_buckets.candidates)[0].position
...
004439e2        *(((&g_zero_parcel_buckets)[i_3].candidate_count << 4) + eax_7 + &g_zero_parcel_buckets) = edx_4
004439f4        int32_t* ebx_6 = ((&g_zero_parcel_buckets)[i_3].candidate_count << 4) + eax_7 + &(*g_zero_parcel_buckets.candidates)[0].position
...
00443ac5        *(eax_22 + &g_zero_parcel_buckets.segment_index) = i_1
00443ada        *((*(eax_22 + &g_zero_parcel_buckets.candidate_count) << 4) + eax_22 + &g_zero_parcel_buckets) = edx_4
00443af0        int32_t* edi_14 = (*(eax_22 + &g_zero_parcel_buckets.candidate_count) << 4) + eax_22 + &(*g_zero_parcel_buckets.candidates)[0].position
...
00443c01        int32_t eax_23 = *(ecx_3 + &g_parcel_set_buckets.candidate_count)
...
00443d6b        int32_t candidate_count = (&g_parcel_set_buckets)[eax_30].candidate_count
00443d75        var_210_1 = ebx_26 + candidate_count
00443d79        if (candidate_count s> 0)
00443d7f        int32_t* ebx_28 = eax_30 * 0x20c + &(*g_parcel_set_buckets.candidates)[0].position
00443e59        bool cond:14_1
00443da8        float out_angle_3 = game->level_definition.segment_slots[(&g_parcel_set_buckets)[eax_30].segment_index].row_base + ebx_28[-1]
...
00443e53        cond:14_1 = var_214_2 + 1 s< (&g_parcel_set_buckets)[eax_30].candidate_count
00443e55        var_214_2 += 1
00443e59        do while (cond:14_1)
00443e5f        int32_t segment_index = (&g_parcel_set_buckets)[eax_30].segment_index
...
00443ee2        do while (j s< *eax_38)
00443ee4        ecx_29 = var_208_2
00443eea        eax_38[-0x83] = *eax_38
00443ef3        eax_38[-0x81] = eax_38[2]
00443efc        eax_38[-0x82] = eax_38[1]
00443f06        eax_38 = &eax_38[0x83]
...
00443fa0        int32_t eax_40
00443fa0        eax_40, x87control = ftol(x87control, random_float_below(fconvert.s(float.t(i_6))))
00443fc4        int32_t segment_index_1 = (&g_zero_parcel_buckets)[eax_40].segment_index
00443fcc        var_210_1 += (&g_zero_parcel_buckets)[eax_40].candidate_count
00443fe0        out_angle = &(&g_zero_parcel_buckets)[eax_40]
00443fee        int32_t edx_38
00443fee        edx_38.b = (&g_zero_parcel_buckets)[eax_40].candidates[0].row.b
00443fee        edx_38:1.b = (&(*g_zero_parcel_buckets.candidates)[0].row:1)[eax_40].candidates[0].row.b
00443fee        edx_38:2.b = (&(*g_zero_parcel_buckets.candidates)[0].row:2)[eax_40].candidates[0].row.b
00443fee        edx_38:3.b = (&(*g_zero_parcel_buckets.candidates)[0].row:3)[eax_40].candidates[0].row.b
00443ff0        int32_t eax_43 = game->level_definition.segment_slots[segment_index_1].row_base + edx_38
00443ffc        int32_t edx_39 = eax_43 * 0x3d
...
00444033        char* ecx_36 = eax_40 * 0x20c + &(*g_zero_parcel_buckets.candidates)[0].position
...
00444061        *(edi_35 + &data_5ccb60) = fconvert.s(float.t(eax_43) + fconvert.t(*(edi_35 + &data_5ccb60)) + fconvert.t(0.5f))
...
00444092        if (eax_40 s< parcel_count_4)
00444094        float out_angle_4 = out_angle
00444098        int32_t j_2 = parcel_count_4 - eax_40
