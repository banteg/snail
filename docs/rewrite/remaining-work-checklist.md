...
- [ ] Finish the remaining collision/powerup owner recovery beyond the now-ported native ring runtime owner, ring-kind ladder (`1`, `2/6`, `3/7`, `4/5/8`), runtime pickup collision slots, health bob lane, and jetpack ramp-bias spawn lane, especially parcel, garbage-impact, the exact health-particle bod owner, the original ring bod anchor/layout fields, and the deeper weapon/jetpack presentation owners
