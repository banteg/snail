...
- the later controller that finally retires `attachment_exit_pending` after swept re-entry
  ...
  - remaining gap: which of the remaining clear sites is the common post-swept-re-entry lane, and whether overlapping `0x40`/`0x80` probes can both succeed before one wins
