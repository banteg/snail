...
- the remaining dedicated health-collect sprite-bod ownership and the surrounding `cRSubHover` / jetpack presentation behavior beyond the now-ported ramp-bias spawn lane
