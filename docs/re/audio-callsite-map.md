...
| `sfx 15` | [`shoot_subgoldy`](../../artifacts/ida/functions/00441ad0-shoot_subgoldy.c) at `0x441b15` | runtime `cRSubLazerManager` Wall2 shot cue after a free pool slot is spawned | SubLazer successful-allocation generation in `NativeGameplaySoundCues`, dispatched as `SFX2/ENEMYFIRE.OGG` | ported for the pool-allocation edge; positional attenuation is still collapsed to the app's flat gameplay SFX path |
