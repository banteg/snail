...
| `sfx 8` | [`update_options_menu`](../../artifacts/ida/functions/0041af60-update_options.c) at `0x41b05c` | options sound-volume change cue | options UI | low priority; not a gameplay-system gap |
