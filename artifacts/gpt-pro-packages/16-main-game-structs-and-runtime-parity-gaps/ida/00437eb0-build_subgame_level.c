...
void __thiscall sub_437EB0(int this, int a2)
{
  ...
  {
    case 0u:
      sub_432D50(aMusic1Ogg);
      break;
    case 1u:
      sub_432D50(aMusic2Ogg);
      break;
    case 2u:
    case 4u:
      sub_432D50(aMusic3Ogg);
      break;
    case 3u:
      sub_432D50(aMusic4Ogg);
      break;
    default:
      break;
  }
...
LABEL_24:
  ...
  sub_443160((_DWORD *)(this + 19260544));
  ...
  {
    switch ( (unsigned int)(__int64)sub_44DC90(4.0) )
    {
      case 0u:
    ...
    *((_BYTE *)MEMORY[0x4DF904] + 322660) = sub_44DC90(1.0) > 0.5;
  }
  else
  {
  ...
  *((_DWORD *)MEMORY[0x4DF904] + 347) = 1;
  sub_44C400((_DWORD *)MEMORY[0x4DF904] + 164);
  ...
  *(_DWORD *)(this + 16743420) = v16;
  ...
  sub_4323A0(0, 320.0, 240.0);
  sub_4323A0(1, 320.0, 240.0);
