...
// Copies authored segment rows into the generated runtime grid, including Random and Length handling, and seeds Goldy's visible life stock to 3 before `initialize_subgoldy` runs.
  ...
  *(_DWORD *)(this + 3914348) = 0;
  ...
  if ( !v7 || v7 == 7 || v7 == 4 || v7 == 1 )
  {
    ...
    *(_DWORD *)(this + 88) = *(_DWORD *)(this + 84) - *(_DWORD *)(this + 1752860);
    if ( *(int *)(this + 84) >= 3100 )
      sub_431CC0("Track (%s) too long, Maximum Length %i", (const char *)(this + 1769808), 3100);
  }
  else if ( v7 == 3 )
  {
    *(_DWORD *)(this + 80) = *(_DWORD *)(this + 1735932);
        ...
        if ( v23 != *(_DWORD *)(v24 + 88) || *(_BYTE *)(v24 + 1769788) )
        {
          *(_DWORD *)(v24 + 72) = 1065353216;
          if ( *(_BYTE *)(v24 + 1769788) == 1 )
          {
            ...
            v108 = v26;
            v25 = 16928 * (__int64)((double)(int)(__int64)sub_44DC90(v108) * *(float *)(v24 + 72)) + v24 + 43128;
            v112 = v25;
            *(_BYTE *)(v25 + 8) = 1;
          }
          else
