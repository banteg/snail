...
int __thiscall sub_4092F0(int this)
{
  ...
  for ( i = 1; i <= dword_4DF9B8; ++i )
  {
    ...
    {
      v45 = sub_44DB60(&v53, 1065353216, 0, 0, 1065185444);
      *(float *)&v42 = *(float *)(this + 32) - 16.0;
      v9 = *(float *)(this + 28);
    }
    *(float *)&v39 = v9 - 16.0;
    sub_44A9B0(151, v39, v42, 1107296256, 1107296256, 0x1000000, v45, 0, 0, 1065353216, 1065353216, 15, 0);
LABEL_17:
    if ( *(float *)(v8 + 40) > 0.0 )
    {
      v57 = *(_DWORD *)(v8 + 40);
      ...
      *(float *)&v40 = *(float *)(v8 + 28) - 32.0;
      sub_44A9B0(150, v40, v43, 1115684864, 1115684864, 0x1000000, v56, 0, 0, 1065353216, 1065353216, 15, 0);
    }
  }
  sub_44DC50(v56);
  v57 = 1045220557;
  ...
  do
  {
    ...
    *(float *)&v41 = *v13 - 128.0;
    sub_44A9B0(v12 + 139, v41, v44, 1132462080, 1132462080, 0x1000000, v56, 0, 0, 1065353216, 1065353216, 15, 0);
    ++v12;
    v13 += 40;
  }
  while ( v12 < 10 );
