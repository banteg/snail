...
LABEL_25:
    ...
    case 2:
      if ( *(_BYTE *)(this + 16721360) == 1 && !*((_BYTE *)MEMORY[0x4DF904] + 324320) )
      {
        if ( *(_DWORD *)(this + 64) == 3 )
        {
          v53 = sub_44DB60(v58, 1065353216, 1065353216, 1065353216, 1053609165);
          sub_44A9B0(
            27,
            1141964800,
            1086324736,
        ...
        {
          v54 = sub_44DB60(v59, 1065353216, 1065353216, 1065353216, 1053609165);
          sub_44A9B0(
            27,
            1133510656,
            1092616192,
      ...
      if ( (sub_432440() == 11 || unk_4B7654 == 1) && !*((_DWORD *)MEMORY[0x4DF904] + 9) )
      {
        *(_BYTE *)(this + 9) = 1;
        *(_DWORD *)(this + 60) = 3;
        sub_44E540(unk_790F30, 1);
...
LABEL_65:
        ...
        while ( 1 )
        {
          ...
          if ( v39 == 33
            ...
            && (v39 == 1 || v39 == 21)
            && (*(_BYTE *)(this + 76) & 2) != 0
            && (1.0 - *(float *)(this + 19267544)) * 0.2 + 0.80000001 < sub_44DC90(1.0)
            ...
            && (*(_DWORD *)(this + 64) != 4 || *(float *)(this + 72) * 0.30000001 + 0.69999999 >= sub_44DC90(1.0))
            && (*(_DWORD *)(this + 64) || *(float *)(this + 72) * 0.60000002 + 0.40000001 >= sub_44DC90(1.0)) )
          {
          ...
          if ( v42 == 34 )
          {
            if ( v16 >= *(_DWORD *)(this + 80) && v16 < *(_DWORD *)(this + 88) )
              goto LABEL_158;
                 ...
                 && (1.0 - *(float *)(this + 19267548)) * 0.02 + 0.98000002 < sub_44DC90(1.0)
                 && v16 >= *(_DWORD *)(this + 80)
                 && v16 < *(_DWORD *)(this + 88) )
          {
LABEL_158:
...
LABEL_208:
            ...
            if ( (*(_BYTE *)(this + 76) & 8) == 0 || sub_44DC90(1.0) <= 0.69999999 && *(_DWORD *)(this + 64) != 7 )
              goto LABEL_209;
