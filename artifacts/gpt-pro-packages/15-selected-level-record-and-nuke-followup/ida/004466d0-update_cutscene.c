...
// Advances the player-side cutscene controller, including the completion camera blend and the handoff into `initialize_completion_screen`. Cross-port Android and iOS symbols match this helper to `cRCutScene::AI()`.
