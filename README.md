...
- selected replay playback now decodes the compact secondary lane into a neutral cache and routes replay-tail exit through the shared fade overlay instead of swapping phases immediately
