...
| `initialize_tip` | `0x448a40` | 81.70%, source-shaped | Tip slot initializer: allocates the main text widget, optional OK/Disable buttons, default tip definition, dismiss timing, and frontend owner capture. | The second argument now matches native as a hide-Disable gate, and direct button y expressions recover native outgoing-slot staging; remaining residual is widget field-load/order and final owner-restore scheduling documented in NOTES. |
