...
| `create_golb` | `0x415280` | 28.38%, structure complete | Seeds projectile kind, velocity/spread, homing target, and RNG stream consumers. | Pointer lifetimes and movement-flag reloads now better match native setup; continue around movement-flag branch sharing, direction/previous-output copy staging, and kind-specific setup locals documented in NOTES. |
