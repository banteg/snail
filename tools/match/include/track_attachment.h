...
// cRSubGoldy's embedded 0x40-byte cRPathFollowGoldy at player+0x384 (player block
// at game+0x42fd7c; 0x42fd7c + 0x384 = 0x430100). Accesses that used to be
// spelled as follow-state +0x8c/+0x90/+0x94/+0x99 are adjacent cRSubGoldy fields:
