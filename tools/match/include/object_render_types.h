...
struct cRObject {
    ...
    Vector3* RequestFaceQuadNormals(); // @ 0x42f800; Android cRObject::RequestFaceQuadNormals()
    void RequestColours(); // @ 0x42f850; Android cRObject::RequestColours()
    void RequestFaceQuads(int facequad_count); // @ 0x42f8c0
