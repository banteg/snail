...
The verified XP SP1 DDK regresses unchanged source from 88.19% to 67.89%.
Seven default-compiler variants couple typed vertex indices with branch or
loop face owners. All regress with 40 clean references; the best is typed
vertex indexing alone at 87.58%, prefix 387. No source or compiler override is
