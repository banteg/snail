...
#define PATH_FUNCTION initialize_looptheloop_path_template_pair
...
#define PATH_LOOP_SEGMENT_OWNER_MODE 1
#define PATH_LOOP_ENDPOINT_MODE 2
#define PATH_LOOP_CURVE_CONTROL_MODE 1
