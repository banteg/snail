...
flag set and returns the resulting live playback handle, which the Warning
owner stores for the matching stop call. That semantic and ABI evidence
distinguishes this adapter from the neighboring one-shot sound wrapper. The
exact Windows scratch remains 5/5 with two masked operands.
