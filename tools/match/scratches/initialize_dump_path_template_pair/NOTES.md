...
2026-09-11 current measurement: **82.81% → 94.56%**,
689 → 689 candidate instructions / 690 native, with a
51-instruction exact prefix. All 43 aligned references are clean;
only 12 share the native instruction index and 17 share the byte
