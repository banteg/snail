    ...
    do {
        ...
        *(unsigned char*)(self + 0x1e8) = 0;
        ...
        case 10:
            ...
            *(int*)(self + 0x94) = 11;
        case 11:
            g_game->subgame.update_subgame();
            break;
        case 12:
            g_game->intro_screen.initialize_intro_screen(aIntroIntroTxt);
            *(int*)(self + 0x94) = 13;
            break;
        case 13:
            ...
            break;
        case 14:
            g_game->intro_screen.initialize_intro_screen(aIntroCreditsTx);
            *(int*)(self + 0x94) = 15;
            break;
        case 15:
            g_game->intro_screen.update_intro_screen();
        ...
        case 1:
            *(int*)(self + 0x94) = 0;
            ...
            g_game->new_game_menu.initialize_new_game_menu();
            break;
        case 2:
            *(int*)(self + 0x94) = 0;
            ((MouseCursorState*)(self + 0x16c))->capture_mouse_cursor();
        ...
        case 3:
            *(int*)(self + 0x94) = 5;
            ((MouseCursorState*)(self + 0x16c))->capture_mouse_cursor();
            g_game->main_menu.initialize_main_menu();
            break;
        case 4:
            *(int*)(self + 0x94) = 5;
            ((MouseCursorState*)(self + 0x16c))->capture_mouse_cursor();
        ...
        case 6:
            *(int*)(self + 0x94) = 7;
            g_game->options_menu.initialize_options_menu();
        case 7:
            g_game->options_menu.update_options_menu();
            break;
        case 8:
            g_game->completion_screen.initialize_exit_prompt();
            *(int*)(self + 0x94) = 9;
        case 9:
            g_game->completion_screen.update_completion_screen();
            break;
        case 18:
            ...
            *(int*)(self + 0x94) = 19;
            break;
        case 19:
            g_game->high_score_screen.update_high_score_screen();
            break;
        case 20: {
        ...
        case 29:
            *(int*)(self + 0x94) = 30;
            g_game->thanks_for_playing_screen.initialize_thanks_for_playing_screen();
        case 30:
            g_game->thanks_for_playing_screen.update_thanks_for_playing_screen();
            break;
        case 31:
            *(int*)(self + 0x94) = 32;
            g_game->help_screen.initialize_help_screen();
        case 32:
            g_game->help_screen.update_help_screen();
            break;
        default:
            break;
        }
