...
void SubgameRuntime::complete_subgame(unsigned char completed)
{
    ...
    ++current_high_score_record.completion_count;
    ...
    if ((g_completion_snapshot_flags & 1) == 0) {
        ...
        current_high_score_record.completion_bonus_x_source = completion_bonus_x_source;
        current_high_score_record.score_tail = source_score_tail;
        current_high_score_record.completion_bonus_y_source = completion_bonus_y_source;
        current_high_score_record.level_arg_tail = level_arg_tail;
        current_high_score_record.timer_snapshot_a = source_timer_a;
        current_high_score_record.timer_snapshot_b = source_timer_b;
        current_high_score_record.active = 1;
        current_high_score_record.source_tail = source_tail;
        current_high_score_record.level_mode = level_mode;
