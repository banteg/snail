...
- allocates one eight-vertex FVF `0x142` pool slot and stores that 12-byte
  wrapper as `g_direct3d_renderer.renderer_state` (`+0xbb88`), whose buffer at
  `+0x08` is the transient sprite/immediate-quad vertex buffer.
