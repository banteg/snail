...
- Corrected `game+0xa874` to inline `FrontendLevelLoader` storage. The loader
  call is a member call with mode/index arguments, not a three-argument free
  helper with a path buffer.
