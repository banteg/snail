...
218 code instructions, 16 compared table bytes, and 22 clean references
...
`GarbageHazardSlot::game` is now shared as `cRSubGame*`, and the shared
...
and live database now carry the same `cRSubGame*` backlink proven by
