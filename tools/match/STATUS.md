...
| covered | Player | 20 | 1 | 17 | header exists; consider replacing matching scratch-local copies with includes |
...
| covered | Color4f | 1 | 1 | 1 | header exists; consider replacing matching scratch-local copies with includes |
