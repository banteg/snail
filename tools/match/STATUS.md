...
**562/662** port-relevant functions matched, **662/662** port-relevant functions have a scratch, **113914/294937** bytes (**38.62%**) are proof-grade, and overall fuzzy is **86.43%**.
...
**100** non-exact scratch-backed functions hold **34723 fuzzy-gap bytes**. The top 5 hold **26.3%** of that gap; the top 10 hold **38.3%**.

Current-baseline experiments cover **11 functions / 903 gap bytes**; **89 / 33819** are historical-only; **0 / 0** have no recorded experiments.
...
|---:|---|---:|---|---|---|---:|---|
| 1 | initialize_game_assets_and_world | 4304 | semantic-complete | analysis,references | historical-only | 0/5 | repeated-variants,metric-tradeoffs,variant-errors,historical-only |
| 2 | update_subgoldy | 1459 | semantic-complete | analysis,references | historical-only | 0/7 | repeated-variants,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 3 | populate_runtime_track_cells_from_segments | 1223 | semantic-complete | analysis,references | historical-only | 0/139 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only |
| 4 | initialize_turnunder_path_template_pair | 1078 | semantic-complete | analysis | historical-only | 0/26 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only |
| 5 | initialize_slalomdouble_path_template_pair | 1068 | semantic-complete | analysis,references | historical-only | 0/26 | repeated-specs,metric-tradeoffs,variant-errors,historical-only |
| 6 | initialize_p_path_template_pair | 879 | semantic-complete | analysis | historical-only | 0/20 | repeated-specs,metric-tradeoffs,variant-errors,historical-only |
| 7 | initialize_toad_path_template_pair | 836 | semantic-complete | analysis | historical-only | 0/58 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only |
| 8 | initialize_loopout_path_template_pair | 833 | semantic-complete | analysis | historical-only | 0/17 | metric-tradeoffs,variant-errors,historical-only |
| 9 | initialize_dip_path_template_pair | 810 | semantic-complete | analysis | historical-only | 0/45 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only |
| 10 | initialize_halfpipe_path_template_pair | 805 | semantic-complete | analysis | historical-only | 0/19 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only |
...
| 14 | initialize_cage2_path_template_pair | 733 | semantic-complete | analysis | historical-only | 0/14 | repeated-variants,metric-tradeoffs,variant-errors,historical-only |
| 15 | initialize_screw_path_template_pair | 733 | semantic-complete | analysis,references | historical-only | 0/37 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only |
| 16 | initialize_looptheloopw_path_template_pair | 698 | semantic-complete | analysis | historical-only | 0/10 | repeated-variants,metric-tradeoffs,historical-only |
| 17 | update_track_attachment_follow_state | 654 | semantic-complete | analysis | historical-only | 0/6 | metric-tradeoffs,variant-errors,historical-only |
| 18 | initialize_worm_path_template_pair | 641 | semantic-complete | analysis | historical-only | 0/9 | repeated-variants,variant-errors,historical-only |
| 19 | load_segment_definitions | 615 | semantic-complete | analysis | historical-only | 0/9 | metric-tradeoffs,variant-errors,historical-only |
...
| 21 | update_galaxy | 595 | semantic-complete | analysis | historical-only | 0/3 | historical-only |
...
| 23 | build_track_fringe_objects | 554 | semantic-complete | analysis,references | historical-only | 0/4 | historical-only,stale-dependencies |
| 24 | initialize_hump_path_template_pair | 543 | semantic-complete | analysis | historical-only | 0/26 | repeated-specs,metric-tradeoffs,variant-errors,historical-only |
| 25 | initialize_dump_path_template_pair | 519 | semantic-complete | analysis | historical-only | 0/22 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only |
| 26 | create_golb | 517 | semantic-complete | analysis,references | historical-only | 0/5 | variant-errors,historical-only |
| 27 | initialize_slalom_path_template_pair | 516 | semantic-complete | analysis | historical-only | 0/48 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 28 | initialize_slalombig_path_template_pair | 516 | semantic-complete | analysis | historical-only | 0/52 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 29 | initialize_wibble_path_template_pair | 507 | semantic-complete | analysis | historical-only | 0/21 | repeated-variants,repeated-specs,metric-tradeoffs,historical-only |
| 30 | remove_subgame_bods | 464 | semantic-complete | analysis | current-active | 2/6 | variant-errors |
| 31 | render_game_frame | 463 | semantic-complete | analysis | historical-only | 0/18 | repeated-specs,metric-tradeoffs,historical-only |
| 32 | initialize_twister_path_template_pair | 443 | semantic-complete | analysis | historical-only | 0/24 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only |
| 33 | initialize_twister2_path_template_pair | 443 | semantic-complete | analysis | historical-only | 0/25 | repeated-variants,metric-tradeoffs,variant-errors,historical-only |
| 34 | initialize_invert_path_template_pair | 433 | semantic-complete | analysis | historical-only | 0/26 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only |
| 35 | initialize_hill_valley_path_template_pair | 415 | semantic-complete | analysis | historical-only | 0/34 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only |
| 36 | initialize_supertramp_path_template_pair | 392 | semantic-complete | analysis | historical-only | 0/18 | repeated-variants,repeated-specs,metric-tradeoffs,historical-only |
| 37 | border_input_text | 391 | semantic-complete | analysis | historical-only | 0/8 | metric-tradeoffs,historical-only |
| 38 | initialize_sweep_path_template_pair | 380 | semantic-complete | analysis | historical-only | 0/30 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only |
...
| 41 | draw_frontend_widget | 350 | semantic-complete | analysis | historical-only | 0/4 | historical-only |
| 42 | initialize_snake_path_template_pair | 318 | semantic-complete | analysis | historical-only | 0/45 | metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 43 | build_subgame_level | 299 | semantic-complete | analysis | historical-only | 0/19 | metric-tradeoffs,variant-errors,historical-only |
| 44 | merge_track_tile_runs | 284 | semantic-complete | analysis | historical-only | 0/4 | repeated-variants,historical-only |
| 45 | place_parcels_on_track | 270 | semantic-complete | analysis | historical-only | 0/6 | variant-errors,historical-only,stale-dependencies |
| 46 | initialize_start_path_template_pair | 268 | incomplete | analysis | current-active | 2/65 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,stale-dependencies |
| 47 | set_snail_weapon | 254 | semantic-complete | analysis | historical-only | 0/3 | historical-only |
| 48 | register_font_texture_sheet | 242 | semantic-complete | analysis | historical-only | 0/4 | historical-only,stale-dependencies |
| 49 | update_golb_ai | 224 | semantic-complete | analysis | historical-only | 0/16 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only |
| 50 | traverse_path_follow_golb | 209 | semantic-complete | analysis | historical-only | 0/12 | metric-tradeoffs,historical-only |
| 51 | initialize_intro_screen | 206 | semantic-complete | analysis | historical-only | 0/3 | variant-errors,historical-only |
| 52 | initialize_sbend_path_template_pair | 206 | semantic-complete | analysis | historical-only | 0/42 | repeated-specs,metric-tradeoffs,historical-only |
| 53 | initialize_loading_screen | 129 | semantic-complete | analysis | historical-only | 0/4 | variant-errors,historical-only |
| 54 | place_challenge_parcels_on_track | 115 | semantic-complete | analysis,references | historical-only | 0/6 | historical-only |
| 55 | update_frontend_widget_interaction | 112 | semantic-complete | analysis,references | historical-only | 0/11 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only |
| 56 | add_object_edge | 104 | semantic-complete | analysis,references | historical-only | 0/9 | variant-errors,historical-only |
| 57 | update_cameraman | 91 | semantic-complete | analysis | historical-only | 0/5 | repeated-variants,metric-tradeoffs,historical-only |
| 58 | load_galaxy_layout | 87 | semantic-complete | analysis | historical-only | 0/14 | repeated-specs,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 59 | calc_object_edges | 85 | semantic-complete | analysis | historical-only | 0/6 | repeated-specs,historical-only |
| 60 | initialize_tip | 80 | semantic-complete | analysis | historical-only | 0/4 | historical-only |
| 61 | build_track_fringe_mesh | 77 | semantic-complete | analysis | historical-only | 0/6 | repeated-variants,repeated-specs,variant-errors,historical-only |
| 62 | build_track_fringe_supertramp_mesh | 76 | semantic-complete | analysis | historical-only | 0/3 | historical-only |
| 63 | sample_smtrack_heightmap | 75 | semantic-complete | analysis | historical-only | 0/3 | historical-only |
| 64 | initialize_completion_screen | 70 | semantic-complete | analysis | historical-only | 0/4 | historical-only |
| 65 | get_or_append_object_texture_group_vertex | 69 | semantic-complete | analysis | historical-only | 0/3 | historical-only |
| 66 | spawn_track_jetpack_pickup | 62 | semantic-complete | analysis | historical-only | 0/4 | repeated-variants,metric-tradeoffs,historical-only |
| 67 | spawn_golb_impact_sprite | 58 | semantic-complete | analysis | historical-only | 0/4 | repeated-variants,repeated-specs,historical-only |
| 68 | promote_track_tiles_to_fringe_variants | 47 | semantic-complete | analysis | historical-only | 0/4 | variant-errors,historical-only |
| 69 | remove_track_render_cache_bods | 44 | semantic-complete | analysis | historical-only | 0/11 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only |
| 70 | initialize_quaternion_from_matrix | 44 | semantic-complete | analysis | current-active | 2/5 | - |
| 71 | load_frontend_level_by_mode_and_index | 41 | semantic-complete | analysis,references | historical-only | 0/3 | historical-only |
| 72 | release_snail_weapons | 40 | semantic-complete | analysis | historical-only | 0/4 | variant-errors,historical-only |
| 73 | select_level_track_texture_set | 37 | semantic-complete | analysis,references | historical-only | 0/3 | variant-errors,historical-only |
| 74 | refresh_object_vertex_buffer | 37 | semantic-complete | analysis | historical-only | 0/3 | historical-only |
| 75 | play_subgoldy_shoot_sfx | 36 | semantic-complete | analysis,references | historical-only | 0/3 | variant-errors,historical-only |
| 76 | calc_object_facequad_normals | 35 | semantic-complete | analysis | current-active | 1/9 | metric-tradeoffs,variant-errors |
| 77 | remove_sub_loc | 35 | semantic-complete | analysis | historical-only | 0/3 | historical-only |
| 78 | try_enter_track_attachment_from_swept_motion | 34 | semantic-complete | analysis | historical-only | 0/5 | historical-only |
| 79 | update_jetpack_gauge | 26 | semantic-complete | analysis | historical-only | 0/6 | historical-only |
| 80 | set_snail_jetpack | 26 | semantic-complete | analysis | historical-only | 0/3 | repeated-variants,historical-only |
| 81 | initialize_star_field | 21 | semantic-complete | analysis | current-active | 1/10 | repeated-specs,metric-tradeoffs,variant-errors |
| 82 | update_input | 21 | semantic-complete | analysis | historical-only | 0/3 | historical-only |
| 83 | update_backdrop | 19 | semantic-complete | analysis | historical-only | 0/5 | historical-only |
| 84 | firework_shoot | 19 | semantic-complete | analysis | current-active | 2/6 | repeated-variants,stale-dependencies |
| 85 | extract_snail_local_hotspots | 18 | semantic-complete | analysis | current-active | 1/5 | repeated-variants,variant-errors |
| 86 | add_time_trial_high_score | 15 | semantic-complete | analysis | historical-only | 0/3 | historical-only |
| 87 | explode_slug_hazard | 13 | semantic-complete | analysis | current-active | 1/4 | repeated-variants |
| 88 | initialize_nuke | 12 | semantic-complete | analysis | historical-only | 0/3 | historical-only |
| 89 | dispatch_cutscene_animation | 12 | semantic-complete | analysis | historical-only | 0/4 | metric-tradeoffs,historical-only |
| 90 | set_weapon_animation | 12 | semantic-complete | analysis | current-active | 1/5 | metric-tradeoffs |
| 91 | mini_delete_high_score_entry | 11 | semantic-complete | analysis | historical-only | 0/5 | historical-only,stale-dependencies |
| 92 | read_repeating_text_input_key_code | 9 | semantic-complete | analysis | historical-only | 0/6 | historical-only,stale-dependencies |
| 93 | border_mouse_test | 7 | semantic-complete | analysis | historical-only | 0/3 | variant-errors,historical-only |
| 94 | update_sub_lazer_projectile | 7 | semantic-complete | analysis | historical-only | 0/9 | historical-only,stale-dependencies |
| 95 | switch_track_mirror | 7 | semantic-complete | analysis | historical-only | 0/3 | historical-only |
| 96 | append_track_cache_object | 5 | semantic-complete | analysis | historical-only | 0/3 | historical-only |
| 97 | render_backdrop | 5 | semantic-complete | analysis | current-active | 5/14 | repeated-variants,metric-tradeoffs,variant-errors |
| 98 | layout_frontend_widget | 4 | semantic-complete | analysis | current-active | 6/9 | variant-errors |
| 99 | spawn_track_health_pickup | 4 | semantic-complete | analysis | historical-only | 0/5 | historical-only |
| 100 | mark_track_warning_zones | 3 | semantic-complete | analysis | historical-only | 0/6 | historical-only,stale-dependencies |
...
| ✅ | initialize_high_score_screen | 0x416910 | 2311 | 600/600 | 100.00% | 600/600 | 137 ok |  | core |
...
| ✅ | apply_distort_to_object | 0x41aa50 | 648 | 197/197 | 100.00% | 197/197 | 26 ok |  | core |
...
| ✅ | calc_object_bounding_box | 0x42fb10 | 402 | 119/119 | 100.00% | 119/119 | 1 ok | msvc6.5 /O2 /G5 /W3 /Ow | core |
| ✅ | calc_object_facequad_normals_simple | 0x430230 | 441 | 139/139 | 100.00% | 139/139 | 5 ok |  | core |
| ✅ | calc_object_texture_groups | 0x4303f0 | 127 | 55/55 | 100.00% | 55/55 | 1 ok |  | core |
...
| ✅ | replace_object_list_texture_refs | 0x430d90 | 129 | 53/53 | 100.00% | 53/53 | 1 ok |  | core |
...
| ✅ | update_input_controller_pointer_region | 0x4321c0 | 466 | 134/134 | 100.00% | 134/134 | 32 ok |  | boundary |
...
| ✅ | initialize_track_render_cache_manager | 0x433060 | 436 | 122/122 | 100.00% | 122/122 | 18 ok |  | core |
| ✅ | build_track_render_caches | 0x433220 | 1552 | 475/475 | 100.00% | 475/475 | 20 ok |  | core |
...
| ✅ | update_ring_or_special_effect_particle | 0x43e780 | 174 | 55/55 | 100.00% | 55/55 | 5 ok |  | core |
...
| ✅ | update_damage_gauge | 0x440fd0 | 1043 | 268/268 | 100.00% | 268/268 | 65 ok |  | core |
...
| ✅ | update_cutscene | 0x4466d0 | 1888 | 505/505 | 100.00% | 505/505 | 58 ok |  | core |
...
| ✅ | queue_axis_aligned_textured_quad | 0x44a8b0 | 249 | 65/65 | 100.00% | 65/65 | 20 ok |  | boundary |
| ✅ | queue_axis_aligned_textured_quad_uv | 0x44a9b0 | 260 | 66/66 | 100.00% | 66/66 | 20 ok |  | boundary |
| ✅ | queue_textured_quad_corners | 0x44aac0 | 274 | 69/69 | 100.00% | 69/69 | 24 ok |  | boundary |
| ✅ | layout_and_queue_wrapped_font_text | 0x44abe0 | 548 | 155/155 | 100.00% | 155/155 | 12 ok |  | boundary |
| ✅ | initialize_font3d_objects | 0x44ae10 | 419 | 126/126 | 100.00% | 126/126 | 20 ok |  | boundary |
...
| 🚧 | calc_object_facequad_normals | 0x42fcb0 | 1397 | 433/437 | 97.47% | 382/437 | 22 ok |  | core |
...
| 🚧 | load_galaxy_layout | 0x4088e0 | 803 | 236/233 | 89.13% | 62/233 | 42 ok |  | core |
...
| 🚧 | mini_delete_high_score_entry | 0x417af0 | 92 | 33/33 | 87.88% | 15/33 | - |  | core |
...
| 🚧 | traverse_path_follow_golb | 0x4217b0 | 1551 | 421/425 | 86.52% | 32/425 | 7 ok |  | core |
| 🚧 | initialize_sweep_path_template_pair | 0x422c00 | 2428 | 650/652 | 84.33% | 32/652 | 37 ok |  | core |
| 🚧 | initialize_snake_path_template_pair | 0x423580 | 2436 | 652/652 | 86.96% | 387/652 | 40 ok |  | core |
...
| 🚧 | initialize_invert_path_template_pair | 0x429250 | 2182 | 605/600 | 80.17% | 120/600 | 35 ok |  | core |
| 🚧 | initialize_twister_path_template_pair | 0x42a540 | 2540 | 682/677 | 82.56% | 129/677 | 49 ok |  | core |
| 🚧 | initialize_twister2_path_template_pair | 0x42af30 | 2540 | 682/677 | 82.56% | 129/677 | 49 ok |  | core |
| 🚧 | initialize_hill_valley_path_template_pair | 0x42d570 | 2447 | 669/668 | 83.02% | 21/668 | 41 ok |  | core |
...
| 🚧 | build_subgame_level | 0x437eb0 | 2128 | 555/555 | 85.95% | 177/555 | 108 ok |  | core |
...
| 🚧 | handle_subgoldy_collisions | 0x444cf0 | 2887 | 673/673 | 86.92% | 18/673 | 89 ok |  | core |
...
| 🚧 | initialize_looptheloop_path_template_pair | 0x41b0f0 | 2630 | 720/721 | 78.56% | 44/721 | 49 ok |  | core |
| 🚧 | initialize_looptheloopw_path_template_pair | 0x41bb40 | 2725 | 739/745 | 74.39% | 10/745 | 55 ok |  | core |
| 🚧 | initialize_loopout_path_template_pair | 0x41c5f0 | 2615 | 723/718 | 68.15% | 0/718 | 52 ok |  | core |
| 🚧 | initialize_hump_path_template_pair | 0x41d030 | 2553 | 684/685 | 78.74% | 20/685 | 43 ok |  | core |
| 🚧 | initialize_dump_path_template_pair | 0x41da30 | 2563 | 687/690 | 79.74% | 20/690 | 43 ok |  | core |
| 🚧 | initialize_dip_path_template_pair | 0x41e440 | 2390 | 640/655 | 66.10% | 8/655 | 37 ok |  | core |
| 🚧 | initialize_screw_path_template_pair | 0x41eda0 | 2495 | 674/685 | 70.64% | 58/685 | 2 unaudited, 38 ok |  | core |
| 🚧 | initialize_slalom_path_template_pair | 0x41f760 | 2564 | 691/696 | 79.88% | 48/696 | 40 ok |  | core |
| 🚧 | initialize_worm_path_template_pair | 0x420170 | 2759 | 728/736 | 76.78% | 0/736 | 37 ok |  | core |
| 🚧 | update_track_attachment_follow_state | 0x420cb0 | 2750 | 712/726 | 76.22% | 122/726 | 65 ok |  | core |
| 🚧 | initialize_slalombig_path_template_pair | 0x4221f0 | 2564 | 691/696 | 79.88% | 48/696 | 40 ok |  | core |
| 🚧 | initialize_supertramp_path_template_pair | 0x423f10 | 1935 | 544/552 | 79.74% | 16/552 | 36 ok |  | core |
| 🚧 | initialize_slalomdouble_path_template_pair | 0x425050 | 2536 | 682/683 | 57.88% | 5/683 | 2 unaudited, 44 ok |  | core |
| 🚧 | initialize_p_path_template_pair | 0x425a40 | 2482 | 677/679 | 64.60% | 6/679 | 41 ok |  | core |
| 🚧 | initialize_turnover_path_template_pair | 0x426cb0 | 2433 | 671/671 | 69.60% | 54/671 | 41 ok |  | core |
| 🚧 | initialize_turnoverdouble_path_template_pair | 0x427640 | 2458 | 683/680 | 75.72% | 80/680 | 46 ok |  | core |
| 🚧 | initialize_turnunder_path_template_pair | 0x427fe0 | 2487 | 662/687 | 56.63% | 6/687 | 45 ok |  | core |
| 🚧 | initialize_wibble_path_template_pair | 0x4289a0 | 2213 | 606/608 | 77.10% | 85/608 | 39 ok |  | core |
| 🚧 | initialize_halfpipe_path_template_pair | 0x429b20 | 2592 | 688/707 | 68.96% | 18/707 | 55 ok |  | core |
| 🚧 | initialize_loopbow_path_template_pair | 0x42ba80 | 2939 | 792/796 | 74.56% | 10/796 | 63 ok |  | core |
| 🚧 | initialize_toad_path_template_pair | 0x42cbf0 | 2419 | 663/663 | 65.46% | 89/663 | 33 ok |  | core |
| 🚧 | initialize_cage2_path_template_pair | 0x42e720 | 2422 | 654/648 | 69.74% | 10/648 | 46 ok |  | core |
...
| 🚧 | build_track_fringe_objects | 0x434be0 | 1428 | 492/495 | 61.20% | 3/495 | 4 unaudited, 49 ok |  | core |
...
| 🚧 | register_font_texture_sheet | 0x449f50 | 1031 | 275/274 | 76.50% | 0/274 | 57 ok |  | boundary |
