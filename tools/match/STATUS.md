...
**564/662** port-relevant functions matched, **662/662** port-relevant functions have a scratch, **116329/299952** bytes (**38.78%**) are proof-grade, and overall fuzzy is **87.76%**.
...
**98** non-exact scratch-backed functions hold **31209 fuzzy-gap bytes**. The top 5 hold **29.5%** of that gap; the top 10 hold **42.9%**.

Current-baseline experiments cover **0 functions / 0 gap bytes**; **74 / 29893** are historical-only; **24 / 1316** have no recorded experiments.
...
|---:|---|---:|---|---|---|---:|---|
| 1 | initialize_game_assets_and_world | 4305 | semantic-complete | analysis,references | historical-only | 0/11 | repeated-variants,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 2 | update_subgoldy | 1416 | semantic-complete | analysis,references | historical-only | 0/8 | repeated-variants,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 3 | populate_runtime_track_cells_from_segments | 1348 | semantic-complete | analysis,references | historical-only | 0/139 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only |
| 4 | initialize_turnunder_path_template_pair | 1068 | semantic-complete | analysis | historical-only | 0/30 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 5 | initialize_slalomdouble_path_template_pair | 1066 | semantic-complete | analysis,references | historical-only | 0/28 | repeated-specs,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 6 | initialize_p_path_template_pair | 884 | semantic-complete | analysis | historical-only | 0/22 | repeated-specs,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 7 | update_subgame | 852 | semantic-complete | analysis | historical-only | 0/13 | historical-only,stale-dependencies |
| 8 | initialize_loopout_path_template_pair | 836 | semantic-complete | analysis | historical-only | 0/18 | metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 9 | initialize_toad_path_template_pair | 807 | semantic-complete | analysis | historical-only | 0/61 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 10 | initialize_dip_path_template_pair | 805 | semantic-complete | analysis | historical-only | 0/46 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 11 | initialize_halfpipe_path_template_pair | 805 | semantic-complete | analysis | historical-only | 0/20 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 12 | initialize_loopbow_path_template_pair | 749 | semantic-complete | analysis | historical-only | 0/12 | metric-tradeoffs,variant-errors,historical-only |
| 13 | initialize_turnover_path_template_pair | 744 | semantic-complete | analysis | historical-only | 0/51 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only |
| 14 | initialize_cage2_path_template_pair | 736 | semantic-complete | analysis | historical-only | 0/15 | repeated-variants,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 15 | initialize_screw_path_template_pair | 706 | semantic-complete | analysis,references | historical-only | 0/38 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 16 | initialize_looptheloopw_path_template_pair | 701 | semantic-complete | analysis | historical-only | 0/10 | repeated-variants,metric-tradeoffs,historical-only |
| 17 | initialize_worm_path_template_pair | 643 | semantic-complete | analysis | historical-only | 0/9 | repeated-variants,variant-errors,historical-only |
| 18 | load_segment_definitions | 616 | semantic-complete | analysis | historical-only | 0/12 | metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 19 | initialize_turnoverdouble_path_template_pair | 598 | semantic-complete | analysis | historical-only | 0/54 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only |
| 20 | initialize_looptheloop_path_template_pair | 566 | semantic-complete | analysis | historical-only | 0/10 | repeated-variants,metric-tradeoffs,historical-only |
| 21 | initialize_hump_path_template_pair | 517 | semantic-complete | analysis | historical-only | 0/27 | repeated-specs,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 22 | build_track_fringe_objects | 512 | semantic-complete | analysis | historical-only | 0/10 | metric-tradeoffs,historical-only,stale-dependencies |
| 23 | initialize_slalom_path_template_pair | 498 | semantic-complete | analysis | historical-only | 0/57 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 24 | initialize_slalombig_path_template_pair | 498 | semantic-complete | analysis | historical-only | 0/55 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 25 | render_game_frame | 445 | semantic-complete | analysis | historical-only | 0/22 | repeated-variants,repeated-specs,metric-tradeoffs,historical-only,stale-dependencies |
| 26 | initialize_dump_path_template_pair | 443 | semantic-complete | analysis | historical-only | 0/26 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 27 | initialize_wibble_path_template_pair | 443 | semantic-complete | analysis | historical-only | 0/27 | repeated-variants,repeated-specs,metric-tradeoffs,historical-only,stale-dependencies |
| 28 | initialize_hill_valley_path_template_pair | 394 | semantic-complete | analysis | historical-only | 0/37 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
...
| 30 | border_input_text | 392 | semantic-complete | analysis | historical-only | 0/13 | metric-tradeoffs,historical-only,stale-dependencies |
| 31 | update_frontend_state_machine | 370 | unspecified | unspecified | historical-only | 0/2 | historical-only,stale-dependencies |
| 32 | load_level_definition_file | 361 | semantic-complete | analysis,references | historical-only | 0/12 | repeated-variants,metric-tradeoffs,variant-errors,historical-only |
| 33 | build_subgame_level | 353 | semantic-complete | analysis | historical-only | 0/21 | metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 34 | initialize_sweep_path_template_pair | 351 | semantic-complete | analysis | historical-only | 0/39 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 35 | initialize_invert_path_template_pair | 341 | semantic-complete | analysis | historical-only | 0/30 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 36 | initialize_twister_path_template_pair | 332 | semantic-complete | analysis | historical-only | 0/33 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 37 | initialize_twister2_path_template_pair | 332 | semantic-complete | analysis | historical-only | 0/30 | repeated-variants,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 38 | initialize_snake_path_template_pair | 289 | semantic-complete | analysis | historical-only | 0/68 | metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 39 | initialize_start_path_template_pair | 268 | incomplete | analysis | historical-only | 0/67 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
...
| 41 | initialize_sbend_path_template_pair | 185 | semantic-complete | analysis | historical-only | 0/74 | repeated-specs,metric-tradeoffs,historical-only,stale-dependencies |
| 42 | set_snail_weapon | 175 | semantic-complete | analysis | historical-only | 0/10 | repeated-variants,historical-only,stale-dependencies |
| 43 | initialize_loading_screen | 131 | semantic-complete | analysis | historical-only | 0/8 | variant-errors,historical-only,stale-dependencies |
| 44 | register_font_texture_sheet | 121 | semantic-complete | analysis | historical-only | 0/26 | repeated-variants,metric-tradeoffs,historical-only,stale-dependencies |
| 45 | place_challenge_parcels_on_track | 116 | semantic-complete | analysis,references | historical-only | 0/9 | historical-only,stale-dependencies |
| 46 | update_row_event_display | 113 | unspecified | unspecified | unexplored | 0/0 | - |
| 47 | update_frontend_widget_interaction | 112 | semantic-complete | analysis,references | historical-only | 0/16 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 48 | initialize_subgame | 97 | unspecified | unspecified | unexplored | 0/0 | - |
| 49 | set_subgoldy_shoot_flags | 93 | unspecified | unspecified | unexplored | 0/0 | - |
| 50 | load_frontend_level_by_mode_and_index | 88 | semantic-complete | analysis,references | historical-only | 0/6 | historical-only,stale-dependencies |
| 51 | initialize_voice_manager | 86 | unspecified | unspecified | unexplored | 0/0 | - |
| 52 | update_cutscene | 84 | unspecified | unspecified | historical-only | 0/8 | repeated-variants,variant-errors,historical-only,stale-dependencies |
| 53 | update_completion_screen | 81 | unspecified | unspecified | unexplored | 0/0 | - |
| 54 | select_level_track_texture_set | 80 | semantic-complete | analysis,references | historical-only | 0/9 | variant-errors,historical-only,stale-dependencies |
| 55 | initialize_tip | 80 | semantic-complete | analysis | historical-only | 0/10 | repeated-variants,historical-only,stale-dependencies |
| 56 | initialize_backdrop_tile_quad | 79 | unspecified | unspecified | unexplored | 0/0 | - |
| 57 | sample_smtrack_heightmap | 76 | semantic-complete | analysis | historical-only | 0/7 | repeated-variants,historical-only,stale-dependencies |
| 58 | update_track_attachment_follow_state | 76 | semantic-complete | analysis | historical-only | 0/24 | repeated-variants,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 59 | update_thanks_for_playing_screen | 69 | unspecified | unspecified | unexplored | 0/0 | - |
| 60 | spawn_track_ring_or_special_effect | 66 | unspecified | unspecified | unexplored | 0/0 | - |
| 61 | add_object_edge | 66 | semantic-complete | analysis,references | historical-only | 0/16 | metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 62 | initialize_exit_prompt | 65 | unspecified | unspecified | unexplored | 0/0 | - |
| 63 | update_track_parcel | 64 | unspecified | unspecified | unexplored | 0/0 | - |
| 64 | normalize_segment_glyph_for_track_flags | 58 | unspecified | unspecified | unexplored | 0/0 | - |
| 65 | update_slug_hazard_ai | 54 | unspecified | unspecified | unexplored | 0/0 | - |
| 66 | initialize_frontend_widget | 51 | unspecified | unspecified | historical-only | 0/6 | repeated-variants,variant-errors,historical-only,stale-dependencies |
| 67 | select_track_tile_edge_variants | 45 | unspecified | unspecified | unexplored | 0/0 | - |
| 68 | initialize_quaternion_from_matrix | 45 | semantic-complete | analysis | historical-only | 0/10 | historical-only,stale-dependencies |
| 69 | update_frontend_transition_overlay | 42 | unspecified | unspecified | unexplored | 0/0 | - |
| 70 | update_golb_ai | 42 | semantic-complete | analysis | historical-only | 0/34 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 71 | release_snail_weapons | 40 | semantic-complete | analysis | historical-only | 0/12 | variant-errors,historical-only,stale-dependencies |
| 72 | refresh_object_vertex_buffer | 38 | semantic-complete | analysis | historical-only | 0/10 | historical-only,stale-dependencies |
| 73 | apply_all_border_visibility_mode | 38 | unspecified | unspecified | unexplored | 0/0 | - |
| 74 | update_star_field | 37 | unspecified | unspecified | unexplored | 0/0 | - |
| 75 | build_track_render_caches | 37 | unspecified | unspecified | historical-only | 0/3 | historical-only |
| 76 | play_subgoldy_shoot_sfx | 37 | semantic-complete | analysis,references | historical-only | 0/12 | repeated-variants,variant-errors,historical-only,stale-dependencies |
| 77 | update_ring_or_special_effect_parent | 36 | unspecified | unspecified | historical-only | 0/3 | historical-only |
| 78 | append_bod_to_end | 35 | unspecified | unspecified | unexplored | 0/0 | - |
| 79 | update_invincible_shell | 35 | unspecified | unspecified | unexplored | 0/0 | - |
| 80 | update_click_start | 34 | unspecified | unspecified | unexplored | 0/0 | - |
| 81 | try_enter_track_attachment_from_swept_motion | 34 | semantic-complete | analysis | historical-only | 0/11 | historical-only,stale-dependencies |
| 82 | galaxy_border_bound | 31 | unspecified | unspecified | unexplored | 0/0 | - |
| 83 | add_subgoldy_score | 29 | unspecified | unspecified | unexplored | 0/0 | - |
| 84 | set_snail_jetpack | 27 | semantic-complete | analysis | historical-only | 0/9 | repeated-variants,historical-only,stale-dependencies |
| 85 | set_subgame_features | 26 | unspecified | unspecified | unexplored | 0/0 | - |
| 86 | update_garbage_hazard | 23 | unspecified | unspecified | unexplored | 0/0 | - |
| 87 | create_golb | 20 | semantic-complete | analysis | historical-only | 0/24 | variant-errors,historical-only,stale-dependencies |
| 88 | firework_shoot | 19 | semantic-complete | analysis | historical-only | 0/11 | repeated-variants,historical-only,stale-dependencies |
| 89 | initialize_subgoldy_death | 18 | unspecified | unspecified | unexplored | 0/0 | - |
| 90 | extract_snail_local_hotspots | 18 | semantic-complete | analysis | historical-only | 0/10 | repeated-variants,variant-errors,historical-only,stale-dependencies |
| 91 | initialize_star_field | 14 | semantic-complete | analysis | historical-only | 0/20 | repeated-specs,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 92 | explode_slug_hazard | 11 | semantic-complete | analysis | historical-only | 0/19 | repeated-variants,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 93 | traverse_path_follow_golb | 11 | semantic-complete | analysis | historical-only | 0/34 | repeated-variants,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 94 | read_repeating_text_input_key_code | 9 | semantic-complete | analysis | historical-only | 0/15 | variant-errors,historical-only,stale-dependencies |
| 95 | border_mouse_test | 7 | semantic-complete | analysis | historical-only | 0/14 | variant-errors,historical-only,stale-dependencies |
| 96 | switch_track_mirror | 7 | semantic-complete | analysis | historical-only | 0/6 | historical-only,stale-dependencies |
| 97 | load_galaxy_layout | 7 | semantic-complete | analysis | historical-only | 0/33 | repeated-variants,repeated-specs,metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
| 98 | draw_frontend_widget | 7 | semantic-complete | analysis | historical-only | 0/21 | historical-only,stale-dependencies |
...
| 🚧 | initialize_frontend_widget | 0x401d30 | 1904 | 450/448 | 97.33% | 430/448 | 50 ok |  | core |
...
| 🚧 | initialize_exit_prompt | 0x4060d0 | 1808 | 466/459 | 96.43% | 442/459 | 109 ok |  | core |
| 🚧 | load_galaxy_layout | 0x4088e0 | 816 | 233/233 | 99.14% | 194/233 | 42 ok |  | core |
| 🚧 | update_golb_ai | 0x414820 | 2656 | 703/701 | 98.43% | 417/701 | 71 ok |  | core |
...
| 🚧 | build_track_render_caches | 0x433220 | 1552 | 486/489 | 97.64% | 476/489 | 20 ok |  | core |
| 🚧 | initialize_star_field | 0x434310 | 864 | 247/247 | 98.38% | 126/247 | 26 ok |  | core |
| 🚧 | spawn_track_ring_or_special_effect | 0x43df10 | 1376 | 365/364 | 95.20% | 347/364 | 4 unaudited, 75 ok |  | core |
| 🚧 | update_ring_or_special_effect_parent | 0x43e830 | 1168 | 361/357 | 96.94% | 337/357 | 38 ok |  | core |
| 🚧 | update_garbage_hazard | 0x43f200 | 777 | 230/217 | 97.09% | 217/217 | 22 ok |  | core |
| 🚧 | explode_slug_hazard | 0x43f680 | 560 | 147/147 | 97.96% | 79/147 | 32 ok |  | core |
| 🚧 | update_slug_hazard_ai | 0x43f930 | 1776 | 479/480 | 96.98% | 465/480 | 71 ok |  | core |
...
| | function | address | bytes | insns | match | prefix | masked | build | scope |
|---|---|---|---|---|---|---|---|---|---|
| 🚧 | apply_all_border_visibility_mode | 0x404360 | 480 | 154/152 | 92.16% | 138/152 | 1 unaudited, 1 ok |  | core |
| 🚧 | update_row_event_display | 0x404cf0 | 848 | 240/254 | 86.64% | 214/254 | 38 ok |  | core |
| 🚧 | update_completion_screen | 0x4067e0 | 992 | 236/232 | 91.88% | 208/232 | 69 ok |  | core |
| 🚧 | galaxy_border_bound | 0x40a0c0 | 240 | 63/82 | 86.90% | 63/82 | 2 ok |  | core |
| 🚧 | update_frontend_transition_overlay | 0x40abf0 | 256 | 81/77 | 83.54% | 63/77 | 9 ok |  | core |
| 🚧 | initialize_game_assets_and_world | 0x40acf0 | 23072 | 5405/5411 | 81.34% | 0/5411 | 2 unaudited, 1880 ok |  | core |
...
| 🚧 | initialize_intro_screen | 0x4191e0 | 1856 | 523/521 | 88.89% | 88/521 | 66 ok |  | core |
...
| 🚧 | initialize_slalom_path_template_pair | 0x41f760 | 2576 | 695/696 | 80.66% | 48/696 | 40 ok |  | core |
| 🚧 | initialize_slalombig_path_template_pair | 0x4221f0 | 2576 | 695/696 | 80.66% | 48/696 | 40 ok |  | core |
| 🚧 | initialize_sweep_path_template_pair | 0x422c00 | 2432 | 652/652 | 85.58% | 32/652 | 37 ok |  | core |
| 🚧 | initialize_snake_path_template_pair | 0x423580 | 2448 | 652/652 | 88.19% | 387/652 | 40 ok |  | core |
...
| 🚧 | initialize_twister_path_template_pair | 0x42a540 | 2544 | 678/677 | 86.94% | 129/677 | 49 ok |  | core |
| 🚧 | initialize_twister2_path_template_pair | 0x42af30 | 2544 | 678/677 | 86.94% | 129/677 | 49 ok |  | core |
| 🚧 | initialize_hill_valley_path_template_pair | 0x42d570 | 2448 | 669/668 | 83.92% | 21/668 | 41 ok |  | core |
| 🚧 | initialize_sbend_path_template_pair | 0x42df00 | 2080 | 578/579 | 91.10% | 443/579 | 39 ok |  | core |
| 🚧 | add_object_edge | 0x4305a0 | 784 | 225/227 | 91.59% | 15/227 | 3 unaudited, 34 ok |  | core |
| 🚧 | update_thanks_for_playing_screen | 0x4340f0 | 384 | 112/110 | 81.98% | 88/110 | 19 ok |  | core |
| 🚧 | update_star_field | 0x4346f0 | 272 | 83/79 | 86.42% | 67/79 | 13 ok |  | core |
| 🚧 | select_track_tile_edge_variants | 0x435a80 | 704 | 244/241 | 93.61% | 220/241 | 18 ok |  | core |
| 🚧 | switch_track_mirror | 0x435e60 | 80 | 27/30 | 91.23% | 20/30 | 3 ok |  | core |
| 🚧 | normalize_segment_glyph_for_track_flags | 0x437270 | 576 | 236/231 | 89.94% | 160/231 | 2 ok |  | core |
| 🚧 | initialize_subgame | 0x4374b0 | 1632 | 423/421 | 94.08% | 397/421 | 8 unaudited, 85 ok |  | core |
| 🚧 | build_subgame_level | 0x437eb0 | 2128 | 574/570 | 83.39% | 177/570 | 4 unaudited, 108 ok |  | core |
| 🚧 | play_subgoldy_shoot_sfx | 0x43afd0 | 336 | 96/88 | 89.13% | 26/88 | 2 unaudited, 19 ok |  | core |
| 🚧 | update_subgoldy | 0x43b120 | 8464 | 2106/2095 | 83.27% | 12/2095 | 1 unaudited, 315 ok |  | core |
| 🚧 | add_subgoldy_score | 0x4402c0 | 190 | 79/58 | 84.67% | 58/58 | 6 ok |  | core |
| 🚧 | update_click_start | 0x442290 | 624 | 148/144 | 94.52% | 138/144 | 24 ok |  | core |
| 🚧 | release_snail_weapons | 0x442e40 | 560 | 125/125 | 92.80% | 13/125 | 33 ok |  | core |
| 🚧 | update_track_parcel | 0x4431d0 | 1152 | 333/330 | 94.42% | 313/330 | 35 ok |  | core |
| 🚧 | place_challenge_parcels_on_track | 0x444240 | 624 | 173/171 | 81.40% | 0/171 | 2 unaudited, 33 ok |  | core |
| 🚧 | update_invincible_shell | 0x444b50 | 416 | 107/109 | 91.67% | 99/109 | 28 ok |  | core |
| 🚧 | set_snail_jetpack | 0x445860 | 192 | 61/62 | 86.18% | 0/62 | 8 ok |  | core |
| 🚧 | set_snail_weapon | 0x445920 | 944 | 439/440 | 81.46% | 1/440 | 24 ok |  | core |
| 🚧 | extract_snail_local_hotspots | 0x445d50 | 208 | 68/74 | 91.55% | 31/74 | 7 ok |  | core |
| 🚧 | load_level_definition_file | 0x447480 | 3040 | 942/926 | 88.12% | 20/926 | 2 unaudited, 183 ok |  | core |
| 🚧 | initialize_tip | 0x448a40 | 512 | 154/154 | 84.42% | 19/154 | 27 ok |  | core |
...
| 🚧 | initialize_quaternion_from_matrix | 0x44d5d0 | 592 | 186/186 | 92.47% | 42/186 | 23 ok |  | core |

## Mid Progress (50-79.99%) (31)
...
| 🚧 | select_level_track_texture_set | 0x410730 | 160 | 66/62 | 50.00% | 0/62 | 1 mismatch, 6 ok |  | core |
| 🚧 | update_frontend_state_machine | 0x4107d0 | 1072 | 255/298 | 65.46% | 181/298 | 69 ok |  | core |
| 🚧 | append_bod_to_end | 0x411420 | 144 | 33/54 | 75.86% | 33/54 | 2 ok |  | core |
| 🚧 | sample_smtrack_heightmap | 0x41a360 | 368 | 108/109 | 79.26% | 37/109 | 13 ok |  | core |
| 🚧 | initialize_looptheloop_path_template_pair | 0x41b0f0 | 2640 | 720/721 | 78.56% | 44/721 | 49 ok |  | core |
| 🚧 | initialize_looptheloopw_path_template_pair | 0x41bb40 | 2736 | 739/745 | 74.39% | 10/745 | 55 ok |  | core |
| 🚧 | initialize_loopout_path_template_pair | 0x41c5f0 | 2624 | 723/718 | 68.15% | 0/718 | 52 ok |  | core |
| 🚧 | initialize_hump_path_template_pair | 0x41d030 | 2560 | 686/685 | 79.80% | 20/685 | 43 ok |  | core |
| 🚧 | initialize_dip_path_template_pair | 0x41e440 | 2400 | 642/655 | 66.46% | 8/655 | 37 ok |  | core |
...
| 🚧 | initialize_slalomdouble_path_template_pair | 0x425050 | 2544 | 684/683 | 58.08% | 5/683 | 2 unaudited, 44 ok |  | core |
...
| 🚧 | initialize_cage2_path_template_pair | 0x42e720 | 2432 | 654/648 | 69.74% | 10/648 | 46 ok |  | core |
| 🚧 | build_track_fringe_objects | 0x434be0 | 1440 | 498/495 | 64.45% | 0/495 | 53 ok |  | core |
| 🚧 | set_subgame_features | 0x435df0 | 76 | 39/19 | 65.52% | 19/19 | 3 ok |  | core |
| 🚧 | populate_runtime_track_cells_from_segments | 0x435eb0 | 5056 | 1356/1338 | 73.35% | 76/1338 | 7 unaudited, 163 ok |  | core |
| 🚧 | update_subgame | 0x438b90 | 3760 | 1073/1076 | 77.34% | 9/1076 | 129 ok |  | core |
| 🚧 | set_subgoldy_shoot_flags | 0x43a1a0 | 352 | 76/68 | 73.61% | 50/68 | 2 ok |  | core |
| 🚧 | load_frontend_level_by_mode_and_index | 0x443650 | 224 | 85/77 | 60.49% | 5/77 | 1 unaudited, 12 ok |  | core |
| 🚧 | initialize_subgoldy_death | 0x446e30 | 47 | 31/14 | 62.22% | 14/14 | 3 ok |  | core |
...
| 🖥 | game_window_proc | 0x4074b0 | 832 | 228/220 | 85.27% | 141/220 | 5 unaudited, 39 ok |  | replaceable-platform |
...
| 🖥 | initialize_game_window_and_input | 0x4119d0 | 928 | 289/285 | 88.85% | 6/285 | 57 ok |  | replaceable-platform |
...
| 🖥 | set_blend_mode | 0x412d00 | 336 | 116/113 | 89.96% | 92/113 | 16 ok |  | replaceable-platform |
| 🖥 | set_immediate_blend_mode | 0x412e50 | 480 | 180/170 | 70.86% | 2/170 | 1 mismatch, 1 unaudited, 21 ok |  | replaceable-platform |
...
| 🖥 | configure_sprite_render_state | 0x413670 | 384 | 144/139 | 91.17% | 110/139 | 18 ok |  | replaceable-platform |
