...
| 37 | initialize_snake_path_template_pair | 288 | semantic-complete | analysis | historical-only | 0/72 | metric-tradeoffs,variant-errors,historical-only,stale-dependencies |
