...
- divergent: 71 type name(s) with multiple scratch-local shapes
...
| divergent | Sprite | 30 | 0 | 25 | same name has multiple scratch-local shapes; do not consolidate yet |
