...
**222/665** mapped gameplay functions matched, **13692/326119** bytes (**4.2%**). Byte totals are curated-extent upper bounds: uncurated code between manifest functions counts toward the preceding extent.
