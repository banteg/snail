...
**150/665** mapped gameplay functions matched, **7448/326119** bytes (**2.3%**). Byte totals are curated-extent upper bounds: uncurated code between manifest functions counts toward the preceding extent.
