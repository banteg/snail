...
**301/676** mapped gameplay functions matched, **21290/326004** bytes (**6.5%**). Byte totals are curated-extent upper bounds: uncurated code between manifest functions counts toward the preceding extent.
...
| 🚧 | request_object_animation | 0x430a70 | 971 | 220/231 | 41.24% | 0/231 | 1 mismatch, 1 unresolved, 13 ok |  |
...
| 🚧 | initialize_jet_particles | 0x43a5b0 | 214 | 75/73 | 86.49% | 17/73 | 3 ok |  |
...
| 🚧 | spawn_track_health_pickup | 0x43d6c0 | 441 | 120/122 | 52.89% | 16/122 | 7 ok |  |
| ✅ | spawn_track_speedup | 0x43d880 | 3 | 1/1 | 100.00% | 1/1 | - |  |
| 🚧 | spawn_track_jetpack_pickup | 0x43d890 | 491 | 137/144 | 55.52% | 1/144 | 8 ok |  |
...
| 🚧 | emit_ring_star_shower | 0x43e690 | 236 | 58/65 | 58.54% | 1/65 | 9 ok |  |
...
| 🚧 | handle_subgoldy_collisions | 0x444cf0 | 2887 | 647/673 | 48.79% | 0/673 | 1 mismatch, 65 ok |  |
...
| covered | Player | 8 | 1 | 8 | header exists; consider replacing matching scratch-local copies with includes |
