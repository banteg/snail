...
**275/665** mapped gameplay functions matched, **15949/326119** bytes (**4.9%**). Byte totals are curated-extent upper bounds: uncurated code between manifest functions counts toward the preceding extent.
