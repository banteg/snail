...
PROTO_UPDATES = (
    ...
    ("append_track_cache_object", "void __thiscall append_track_cache_object(SegmentCache* manager, int32_t row_index, Object* source, Vec3* position, ObjectRenderVertex* vertices, int32_t* vertex_count, uint16_t* indices, int32_t* index_count, int32_t max_vertices, int32_t max_indices, uint32_t color, uint8_t project_uv)"),
    ...
    ("is_sub_loc_floor", "int32_t __fastcall is_sub_loc_floor(cRSubLoc* cell)"),
    ("is_sub_loc_slide", "int32_t __fastcall is_sub_loc_slide(cRSubLoc* cell)"),
    ("is_sub_loc_ramp", "int32_t __fastcall is_sub_loc_ramp(cRSubLoc* cell)"),
    ("is_sub_loc_empty", "int32_t __fastcall is_sub_loc_empty(cRSubLoc* cell)"),
)
