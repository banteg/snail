...
ARCHIVE_SHELL_LVAR_SPECS = [
    ...
    (
        "load_archive_index",
        "serialized_header",
        "SerializedArchiveHeader serialized_header;",
        68,
        None,
    ),
    (
    ...
    (
        ...
        "ArchiveEntry* archive_entry_cursor;",
        None,
        0x431062,
    ),
    (
    ...
    (
        ...
        "int allocation_archive_position;",
        None,
        0x4310EE,
    ),
    (
    ...
    (
        ...
        "int allocation_byte_count_offset;",
        None,
        0x4313D8,
    ),
    (
