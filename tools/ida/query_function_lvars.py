...
IDAPYTHON_SCRIPT_PATH = REPO_ROOT / "tools/ida/inspect_function_lvars.py"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="List Hex-Rays local-variable identities, types, and stack offsets."
    )
...
def main() -> int:
    ...
    if not IDAPYTHON_SCRIPT_PATH.is_file():
        raise FileNotFoundError(f"IDAPython inspection script not found: {IDAPYTHON_SCRIPT_PATH}")
