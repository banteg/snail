...
DEFAULT_HEADER_PATH = REPO_ROOT / "analysis/headers/segment_catalog_types.h"
IDAPYTHON_SCRIPT_PATH = REPO_ROOT / "tools/ida/apply_segment_catalog_types.py"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Path to the checked-in segment catalog type header.",
    )
...
def main() -> int:
    ...
    exit_code, log_text = run_ida_script(
        ...
        log_stem="sync-segment-catalog-types",
    )
