...
IDAPYTHON_SCRIPT_PATH = REPO_ROOT / "tools/ida/apply_backdrop_types.py"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Apply the exact cRBackdrop owner and root composition to IDA."
    )
