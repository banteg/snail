...
IDAPYTHON_SCRIPT_PATH = REPO_ROOT / "tools/ida/apply_display_mode_types.py"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Path to the checked-in display-mode type declaration.",
    )
...
def main() -> int:
    ...
    exit_code, log_text = run_ida_script(
        ...
        log_stem="sync-display-mode-types",
    )
